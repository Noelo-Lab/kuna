...
(FID PR3). The design doc (`docs/history/fid-design.md` §7) is retired — see
`docs/history.md` and git history.
...
design doc (retired; git history of `docs/history/fid-design.md` §7.2) targets. The byte-exact PR2 hasher, the
