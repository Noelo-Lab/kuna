...
public:
  ...
  bool input_varnode_adjust;	///< (kuna) True if overlapping input Varnodes extending above a justified container are absorbed instead of aborting (GH-9218)
  ...
  bool strip_stack_guard;	///< (kuna) True if the glibc -fstack-protector canary epilogue is stripped (angr StackCanarySimplifier port)
