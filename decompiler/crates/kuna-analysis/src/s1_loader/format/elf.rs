...
//!   [`crate::s1_loader::elf_plt::resolve_plt_imports`] (its internals are
...
impl ObjectFormat for ElfFormat {
    ...
    fn resolve_imports(&self, file: &object::File, _bytes: &[u8]) -> Vec<ImportSym> {
        ...
        crate::s1_loader::elf_plt::resolve_plt_imports(file)
            .into_iter()
    ...
    fn const_ranges(&self, file: &object::File, _bytes: &[u8]) -> Vec<(u64, u64)> {
        crate::s1_loader::elf_plt::mips_got_const_ranges(file)
    }
}
