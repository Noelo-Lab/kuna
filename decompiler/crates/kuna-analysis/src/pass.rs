...
pub struct AnalysisOutput {
    ...
    /// [`crate::entry::kuna_fdeinterior`] (`.eh_frame` FDEs),
    /// [`crate::entry::kuna_pdatainterior`] (`.pdata` records) and
    /// [`crate::pdb::kuna_pdbinterior`] (PDB procedures), so the list is empty
    /// whenever their gates are off and the suppression is a no-op.
