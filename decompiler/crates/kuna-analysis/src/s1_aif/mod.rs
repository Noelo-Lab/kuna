...
//!
//! Entry discovery ([`crate::s1_entry`]) + funcsyms find functions that are
...
//!
//! The two no-return consumers ([`crate::s1_noreturn_disc`] /
//! [`crate::s1_noreturn_propagate`]) read ONLY the built Listing, so they are pure
