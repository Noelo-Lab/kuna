...
fn conflicting_tocs_are_not_arbitrarily_chosen() {
    let mut d=Descriptors(vec![
        Descriptor { address:0x2000,entry:0x1000,toc:Some(0x3000) },
        Descriptor { address:0x2018,entry:0x1000,toc:Some(0x3008) },
        Descriptor { address:0x2030,entry:0x1010,toc:Some(0x3010) },
    ]);
