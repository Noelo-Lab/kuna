...
#[test]
fn fixture_has_all_46_settables() {
    ...
    // goto-reduction gate, and the `tailcalljump` angr -O2 tail-jump S2
    // flow-classification gate) + 15 analysis-tier gates (10 per-run
