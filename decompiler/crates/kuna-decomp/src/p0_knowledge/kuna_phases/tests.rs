...
fn settable_count_is_165() {
    ...
    assert_eq!(kuna_num_settables(), 165);
    assert_eq!(SETTABLE_TABLE.len(), 165);
}

#[test]
fn tier_counts_are_46_core_64_transform_55_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (46, 64, 55));
}
...
#[test]
fn option_values_live_value_present_for_55_suppressed_for_99() {
    let ov = OptionValues::default();
