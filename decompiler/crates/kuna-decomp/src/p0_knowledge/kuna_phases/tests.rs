...
fn settable_count_is_206() {
    ...
    assert_eq!(kuna_num_settables(), 206);
    assert_eq!(SETTABLE_TABLE.len(), 206);
}

#[test]
fn tier_counts_are_66_core_78_transform_62_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (66, 78, 62));
}
