...
fn settable_count_is_172() {
    ...
    assert_eq!(kuna_num_settables(), 172);
    assert_eq!(SETTABLE_TABLE.len(), 172);
}

#[test]
fn tier_counts_are_49_core_66_transform_57_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (49, 66, 57));
}
