...
fn settable_count_is_175() {
    ...
    assert_eq!(kuna_num_settables(), 175);
    assert_eq!(SETTABLE_TABLE.len(), 175);
}

#[test]
fn tier_counts_are_51_core_67_transform_57_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (51, 67, 57));
}
