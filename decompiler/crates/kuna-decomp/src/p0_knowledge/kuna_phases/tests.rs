...
fn settable_count_is_173() {
    ...
    assert_eq!(kuna_num_settables(), 173);
    assert_eq!(SETTABLE_TABLE.len(), 173);
}

#[test]
fn tier_counts_are_50_core_66_transform_57_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (50, 66, 57));
}
...
#[test]
fn option_values_live_value_present_for_60_suppressed_for_101() {
    let ov = OptionValues::default();
