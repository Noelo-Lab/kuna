...
fn settable_count_is_180() {
    ...
    assert_eq!(kuna_num_settables(), 180);
    assert_eq!(SETTABLE_TABLE.len(), 180);
}

#[test]
fn tier_counts_are_55_core_68_transform_57_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (55, 68, 57));
}
...
#[test]
fn option_values_live_value_present_for_64_suppressed_for_102() {
    let ov = OptionValues::default();
