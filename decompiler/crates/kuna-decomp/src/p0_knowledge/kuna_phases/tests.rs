...
fn settable_count_is_169() {
    ...
    assert_eq!(kuna_num_settables(), 169);
    assert_eq!(SETTABLE_TABLE.len(), 169);
}

#[test]
fn tier_counts_are_47_core_66_transform_56_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (47, 66, 56));
}
