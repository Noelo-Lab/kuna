...
fn settable_count_is_152() {
    ...
    // DIV-118).
    assert_eq!(kuna_num_settables(), 152);
    assert_eq!(SETTABLE_TABLE.len(), 152);
}

#[test]
fn tier_counts_are_37_core_61_transform_54_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (37, 61, 54));
}
