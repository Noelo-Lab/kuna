...
fn settable_count_is_166() {
    ...
    assert_eq!(kuna_num_settables(), 166);
    assert_eq!(SETTABLE_TABLE.len(), 166);
}

#[test]
fn tier_counts_are_46_core_65_transform_55_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (46, 65, 55));
}
...
#[test]
fn option_values_live_value_present_for_56_suppressed_for_99() {
    let ov = OptionValues::default();
