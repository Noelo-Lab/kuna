...
#[test]
fn tier_counts_are_27_core_51_transform_47_analysis() {
    let mut core = 0;
    let mut transform = 0;
    let mut analysis = 0;
    ...
    assert_eq!((core, transform, analysis), (27, 51, 47));
}
...
#[test]
fn option_values_live_value_present_for_37_suppressed_for_77() {
    let ov = OptionValues::default();
