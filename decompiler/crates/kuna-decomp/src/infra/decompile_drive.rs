...
fn run_pipeline(arch: &mut Architecture, fd: &mut Funcdata) -> KunaResult<int4> {
    ...
    for _ in 0..=MAX_REFLOW {
        ...
        crate::p4_calls::kuna_callbacktype::seed(arch, fd);
...
pub fn decompile_func_full_with_override_dyn_prefollowed(
    ...
    let result = (|| {
        ...
        // (kuna `callbacktype`) What the parked callbacks it calls stated.
        crate::p4_calls::kuna_callbacktype::seed(arch, &mut fd);
