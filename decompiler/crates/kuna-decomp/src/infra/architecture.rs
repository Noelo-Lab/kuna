...
impl Architecture {
    ...
    pub fn reset_defaults_internal(&mut self) {
        ...
        self.pass_through = true; // (kuna) option passthrough default-on: over 444 decbench slices 2,773 of 2,900 gained parameters are confirmed by the unstripped twin's DWARF, 4 contradicted and 123 are thunks DWARF does not describe, with 0 parameters and 0 call arguments lost; docs/features/passthrough/dwarf-confirmation.md
