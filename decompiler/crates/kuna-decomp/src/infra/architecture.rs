...
impl Architecture {
    ...
    pub fn from_engine_translate(
        ...
        let mut arch = Architecture {
            ...
            struct_synth: crate::kuna_structsynth::StructSynthMode::Off, // (kuna) option structsynth
    ...
    pub fn reset_defaults_internal(&mut self) {
        ...
        self.struct_synth = crate::kuna_structsynth::StructSynthMode::Off; // (kuna) structsynth default `off`: synthesizing a structure invents a type the binary does not carry, so it is opt-in
