...
impl Architecture {
    ...
    pub fn reset_defaults_internal(&mut self) {
        ...
        self.cast_sign = true; // (kuna) option castsign default-on: a frame local or pointer index only ever compared signed, and never an operand of + - * <<, is declared signed; 0/675 datatest assertions and 0 stage assertions moved, test-cli unchanged, the 444-slice typesweep identical, casts 43,673 -> 43,592 on the census corpus, 39 functions fewer and 0 more; docs/features/castsign/default-on-evaluation.md
