...
mod tests {
    ...
    fn test_xml_corpus_datatests_and_stage_tests() {
        ...
        // and ghangr-condjoin / condjoin, the angr MultiStatementExpression escape
        // hatch for ruleBlockOr's isComplex readability budget (a guard cascade whose
        // arms reconverge on a shared body loses its forward goto + label))
