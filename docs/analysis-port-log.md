...
|----|---------|-------------------|------|----------|
| ✅ | `plt-got` | PLT/GOT import names (`ElfDefaultGotPltMarkup`) | — | fauxware `0x400510→puts` (x86-64); **RISC-V64 e2e** (Increment 20): linked `plt_riscv64` `main` renders `puts`/`printf` |
