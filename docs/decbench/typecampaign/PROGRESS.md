...
| C12 | structsynth `locals` — records for call-returned pointers | C | built + gated, no PR | /home/mahaloz/kwt/structlocals (feat/structlocals) | — | typesweep 1,353 = 1,353 (0/0); record-typed call-defined locals 40 → 128 on 14 builds; make test 675/675, stages + test-cli green, rust-test 7,377 passed | open the PR |
