...
| A3 | protoorder (types-only redesign, default types) | A | open, review CHANGES (not landed) | /home/mahaloz/kwt/protoorder | #669 | r11 on d96e3408: 986→1105 perfect (+119), 3 worse; 0 call-arity changes (60-binary corpus); speed ≤+3.4%; all gates green | address review, land |
...
| A5 | formatstring at load time (default static) | A | open, review CHANGES (not landed) | /home/mahaloz/kwt/formatstring | #673 | r4: 987→1025 perfect (+38), 176 better / 2 worse; speed −1.1..+1.0% | address review, land |
| B6 | orphan goto (invalid C) | B | merged 70511284 | — | #674 | strict fix | — |
| C4 | structsynth subsumption dedup | C | open, review CHANGES (not landed) | /home/mahaloz/kwt/structdedup | #675 | r7: 516→472 struct names; held-out precision .8750 vs .8735 | address review, land |
...
| B4a-on | foldcallretphi default on | B | open, review CHANGES (not landed) | /home/mahaloz/kwt/foldcallretphi-on | #681 | 986=986; −14 declarations; speed ≤+1.04% | address review |
...
| A2-on | ptrfromuse void default | A | no PR, waits on #669 | /home/mahaloz/kwt/ptrfromuse-on | — | on the protoorder base: 1105→1309 (+204), 85 improved / 0 worse | rebase after #669 lands, open flip PR |
| B1-on | argclobber default | B | stays off, no PR | /home/mahaloz/kwt/argclobber-on | — | 4 counterexamples drop a read arg; typesweep 986=986 | — |
