...
| C14 | `layoutrecall` — claim more ground-truth struct fields | C | not landed (no PR) | /home/mahaloz/kwt/layoutrecall | — | the lane's agent died against its structured-output retry cap | layout recall is still .0932 (8,563 of 9,443 GT fields never claimed) |
