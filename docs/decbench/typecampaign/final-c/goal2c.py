...
OUT = Path("/home/mahaloz/kwt/_final-c/goal2")
KUNAS = {"c": ("/home/mahaloz/kwt/_final-c/kuna", "/home/mahaloz/kwt/_final-main/specs"),
         "c-argclobber": ("/home/mahaloz/kwt/_final-c/kuna", "/home/mahaloz/kwt/_final-main/specs")}
...
def run(label, opt, b):
    ...
    extra = ["--option", "argclobber", "on"] if label.endswith("argclobber") else []
