...
sys.path.insert(0, "/home/mahaloz/kwt/_final/tools")
...
OUT = Path("/home/mahaloz/kwt/_final/goal2")
KUNAS = {"base": ("/home/mahaloz/kwt/_baseline/kuna", "/home/mahaloz/github/kuna/specs"),
...
def run(label, opt, b):
    ...
    t = subprocess.run([kb, "decompile-all", str(binp)], capture_output=True, text=True, env=env, timeout=3600)
    j = subprocess.run([kb, "decompile-all", str(binp), "--json"], capture_output=True, text=True, env=env, timeout=3600)
