#!/bin/bash
# round-E sweep (pinned metric) + round-D binary control under this tree
set -u
...
KUNA_BIN=/home/mahaloz/kwt/_final-e/kuna ~/.virtualenvs/decbench/bin/python -m finalsweep kuna $P --workers 12 --out /home/mahaloz/kwt/_final-e/sweep-e \
  > /home/mahaloz/kwt/_final-e/sweep-e.log 2>&1 &
KUNA_BIN=/home/mahaloz/kwt/_final-d/kuna ~/.virtualenvs/decbench/bin/python -m finalsweep kuna $P --workers 12 --out /home/mahaloz/kwt/_final-e/sweep-dctl \
  > /home/mahaloz/kwt/_final-e/sweep-dctl.log 2>&1 &
wait
echo ALLSWEEPS_DONE
