...
KUNA_BIN=/home/mahaloz/kwt/_final-e/bis-$c/kuna ~/.virtualenvs/decbench/bin/python -m finalsweep kuna $P --workers 12 --out /home/mahaloz/kwt/_final-e/sweep-bis-$c \
  > /home/mahaloz/kwt/_final-e/sweep-bis-$c.log 2>&1 &
done
wait
echo BIS_SWEEPS_DONE
