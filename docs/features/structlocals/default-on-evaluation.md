...
| (e) | interleaved min-of-15, fmt/ls/sort O2 + bash O2, worst delta <= +5% | locals vs param: fmt -1.74%, ls -0.32%, sort +1.72%, bash -0.37%; locals vs the tree before this change: fmt -0.11%, ls -0.50%, sort +0.75%, bash +0.72% (worst +1.72%) |
