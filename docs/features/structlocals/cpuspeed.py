"""Interleaved min-of-N decompile-all wall AND cpu (user+sys of the child) time: param vs default locals, one build.

    python3 cpuspeed.py <N> <out.json> sort[,fmt,...] <kuna>
...
K = {"param": ["--option", "structsynth", "param"], "locals": []}
ARMS = list(K)
