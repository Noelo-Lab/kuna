...
| (e) speed, interleaved min-of-15, fmt/ls/sort/bash -O2 | SPEED_ROW |
| (f) whole-corpus before/after, 15 binaries | **pass** — 708 of 10,288 functions change; every one classified (below), no hunk outside the option's documented effect. |
