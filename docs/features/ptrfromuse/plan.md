...
5. Fix what the sweep finds rather than document it: the store split the first
   sweep found came from a `protoorder` vote, so the refusal went there and
   shipped in #669, ahead of this flip.
