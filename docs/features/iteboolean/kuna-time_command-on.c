uint4 sub_4ea10(int4 *a0,unsigned int a1,unsigned int a2,unsigned int a3,unsigned long a4) // warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_4ea10
{
  unsigned long v1;
  char v10 [16];
  char v11 [16];
