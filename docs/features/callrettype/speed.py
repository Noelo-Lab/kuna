"""Interleaved min-of-N whole-binary decompile-all timing: callrettype off vs on (explicit both arms)."""
...
ARMS = {"off": ["--option", "callrettype", "off"], "on": ["--option", "callrettype", "on"]}
