...
`PARITY OK` (1094/1094 on the foldcallret-barrier base), speed within the +5% budget, and every hunk
over twelve whole binaries classified as a declaration flip or a dropped cast.
