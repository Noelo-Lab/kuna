...
| 1243 | 8051 | spec-fix | S2 | 8051-addc-carry-semantics | easy | — | — | triaged |
...
| 4788 | V850 | spec-fix | S2 | v850-rh850-missing-decode | medium | — | — | triaged |
| 5666 | x86 | spec-fix | S2 | x86-addrsize-stack-push | medium | — | — | triaged |
| 5897 | ARM | spec-fix | S2 | arm-mnemonic-display | easy | — | — | triaged |
...
| 7139 | x86 | spec-fix | S1 | x86-16bit-disp-signedness | medium | — | — | triaged |
...
| 7418 | x86 | spec-fix | S2 | x86-addrsize-stack-push | easy | — | — | triaged |
| 7451 | RISC-V | spec-fix | S2 | riscv-zfa-missing-decode | medium | — | — | triaged |
| 7890 | ARM | spec-fix | S2 | arm-vfp-pseudoop-fpscr | hard | — | — | triaged |
...
| 8391 | ARM | spec-fix | S2 | arm-thumb-cde-guard | medium | — | — | triaged |
| 8456 | ARM | spec-fix | S2 | arm-missing-instruction-decode | medium | — | — | triaged |
| 8467 | AARCH64 | stage-exposure | S6 | dynamic-hash-maxduplicates | medium | 4013 | dynamichashmax | triaged |
