...
void sub_9f80(void *a0,int a1) // return-dupe
{
  short *v1;
  int v10; // r9d
  unsigned short *v2;
...
void sub_a6b0(void *a0,int a1) // return-dupe
{
  unsigned short v1;
  int v2; // ecx
  int v3;
...
void sub_a870(void *a0,long a1) // ternary
{
  unsigned short *v1;
  unsigned long v10;
  unsigned long v11;
  ...
  sub_43b0(*(unsigned short *)((long)a0 + 0x400),*(unsigned short *)((long)a0 + 0x402)); // tail-call
}
...
long sub_add0(char *a0,unsigned long a1,int a2,int a3)
{
  ...
  *(char *)((unsigned long)dat_dca4c + 0xdca60) = dat_dca49;
  ...
  sub_9f80((void *)0xdf080,dat_183e4);
  sub_9f80((void *)0xdef80,dat_183a4);
...
label_aeb0:
      ...
      if ((a1 + 4 <= v9) && (a0)) {
        ...
        if (v10 <= v5) { // branch-flip
          ...
          sub_a6b0((void *)0xdf080,v3);
          sub_a6b0((void *)0xdef80,v2);
          sub_a870((void *)0xdf080,0xdef80);
...
long sub_e980(void *a0,long *a1) // return-dupe x3
{
  unsigned long *v1;
  unsigned long v2;
  long v3; // rax
  ...
  if (v1[1] != 0x3ffffffe) { // branch-flip
    ...
    if (v3 == 0x3ffffffe) {
      v2 = *(unsigned long *)((long)a0 + 0x60);
      v1[2] = *(unsigned long *)((long)a0 + 0x58);
      v1[3] = v2;
      v3 = 0;
      return v3;
    }
    ...
    v2 = *(unsigned long *)((long)a0 + 0x50);
    *v1 = *(unsigned long *)((long)a0 + 0x48);
    v1[1] = v2;
  }
  if (v3 != 0x3fffffff) {
    v3 = 0;
