...
void sub_47f1(char *a0)
{
  *a0 = pthread_sigmask(0,(void *)0x236a0,&a0[8]) == 0;
}
...
unsigned long sub_486b(char *a0,unsigned long a1)
{
  return (unsigned long)(long)*(int *)&a0[8] % a1;
}

// Function: sub_489a @ 0x489a
unsigned int sub_489a(char *a0,char *a1)
{
...
char * sub_5372(long *a0,char a1) // early-return
{
  char *v1;
  unsigned int v2; // eax
  int v3; // stack - 0x34
  ...
  v5 = (char *)sub_4c3d(&v3,(unsigned char)a1);
  if (!v5)
    return NULL;
  v5[0xc] = 0;
  if (dat_23690) {
    v2 = sub_5193(&v4,4);
    *(unsigned int *)&v5[8] = v2;
    if (1 <= *(int *)&v5[8]) { // branch-flip
      close(v3);
      close(v4);
      v3 = v6;
      sub_4a08(v5);
...
FILE * sub_551c(char *a0) // early-return
{
  int v1;
  int v2; // eax
  unsigned long v3; // rax
...
char * sub_6898(struct_4 *a0,char *a1)
{
  long v1;
  long v2;
  char *v3;
...
unsigned int sub_7fc5(char *a0) // return-dupe
{
  if (((!a0[0x32]) && (!a0[0x34])) && (!a0[0x35]))
    return 0;
  return 1;
}
...
unsigned int sub_8305(char *a0) // return-dupe
{
  if (((((!*(long *)&a0[0x20]) && (!*(long *)&a0[0x28])) && (a0[0x30] != '\x01')) && ((a0[0x31] != '\x01' && (sub_7fc5(a0) != '\x01')))) && ((a0[0x36] != '\x01' && ((a0[0x38] != '\x01' && (a0[0x33] != '\x01'))))))
    return 1;
  return 0;
}

// Function: sub_839e @ 0x839e
void sub_839e(char *a0,char *a1)
{
  char *v1;
  char *v2; // stack - 0x18
  
  if ((a0[0x30]) || (v2 = a1, a0[0x31])) {
    v2 = &a1[1];
    *a1 = 0x62;
  }
  ...
  *a2 = sub_1819d(a1,8);
  ...
  for (v3 = 0; (unsigned long)(long)v3 < a1; v3 = v3 + 1) {
    if ((*(long *)(a0 + (long)v3 * 0x10 + 8)) && (*(char *)(*(long *)(a0 + (long)v3 * 0x10 + 8) + 0xc)))
      v2 = sub_551c(*(char **)(a0 + (long)v3 * 0x10 + 8));
    else {
...
void sub_b536(unsigned long *a0,unsigned long a1,unsigned long *a2,char a3) // return-dupe x2
{
  ...
  if (a1 != 2) {
    ...
    sub_b536(&a0[v4 * -4],a1 - v4,(char *)(v5 + (long)a2),(unsigned char)a3);
    if (2 <= v4) // branch-flip
...
unsigned long * sub_b911(char *a0,struct_17 *a1,long a2,unsigned long a3,long a4,bool a5) // ternary x2
{
  unsigned long v1;
  unsigned long v2; // rax
  long v3; // rax
...
bool sub_bb0c(char *a0,char *a1) // ternary
{
  bool v1; // cf
...
void sub_bc6b(unsigned long *a0,char *a1)
{
...
void sub_c34c(unsigned long *a0,char *a1) // return-dupe
{
  if (2 <= *(unsigned int *)&a1[0x50]) {
    sub_bb87(*(long *)&a1[0x38]);
    sub_c28e(a0,*(struct_20 **)&a1[0x38]);
    sub_bba6(*(long *)&a1[0x38]);
    return;
  }
  if (!(*(long *)&a1[0x30] + *(long *)&a1[0x28])) {
    sub_bc6b(a0,*(char **)&a1[0x38]);
    return;
  }
}
...
char * sub_d929(char *a0,char *a1,int a2)
{
  char *v1; // stack - 0x10
...
long sub_10b58(char *a0,long a1) // return-dupe
{
  void *v1;
  long v2;
  long *v3; // stack - 0x18
...
long sub_10c4f(char *a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_110f4(unsigned long a0,char *a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
...
long * sub_1120d(unsigned long a0,char *a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
unsigned long sub_11bdd(char *a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
...
unsigned long sub_11f4e(char *a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_11fbe(char *a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
...
void sub_122c4(char *a0,long a1)
{
  sub_11fbe(a0,a1);
}
...
char * sub_12802(unsigned int a0,char *a1)
{
...
char * sub_1287e(unsigned long a0,char *a1)
{
  unsigned long v1; // stack - 0x20
  char *v2; // stack - 0x10
...
unsigned int sub_13678(char *a0,unsigned int a1)
{
  unsigned int v1;
  char *v2; // stack - 0x20
...
void sub_15790(char *a0,unsigned long a1)
{
  *(unsigned long *)&a0[8] = a1;
}

// Function: sub_157af @ 0x157af
void sub_157af(char *a0,unsigned long a1)
{
...
void sub_161e0(char *a0)
{
  ...
  v14 = 0x647c4677a2884b7c;
  v15 = 0xb9f8b322c73ac862;
  v16 = 0x8c0ea5053d4712a0;
  v17 = 0xb29b2e824a595524;
  v18 = 0x82f053db8355e0ce;
  v19 = 0x48fe4a0fa5a09315;
  v20 = -0x5167a40d34037613;
  v21 = -0x670a8fb093bb3f55;
  for (v12 = 0; v12 <= 0xff; v12 = v12 + 8) {
    v5 = *(long *)&a0[(long)(v12 + 1) * 8];
    v6 = *(long *)&a0[(long)(v12 + 2) * 8];
    v7 = *(long *)&a0[(long)(v12 + 3) * 8];
    v8 = *(long *)&a0[(long)(v12 + 4) * 8];
    v9 = *(long *)&a0[(long)(v12 + 5) * 8];
    v10 = *(long *)&a0[(long)(v12 + 6) * 8];
    v11 = *(long *)&a0[(long)(v12 + 7) * 8];
    v1 = (v14 + *(long *)&a0[(long)v12 * 8]) - (v18 + v8);
    v2 = v19 + v9 ^ (unsigned long)sub_15a2d(v21 + v11) >> 9;
    v5 = (v15 + v5) - v2;
    v3 = v20 + v10 ^ v1 * 0x200;
    v6 = (v16 + v6) - v3;
    v4 = v21 + v11 + v1 ^ (unsigned long)sub_15a2d(v5) >> 0x17;
    v7 = (v17 + v7) - v4;
    v14 = v1 + v5 ^ v6 * 0x8000;
    v1 = (v18 + v8) - v14;
    v15 = v5 + v6 ^ (unsigned long)sub_15a2d(v7) >> 0xe;
    v5 = v2 - v15;
    v16 = v6 + v7 ^ v1 * 0x100000;
    v20 = v3 - v16;
    v17 = v7 + v1 ^ (unsigned long)sub_15a2d(v5) >> 0x11;
    v19 = v5 + v20;
    v21 = v4 - v17;
    v18 = v1 + v5 ^ v20 * 0x4000;
    v20 += v21;
    *(unsigned long *)&a0[(long)v12 * 8] = v14;
    *(unsigned long *)&a0[(long)(v12 + 1) * 8] = v15;
    *(unsigned long *)&a0[(long)(v12 + 2) * 8] = v16;
    *(unsigned long *)&a0[(long)(v12 + 3) * 8] = v17;
    *(unsigned long *)&a0[(long)(v12 + 4) * 8] = v18;
    *(long *)&a0[(long)(v12 + 5) * 8] = v19;
    *(long *)&a0[(long)(v12 + 6) * 8] = v20;
    *(long *)&a0[(long)(v12 + 7) * 8] = v21;
  }
  for (v13 = 0; v13 <= 0xff; v13 = v13 + 8) {
    v5 = *(long *)&a0[(long)(v13 + 1) * 8];
    v6 = *(long *)&a0[(long)(v13 + 2) * 8];
    v7 = *(long *)&a0[(long)(v13 + 3) * 8];
    v8 = *(long *)&a0[(long)(v13 + 4) * 8];
    v9 = *(long *)&a0[(long)(v13 + 5) * 8];
    v10 = *(long *)&a0[(long)(v13 + 6) * 8];
    v11 = *(long *)&a0[(long)(v13 + 7) * 8];
    v1 = (v14 + *(long *)&a0[(long)v13 * 8]) - (v18 + v8);
    v2 = v19 + v9 ^ (unsigned long)sub_15a2d(v21 + v11) >> 9;
    v5 = (v15 + v5) - v2;
    v3 = v20 + v10 ^ v1 * 0x200;
    v6 = (v16 + v6) - v3;
    ...
    v18 = v1 + v5 ^ v20 * 0x4000;
    v20 += v21;
    *(unsigned long *)&a0[(long)v13 * 8] = v14;
    *(unsigned long *)&a0[(long)(v13 + 1) * 8] = v15;
    *(unsigned long *)&a0[(long)(v13 + 2) * 8] = v16;
    *(unsigned long *)&a0[(long)(v13 + 3) * 8] = v17;
    *(unsigned long *)&a0[(long)(v13 + 4) * 8] = v18;
    *(long *)&a0[(long)(v13 + 5) * 8] = v19;
    *(long *)&a0[(long)(v13 + 6) * 8] = v20;
    *(long *)&a0[(long)(v13 + 7) * 8] = v21;
  }
...
unsigned long sub_16b8b(FILE *a0,char *a1)
{
  char *v1;
  long v2;
  int v3; // eax
...
void sub_1a1a6(char *a0,unsigned long a1) // return-dupe
{
  if (a0[0x50] & 1) {
...
void sub_1a1fa(char *a0,unsigned long a1) // return-dupe
{
  if (a0[0x50] & 1) {
