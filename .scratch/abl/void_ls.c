...
void sub_5297(void *a0,struct_4 *a1)
{
  ...
  v1 = *(unsigned int *)((long)a0 + 0x8c);
  v2 = *(unsigned int *)((long)a0 + 0x88);
  ...
  v3 = sub_5267(*(unsigned long *)((long)a0 + 0x40),*(unsigned long *)((long)a0 + 0x48));
  a1->field_0x48 = SUB168(v3,0);
  a1->field_0x50 = SUB168(v3,8);
  v3 = sub_5267(*(unsigned long *)((long)a0 + 0x70),*(unsigned long *)((long)a0 + 0x78));
  a1->field_0x58 = SUB168(v3,0);
  a1->field_0x60 = SUB168(v3,8);
  v3 = sub_5267(*(unsigned long *)((long)a0 + 0x60),*(unsigned long *)((long)a0 + 0x68));
...
void sub_581f(char *a0,void *a1) // return-dupe
{
  long v1;
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x40
  
  v2 = (unsigned long)(*(long *)((long)a1 + 0x18) - *(long *)((long)a1 + 0x10)) >> 3;
  if (!v2)
    return;
  v1 = *(long *)((long)a1 + 0x10);
  if (v1 == *(long *)((long)a1 + 0x18))
    *(unsigned char *)((long)a1 + 0x50) = *(unsigned char *)((long)a1 + 0x50) | 2;
  *(unsigned long *)((long)a1 + 0x18) = ~*(unsigned long *)((long)a1 + 0x30) & *(long *)((long)a1 + 0x18) + *(long *)((long)a1 + 0x30);
  if ((unsigned long)(*(long *)((long)a1 + 0x20) - *(long *)((long)a1 + 8)) < (unsigned long)(*(long *)((long)a1 + 0x18) - *(long *)((long)a1 + 8)))
    *(unsigned long *)((long)a1 + 0x18) = *(unsigned long *)((long)a1 + 0x20);
  *(unsigned long *)((long)a1 + 0x10) = *(unsigned long *)((long)a1 + 0x18);
...
int main(int argc,char **argv,char **envp) // warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in main
{
  ...
  if (dat_2b3cc) {
    sub_581f("//DIRED//",(void *)0x2b520);
    sub_581f("//SUBDIRED//",(void *)0x2b580);
...
unsigned int sub_a8a4(void *a0) // return-dupe
{
  if (((*(int *)((long)a0 + 0xa8) != 3) && (*(int *)((long)a0 + 0xa8) != 9)) && ((*(unsigned int *)((long)a0 + 0xac) & 0xf000) != 0x4000))
    return 0;
  return 1;
}

// Function: sub_a8f5 @ 0xa8f5
void sub_a8f5(char *a0,void *a1,char a2) // return-dupe
{
  unsigned long v1;
  
  v1 = *(unsigned long *)((long)a1 + 0x48);
  *(unsigned long *)((long)a1 + 8) = sub_f7a0(a0,v1);
  if (*(long *)((long)a1 + 8))
    return;
...
unsigned long sub_ad02(void *a0,void *a1,void *a2)
{
  unsigned char v1; // al
  unsigned long v2; // rax
  unsigned int v3; // edx
...
void sub_be7a(void *a0,void *a1)
{
  sub_ad02(a0,a1,sub_be28);
}

// Function: sub_beaa @ 0xbeaa
void sub_beaa(void *a0,void *a1)
{
...
char * sub_c643(void *a0,unsigned long a1,void *a2) // early-return
{
  unsigned long v1;
  
  if (a1 <= 0x14)
    __assert_fail("INT_BUFSIZE_BOUND (uintmax_t) <= buflen","src/ls.c",0x10be,"format_inode"); // no-return
  if ((*(char *)((long)a2 + 0xb8)) && (*(long *)((long)a2 + 0x20))) {
...
void sub_c6c8(void *a0) // return-dupe x4, ternary x2, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_c6c8
{
  unsigned long v1;
  long v10; // rax
  int v11;
  ...
  if (*(char *)((long)a0 + 0xb8)) // branch-flip
    sub_1167b((struct_25 *)((long)a0 + 0x18),&v12);
  else {
    v12 = "?pcdb-lswd"[*(unsigned int *)((long)a0 + 0xa8)];
    memset(v13,0x3f,10);
    v31 = 0;
  }
  if (dat_2b381 != '\x01') // branch-flip
    v30 = 0;
  else if (*(int *)((long)a0 + 0xbc) != 1) { // branch-flip
    if (*(int *)((long)a0 + 0xbc) == 2)
      v30 = 0x2b;
  }
  else {
    v30 = 0x2e;
  ...
  switch(dat_2b3b0) { // branch-flip
    case 0:
      v20 = sub_1b491((void *)((long)a0 + 0x18));
      v27 = SUB168(v20,8);
      v18 = SUB168(v20,0);
      break;
    default:
    ...
    case 1:
      v20 = sub_1b477((void *)((long)a0 + 0x18));
      v27 = SUB168(v20,8);
      v18 = SUB168(v20,0);
      break;
    case 2:
      v20 = sub_1b45d((void *)((long)a0 + 0x18));
      v27 = SUB168(v20,8);
      v18 = SUB168(v20,0);
      break;
    case 3:
      v20 = sub_5990((void *)((long)a0 + 0x18));
      v27 = SUB168(v20,8);
      v18 = SUB168(v20,0);
  ...
  if (dat_2b3bb) {
    v25 = (*(char *)((long)a0 + 0xb8) != '\x01') ? "?" : (char *)sub_13d91(*(unsigned long *)((long)a0 + 0x58),v15,dat_2b3bc,0x200,dat_2b3c0); // branch-flip
    v21 = dat_2b388;
    v21 -= sub_1574e(v25,0);
    while (v8 = v24, 0 < v21) {
      v8 = &v24[1];
  ...
  v8 = (*(char *)((long)a0 + 0xb8) != '\x01') ? "?" : (char *)sub_15035(*(unsigned long *)((long)a0 + 0x28),v15); // branch-flip
  v24 = &v24[sprintf(v24,"%s %*s ",&v12,dat_2b38c,v8)];
  sub_54cf();
  if ((((dat_2b022) || (dat_2b023)) || (dat_2b3b9)) || (dat_2b380)) {
    sub_5453(v14,(long)v24 - (long)v14);
    if (dat_2b022)
      sub_c49e(*(unsigned int *)((long)a0 + 0x34),dat_2b394,(unsigned char)*(char *)((long)a0 + 0xb8));
    if (dat_2b023)
      sub_c4fe(*(unsigned int *)((long)a0 + 0x38),dat_2b398,(unsigned char)*(char *)((long)a0 + 0xb8));
    if (dat_2b3b9)
      sub_c49e(*(unsigned int *)((long)a0 + 0x34),dat_2b39c,(unsigned char)*(char *)((long)a0 + 0xb8));
    if (dat_2b380)
      sub_c3fc(*(char **)((long)a0 + 0xb0),0,dat_2b390);
    v24 = v14;
  }
  v4 = dat_2b3c8;
  v1 = dat_2b028;
  if ((*(char *)((long)a0 + 0xb8)) && (((*(unsigned int *)((long)a0 + 0x30) & 0xf000) == 0x2000 || ((*(unsigned int *)((long)a0 + 0x30) & 0xf000) == 0x6000)))) {
    v6 = dat_2b3a8 - (dat_2b3a4 + dat_2b3a0 + 2);
    v1 = *(unsigned long *)((long)a0 + 0x40);
    ...
    if (*(char *)((long)a0 + 0xb8) != '\x01') // branch-flip
      v26 = "?";
    else {
  ...
  v23 = 0;
  *v24 = '\x01';
  if (((*(char *)((long)a0 + 0xb8)) && (v3)) && (sub_1b9a5(dat_2b438,&v18,v17))) {
  ...
  if (*(int *)((long)a0 + 0xa8) != 6) {
    if (!dat_2b3d0)
      return;
    sub_e05c((unsigned char)*(char *)((long)a0 + 0xb8),*(unsigned int *)((long)a0 + 0x30),*(unsigned int *)((long)a0 + 0xa8));
    return;
  }
  if (!*(long *)((long)a0 + 8))
    return;
  ...
  if (!dat_2b3d0)
    return;
  sub_e05c(1,*(unsigned int *)((long)a0 + 0xac),0);
}
...
char * sub_dd38(void *a0,unsigned long a1) // ternary
{
  char v1;
  unsigned int v2;
  unsigned int v3;
  ...
  if (dat_2b3bb) {
    v6 = (*(char *)((long)a0 + 0xb8) != '\x01') ? "?" : (char *)sub_13d91(*(unsigned long *)((long)a0 + 0x58),v8,dat_2b3bc,0x200,dat_2b3c0); // branch-flip
    if (dat_2b3ac != 4) // branch-flip
      v7 = dat_2b388;
    else {
      v7 = 0;
...
long sub_e530(void *a0) // ternary
{
  ...
  if (dat_2b3bb) {
    if (dat_2b3ac != 4) // branch-flip
      ...
      v5 = (*(char *)((long)a0 + 0xb8) != '\x01') ? "?" : (char *)sub_13d91(*(unsigned long *)((long)a0 + 0x58),v6,dat_2b3bc,0x200,dat_2b3c0); // branch-flip
      v4 = strlen(v5);
    }
    v7 += v4 + 1;
  }
...
unsigned long sub_ee73(bool a0) // ternary
{
  ...
  sub_ec50(v6);
  for (v5 = 0; v5 < dat_2b338; v5 = v5 + 1) {
    v1 = sub_e530(*(void **)(v5 * 8 + dat_2b348));
...
void sub_112dd(void *a0,char *a1,struct_8 *a2) // return-dupe x2
{
  unsigned long *v1; // rax
  unsigned long *v2; // rax
...
long sub_123d1(void *a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_12876(unsigned long a0,void *a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
  unsigned long v3; // stack - 0x20
...
long * sub_1298f(unsigned long a0,void *a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
unsigned long sub_1335f(void *a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
  ...
  if (((float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18)) && (sub_12769(a0), (float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18))) {
...
unsigned long sub_136d0(void *a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_13740(void *a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
  ...
  if (!v5)
    return 0;
  *(long *)((long)a0 + 0x20) = *(long *)((long)a0 + 0x20) + -1;
  if (((!*v2) && (*(long *)((long)a0 + 0x18) = *(long *)((long)a0 + 0x18) + -1, (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) && (sub_12769(a0), (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) {
    v6 = *(long *)((long)a0 + 0x28);
...
void sub_13a46(void *a0,long a1)
{
  sub_13740(a0,a1);
}
...
char * sub_14ef7(long a0,void *a1)
{
  char *v1;
  long v2; // stack - 0x20
  char *v3; // stack - 0x10
  
  v3 = (char *)((long)a1 + 0x14);
  *v3 = '\0';
  v2 = a0;
  v1 = v3;
  if (0 <= a0) { // branch-flip
...
char * sub_15035(unsigned long a0,void *a1)
{
...
void sub_18845(void *a0,unsigned long a1) // return-dupe
{
...
void sub_18899(void *a0,unsigned long a1) // return-dupe
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
...
unsigned int sub_190a2(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
bool sub_1b822(void *a0) // ternary
{
  char *v1; // rax
  bool v2; // zf
...
unsigned long * sub_1b86c(void *a0) // early-return x2
{
  int v1;
  char *v2; // rax
  unsigned long *v3; // rax
