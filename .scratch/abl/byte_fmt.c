...
long sub_406b(char *a0,int a1) // early-return
{
  long v1; // stack - 0x10
...
void sub_411d(long a0)
{
  ...
  sub_417f((char *)0xe4e0,dat_18130);
...
void sub_417f(char *a0,int a1)
{
  ...
  v1 = *(long *)&a0[0x20];
  for (v2 = a0; v2 != (char *)(v1 + -0x28); v2 = &v2[0x28]) {
    sub_4248(v2);
...
unsigned int sub_4ba8(char *a0,unsigned int a1)
{
  unsigned int v1;
  char *v2; // stack - 0x20
