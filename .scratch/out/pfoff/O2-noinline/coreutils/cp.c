...
unsigned int sub_75b0(char *a0,stat *a1,int a2,char *a3,stat *a4,struct_22 *a5,char *a6) // return-dupe
{
  int v1;
  stat *v10;
  bool v2;
...
int sub_8430(long a0,char *a1,unsigned int a2,char *a3,int a4,unsigned int a5,unsigned int a6,unsigned int a7,char a8,long a9)
{
  int v1;
  int *v2; // rax
  unsigned long v3; // rax
...
unsigned int sub_dd00(long *a0,char *a1,struct_1 *a2)
{
  unsigned int v1; // eax
  long v2;
...
void sub_ea00(long a0,char *a1,struct_1 *a2)
{
  unsigned long *v1; // rax
  unsigned long *v2; // rax
...
unsigned long sub_ea90(long a0,unsigned long a1,struct_1 *a2) // early-return
{
  unsigned long v1; // rax
  unsigned long v2; // stack - 0x28
  unsigned long v3; // stack - 0x20
...
long sub_edb0(struct_25 *a0) // early-return
{
  long v1; // rax
...
unsigned long sub_ee60(struct_4 *a0,struct_4 *a1)
{
...
int sub_eff0(long a0,long a1,bool a2) // early-return x3
{
  stat *v1;
  unsigned long *v2;
  char *v3;
...
unsigned long sub_f5d0(long a0,int a1)
{
  unsigned long v1; // rax
...
void sub_f610(struct_15 *a0,long a1)
{
  char *v1;
  void *v2;
  long v3;
...
unsigned long sub_f6a0(long a0,struct_12 *a1) // return-dupe x2
{
  long v1;
  struct_13 *v2; // rax
  struct_13 *v3; // rax
  ...
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    v4 = sub_17a40(*(struct_11 **)(a0 + 0x58),&a1->field_0x70);
    if (!(char)v4)
      return 1;
    a1->field_0x0 = a1;
    a1->field_0x68 = 2;
...
void sub_f750(long a0,int a1,bool a2)
{
  int v1;
...
void sub_f820(long a0,long a1)
{
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x102) { // branch-flip
    ...
    v4 = (void *)sub_12350(*(long *)(a0 + 0x58),&v5);
    if (!v4)
...
void * sub_fc50(struct_14 *a0,int a1) // return-dupe
{
  long v1;
  dirent *v10; // rax
  unsigned long v11;
...
label_fcb2:
    ...
    if ((v14 & 0x204) == 0x200)
      v16 = a0->field_0x2c;
    v13 = sub_12790(v16,*(char **)(v1 + 0x30),v7,&v15);
    *(long *)(v1 + 0x18) = v13;
    if (!v13) {
      if (a1 == 3) {
        *(unsigned short *)(v1 + 0x68) = 4;
...
label_10097:
    ...
    if ((0 <= v7) && (!sub_f9a0(a0,v1,v7,NULL))) goto label_fcb2;
    if ((v20) && (v4))
      *(int *)(v1 + 0x40) = *__errno_location();
...
label_fd83:
      ...
      v12 = (void *)sub_f2b0(a0,&v10->field_0x13,v11);
      if (!v12) {
label_10110:
        v7 = *v9;
        free(v12);
...
label_10214:
    if (v27)
      sub_f8e0(a0->field_0x8,a0->field_0x20,v23);
    if (a0->field_0x48 & 4) {
      if ((a0->field_0x30 == v21) || (!v18)) goto label_10244;
label_1024a:
      *v24 = 0;
    }
    if ((v2) || (!v20)) {
...
label_102d0:
      if (*(long *)(v1 + 0x58)) // branch-flip
        v7 = sub_f9a0(a0,*(long *)(v1 + 8),0xffffffff,"..");
      else {
        v7 = sub_f7b0(a0);
      }
      if (v7) {
...
void sub_105a0(unsigned int a0,struct_7 *a1)
{
  if (!(a0 & 0x102)) {
    free(a1); // tail-call
    return;
    ...
    if (v7) {
      ...
      *(unsigned long *)(v7 + 0x58) = 1;
      if (sub_f350(v3)) {
        ...
        sub_125d0((struct_16 *)&v3[0xc],0xffffffff);
        return v3;
      }
    }
label_107e0:
...
unsigned int sub_10940(struct_10 *a0) // return-dupe
{
  struct_10 *v1;
  int v2;
  void *v3;
          ...
          if (*(short *)((long)v8 + 0x68) != 0xb) {
            *(char *)(a0->field_0x20 + *(long *)((long)v8 + 0x48)) = 0;
            if (*(long *)((long)v8 + 0x58)) { // branch-flip
              ...
              v6 = sub_f9a0(a0,*(long *)((long)v8 + 8),0xffffffff,"..");
            }
            else {
              v6 = sub_f7b0(a0);
            }
...
int * sub_111a0(struct_27 *a0,unsigned int a1) // early-return x2
{
  long v1;
  int v2;
  int *v3;
...
void sub_11b90(struct_28 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
unsigned long sub_12540(struct_6 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
void sub_125d0(struct_16 *a0,unsigned int a1)
{
...
struct_8 * sub_12970(struct_8 *a0,int a1)
{
  if (a1 != 10) {
    a0->field_0x0 = a1;
    a0->field_0x4 = 0;
...
char * sub_144f0(unsigned int a0,char *a1,unsigned long a2,struct_9 *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
...
{
  return sub_144f0(a0,a1,0xffffffffffffffff,(struct_9 *)0x256c0); // tail-call
}
...
unsigned int sub_15e70(int a0,char *a1,struct_24 *a2,long a3,unsigned int a4)
{
  long v1;
  unsigned int v10;
  unsigned long *v11;
  ...
  if (v22 < (long)(v1 - 1))
    return v16;
  v13 = dat_25700;
  if ((dat_25700) || (v13 = sub_11cd0(0x10,0,sub_15e50,sub_15e60,dat_24fd0), dat_25700 = v13, v13)) {
    v11 = dat_256f8;
...
unsigned int sub_16690(char *a0,struct_24 *a1,long a2,unsigned int a3)
{
...
void sub_16c20(FILE *a0,char *a1,char *a2,char *a3,struct_26 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_175e0(unsigned long *a0,int *a1,struct_18 *a2) // early-return x2
{
  void *v1; // rax
  unsigned long v2; // stack - 0x18
...
unsigned long sub_17a40(struct_11 *a0,long *a1) // return-dupe x3
{
  long v1;
  char v2; // al
  unsigned long v3;
...
void * sub_18000(void *a0,unsigned long *a1,int *a2,struct_18 *a3)
{
  unsigned long v1;
  unsigned long v10;
  void *v11;
...
unsigned long sub_19190(struct_18 *a0,struct_19 *a1) // return-dupe x2
{
  unsigned int v1;
  long v2;
  unsigned int *v3;
...
unsigned long sub_193c0(char *a0,unsigned long *a1,struct_20 *a2) // return-dupe x2
{
  unsigned long *v1;
  unsigned long v10;
  int v11;
