...
{
  *(bool *)a0 = pthread_sigmask(0,(void *)0x1e380,(void *)(a0 + 8)) == 0;
}
...
void sub_6240(struct_3 *a0,long a1,unsigned long a2)
{
  void *v1; // rax
...
long sub_76b0(unsigned long *a0,char a1)
{
  ...
  v2 = sub_7510(&v4,(unsigned char)a1);
  if (v2) {
    *(char *)(v2 + 0xc) = 0;
    if (dat_1e408) {
      v1 = sub_7040(&v5,4);
    ...
    *a0 = v3;
    if (!v3)
      sub_5e10(dcgettext(NULL,"couldn\'t create temporary file",5),(char *)(v2 + 0xd)); // no-return
  }
  return v2;
}

// Function: sub_77e0 @ 0x77e0
long sub_77e0(unsigned long *a0)
{
...
void sub_7bc0(unsigned long *a0,struct_12 *a1) // return-dupe
{
  long v1;
...
void sub_7c10(unsigned long *a0,long a1)
{
  if (2 <= *(unsigned int *)(a1 + 0x50)) {
    sub_7b70(*(long *)(a1 + 0x38));
    sub_7bc0(a0,*(struct_12 **)(a1 + 0x38));
    sub_7c00(*(long *)(a1 + 0x38)); // tail-call
    return;
  }
  if (*(long *)(a1 + 0x30) + *(long *)(a1 + 0x28))
    return;
  sub_7b80(a0,*(long *)(a1 + 0x38)); // tail-call
}
...
unsigned long sub_9400(struct_4 *a0)
{
  unsigned long v1; // rax
  long v2;
...
void sub_9460(struct_4 *a0,FILE *a1,char *a2)
{
  char *v1;
  char v2;
  unsigned long v3;
...
unsigned long sub_9c70(struct_5 *a0,struct_5 *a1)
{
  unsigned long v1;
  unsigned long v2;
  int v3; // eax
...
void sub_9e20(long a0,unsigned long a1,long a2,bool a3) // return-dupe
{
  unsigned long v1;
  ...
  v9 = sub_9c70((struct_5 *)(a0 + -0x20),(struct_5 *)(a0 + -0x40));
  if (a3) {
...
void sub_9fb0(long *a0,FILE *a1,char *a2)
{
  if (dat_1e419) {
    if (dat_1e840) {
      if (!sub_9c70(a0,(struct_5 *)0x1e840))
        return;
    }
    dat_1e840 = *a0;
    dat_1e848 = a0[1];
...
void sub_a020(struct_14 *a0,unsigned long a1,FILE *a2,char *a3)
{
  long *v1;
  unsigned long *v10;
  long v11;
  ...
  if (a0->field_0x50 < 2) {
    ...
    if (v2 != v8) { // branch-flip
      while (a0->field_0x18 != v10) {
        ...
        if (1 <= (int)sub_9c70((struct_5 *)&v7[-4],(struct_5 *)&v10[-4])) { // branch-flip
...
label_a1f2:
  ...
  if (v2 != v8) { // branch-flip
    while (a0->field_0x18 != v10) {
      ...
      v17 = &v18[-4];
      if (1 <= (int)sub_9c70((struct_5 *)&v6[-4],(struct_5 *)&v10[-4])) { // branch-flip
...
void sub_a4e0(long a0,unsigned long a1,unsigned long a2,struct_15 *a3,unsigned long *a4,FILE *a5,char *a6)
{
  char *v1;
...
label_acaa:
    ...
    v18 = v7;
    v10 = &v7[v23 * -4];
    if ((v16) && ((int)(v12 ^ 1) <= (int)sub_9c70(&v14,(struct_5 *)&v7[-4]))) {
label_aca0:
      v17 = 0;
      if (a1 == 'c') {
    ...
    if (v37 != 1) {
      ...
      do {
        while( true ) {
          v24 = &v21[v29];
          v26 = &v21[v29 - 1];
          v5 = *(struct_5 **)((long)v20 + *v24 * 8);
          v6 = *(struct_5 **)((long)v20 + *v26 * 8);
...
label_b086:
      ...
      do {
        while( true ) {
          v33 = v18;
          v19 = sub_9c70(*(struct_5 **)((long)v20 + v29 * 8),*(struct_5 **)((long)v20 + v21[v33] * 8));
...
label_bc5b:
        ...
        if (2 <= v7) { // branch-flip
          ...
          sub_a4e0(v6,a3,v7,(struct_15 *)((long)v5 + 0x80),v14,v15,v18);
          sub_7cd0(a3,v5);
          sub_7d10(v14);
          v9 = 0xbb91;
        }
...
unsigned long sub_c6f0(struct_19 *a0,unsigned long a1)
{
...
void sub_d1b0(long a0,struct_6 *a1)
{
  unsigned long v1;
...
long sub_d1d0(struct_7 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
long sub_d200(long a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long *v2;
  long v3;
...
unsigned long sub_d330(long a0,struct_20 *a1,bool a2) // return-dupe x2
{
  long *v1;
  long v2;
  struct_9 *v3; // rax
...
unsigned long sub_d520(struct_20 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
void sub_d830(struct_20 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_d880(struct_20 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_d970(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_d120(v1)) {
    v2 = sub_d460(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_dc20(struct_10 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_df90(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_dff0(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
unsigned long sub_e400(struct_13 *a0)
{
  long v1;
  long v2;
  unsigned long v3;
  ...
  if (v1) {
    ...
    *(unsigned long *)(v2 + 8) = v3;
    sub_e220(a0->field_0x0,v1 - 1U,a0->field_0x18);
  }
  return v4;
}
...
struct_2 * sub_efa0(struct_2 *a0,int a1)
{
  if (a1 != 10) {
    a0->field_0x0 = a1;
    a0->field_0x4 = 0;
...
char * sub_10b20(unsigned int a0,char *a1,unsigned long a2,struct_0 *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
...
{
  return sub_10b20(a0,a1,0xffffffffffffffff,(struct_0 *)0x1e9a0); // tail-call
}
...
unsigned long sub_11f90(FILE *a0,long a1)
{
  int v1; // eax
  char *v2;
  long v3; // rax
...
void sub_12ca0(FILE *a0,char *a1,char *a2,char *a3,struct_18 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_144b0(struct_11 *a0,timespec *a1) // early-return
{
  int v1; // eax
  long v2;
...
unsigned long sub_145c0(struct_16 *a0,long a1,long a2)
{
  long *v1; // rax
