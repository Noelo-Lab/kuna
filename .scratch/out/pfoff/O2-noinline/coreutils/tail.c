...
void * memrchr(void *a0,int a1,unsigned long a2)
{
  ...
  v1 = (void *)(*dat_14f60)(); // jump-as-call
  return v1;
}
...
label_2b55:
  ...
  if (!dat_15116)
    return 0;
label_2b6a:
  v10 = (unsigned long *)sub_c0c0(v23,0x60);
  v11 = v10;
  do {
    v14 = *v15;
    v15 = &v15[1];
...
void sub_2ec0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_14fd0)(main,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
unsigned int sub_2fb0(char *a0) // return-dupe x5, switch-return x24
{
  ...
  if (a0 <= (char *)0x6969) {
    ...
    if (a0 <= (char *)0x2478) {
      ...
      return ((unsigned int)(a0 == (char *)0x7c0) - 1) + (unsigned int)(a0 == (char *)0x7c0);
    }
    if (a0 == (char *)0x4244)
      return 1;
    if (a0 <= (char *)0x4244) {
...
void sub_3830(long a0,unsigned int a1,unsigned long a2,struct_3 *a3,unsigned int a4)
{
  unsigned int v1;
  unsigned long v2;
  char v3 [16];
...
unsigned int sub_4c60(char *a0,int a1,unsigned long a2,unsigned long *a3)
{
  unsigned int v1; // eax
  unsigned long v2; // rax
  char *v3; // rax
  ...
  if (fstat(a1,&v7)) { // branch-flip
    ...
    if (dat_15116) { // branch-flip
      ...
      if (((!dat_1510d) && ((v7._24_4_ & 0xf000) == 0x8000)) && (v5 = lseek(a1,0,1), v5 != 0xffffffffffffffff)) {
        v6 = lseek(a1,0,2);
        if (v5 < v6) {
          *a3 = v6;
          if (!v6)
            return 1;
          return sub_4290(a0,a1,a2,v5,v6,a3);
        }
        sub_41c0(a1,v5,0,a0);
      }
      v8 = sub_4760(a0,a1,a2,a3);
    }
  }
  return v8;
}
...
void sub_5880(double a0,unsigned int a1,long *a2,unsigned long a3,long *a4) // return-dupe
{
  char v1;
  long v10; // rax
  ...
  v10 = sub_8850(a3,0,sub_3980,sub_39a0,0);
  if (!v10)
...
label_5e28:
      v29 = v9;
      v14 = (struct_10 *)sub_85f0(v10,v22);
      if (v14) {
        v2 = v19[1];
label_5cde:
      ...
      do {
        if (((int)v17[9] == v9) && (v12 = v17[10], v5 = *v17, !strcmp((char *)&v19[4],(char *)(v12 + v5)))) {
          ...
          if (!(v3 & 0x200)) {
            ...
            v16 = (struct_10 *)sub_8ed0(v10,v14);
            if ((v16) && (v14 != v16)) {
              if (dat_15020 == 1)
                sub_5270(v16,0);
...
unsigned long sub_6820(char *a0,int a1,unsigned long a2,unsigned long *a3) // early-return
{
  unsigned int v1; // eax
  long v2;
  unsigned long v3; // rax
  ...
  if (fstat(a1,&v6)) {
    v4 = sub_b410(4,a0);
    v5 = dcgettext(NULL,"cannot fstat %s",5);
    error(0,*__errno_location(),v5,v4);
    return 0;
  }
  if (dat_15116) {
    if (((dat_1510d) || ((long)a2 <= -1)) || ((((v6._24_4_ & 0xf000) != 0x8000 || ((long)sub_41c0(a1,a2,1,a0) <= -1)) && (lseek(a1,a2,1) == -1)))) {
...
label_68c0:
  ...
  if ((!dat_1510d) && (0 <= (long)a2)) {
    if (sub_6810(v6._24_4_)) { // branch-flip
      ...
      if (v3 == 0xffffffffffffffff) {
        v3 = sub_4510(a0,a1,a2,a3); // return-dupe
        return v3;
      }
      v2 = v3 + a2;
    }
    if (0x2000000000000000 <= (unsigned long)(v6._56_8_ - 1U))
      v6._56_8_ = 0x200;
    if (v6._56_8_ < v2) {
      if (v3 == 0xffffffffffffffff)
        v3 = sub_41c0(a1,0,1,a0);
      if (((long)v3 < v2) && (a2 < v2 - v3)) {
        v3 = v2 - a2;
        sub_41c0(a1,v3,0,a0);
      }
      *a3 = v3;
...
unsigned int sub_6ab0(struct_12 *a0,unsigned long a1)
{
  unsigned char v1;
  stat v10; // stack - 0xd8
  int v2;
...
void sub_7080(int a0,char **a1,unsigned long *a2,unsigned int *a3,double *a4)
{
  char v1; // al
  int v2; // eax
  double v3; // stack - 0x48
  char *v4; // rax
  
  while( true ) {
    v2 = getopt_long(a0,a1,"c:n:fFqs:vz0123456789",(option *)0x14900,NULL);
    if (v2 == -1) break;
    if (0x85 < v2) {
label_74d0:
    ...
    switch(v2) {
      ...
      case 0x38:
      case 0x39:
        error(1,0,dcgettext(NULL,"option used in invalid context -- %c",5),(char)v2);
        return;
      default:
        goto label_74d0;
      case 0x46:
      ...
      case 0x6e:
        ...
        if (v2 != 0x6e) // branch-flip
          v4 = dcgettext(NULL,"invalid number of bytes",5);
        else {
          v4 = dcgettext(NULL,"invalid number of lines",5);
        }
        *a2 = sub_c4b0(optarg,0,0xffffffffffffffff,"bkKmMGTPEZY0",v4,0);
        break;
      case 0x66:
      case 0x84:
        dat_15118 = '\x01';
        if (optarg) // branch-flip
          dat_15020 = *(int *)(sub_78a0("--follow",optarg,0x14b00,0xf4d8,4,dat_15038,1) * 4 + 0xf4d8);
        else {
          dat_15020 = 2;
        }
        break;
      case 0x71:
        *a3 = 2;
        break;
      case 0x73:
        v1 = sub_c590(optarg,0,&v3,sub_7a20);
        if ((!v1) || (v3 < 0.0)) {
          v4 = (char *)sub_b6d0(optarg);
  ...
  if (dat_1511a) {
    if (dat_15118) { // branch-flip
      ...
      v4 = "warning: --retry only effective for the initial open";
    }
    else {
      dat_1511a = '\0';
      v4 = "warning: --retry ignored; --retry is useful only when following";
    }
...
label_73cd:
  if ((kill(dat_15110,0)) && (*__errno_location() == 0x26)) {
...
void sub_7710(char *a0,char *a1,long a2)
{
  char *v1; // rax
  unsigned long v2; // rax
...
void sub_77a0(unsigned long *a0,void *a1,unsigned long a2)
{
  char *v1;
  FILE *v2;
  long v3;
  ...
  while (v1) {
    if ((v3) && (!memcmp(v4,a1,a2)))
      __fprintf_chk(stderr,1,", %s",(char *)sub_b6d0(v1));
    else {
...
long sub_78a0(char *a0,char *a1,long *a2,void *a3,unsigned long a4,void *a5,char a6) // early-return
{
  long v1; // rax
...
void sub_8090(long a0,struct_6 *a1)
{
  unsigned long v1;
...
long sub_80b0(struct_5 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
long sub_80e0(long a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long *v2;
  long v3;
...
unsigned long sub_8210(long a0,struct_15 *a1,bool a2) // return-dupe x2
{
  long *v1;
  long v2;
  struct_8 *v3; // rax
...
unsigned long sub_8340(float a0,unsigned long a1,bool a2) // early-return, ternary
{
  unsigned long v1; // rax
...
unsigned long sub_8400(struct_15 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
void sub_8710(struct_15 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_8760(struct_15 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_8850(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_8000(v1)) {
    v2 = sub_8340(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_8b00(struct_9 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_8e70(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
...
long sub_8ed0(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
long sub_9060(long a0)
{
  return sub_8ed0(a0); // tail-call
}
...
struct_1 * sub_9240(struct_1 *a0,int a1)
{
  if (a1 != 10) {
    a0->field_0x0 = a1;
    a0->field_0x4 = 0;
...
{
  return sub_cd10((char *)(a0 + 9),(char *)(a1 + 9)) == 0;
}

// Function: sub_92b0 @ 0x92b0
unsigned long sub_92b0(long a0,long a1,unsigned char a2)
{
  unsigned char v1;
...
unsigned long sub_9310(long a0,long a1,unsigned char a2,char a3)
{
  unsigned char v1;
...
unsigned long sub_9390(long a0,long a1,unsigned char a2,char a3,char a4)
{
  unsigned char v1;
...
unsigned long sub_9400(long a0,long a1,unsigned char a2,char a3,char a4,char a5)
{
  unsigned char v1;
...
unsigned long sub_94a0(long a0,long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6)
{
  unsigned int v1;
  unsigned char v2;
...
unsigned long sub_9540(long a0,long a1,unsigned char a2,char a3,char a4,char a5,int a6,unsigned int a7)
{
  unsigned int v1;
  unsigned int v2;
  unsigned char v3;
...
unsigned long sub_9600(long a0,long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,unsigned int a8)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_96c0(long a0,long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,int a8,unsigned int a9)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_97a0(unsigned char *a0,long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6,unsigned int a7,unsigned int a8) // early-return
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
    ...
    if (v24) {
      ...
      if (v24) {
        if (v29) {
          ...
          if ((a3 < v22 + v29) || (v8 = memcmp(v11,v30,v29), v8)) goto label_a450;
          if (!v23) {
            v7 = *v11;
...
label_a4f4:
              ...
              if (((bool)(v2 & v23)) && (v29)) goto label_a51a;
              v16 = 0x5c;
              goto label_9f42;
            }
          }
...
label_9c18:
    v16 = (unsigned char)v20;
    v12 = v13;
    if (!v28) goto label_9dc3;
    if (!(*(unsigned int *)(v28 + (v20 >> 5) * 4) >> (v16 & 0x1f) & 1)) goto label_9dc3;
  }
  else {
label_9dc0:
    v7 = 0;
...
label_9f53:
  if (v23) {
    v23 = v2;
label_9f6f:
    if ((bool)(v23 & a4 == 2)) goto label_9f7b;
label_9d0c:
    v33 &= 0xfffffffd;
    v28 = 0;
    goto label_9a00;
...
char * sub_adc0(unsigned int a0,char *a1,unsigned long a2,struct_0 *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_15098 <= (int)a0) {
      v10 = (long)dat_15098;
      v8 = (long)(int)((a0 - dat_15098) + 1);
      if (dat_150a0 != (unsigned long *)0x150b0) // branch-flip
        v5 = (unsigned long *)sub_c160(dat_150a0,&v10,v8,0x7fffffff,0x10);
      else {
        v5 = (unsigned long *)sub_c160(NULL,&v10,v8,0x7fffffff,0x10);
        *v5 = dat_150b0;
        v5[1] = dat_150b8;
      }
      dat_150a0 = v5;
      memset(&v5[(long)dat_15098 * 2],0,(v10 - dat_15098) * 0x10);
      dat_15098 = (int)v10;
    }
    v1 = &v5[(long)(int)a0 * 2];
    v4 = *v1;
    v7 = (char *)v1[1];
    v9 = a3->field_0x4 | 1;
    v6 = sub_9990(v7,v4,a1,a2,a3->field_0x0,v9,a3->field_0x8,a3->field_0x28,a3->field_0x30);
    if (v4 <= v6) {
      v6 += 1;
      *v1 = v6;
      if (v7 != (char *)0x15140)
      ...
      sub_9990(v7,v6,a1,a2,v3,v9,a3->field_0x8,a3->field_0x28,a3->field_0x30);
    }
    *v11 = v2;
    return v7;
  }
...
void sub_b0d0(char *a0,unsigned long a1,char *a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_9990(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(char **)&a4[10],*(char **)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_b150 @ 0xb150
char * sub_b150(char *a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_9990(NULL,0,a0,a1,*a3,v5,&a3[2],*(char **)&a3[10],*(char **)&a3[0xc]);
  v4 = (char *)sub_bfe0(v3 + 1U);
  sub_9990(v4,v3 + 1U,a0,a1,*a3,v5,&a3[2],*(char **)&a3[10],*(char **)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
char * sub_b240(char *a0,unsigned long a1,unsigned int *a2)
{
  return sub_b150(a0,a1,NULL,a2); // tail-call
}
...
char * sub_b2f0(unsigned int a0,char *a1)
{
  return sub_adc0(a0,a1,0xffffffffffffffff,(struct_0 *)0x15240); // tail-call
}

// Function: sub_b310 @ 0xb310
char * sub_b310(unsigned int a0,char *a1,unsigned long a2)
{
  return sub_adc0(a0,a1,a2); // tail-call
}

// Function: sub_b320 @ 0xb320
char * sub_b320(char *a0)
{
  return sub_b2f0(0,a0); // tail-call
}

// Function: sub_b330 @ 0xb330
char * sub_b330(char *a0,unsigned long a1)
{
  return sub_b310(0,a0,a1); // tail-call
}

// Function: sub_b340 @ 0xb340
void sub_b340(unsigned int a0,unsigned long a1,char *a2)
{
  char v1 [56];
...
void sub_b3a0(unsigned int a0,unsigned long a1,char *a2,unsigned long a3)
{
  char v1 [56];
...
void sub_b410(unsigned int a0,char *a1)
{
  sub_b340(0,a0,a1); // tail-call
}

// Function: sub_b420 @ 0xb420
void sub_b420(unsigned int a0,char *a1,unsigned long a2)
{
  sub_b3a0(0,a0,a1,a2); // tail-call
}

// Function: sub_b440 @ 0xb440
void sub_b440(char *a0,unsigned long a1,char a2,unsigned long a3)
{
...
void sub_b5b0(unsigned int a0,long a1,long a2,char *a3,unsigned long a4)
{
...
void sub_b650(unsigned int a0)
{
  sub_b5b0(a0); // tail-call
}
...
void sub_b680(long a0,long a1,char *a2,unsigned long a3)
{
  sub_b5b0(0,a0,a1,a2,a3); // tail-call
}

// Function: sub_b6a0 @ 0xb6a0
char * sub_b6a0(unsigned int a0,char *a1,unsigned long a2)
{
  return sub_adc0(a0,a1,a2); // tail-call
}

// Function: sub_b6b0 @ 0xb6b0
char * sub_b6b0(char *a0,unsigned long a1)
{
  return sub_b6a0(0,a0,a1); // tail-call
}

// Function: sub_b6c0 @ 0xb6c0
char * sub_b6c0(unsigned int a0,char *a1)
{
  return sub_b6a0(a0,a1,0xffffffffffffffff); // tail-call
}

// Function: sub_b6d0 @ 0xb6d0
char * sub_b6d0(char *a0)
{
  return sub_b6c0(0,a0); // tail-call
}
...
long sub_b8f0(FILE *a0,char *a1,char *a2,char *a3,unsigned long *a4,unsigned long a5)
{
  long v1;
  unsigned long v10; // stack - 0x48
  char *v2; // rax
...
void sub_bd90(FILE *a0,char *a1,char *a2,char *a3,struct_13 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_c090(void *a0,unsigned long a1,unsigned long a2)
{
  sub_c050(a0,a1,a2); // tail-call
}
...
void sub_c0e0(void *a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  unsigned long v2; // rax
  unsigned long v3;
...
void sub_c150(void *a0,unsigned long *a1)
{
  sub_c0e0(a0,a1,1); // tail-call
}

// Function: sub_c160 @ 0xc160
void sub_c160(void *a0,long *a1,long a2,long a3,long a4)
{
  long v1;
  long v2;
  long v3;
...
unsigned long sub_c3a0(unsigned char *a0,unsigned int a1,unsigned long a2,unsigned long a3,unsigned long a4,char *a5,int a6)
{
  int v1;
  char *v2; // rax
  int *v3; // rax
...
void sub_c4b0(unsigned char *a0,unsigned long a1,unsigned long a2,unsigned long a3,char *a4,unsigned long a5)
{
...
label_c789:
  ...
  switch((unsigned int)v6 - 0x42 & 0xff) {
    case 0:
      v11 |= sub_c660(&v8,0x400);
      break;
    default:
      goto label_c789;
    case 3:
      v11 |= sub_c690(&v8,v10,6);
      break;
    case 5:
    case 0x25:
      v11 |= sub_c690(&v8,v10,3);
      break;
    case 9:
    case 0x29:
      v11 |= sub_c690(&v8,v10,1);
      break;
    case 0xb:
    case 0x2b:
      v11 |= sub_c690(&v8,v10,2);
      break;
    case 0xe:
      v11 |= sub_c690(&v8,v10,5);
      break;
    case 0x12:
    case 0x32:
      v11 |= sub_c690(&v8,v10,4);
      break;
    case 0x17:
      v11 |= sub_c690(&v8,v10,8);
      break;
    case 0x18:
      v11 |= sub_c690(&v8,v10,7);
      break;
    case 0x20:
      v11 |= sub_c660(&v8,0x200);
      break;
    case 0x21:
      break;
    case 0x35:
...
unsigned long sub_cae0(unsigned long a0,unsigned char a1)
{
  return sub_caa0(a0,a1); // tail-call
}

// Function: sub_caf0 @ 0xcaf0
unsigned long sub_caf0(unsigned long a0,unsigned char a1)
{
  return sub_cab0(a0,a1); // tail-call
}
...
int sub_cd10(char *a0,char *a1) // early-return
{
  ...
  if (a0 == a1)
    return 0;
  do {
    v2 = sub_ccd0((unsigned char)*a0);
    v1 = sub_ccd0((unsigned char)*a1);
...
unsigned long sub_cdc0(char *a0,char **a1) // return-dupe
{
  long v1; // rax
...
unsigned long sub_ce10(FILE *a0) // early-return x2, return-dupe
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_cf50(FILE *a0) // early-return
{
  int v1; // eax
  int v2;
  int *v3; // rax
...
int sub_d040(FILE *a0,long a1,int a2) // return-dupe
{
  long v1; // rax
...
unsigned long sub_d170(unsigned int *a0,char *a1,unsigned long a2,mbstate_t *a3)
{
  unsigned long v1; // rax
  long v2;
...
unsigned long sub_d200(struct_11 *a0,timespec *a1) // early-return
{
  int v1; // eax
  long v2;
...
unsigned long sub_d440(void)
{
  return sub_d390(); // tail-call
}
