      ...
      if (*a0 != a0[0x4c]) {
        ...
        *(unsigned long *)&a0[0x74] = sub_15fa0(v23,v7);
        while( true ) {
          ...
          if (0 <= a0[0x4c])
            sub_bf50((struct_9 *)&a0[0x4c],v7 - *(long *)&a0[0x78]);
...
void sub_7ab0(char *a0,long a1,char *a2,char *a3)
{
  tm *v1; // rax
  unsigned long v2; // rax
  char v3 [56];
  ...
  if (a3) // branch-flip
    ...
    if ((!v1) || (!sub_13d10(v3,0x2b,dat_26400,v1,0,v2 & 0xffffffff)))
      __sprintf_chk(v3,1,0x2b,"%ld.%.9d",*(long *)(a1 + 0x68),(int)v2);
  ...
  if (v2) {
    ...
    if ((v2 & 1) && (v7 <= v6)) {
      ...
      do {
        ...
        v3 = " ";
label_8084:
        sub_ef20(v3,(struct_8 *)(dat_26258 + v4 * 8),1);
        sub_eb70(3);
    ...
    if ((v2 & 2) && (v5 <= v8)) {
      ...
      do {
        ...
        v3 = " ";
label_819d:
        sub_ef20(v3,(struct_8 *)(dat_26388 + v4 * 8),1);
        sub_eb70(3);
...
void sub_87e0(long a0,struct_7 *a1,bool a2)
{
  if (a2) {
    sub_7ab0("---",a0,a1->field_0x0,dat_26540);
    sub_7ab0("+++",a0 + 0x130,a1->field_0x8,dat_26548); // tail-call
    return;
  }
  sub_7ab0("***",a0,a1->field_0x0,dat_26540);
  sub_7ab0("---",a0 + 0x130,a1->field_0x8,dat_26548); // tail-call
...
void sub_8930(struct_14 *a0,char *a1)
{
  long v1;
  void *v2;
...
char * sub_8ba0(struct_15 *a0,unsigned long a1,unsigned long a2)
{
  char v1;
  long v2;
  char *v3; // rax
...
label_9578:
    ...
    if (!dat_26586) {
      ...
      sub_e0e0("Only in %s: %s\n",*(unsigned long *)(a0 + 8 + (long)v7),v20);
      v6 = 1;
      return v6;
    }
    v43 = a0;
...
label_8f50:
  v43 = a0;
  if (a0) { // branch-flip
    v7 = (char *)sub_10920(*(void **)(a0 + 8),a1,NULL);
    v20 = (char *)v7;
    v25 = (char *)v7;
    v7 = (char *)sub_10920(*(void **)(a0 + 0x138),a2,NULL);
    v24 = (char *)v7;
  }
  else {
    v25 = a1;
...
unsigned long sub_9e90(struct_19 *a0,unsigned long *a1) // return-dupe x2
{
  char *v1;
...
int sub_a0c0(int *a0,void *a1) // early-return
{
  ...
  if (sub_9e90((struct_19 *)&a0[0x4c],&v6)) { // branch-flip
    if (!v10) {
      dat_266e8 = 1;
      v5[0] = v5[3];
      v5[1] = v12;
...
void sub_a7a0(long *a0) // return-dupe x2
{
  ...
  if (v3 <= v6) {
    do {
      v2 = v3 + 1;
      sub_f0a0("",(struct_8 *)(dat_26388 + v3 * 8));
      v3 = v2;
    } while (v2 <= v6);
  }
  fputs_unlocked(".\n",dat_26188);
...
long sub_aaf0(long *a0,char a1) // early-return
{
  long v1;
  long v2;
...
unsigned char * sub_abe0(FILE *a0,void *a1,long a2,long a3,long *a4)
{
  char *v1;
...
void sub_b040(FILE *a0,char *a1,char a2,long *a3)
{
  FILE *v1;
  char v10;
  char *v11; // stack - 0x60
...
void sub_b600(long a0)
{
  ...
  v29 = *(long *)(a0 + 0xb8);
  v3 = *(long *)(a0 + 0xc0);
  v20 = *(unsigned char **)(a0 + 0xe0);
  v31 = *(unsigned long *)(a0 + 0xd8);
  v30 = (void *)sub_15f50(v31 * 8);
  v5 = dat_26558;
  v4 = dat_26552;
  v19 = *(unsigned char **)(a0 + 0xf0);
  v26 = dat_26708;
  v28 = dat_26700;
  v6 = (unsigned char *)(*(long *)(a0 + 0xb0) + *(long *)(a0 + 0xa0));
  v22 = dat_26558 == 0;
  v7 = dat_26710;
  if (v20 < v19) {
    v23 = 0;
...
label_b820:
      ...
      v24 = v15;
      if ((((v20 == v6) && (*(char *)(a0 + 0x120))) && (2 <= (unsigned int)(dat_26580 - 4U))) && (v24 = (unsigned long *)(dat_26720 + -8), 2 <= v5))
        v24 = v15;
      v27 = *v24;
      if (v27) {
        v13 = v27;
...
label_bea8:
      dat_26710 = v7;
      *(long *)(a0 + 0xb8) = v29;
      *(unsigned long *)(a0 + 0xd0) = v23;
      *(unsigned long *)(a0 + 0xd8) = v31;
      *(void **)(a0 + 0xf8) = v30;
      dat_26700 = v28;
      dat_26708 = v26;
      return;
...
void sub_bf50(struct_9 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
unsigned long sub_bfd0(struct_10 *a0,bool a1)
{
  int v1;
  unsigned long v2;
  void *v3; // rax
...
void sub_c0d0(struct_11 *a0) // return-dupe x2
{
  void *v1;
  unsigned long v2;
  unsigned long v3;
...
unsigned int sub_c8f0(struct_13 *a0,unsigned int a1)
{
  int v1; // ecx
  unsigned long v2;
  char v3; // r12b
...
unsigned long sub_cda0(struct_7 *a0,unsigned long a1,unsigned long a2)
{
  char v1;
  unsigned long v10;
  int v11; // eax
...
void sub_d0a0(struct_7 *a0,char a1,struct_7 *a2)
{
  bool v1;
  bool v2;
  FILE *v3;
...
void sub_d260(long a0,long a1) // return-dupe x3
{
  ...
  if ((v4) && (v5)) {
    while( true ) {
      v2 += 1;
      v3 += 1;
      sub_d0a0((struct_7 *)(dat_26258 + -8 + v3 * 8),0x20,(struct_7 *)(dat_26388 + -8 + v2 * 8));
      if (a0 == v3) break;
  ...
  do {
    v1 = v2 * 8;
    v2 += 1;
    sub_d0a0(NULL,0x29,(struct_7 *)(dat_26388 + v1));
  } while (a1 != v2);
  if (a0 == v3) {
    dat_26728 = a1;
    dat_26730 = a0;
  ...
  do {
    v2 = v3 * 8;
    v3 += 1;
    sub_d0a0((struct_7 *)(dat_26258 + v2),0x28,NULL);
label_d37b:
  } while (a0 != v3);
  dat_26728 = a1;
  dat_26730 = a0;
  ...
  if (v1 == 3) {
    ...
    if (v7 <= v6) {
      do {
        ...
        v2 = v4 * 8;
        v4 += 1;
        sub_d0a0((struct_7 *)(dat_26258 + v2),0x7c,(struct_7 *)(dat_26388 + v3));
      } while (v6 >= v4);
      v3 = v8;
      v2 = v6;
      v7 = v4;
...
label_d52f:
  ...
  if (v1 & 2) {
    ...
    if (v5 <= v8) {
      do {
        v3 = v2 + 1;
        sub_d0a0(NULL,0x3e,(struct_7 *)(dat_26388 + v2 * 8));
        v2 = v3;
      } while (v3 <= v8);
    }
    dat_26728 = v3;
  ...
  if (v6 >= v7) {
    do {
      v2 = v3 * 8;
      v3 += 1;
      sub_d0a0((struct_7 *)(dat_26258 + v2),0x3c,NULL);
    } while (v3 <= v6);
    dat_26730 = v3;
    return;
  }
...
void sub_ef20(char *a0,struct_8 *a1,bool a2)
{
  char v1;
  unsigned char *v2;
  unsigned char *v3;
...
void sub_f0a0(char *a0,struct_8 *a1)
{
...
void sub_f0c0(long a0,long a1,unsigned long a2,long *a3,long *a4)
{
  long v1; // rax
  long v2; // rdx
...
void sub_f0f0(char a0,long a1,long a2,unsigned long a3)
{
  long v1; // stack - 0x18
  long v2; // stack - 0x20
...
void sub_fd40(unsigned long *a0,int a1,unsigned int a2)
{
  ...
  if (!a1) {
    ...
    if (v5)
      v4 = sub_fdc0;
    v2->field_0x10 = sub_11470(0,0,v4,v3,sub_fb70);
  }
  v1 = *a0;
  *a0 = v2;
  v2->field_0x0 = v1;
...
char * sub_fea0(unsigned int a0,long a1,char *a2,char *a3)
{
  char *v1; // rax
...
unsigned int sub_10180(struct_18 *a0,char *a1)
{
  unsigned long v1;
  unsigned int v2; // eax
...
int sub_10580(void *a0,long a1,FILE *a2,unsigned int a3,unsigned char a4,unsigned long a5)
{
  int v1; // eax
  int *v10; // stack - 0x58
  int v11; // stack - 0x50
...
unsigned int sub_10770(unsigned long a0,long a1,char *a2,unsigned long a3,char a4) // return-dupe
{
  unsigned int v1; // eax
  FILE *v2; // rax
...
void sub_10cb0(long a0,struct_22 *a1)
{
  unsigned long v1;
  ...
  a1->field_0x0 = 0;
  a1->field_0x8 = v1;
  *(struct_22 **)(a0 + 0x48) = a1;
}

// Function: sub_10cd0 @ 0x10cd0
long sub_10cd0(struct_16 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
long sub_10d00(long a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long *v2;
  long v3;
...
unsigned long sub_10e30(long a0,struct_26 *a1,bool a2) // return-dupe x2
{
  long *v1;
  long v2;
  struct_5 *v3; // rax
...
unsigned long sub_11020(struct_26 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
void sub_110f0(long a0,FILE *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
char * sub_11210(long a0,char *a1)
{
  void *v1;
  long *v2;
  char *v3;
...
void sub_11330(struct_26 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_11380(struct_26 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_11470(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_10c20(v1)) {
    v2 = sub_10f60(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_11720(struct_25 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_11a90(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
...
long sub_11af0(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
void sub_120f0(struct_31 *a0,struct_31 *a1)
{
  char v1;
  ...
  sub_17060((struct_29 *)&a0[1].field_0x1[2],(struct_30 *)&a1[1].field_0x1[2]); // tail-call
}
...
void sub_15d40(FILE *a0,char *a1,char *a2,char *a3,struct_33 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_16800(long *a0,struct_6 *a1) // return-dupe x2
{
  struct_6 *v1;
  long *v2;
  int v3; // eax
...
struct_6 * sub_16a80(long a0,void *a1,struct_6 *a2) // return-dupe
{
  long v1; // rax
...
void sub_17060(struct_29 *a0,struct_30 *a1) // return-dupe
{
  char v1;
  long v2;
  struct_30 *v3;
  
  v3 = (struct_30 *)a1->field_0x0;
  if (v3 == &a1[1])
...
void sub_17260(struct_34 *a0,struct_34 *a1)
{
  char v1;
  ...
  a0->field_0x14 = a1->field_0x14;
  sub_17060((struct_29 *)&a0[1],(struct_30 *)&a1[1]); // tail-call
}
...
struct_35 * sub_17f00(struct_35 *a0,int a1)
{
  if (a1 != 10) {
    a0->field_0x0 = a1;
    a0->field_0x4 = 0;
...
char * sub_19a80(unsigned int a0,char *a1,unsigned long a2,struct_36 *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
...
{
  return sub_19a80(a0,a1,0xffffffffffffffff,(struct_36 *)0x369a0); // tail-call
}
