...
void sub_a0c0(struct_3 *a0) // return-dupe
{
  unsigned short *v1;
  unsigned short v10;
  int v11;
...
long sub_b070(char *a0,unsigned long a1,int a2,int a3)
{
  ...
  *(char *)((unsigned long)dat_dda4c + 0xdda60) = dat_dda49;
  if (*dat_dda20 == -1)
    sub_a480();
  sub_a5a0((struct_4 *)0x193c0);
  sub_a5a0((struct_4 *)0x19380);
  v1 = sub_a8c0();
  dat_dda28 += a1;
  v4 = dat_dda40 + 10U >> 3;
  v3 = dat_dda38 + 10U >> 3;
...
unsigned long sub_ea90(long a0,long *a1) // return-dupe x3
{
  unsigned long *v1;
  long v2;
  char v3 [16];
