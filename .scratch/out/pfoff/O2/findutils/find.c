...
void sub_7670(long a0,struct_2 *a1) // return-dupe
{
  char v1;
  char *v10;
...
unsigned long sub_8660(char *a0,long a1,unsigned int a2)
{
  char *v1;
  char *v2; // rax
...
void sub_86e0(FILE *a0,long a1)
{
  char *v1; // rcx
  char *v2; // r8
  char *v3; // r9
  
  sub_8870(a0,*(long **)(a1 + 0x110));
  v3 = "[need inum] ";
  if (!*(char *)(a1 + 0x1c))
    v3 = "";
  v2 = "[need type] ";
  ...
  sub_8870(a0,*(long **)(a1 + 0x118)); // tail-call
}
...
void sub_8940(char *a0,long a1,long a2)
{
  struct_1 *v1;
  
  v1 = *(struct_1 **)(a2 + 0x110);
  if (v1) {
    if (sub_e7b0(a0,a1,v1))
      return;
  }
  sub_e7b0(a0,a1,*(struct_1 **)(a2 + 0x118)); // tail-call
}

// Function: sub_8990 @ 0x8990
void sub_8990(char *a0,long a1,long a2)
{
  struct_1 *v1;
...
unsigned long sub_8b10(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
...
unsigned long sub_8bc0(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
...
unsigned long sub_8bf0(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
...
unsigned long sub_8ca0(char *a0,long a1,long a2)
{
  struct_1 *v1;
  
  if (*(struct_1 **)(a2 + 0x110))
    sub_e7b0(a0,a1,*(struct_1 **)(a2 + 0x110));
  v1 = *(struct_1 **)(a2 + 0x118);
  return sub_e7b0(a0,a1,v1); // tail-call
}

// Function: sub_8ce0 @ 0x8ce0
unsigned long sub_8ce0(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
...
char sub_8d00(char *a0,long a1) // return-dupe
{
  int *v1; // rax
  char *v2;
  char *v3; // rax
  ...
  v4 = 0;
  if (dat_385e4)
    v4 = (unsigned int)((*(unsigned int *)(a1 + 0x18) & 0xf000) == 0x4000) << 9;
...
unsigned long sub_8fe0(unsigned char *a0,unsigned long a1,long a2)
{
  sub_165e0(a0,dat_385f8,dat_385f0,a1,dat_38638,dat_3865c,(unsigned char)*(char *)(a2 + 0x28),*(FILE **)(a2 + 0x40));
  return 1;
}

// Function: sub_9020 @ 0x9020
unsigned long sub_9020(char *a0,unsigned long a1,long a2)
{
  sub_16e80(*(FILE **)(a2 + 0x40),*(unsigned int **)(a2 + 0x58),(unsigned char)*(char *)(a2 + 0x50),"%s\n",a0);
  return 1;
}
...
unsigned int sub_9090(unsigned long a0,long *a1,long a2)
{
  char *v1;
  unsigned int v2; // eax
...
unsigned long sub_9120(char *a0,long a1,long a2)
{
...
int sub_9150(char *a0,unsigned long a1,long a2)
{
  unsigned int v1;
  int v2;
  char *v3;
...
unsigned long sub_9260(char *a0,long a1,long a2)
{
  if ((*(unsigned int *)(a1 + 0x18) & 0xf000) != 0xa000)
    return 0;
...
unsigned long sub_9290(unsigned char *a0,unsigned long a1,long a2)
{
  sub_165e0(a0,dat_385f8,dat_385f0,a1,dat_38638,dat_3865c,(unsigned char)*(char *)(a2 + 0x28),*(FILE **)(a2 + 0x40));
  return 1;
}
...
unsigned long sub_92d0(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
...
unsigned long sub_92f0(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
...
int sub_9310(char *a0,unsigned long a1,long a2)
{
  unsigned int v1;
  int v2;
  char *v3;
...
unsigned int sub_9350(char *a0,long a1,long a2)
{
  struct_1 *v1;
...
unsigned long sub_9400(char *a0,long a1,long a2) // early-return
{
  long v1;
...
unsigned long sub_9580(char *a0,unsigned long a1,struct_30 *a2)
{
  char *v1;
...
unsigned long sub_95d0(char *a0,unsigned long a1,struct_30 *a2)
{
  char *v1;
  unsigned long v2; // rax
...
unsigned long sub_9770(char *a0,unsigned long a1,long a2)
{
  sub_16e80(*(FILE **)(a2 + 0x40),*(unsigned int **)(a2 + 0x58),(unsigned char)*(char *)(a2 + 0x50),"%s\n",a0);
  return 1;
}
...
unsigned long sub_9890(char *a0,struct_9 *a1,long a2)
{
  unsigned long v1; // rax
  
  if (((!a1->field_0x8) || (a1->field_0x8 == *(long *)(a2 + 0x38))) && (v1 = sub_d820(a0,dat_385f0,a1), !(int)v1)) {
...
unsigned long sub_9a30(unsigned long a0,long a1,long a2)
{
  long v1;
  long v2;
  unsigned long v3; // rax
...
int * sub_9af0(char *a0,long a1,long a2) // early-return, ternary
{
  char v1;
  int *v2;
  char v3; // al
...
unsigned long sub_9c00(char *a0,unsigned long a1,long a2)
{
  int v1; // eax
  unsigned long v2; // rax
  char *v3;
...
unsigned long sub_a040(char *a0,unsigned long a1,struct_30 *a2)
{
  char *v1;
  long v10; // rbx
  char v11;
...
label_a33f:
  ...
  v2 = (struct_4 *)&a2->field_0x39[0x5f];
  v1 = &a2->field_0x39[7];
  if (a2->field_0x38) { // branch-flip
    ...
    sub_242c0((struct_8 *)a2->field_0xf8);
    if (!v15) {
      return v4 & 0xffffffff;
    }
    v14 = v12;
...
int * sub_a3a0(unsigned long a0,struct_48 *a1,unsigned long a2,char **a3) // return-dupe
{
  long v1;
...
void sub_ae30(struct_35 *a0) // return-dupe
{
  char *v1;
  unsigned long v10;
...
void sub_bac0(FILE *a0,long a1,int a2)
{
  char v1;
  char *v10;
  int v11; // ecx
  ...
  do {
    ...
    if (*(char **)(a1 + 0x30)) // branch-flip
      __fprintf_chk(a0,1,"%s %s",*(char **)(a1 + 8),*(char **)(a1 + 0x30));
    else {
      __fprintf_chk(a0,1,"%s",*(char **)(a1 + 8));
    }
    v10 = "no";
    ...
    v7 = "unknown";
label_bc5b:
    __fprintf_chk(a0,1," cost=%s est_success_rate=%#.4g %sside effects ",v7,(double)*(float *)(a1 + 0x24),v10);
...
void sub_bef0(struct_9 *a0,long *a1) // return-dupe
{
  float v1;
  long v10;
  float v2;
  ...
  if (dat_38660 & 8) { // branch-flip
    ...
    sub_bac0(stderr,a0->field_0x0,2);
    v10 = a0->field_0x0;
    sub_b590(v10);
    if (!v10) {
      v8 = 0;
...
void sub_c0b0(long a0,unsigned long a1,struct_9 *a2,unsigned long a3,long *a4)
{
  long v1;
  long v2; // rbx
...
void sub_d0f0(struct_28 *a0) // return-dupe
{
  void *v1;
...
label_d180:
    ...
    sub_159f0((struct_7 *)a0[0x1f],sub_d220,&a0[7]);
    if ((struct_8 *)a0[0x1f] == dat_385c0) goto label_d180;
    sub_242c0((struct_8 *)a0[0x1f]);
    free((void *)a0[0x1f]);
    a0[0x1f] = 0;
    a0 = (long *)a0[0x23];
    if (!a0)
...
{
  sub_15430(a0 + 8,(struct_3 *)(a0 + 0x60));
  return 0;
}
...
void sub_d240(long *a0)
{
  ...
  do {
    ...
    if ((((void *)*a0 == sub_8fb0) && ((char)a0[7])) && ((int)a0[0x1a]))
      sub_15430(&a0[8],(struct_3 *)&a0[0x13]);
    a0 = (long *)a0[0x23];
  } while (a0);
}
...
void sub_d490(struct_50 *a0,unsigned long a1,unsigned long a2)
{
  unsigned long v1;
  struct_49 *v2; // rax
  
  v2 = (struct_49 *)sub_b9b0(a0,a2);
  v1 = a0->field_0x8;
  v2->field_0x0 = a1;
  v2->field_0x8 = v1;
  v2->field_0x38 = 0;
...
unsigned long sub_d820(char *a0,char *a1,long a2) // return-dupe x3
{
  int v1;
  char *v2; // rax
  int *v3; // rax
...
unsigned int sub_dfe0(unsigned int *a0,char *a1,char *a2,long a3,unsigned int a4) // return-dupe
{
  unsigned int v1;
...
unsigned long sub_e7b0(char *a0,long a1,struct_1 *a2)
{
  int v1; // eax
  unsigned long v2; // rax
  
  a2->field_0x120 = a2->field_0x120 + 1;
  if ((((!(a2->field_0x18 & 0xffffff0000)) || ((((!*(char *)((long)&a2->field_0x18 + 2) || (dat_385e4)) && ((!*(char *)((long)&a2->field_0x18 + 3) || (dat_385e5)))) && ((!*(char *)((long)&a2->field_0x18 + 4) || (((*(long *)(a1 + 8) && (dat_385e5)) && ((*(unsigned int *)(a1 + 0x18) & 0xf000) != 0x4000)))))))) || (v1 = sub_d820(a0,dat_385f0,a1), !v1)) && (v2 = (*a2->field_0x0)(a0,a1,a2), (char)v2)) {
...
unsigned long sub_ea00(struct_9 *a0,struct_9 *a1)
{
...
unsigned long sub_ea30(struct_45 *a0,unsigned long a1)
{
...
unsigned long sub_eb40(struct_41 *a0,char *a1)
{
  struct_20 *v1;
  int v2;
  unsigned long *v3; // rax
...
void sub_f620(long a0,struct_33 *a1,char *a2,struct_32 *a3) // return-dupe
{
  FILE *v1;
  char v10 [10];
  ...
  if (v3 == 1) {
    ...
    if (fwrite(v13,1,(long)v3,v1) < (unsigned long)(long)v3) {
      v4 = __errno_location();
      sub_e970(*v4,*(char **)(a0 + 0x10));
    }
    v1 = *(FILE **)(a0 + 8);
    if (!sub_180c0(v1))
      return;
    v4 = __errno_location(); // return-dupe
    sub_e970(*v4,*(char **)(a0 + 0x10)); // tail-call
    return;
  }
  if (v3 != 2) {
    if (v3)
...
label_f7c4:
      v3 = sub_16e80(*(FILE **)(a0 + 8),*(unsigned int **)(a0 + 0x20),(unsigned char)*(char *)(a0 + 0x18),a1->field_0x8,v9);
label_fa78:
      if (0 <= v3)
        return;
      v4 = __errno_location();
...
label_f9ef:
    ...
    case 0x68:
      ...
      v3 = sub_16e80(*(FILE **)(a0 + 8),*(unsigned int **)(a0 + 0x20),(unsigned char)*(char *)(a0 + 0x18),a1->field_0x8,".");
      goto label_fb12;
    case 0x69:
      v15 = a3->field_0x8;
      v14 = 1;
...
label_fb12:
    ...
    case 0x6e:
      ...
      break;
    case 0x70:
      v3 = sub_16e80(*(FILE **)(a0 + 8),*(unsigned int **)(a0 + 0x20),(unsigned char)*(char *)(a0 + 0x18),a1->field_0x8,a2);
      goto label_fa78;
    case 0x73:
      v15 = a3->field_0x30;
      v14 = 1;
...
unsigned long sub_ff90(char *a0,struct_32 *a1,long a2) // return-dupe
{
  char v1;
  unsigned long v2; // rax
  int *v3;
...
unsigned long sub_10380(unsigned long *a0,struct_50 *a1,unsigned char *a2) // return-dupe x2
{
  unsigned char v1;
  int v10;
  unsigned char *v11;
...
char * sub_10f30(long a0,int *a1,struct_50 *a2,void *a3) // return-dupe x2
{
  char v1;
  char *v2;
  long v3;
...
void sub_111e0(struct_50 *a0,long a1,int *a2)
{
  sub_10f30(a1,a2,a0,sub_9af0); // tail-call
}

// Function: sub_11200 @ 0x11200
void sub_11200(struct_50 *a0,long a1,int *a2)
{
...
unsigned long sub_112c0(struct_50 *a0,long a1,int *a2,char *a3,void *a4) // return-dupe
{
  char *v1;
  long v2; // rax
  char *v3; // rax
...
unsigned long sub_113f0(struct_50 *a0,long a1,int *a2)
{
  return sub_112c0(a0,a1,a2); // tail-call
}

// Function: sub_11410 @ 0x11410
unsigned long sub_11410(struct_50 *a0,long a1,int *a2)
{
  return sub_112c0(a0,a1,a2); // tail-call
}

// Function: sub_11430 @ 0x11430
unsigned long sub_11430(struct_50 *a0,long a1,int *a2)
{
  return sub_112c0(a0,a1,a2); // tail-call
}

// Function: sub_11450 @ 0x11450
unsigned long sub_11450(struct_50 *a0,long a1,int *a2)
{
  return sub_112c0(a0,a1,a2); // tail-call
}
...
void sub_11c90(char *a0,struct_42 *a1)
{
  int v1; // eax
  FILE *v2;
  char *v3; // rax
...
unsigned long sub_11d80(struct_50 *a0,long a1,int *a2) // early-return x2
{
  int v1;
  unsigned char *v2;
  unsigned long v3; // rax
...
unsigned long sub_11e20(int *a0)
{
  ...
  v1 = sub_d520(a0);
  *(unsigned int *)(v1 + 0x18) = 0x101;
  sub_11c90("/dev/stdout",(struct_42 *)(v1 + 0x38));
  return 1;
}
...
bool sub_11e50(int *a0,long a1,int *a2)
{
  ...
  if (a1) {
    ...
    if (v1) {
      *a2 = *a2 + 1;
      v2 = sub_d4d0(a0,v1);
      sub_11c90(v1,(struct_42 *)(v2 + 0x38));
...
unsigned long sub_11f30(struct_50 *a0,long a1,int *a2)
{
  char *v1;
  unsigned char *v2;
  unsigned long v3; // rax
...
unsigned long sub_12230(char *a0,long a1,long a2,int *a3)
{
  struct_4 *v1;
  long v10;
  char *v11; // rax
  ...
  if ((!a2) || (!*(long *)(a2 + (long)*a3 * 8)))
    return 0;
  v7 = (void *)sub_d490(a1,v4,"(some -exec* arguments)");
  *(unsigned int *)((long)v7 + 0x18) = 0x101;
  *(unsigned long *)((long)v7 + 0xf8) = 0;
  if (v4 != sub_9580 && v4 != sub_95d0) {
    *(char *)((long)v7 + 0xf4) = 0;
    v6 = sub_8fc0;
label_123d6:
    if (v4 != v6) {
  ...
  if (v8) {
    ...
    do {
      ...
      if (v2 != '/') {
        v11 = strndup(&v8[v21],v20);
        if (!v11)
          v11 = &v8[v21];
        v8 = (char *)sub_e8a0(0,v11);
        error(1,0,dcgettext(NULL,"The relative path %s is included in the PATH environment variable, which is insecure in combination with the %s action of find.  Please remove that entry from $PATH",5),v8,a0);
        return v16;
      }
    } while (sub_17570(v8,":",0,&v21,&v20));
  }
label_123f8:
  *(char *)((long)v7 + 0x38) = 0;
  v3 = *a3;
  ...
  if (v8) {
    ...
    do {
      if (*v8 != ';') { // branch-flip
        if ((((*v8 == '+') && (v4 != sub_9580 && v4 != sub_95d0)) && (!v8[1])) && (v5)) {
          *(char *)((long)v7 + 0x38) = 1;
label_124de:
          if ((v3 != v23) && (*v19)) {
            if (*(char *)((long)v7 + 0x38)) {
              ...
              if (v4 != sub_8fc0)
                v8 = "";
              if (1 < v24) {
                error(1,0,dcgettext(NULL,"Only one instance of {} is supported with -exec%s ... +",5),v8);
                return v18;
              }
              if (strlen(v27) != 2) {
                __snprintf_chk(v22,0x13,1,0x13,"-exec%s ... {} +",v8);
                v8 = (char *)sub_239f0(2,dat_3868c,v27);
                v11 = (char *)sub_239f0(1,dat_3868c,"{}");
                v12 = (char *)sub_239f0(0,dat_3868c,v22);
                error(1,0,dcgettext(NULL,"In %s the %s must appear by itself, but you specified %s",5),v12,v11,v8);
                return v13;
              }
            }
            v10 = (long)v7 + 0x40;
            if ((unsigned int)(sub_156e0(v10,0x800) - 1) < 2) {
              error(1,0,dcgettext(NULL,"The environment is too large for exec().",5));
              return v17;
            }
            sub_15860(v10);
            v24 = v23 - v3;
            v1 = (struct_4 *)((long)v7 + 0x98);
            *(void **)((long)v7 + 0x80) = sub_a3a0;
            if (*(char *)((long)v7 + 0x38)) { // branch-flip
              *(unsigned long *)((long)v7 + 0xe8) = 0;
              *(unsigned long *)((long)v7 + 0x70) = 0;
              *(long *)((long)v7 + 0x78) = (long)(v24 + -1);
              *(unsigned long *)((long)v7 + 0x68) = 0;
              *(unsigned long *)((long)v7 + 0x88) = 0;
              *(unsigned long *)((long)v7 + 0x90) = 0;
              sub_15890(v10,v1,(long)v7 + 0x38);
              if (v3 < v23 + -1) {
                do {
                  v8 = (char *)*v26;
                  v26 = &v26[1];
                  sub_14fb0(v10,v1,v8,strlen(v8) + 1,NULL,0,1);
                } while (v26 != (long *)(a2 + 8 + ((unsigned long)(unsigned int)((v23 - v3) - 2) + (long)v3) * 8));
              }
            }
            else {
              *(int *)((long)v7 + 0xf0) = v24;
              *(char **)((long)v7 + 0x70) = "{}";
              *(unsigned long *)((long)v7 + 0x68) = strlen("{}");
              *(unsigned long *)((long)v7 + 0x88) = 0;
              *(unsigned long *)((long)v7 + 0x90) = 0;
              *(unsigned long *)((long)v7 + 0xe8) = sub_25a50((long)v24 << 3);
              sub_15890(v10,v1,(long)v7 + 0x38);
              v3 = *(int *)((long)v7 + 0xf0);
              if (1 <= v3) {
                v10 = *(long *)((long)v7 + 0xe8);
                v14 = 0;
                do {
                  *(long *)(v10 + v14 * 8) = v26[v14];
                  v14 += 1;
                } while (v14 != v3);
              }
            }
      ...
      else if (!v8[1]) goto label_124de;
      if (sub_1d5d0(v8,"{}")) { // branch-flip
        v24 += 1;
        if ((!v23) && ((v4 == sub_8fc0 || (v4 == sub_95d0)))) {
...
unsigned long sub_13200(long a0,int *a1,struct_50 *a2,int a3)
{
  char *v1;
  long v2; // rax
...
void sub_13360(struct_50 *a0,long a1,int *a2)
{
  sub_13200(a1,a2,a0,dat_3867c); // tail-call
}

// Function: sub_13380 @ 0x13380
void sub_13380(struct_50 *a0,long a1,int *a2)
{
          ...
          if (strchr(v10,(int)v2)) {
            ...
            *(unsigned int *)&v5[7] = v15;
            if (v2 != 't') { // branch-flip
              ...
              if (!sub_21de0((struct_9 *)&v5[8],v7,(long *)0x38638)) {
...
unsigned long sub_14ef0(long a0,long a1,bool a2,unsigned long a3) // early-return
{
  unsigned long v1;
  unsigned long v2;
...
void sub_14fb0(struct_5 *a0,struct_4 *a1,char *a2,long a3,char *a4,long a5,int a6) // return-dupe x2
{
  unsigned long v1;
  void *v2;
  unsigned long v3;
...
void sub_15270(long a0,struct_4 *a1,char *a2,unsigned long a3,char *a4,long a5,char *a6,long a7,unsigned int a8)
{
  char *v1;
  char *v2;
  long v3;
  ...
  do {
    while( true ) {
      v5 = (char *)sub_1d5d0(a2,*(char **)(a0 + 0x30));
      if (v5) break;
      if (v7 <= a3) {
label_153e4:
        if (*a2) {
...
void sub_15430(long a0,struct_3 *a1)
{
  unsigned long v1;
  long v10; // r12
...
unsigned long sub_156e0(struct_52 *a0,unsigned long a1)
{
  unsigned long v1; // rax
  unsigned long v2;
  unsigned long v3;
...
void sub_15940(long a0,struct_56 *a1)
{
  a1->field_0x0 = *(unsigned long *)(a0 + 0x38);
  a1->field_0x20 = a1->field_0x28;
  a1->field_0x38 = 0xffffffff00000000;
...
int sub_159f0(struct_7 *a0,void *a1,unsigned long a2)
{
  int v1;
  int v2; // eax
  int *v3; // rax
...
unsigned long sub_15de0(unsigned long a0,struct_46 *a1) // return-dupe
{
  long v1;
  void *v2; // rax
...
unsigned long sub_15e60(int a0,struct_34 *a1)
{
  int v1;
  unsigned long v2;
...
void sub_165e0(unsigned char *a0,unsigned int a1,unsigned long a2,unsigned long a3,long a4,unsigned int a5,int a6,FILE *a7)
{
  long v1;
  unsigned long v10; // rax
  int *v11; // rax
  ...
  v5 = __fprintf_chk(v2,1,"%*lu",dat_384ac,*(unsigned long *)(a3 + 0x10));
  if (v5 < 0) {
    v23 = 300;
    v21 = v17;
    goto label_169b6;
  ...
  if (dat_384ac < v5)
    dat_384ac = v5;
  putc(0x20,v2);
  v8 = (char *)sub_1c9f0(*(unsigned int *)(a3 + 0x1c));
  if (v8) { // branch-flip
    v26 = v8;
    v6 = sub_1dec0(v8,0);
    v5 = dat_384a8;
  ...
  v8 = (char *)sub_1cb90(*(unsigned int *)(a3 + 0x20));
  if (v8) { // branch-flip
    v26 = v8;
    v6 = sub_1dec0(v8,0);
    v5 = dat_384a4;
    ...
    v5 = __fprintf_chk(v2,1,"%-*lu",dat_384a4,(unsigned long)*(unsigned int *)(a3 + 0x20));
    if (dat_384a4 < v5)
      dat_384a4 = v5;
    v23 = 0x226;
    v21 = v17;
  ...
  if ((*(unsigned int *)(a3 + 0x18) & 0xb000) != 0x2000) { // branch-flip
    ...
    if ((int)v32 <= -1)
      v24 = v25;
    v7 = sub_1bb50(*(unsigned long *)(a3 + 0x30),v16,0,1,v24);
  ...
  if (v9) { // branch-flip
    v8 = "%b %e  %Y";
    if ((v30 + -0xed4e00 <= *(long *)(a3 + 0x58)) && (v8 = "%b %e %H:%M", v30 + 0xe10 < *(long *)(a3 + 0x58)))
      v8 = "%b %e  %Y";
    v14 = v18;
    v24 = 0x100;
    v32 = a3;
...
long sub_176e0(struct_24 *a0,int *a1) // early-return x2
{
  FILE *v1;
  long *v2;
  long v3;
...
void sub_18110(unsigned int a0,struct_27 *a1) // ternary x2
{
  unsigned char v1;
  char v2; // cl
  char v3; // cl
...
void sub_18290(long a0,struct_27 *a1)
{
  sub_18110(*(unsigned int *)(a0 + 0x18),a1); // tail-call
}
...
unsigned long sub_183c0(struct_9 *a0,struct_9 *a1)
{
  if (a0->field_0x8 != a1->field_0x8)
    return 0;
  return CONCAT71((undefined7)((unsigned long)a1->field_0x0 >> 8),a0->field_0x0 == a1->field_0x0);
...
void sub_18730(long a0,int a1,bool a2)
{
  int v1;
...
unsigned long sub_18870(long a0,struct_18 *a1) // return-dupe x2
{
  long v1;
  struct_19 *v2; // rax
  struct_19 *v3; // rax
  ...
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    v4 = sub_27400(*(struct_17 **)(a0 + 0x58),&a1->field_0x70);
    if (!(char)v4)
      return 1;
    a1->field_0x0 = a1;
    a1->field_0x68 = 2;
...
void sub_18920(long a0,long a1)
{
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x102) { // branch-flip
    ...
    v4 = (void *)sub_1b9b0(*(long *)(a0 + 0x58),&v5);
    if (!v4)
...
int sub_189e0(int a0,unsigned long a1,long a2,bool a3) // early-return x3
{
  stat *v1;
  unsigned long *v2;
  char *v3;
...
label_18f32:
    ...
    v15 = sub_1f100(v7,*(char **)(v2 + 0x30),v8,&v18);
    *(long *)(v2 + 0x18) = v15;
    if (!v15) {
      if (a1 == 3) {
        *(unsigned short *)(v2 + 0x68) = 4;
    ...
    if (*(short *)(v2 + 0x68) != 0xb) { // branch-flip
      if (v16 & 0x100) {
        sub_18920(a0,v2);
        sub_189e0(*(unsigned int *)((long)a0 + 0x2c),*(unsigned int *)&a0[9],v2,0);
        if (!sub_18870(a0,v2)) {
          *__errno_location() = 0xc;
          return NULL;
        }
      ...
      v7 = *(unsigned int *)((long)a0 + 0x2c);
      *(unsigned short *)(v2 + 0x68) = sub_189e0(v7,v16,v2,0);
    }
...
label_1940a:
      ...
      v15 = sub_18600(v2,v18);
      v8 = v18;
      if (v15 == 0x9fa0) goto label_1940a;
      if (v15 <= 0x9fa0) {
        if ((v15) && (v15 != 0x6969)) goto label_195a1;
        goto label_1940a;
      }
      if ((v15 == 0x5346414f) || (v15 == 0xff534d42)) goto label_1940a;
label_195a1:
    ...
    if (*(unsigned char *)((long)a0 + 0x49) & 2) {
      v8 = sub_17dd0(v8,0x406,3);
      v18 = v8;
    }
    if ((0 <= v8) && (!sub_18bd0(a0,v2,v8,NULL))) goto label_18f32;
    if ((v23) && (v4))
      *(int *)(v2 + 0x40) = *__errno_location();
...
label_19004:
      ...
      v12 = (void *)sub_18560(a0,&v10->field_0x13,v11);
      if (!v12) {
label_194a8:
        v8 = *v9;
        free(v12);
      ...
      if (v22 <= v11) {
        v14 = a0[4];
        v5 = sub_18790(a0,v29 + 2 + v11);
        if (!v5) goto label_194a8;
        if (a0[4] != v14) {
          v19 = (char *)(a0[4] + v24);
      ...
      *(unsigned long *)((long)v12 + 0x78) = *(unsigned long *)v10;
      ...
      if ((a0[8]) && (!(v16 & 0x400))) {
        v7 = *(unsigned int *)((long)a0 + 0x2c);
        *(unsigned short *)((long)v12 + 0x68) = sub_189e0(v7,v16,v12,0);
      }
      else {
        v1 = v10->field_0x12;
...
label_19268:
          ...
          v7 = *(unsigned int *)((unsigned long)v6 * 4 + 0x2c380);
        }
        else {
          *(unsigned short *)((long)v12 + 0x68) = 0xb;
          if (v6 <= 0xb) goto label_19268;
          v7 = 0;
          v17 = 2;
        }
label_190fc:
...
label_1962b:
    ...
    v26 = NULL;
    if (!(bool)(v23 & v3 == NULL)) goto label_196d5;
    v4 = 0;
    v21 = 0;
label_196b0:
    if (*(long *)(v2 + 0x58)) // branch-flip
      v8 = sub_18bd0(a0,*(long *)(v2 + 8),0xffffffff,"..");
    else {
      v8 = sub_18b40(a0);
    }
    if (v8) {
...
label_19cf7:
          ...
          sub_1c940((struct_10 *)&v6[0xc],0xffffffff);
          return v6;
        }
      }
label_19c1d:
...
unsigned int sub_19e00(struct_12 *a0) // return-dupe
{
  long v1;
  void *v2;
  struct_11 *v3;
          ...
          if (*(short *)((long)v13 + 0x68) != 0xb) {
            *(char *)(a0->field_0x20 + *(long *)((long)v13 + 0x48)) = 0;
            if (*(long *)((long)v13 + 0x58)) { // branch-flip
              ...
              v9 = sub_18bd0(a0,*(long *)((long)v13 + 8),0xffffffff,"..");
            }
            else {
              v9 = sub_18b40(a0);
            }
...
int * sub_1a780(struct_57 *a0,unsigned int a1) // early-return x2
{
  unsigned int v1;
  long v2;
  void *v3;
...
unsigned long sub_1aa40(struct_13 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  long *v1;
  long v2;
  char v3; // al
...
unsigned long sub_1ac90(struct_14 *a0,struct_58 *a1,bool a2) // return-dupe x2
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
unsigned long sub_1ae30(struct_58 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
long sub_1b060(struct_20 *a0,long a1) // return-dupe
{
  void *v1;
  unsigned long v2; // rax
  long *v3;
...
long sub_1b120(struct_59 *a0,long a1)
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
void sub_1b1b0(struct_58 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_1b200(struct_58 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_1b2f0(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_1a9b0(v1)) {
    v2 = sub_1ab50(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_1b5a0(struct_16 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_1b950(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
...
long sub_1b9b0(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
void sub_1c940(struct_10 *a0,unsigned int a1)
{
...
struct_62 * sub_1e290(char *a0) // early-return
{
  struct_62 *v1; // rax
  stat v2; // stack - 0xa8
...
unsigned long sub_1f4d0(long a0,bool a1,long a2,long a3,long a4) // return-dupe
{
  long v1;
  bool v2;
...
unsigned long sub_1f590(struct_54 *a0) // ternary
{
  char v1;
  long v10;
  long v11;
...
unsigned int sub_210e0(struct_9 *a0,char *a1,long *a2,long a3)
{
  char *v1;
  long v10;
  long v11; // rax
...
label_21aeb:
    if (sub_250c0(v13,a2,&v19)) goto label_211cf;
    goto label_21b07;
  }
label_211a8:
...
label_211cf:
  ...
  do {
    v21 = v31 + v10;
    if (SCARRY8((long)v31,v10)) {
label_21b8e:
      if (((v51) && (v90)) && (!strcmp(v51,v90))) {
        v89 = -1;
        v90 = NULL;
      }
      break;
    }
    if (((sub_250c0(v13,&v21,&v20)) && (v58)) && (v50 != v57)) {
      v90 = v58;
      v91 = 0x10d;
      v92 = v57;
      v93 = 0;
  ...
  v28 = v80;
  if (!v31) {
    v6 = (unsigned int)(unsigned char)v79;
...
label_21cc8:
              ...
              v55 = v16;
              v56 = v31;
              v10 = sub_25170(v13,&v23);
              v6 = sub_1f2e0(&v20,&v23);
              v8 = v62;
...
label_218b1:
                  if ((v72 || v73) || v74) { // branch-flip
                    v10 = v41 + v72;
                    v31 = (int)v10;
                    if ((v10 == v31) && (!SCARRY8((long)v41,v72))) {
                      v10 = v40 + v73;
                      v16 = (int)v10;
                      if ((v10 == v16) && (!SCARRY8((long)v40,v73))) {
                        v10 = v39 + v74;
                        v9 = (int)v10;
                        if ((v10 == v9) && (!SCARRY8((long)v39,v74))) {
                          v6 = 0;
                          v38 = v34;
                          v23 = CONCAT44(v36,v35);
                          v43 = v37;
...
label_219b0:
                    if (v12) {
                      v12 = v62 - v44;
                      v32 = SBORROW8(v10,v12);
                      v10 -= v12;
                      v6 = 0;
                      if (SBORROW8((long)v62,v44) || v32) goto label_213fd;
                    }
                    v12 = v75 * 0xe10;
                    if ((((SEXT816(v12) == SEXT816(v75) * SEXT416(0xe10)) && (!SCARRY8(v10,v12))) && (v11 = v76 * 0x3c, SEXT816(v11) == SEXT816(v76) * SEXT816(0x3c))) && ((v15 = v10 + v12 + v11, !SCARRY8(v10 + v12,v11) && (v12 = v15 + v77, !SCARRY8(v15,v77))))) {
                      v11 = ((v78 + v71) % 1000000000 + 1000000000) % 1000000000;
                      v10 = (long)(int)(((v78 + v71) - v11) / 1000000000);
                      if (!SCARRY8(v12,v10)) {
                        v6 = 1;
...
label_21b07:
                  ...
                  v10 = v59 * 7;
                  if ((SEXT816(v10) != SEXT816(v59) * SEXT816(7)) || (v11 = (long)(((v60 - v42) + 7) % 7), v15 = v11 + v10, SCARRY8(v11,v10))) goto label_21b07;
                  v11 = (long)v39;
                  v10 = v15 + v11;
                  v39 = (int)v10;
                  v6 = 0;
                  if (v10 == v39 && !SCARRY8(v15,v11)) {
                    v43 = -1;
                    v10 = sub_25170(v13,&v23);
                ...
                v3 = v62 >> 0x1f;
                v7 = v62 / 0xe10;
                v7 = __sprintf_chk(v24,1,0x1b,"%c%02d",((unsigned char)v3 & 2) + 0x2b,abs(v7));
                v8 = abs(v8 % 0xe10);
                if (v8) {
                  v10 = (long)v7;
                  v24[v10] = ':';
                  ...
                  v7 = v8 % 0x3c;
                  v1 = &v24[3];
                  v24[v10 + 2] = (char)(v8 / 0x3c) + v2 * '\xf6' + '0';
                  if (v7) {
                    v24[v10 + 3] = ':';
                    v1 = &v24[6];
                    v2 = (char)(v7 / 10);
                    v24[v10 + 4] = v2 + '0';
                    v24[v10 + 5] = (char)v7 + v2 * '\xf6' + '0';
                  }
                  v1[v10] = '\0';
                }
                v11 = sub_24db0(&v25);
...
unsigned int sub_21de0(struct_9 *a0,char *a1,long *a2)
{
  unsigned int v1; // eax
  long v2; // rax
...
unsigned long sub_24e50(long *a0,struct_55 *a1) // return-dupe
{
  struct_55 *v1;
  long *v2;
  int v3; // eax
...
struct_55 * sub_250c0(long a0,void *a1,struct_55 *a2) // return-dupe x3
{
  long *v1; // rax
  
  if (!a0)
    return (struct_55 *)gmtime_r(a1,(tm *)a2); // tail-call
...
void sub_257e0(FILE *a0,char *a1,char *a2,char *a3,struct_63 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_27400(struct_17 *a0,struct_9 *a1)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
...
void sub_27670(struct_64 *a0,struct_65 *a1) // return-dupe
{
  char v1;
  long v2;
  struct_65 *v3;
  
  v3 = (struct_65 *)a1->field_0x0;
  if (v3 == &a1[1])
