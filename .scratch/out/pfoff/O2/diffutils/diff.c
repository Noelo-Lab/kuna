...
char * sub_8ea0(struct_12 *a0,unsigned long a1,unsigned long a2)
{
  char v1;
  long v2;
  char *v3; // rax
...
void sub_b8a0(struct_7 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
void sub_f510(int a0)
{
  ...
  if ((dat_26758) && (dat_26010 != a0)) {
    ...
    switch(a0) {
      case 0:
        sub_e180((struct_3 *)0x26060);
        break;
      case 1:
        sub_e180((struct_3 *)0x26070);
        break;
      case 2:
        sub_e180((struct_3 *)0x26080);
        break;
      case 3:
        sub_e180((struct_3 *)0x26050);
        break;
      case 4:
        sub_e180((struct_3 *)0x26090);
        break;
      default:
        abort(); // no-return
...
void sub_10680(struct_23 *a0,char *a1,unsigned int a2) // return-dupe x2
{
  unsigned int *v1;
  struct_24 *v10; // rax
  void *v11;
  ...
  if ((!(a2 & 0x18000000)) || (!sub_10240(a1,a2))) {
    if (((!v5) || ((int)v5[1])) || ((*(unsigned int *)((long)v5 + 0xc) ^ a2) & 0x60000018)) {
      ...
      *(unsigned int *)((long)v5 + 0xc) = a2;
      ...
      v5[2] = sub_11910(0,0,v14,v11,sub_fe10);
      v2 = a0->field_0x0;
      a0->field_0x0 = v5;
      *v5 = (long)v2;
    }
...
int sub_109c0(void *a0,long a1,FILE *a2,unsigned int a3,unsigned char a4,unsigned long a5)
{
  unsigned long v1;
  unsigned char *v10;
  int v11; // stack - 0x5c
...
unsigned int sub_10bd0(unsigned long a0,long a1,char *a2,unsigned long a3,char a4) // return-dupe
{
  unsigned int v1; // eax
  FILE *v2; // rax
...
unsigned long sub_11060(struct_19 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  long *v1;
  long v2;
  char v3; // al
...
unsigned long sub_112b0(struct_20 *a0,struct_26 *a1,bool a2) // return-dupe x2
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
unsigned long sub_11450(struct_26 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
char * sub_11680(struct_14 *a0,char *a1) // return-dupe
{
  void *v1;
  unsigned long v2; // rax
  long *v3;
...
long sub_11740(struct_27 *a0,long a1)
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
void sub_117d0(struct_26 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_11820(struct_26 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_11910(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_10fd0(v1)) {
    v2 = sub_11170(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_11bc0(struct_22 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_11f70(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
...
long sub_11fd0(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
void sub_12220(struct_30 *a0,struct_31 *a1) // return-dupe
{
  char v1;
  long v2;
  struct_31 *v3;
  
  v3 = (struct_31 *)a1->field_0x0;
  if (v3 == &a1[1])
...
void sub_167a0(FILE *a0,char *a1,char *a2,char *a3,struct_32 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_173c0(long *a0,struct_4 *a1) // return-dupe
{
  struct_4 *v1;
  long *v2;
  int v3; // eax
...
struct_4 * sub_17630(long a0,void *a1,struct_4 *a2) // return-dupe x3
{
  long *v1; // rax
  
  if (!a0)
    return (struct_4 *)gmtime_r(a1,(tm *)a2); // tail-call
...
char * sub_19ee0(unsigned int a0,char *a1,unsigned long a2,struct_33 *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
...
{
  return sub_19ee0(a0,a1,0xffffffffffffffff,(struct_33 *)0x369a0); // tail-call
}
...
{
  return sub_19ee0(0,a0,0xffffffffffffffff,(struct_33 *)0x369a0); // tail-call
}

// Function: sub_1a460 @ 0x1a460
char * sub_1a460(char *a0,unsigned long a1)
{
  return sub_19ee0(0,a0,a1,(struct_33 *)0x369a0); // tail-call
}
...
{
  return sub_19ee0(0,a0,a1,(struct_33 *)0x260c0); // tail-call
}

// Function: sub_1ac80 @ 0x1ac80
char * sub_1ac80(unsigned int a0,char *a1)
{
  return sub_19ee0(a0,a1,0xffffffffffffffff,(struct_33 *)0x260c0); // tail-call
}

// Function: sub_1aca0 @ 0x1aca0
char * sub_1aca0(char *a0)
{
  return sub_19ee0(0,a0,0xffffffffffffffff,(struct_33 *)0x260c0); // tail-call
}
