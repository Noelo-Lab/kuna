...
label_5402:
    ...
    if (2 <= v79) { // branch-flip
      ...
      *(char *)((long)v28 + 0x54) = 0;
      ...
      sub_7af0(v28,(struct_13 *)&v28[0x10],v29,v31,v79,0);
      sub_b220(v29,v31,v79,(struct_13 *)&v28[0x10],(sigaction *)&v51,v52,v69);
      if (v81) {
        v27 = &v28[0xb];
        v29 = v81 - 1;
        do {
...
label_5e04:
      ...
      v29 = v110 * -4;
      if ((v31) && ((int)(v48 ^ 1) <= (int)sub_a0b0(&v52,(struct_10 *)&v28[-4]))) {
        v27 = v28;
label_5df7:
        v48 = 0;
        if (v12 == 'c') {
...
char * sub_7ca0(char *a0,long a1,long a2)
{
  char *v1;
  long v2;
  char *v3;
...
char * sub_7dd0(char *a0,long a1,struct_6 *a2)
{
  long v1;
  long v2;
  char *v3; // rax
...
unsigned long sub_7ef0(struct_7 *a0,FILE *a1,char *a2)
{
  long v1;
  unsigned long v10;
  unsigned char *v11;
...
void sub_82d0(struct_8 *a0,FILE *a1,char *a2)
{
  char v1;
  long *v10;
  char *v11;
...
unsigned long sub_a0b0(struct_10 *a0,struct_10 *a1)
{
  unsigned long v1;
  unsigned long v2;
  int v3; // eax
...
void sub_a180(unsigned long *a0,unsigned long a1,unsigned long *a2,bool a3) // return-dupe x2
{
  ...
  v9 = sub_a0b0((struct_10 *)&a0[-4],(struct_10 *)&a0[-8]);
  if (a3) {
...
void sub_a3c0(long *a0,FILE *a1,char *a2)
{
  if (dat_1d419) {
    if (dat_1d840) {
      if (!sub_a0b0(a0,(struct_10 *)0x1d840))
        return;
    }
    dat_1d840 = *a0;
    dat_1d848 = a0[1];
    ...
    if (v38 != 1) {
      ...
      do {
        while( true ) {
          v25 = &v23[v34];
          v28 = &v23[v34 - 1];
          v6 = *(struct_10 **)((long)v22 + *v25 * 8);
          v7 = *(struct_10 **)((long)v22 + *v28 * 8);
...
label_a81c:
    ...
    v5 = *(char **)(a0 + v34 * 0x10);
    if (sub_7ef0((struct_7 *)((long)v40 + v34 * 0x38),v4,v5)) {
      v34 = *v23;
...
label_a761:
      ...
      do {
        while( true ) {
          v33 = v1;
          v21 = sub_a0b0(*(struct_10 **)((long)v22 + v34 * 8),*(struct_10 **)((long)v22 + v23[v33] * 8));
...
void sub_b1a0(unsigned long *a0,struct_11 *a1)
{
  long v1;
...
void sub_b220(long a0,unsigned long a1,unsigned long a2,struct_13 *a3,unsigned long *a4,FILE *a5,char *a6)
{
  pthread_mutex_t *v1;
  long v10;
  long v11;
  ...
  do {
    pthread_mutex_lock(v1);
    while (v8 = (long *)sub_e010((struct_12 *)*a4), !v8) {
    ...
    if (v3 != 1) { // branch-flip
      ...
      if (v30 != v18) { // branch-flip
        ...
        while ((unsigned long *)v8[3] != v9) {
          ...
          v15 = &v14[-4];
          if (1 <= (int)sub_a0b0((struct_10 *)&v26[-4],(struct_10 *)&v9[-4])) { // branch-flip
            v25 = v8[1];
      ...
      *v12 = v14;
      ...
      if (v30 != v18) { // branch-flip
        ...
        while ((unsigned long *)v8[3] != v9) {
          ...
          if (1 <= (int)sub_a0b0((struct_10 *)&v21[-4],(struct_10 *)&v9[-4])) { // branch-flip
            v25 = v8[1];
            v8[1] = v25 + -0x20;
...
unsigned long sub_cd90(struct_2 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  long *v1;
  long v2;
  char v3; // al
...
unsigned long sub_cfe0(struct_3 *a0,struct_16 *a1,bool a2) // return-dupe x2
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
unsigned long sub_d180(struct_16 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
long sub_d3b0(struct_17 *a0,long a1) // return-dupe
{
  void *v1;
  unsigned long v2; // rax
  long *v3;
...
long sub_d470(struct_18 *a0,long a1)
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
void sub_d500(struct_16 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_d550(struct_16 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_d640(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_cd00(v1)) {
    v2 = sub_cea0(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_d8f0(struct_5 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_dca0(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
...
long sub_dd00(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
unsigned long * sub_e010(struct_12 *a0)
{
  unsigned long v1;
  unsigned long v10;
  unsigned long v11;
...
unsigned long sub_11aa0(FILE *a0,long a1)
{
  int v1; // eax
  char *v2;
  long v3; // rax
...
void sub_12840(FILE *a0,char *a1,char *a2,char *a3,struct_22 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_13e80(struct_9 *a0,timespec *a1) // early-return
{
  int v1; // eax
  long v2;
...
long * sub_13fa0(struct_14 *a0,long a1,long a2) // ternary
{
  long *v1; // rax
