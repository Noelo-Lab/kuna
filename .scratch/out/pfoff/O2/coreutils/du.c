...
long sub_6080(struct_13 *a0,long a1) // early-return
{
  struct_14 *v1; // rax
  struct_14 *v2;
  long v3;
  
  v2 = (struct_14 *)a0->field_0x10;
  if (v2) { // branch-flip
  ...
  *(long *)v2->field_0x0 = a1;
  v1 = (struct_14 *)sub_c720(a0->field_0x0,v2);
  if (!v1)
    return 0;
  if (v2 == v1) {
    a0->field_0x10 = NULL;
    v3 = sub_c0c0(0x3fd,0,sub_6050,NULL,0);
    v2->field_0x8 = v3;
    return v3;
  }
  v3 = v1->field_0x8;
...
void sub_61a0(unsigned long *a0)
{
  ...
  if ((struct_8 *)a0[1])
    sub_d850((struct_8 *)a0[1]);
  free((void *)a0[2]);
  free(a0); // tail-call
}

// Function: sub_61d0 @ 0x61d0
unsigned long sub_61d0(long a0,long a1,long a2)
{
  long v1; // rax
  long *v2;
  ...
  if (0x7ffffffffffffffe <= (unsigned long)(a2 - 1U)) {
    v2 = *(long **)(a0 + 8);
    if (!v2) {
      v2 = (long *)sub_d7e0(0x7fffffffffffffff);
      *(long **)(a0 + 8) = v2;
      if (!v2)
        return 0xffffffff;
    }
...
unsigned long sub_6260(long a0,long a1,long a2)
{
  struct_15 *v1; // rax
  long *v2;
  
  v1 = (struct_15 *)sub_6080(a0,a1);
  if (!v1)
    return 0xffffffff;
  if (0x7ffffffffffffffe <= (unsigned long)(a2 - 1U)) {
    v2 = *(long **)(a0 + 8);
...
void sub_6b70(struct_27 *a0,char *a1,unsigned int a2) // return-dupe x2
{
  unsigned int *v1;
  struct_28 *v10; // rax
  void *v11;
  ...
  if ((!(a2 & 0x18000000)) || (!sub_6730(a1,a2))) {
    if (((!v5) || ((int)v5[1])) || ((*(unsigned int *)((long)v5 + 0xc) ^ a2) & 0x60000018)) {
      ...
      *(unsigned int *)((long)v5 + 0xc) = a2;
      ...
      v5[2] = sub_c0c0(0,0,v14,v11,sub_6300);
      v2 = a0->field_0x0;
      a0->field_0x0 = v5;
      *v5 = (long)v2;
    }
...
int sub_6eb0(void *a0,long a1,FILE *a2,unsigned int a3,unsigned char a4,unsigned long a5)
{
  unsigned long v1;
  unsigned char *v10;
  int v11; // stack - 0x5c
...
unsigned int sub_70c0(unsigned long a0,long a1,char *a2,unsigned int a3,char a4) // return-dupe
{
  int v1;
  unsigned int v2; // eax
  FILE *v3; // rax
...
unsigned long sub_7280(FILE *a0,char *a1,tm *a2,char a3,unsigned int a4,int a5,long a6,int a7)
{
  ...
  char v23 [23];
  unsigned short v24; // stack - 0x44d
  long v25;
  unsigned long v26; // stack - 0x488
  unsigned char v27 [1010];
  unsigned char *v28;
  unsigned char *v29;
  int v3;
  unsigned int v30;
  ...
  bool v42;
  int *v43; // stack - 0x4f0
  unsigned int v44; // stack - 0x4e8
  unsigned long v45; // stack - 0x4c0
  char *v46; // stack - 0x4b8
  unsigned long v47; // stack - 0x4a8
  bool v48; // stack - 0x4a0
  unsigned long v49; // stack - 0x480
  long v5;
  unsigned long v50; // stack - 0x478
  long v51; // stack - 0x470
  unsigned long v52; // stack - 0x468
  unsigned long v53; // stack - 0x460
  unsigned long v54; // stack - 0x458
  int *v6;
  long v7;
  char v8;
  bool v9;
...
label_7313:
  ...
  if (v16 - 0x30 <= 9) {
    ...
    do {
      v40 = (long)(int)v36 * 10;
      v35 = (int)v40;
      if ((v35 != v40) || (v36 = (unsigned long)(unsigned int)(v35 + *v20 + -0x30), SCARRY4(v35,*v20 + -0x30)))
        v36 = 0x7fffffff;
  ...
  if (((char)v16 != 'E') && ((char)v16 != 'O'))
    ...
    v16 = (unsigned int)(unsigned char)v20[1];
    v20 = &v20[1];
  }
  v15 = (char)v16;
  v35 = (int)v36;
  ...
  switch(v16 & 0xff) {
    ...
    case 0x25:
      if (&v20[-1] == a1) {
        if ((v32 != 0x2d) && (0 <= v35)) {
          v11 = (unsigned long)v35;
          v36 = 1;
          if (v11)
            v36 = v11;
          if (~v41 <= v36) goto label_7388;
          if (a0) {
            if (2 <= v35) {
              if ((v32 != 0x30) && (v21 = 0, v32 != 0x2b)) {
                do {
                  v21 += 1;
                  fputc(0x20,a0);
                } while (v11 - 1 != v21);
...
label_89ef:
          ...
          if (0xfffffffffffffffe <= v41) goto label_7388;
          v36 = 1;
    ...
    case 0x43:
      if (v30 != 0x45) {
        v14 = *(int *)&a2->field_0x14;
        v42 = v14 < -0x76c;
        v19 = (int)((-(unsigned int)(v14 + 0x76cU < 0x76c) & 0xffffff9d) + v14) / 100 + 0x13;
        v9 = -0x76c <= v14;
        if (!v32)
          v32 = a4;
...
label_8a70:
    ...
    case 0x46:
      ...
      v14 = 4;
      v36 = sub_7280(0,"%Y-%m-%d",a2,(unsigned char)v8,0x2b,4,v7,v31);
      v32 = 0x2b;
      v46 = "%Y-%m-%d";
      v11 = 0;
      v45 = v36;
    ...
    case 0x67:
      if (v30 != 0x45) {
        v34 = *(int *)&a2->field_0x1c;
        v18 = *(int *)&a2->field_0x18;
        v3 = *(int *)&a2->field_0x14;
        v14 = (v34 - v18) + 0x17e;
        v19 = v3 + -100 + (v3 >> 0x1f & 400U);
        v14 = (v34 - v14) + 3 + (v14 / 7) * 7;
        if (0 <= v14) { // branch-flip
          v17 = 0x16d;
          if ((!(v19 & 3)) && (v17 = 0x16e, (v19 * -0x3d70a3d7 + 0x51eb850 >> 2 | v3 * 0x40000000) <= 0x28f5c28))
            v17 = 0x16e - (unsigned int)((int)v19 % 400 != 0);
          v18 = ((v34 - v17) - v18) + 0x17e;
          v34 = ((v34 - v17) - v18) + 3 + (v18 / 7) * 7;
          if (0 <= v34)
            v14 = v34;
          v18 = (v34 >> 0x1f) + 1;
        }
          ...
          v19 -= 1;
          v14 = 0x16d;
          if ((!(v19 & 3)) && (v14 = 0x16e, (v19 * -0x3d70a3d7 + 0x51eb850 >> 2 | v19 * 0x40000000) <= 0x28f5c28))
            v14 = 0x16e - (unsigned int)((int)v19 % 400 != 0);
          v17 = ((v14 + v34) - v18) + 0x17e;
          v18 = -1;
          v14 = ((v14 + v34) - v17) + 3 + (v17 / 7) * 7;
        }
        if (v15 == 'G') {
          v19 = v3 + 0x76c + v18;
          v42 = v3 < 0xfffff894U - v18;
          if (v32) { // branch-flip
label_8a59:
            v46._0_4_ = 4;
            v16 = 9999;
            if (v32 == 0x2b) goto label_8a70;
            v4 = 0;
            v9 = (bool)(v42 ^ 1);
          }
          else {
...
label_8ce5:
        ...
        v19 = (v3 % 100 + v18) % 100;
        if (0 <= (int)v19) goto label_78c0;
        if (v3 < 0xfffff894U - v18) {
          v19 = -v19;
          if (!v32) goto label_78d2;
label_8a1a:
          v33 = v32;
          goto label_78d2;
        }
        v19 += 100;
        if (v32) goto label_8a1a;
    ...
    case 0x54:
      ...
      v46 = "%H:%M:%S";
label_808e:
      v36 = sub_7280(0,v46,a2,(unsigned char)v8,v32,v14,v7,v31);
      if ((v32 != 0x2d) && (0 <= v35)) {
        v11 = (unsigned long)v35;
        v45 = v11;
        if (v11 <= v36)
...
label_80e8:
      ...
      if (a0) {
        ...
        sub_7280(a0,v46,a2,(unsigned char)v8,v32,v14,v7,a7);
      }
      v41 += v45;
      goto label_735f;
    case 0x55:
      if (v30 != 0x45) {
        v14 = (*(int *)&a2->field_0x1c - *(int *)&a2->field_0x18) + 7;
label_7c2e:
        v46._0_4_ = 2;
        v19 = v14 / 7;
        goto label_7b80;
    ...
    case 0x57:
      if (v30 != 0x45) {
        v14 = *(int *)&a2->field_0x18 + 6;
        v14 = ((v14 / 7) * 7 - v14) + 7 + *(int *)&a2->field_0x1c;
        goto label_7c2e;
      }
      break;
    case 0x58:
    case 99:
    case 0x78:
      if (v30 != 0x4f) goto label_7621;
      break;
    case 0x59:
      if (v30 == 0x45) goto label_7901;
      if (v30 == 0x4f) break;
      v42 = *(int *)&a2->field_0x14 < -0x76c;
      v19 = *(int *)&a2->field_0x14 + 0x76c;
      if (v32) goto label_8a59;
        ...
        if (v42) { // branch-flip
          if (v36) {
            ...
            do {
              v13 = *v28;
              v28 = &v28[1];
              fputc(*(int *)(*v12 + (unsigned long)v13 * 4),a0);
            } while (v28 != &v10[v36]);
          }
        }
    ...
    case 0x68:
      if (v42)
        v8 = v42;
      if (v30 != 0x45) goto label_7621;
      break;
    case 100:
      if (v30 != 0x45) {
        v46._0_4_ = 2;
        v19 = *(unsigned int *)&a2->field_0xc;
        goto label_7b80;
      }
      break;
    case 0x65:
...
label_81d4:
    ...
    case 0x6b:
      ...
      break;
    case 0x6c:
      if (v30 != 0x45) goto label_81d4;
      break;
    case 0x6d:
      if (v30 != 0x45) {
        v4 = 0;
        v46._0_4_ = 2;
        v14 = *(int *)&a2->field_0x10;
        v19 = v14 + 1;
        v42 = v14 < -1;
        v9 = -1 <= v14;
        v16 = 0;
...
label_85f6:
      ...
      if (v42)
        v8 = 0;
label_7626:
      if (v30) goto label_7915;
      v39 = &v22;
      goto label_7643;
    case 0x71:
      if (v30 == 0x4f) goto label_7901;
      v4 = 0;
      v42 = 0;
      v16 = 0;
      v46._0_4_ = 1;
      v19 = (*(int *)&a2->field_0x10 * 0xb >> 5) + 1;
      goto label_7f40;
    case 0x72:
label_7621:
      v48 = 0;
      goto label_7626;
    case 0x73:
      v52 = *(unsigned long *)&a2->field_0x20;
      v53 = *(unsigned long *)&a2->field_0x28;
      v26 = *(unsigned long *)a2;
      v49 = *(unsigned long *)&a2->field_0x8;
      v50 = *(unsigned long *)&a2->field_0x10;
      v54 = *(unsigned long *)&a2->field_0x30;
      v51._0_4_ = (unsigned int)*(unsigned long *)&a2->field_0x18;
      v51 = CONCAT44(0xffffffff,(unsigned int)v51);
      v21 = sub_113a0(v7,&v26);
      if (v51 <= -1) {
        *v43 = 0x4b;
        return 0;
      }
      v42 = (bool)((unsigned long)v21 >> 0x3f);
      v28 = &v27[1];
      v40 = v21;
      do {
        v5 = v40 / 10;
        v15 = (char)v40 + (char)v5 * '\xf6';
        if (v21 <= -1)
          v15 = -v15;
        v28 = &v28[-1];
        *v28 = v15 + 0x30;
...
label_7ede:
    ...
    case 0x75:
      v46._0_4_ = 1;
      v19 = (*(int *)&a2->field_0x18 + 6) % 7 + 1;
label_7b80:
      v4 = 0;
      v16 = 0;
      v13 = (unsigned char)(v19 >> 0x18);
      v42 = (bool)(v13 >> 7);
      v9 = (bool)((unsigned char)~v13 >> 7);
      goto label_78f0;
    case 0x77:
      if (v30 != 0x45) {
        v46._0_4_ = 1;
        v19 = *(unsigned int *)&a2->field_0x18;
        goto label_7b80;
      }
      break;
    case 0x79:
      if (v30 == 0x45) goto label_7901;
      v16 = *(int *)&a2->field_0x14 % 100;
      v19 = v16;
      if ((int)v16 <= -1) {
        v19 = v16 + 100;
...
label_8483:
      ...
      v42 = 1;
      v14 = (int)*(unsigned long *)&a2->field_0x28;
      if ((0 <= v14) && (v42 = 0, !v14))
        v42 = *v10 == 0x2d;
      v19 = v14 / 0xe10;
      v34 = (v14 / 0x3c) % 0x3c;
      if (v36 != 2) { // branch-flip
        if (3 <= v36) { // branch-flip
          if (v36 != 3) break;
          if (v14 % 0x3c) goto label_8baf;
          if (v34) goto label_8533;
          v4 = 1;
          v46._0_4_ = 3;
          v9 = (bool)(v42 ^ 1);
          v16 = 0;
...
label_8baf:
        ...
        v46._0_4_ = 9;
        v16 = 0x14;
        v19 = v14 % 0x3c + v19 * 10000 + v34 * 100;
        v9 = (bool)(v42 ^ 1);
      }
label_78f0:
      if ((v30 != 0x4f) || (!v9)) {
...
label_7f40:
        ...
        while( true ) {
          ...
          v16 = (int)v16 >> 1;
          v28 = &v29[-1];
          v29[-1] = (char)v19 + (char)(v19 / 10) * '\xf6' + 0x30;
          if ((v19 <= 9) && (!v16)) break;
          v19 /= 10;
          v29 = v28;
        }
...
label_8675:
          ...
          if (0xfffffffffffffffe <= v41) goto label_7388;
          if (a0)
            fputc((int)(char)v46,a0);
          v11 = (unsigned long)v31;
          v41 += 1;
          v36 = 0;
          if ((v19 != 0x2d) && (v35 = v35 + -1, 0 <= v35)) {
label_7d87:
            v36 = (unsigned long)v35;
            v11 = (long)v31;
            if ((unsigned long)(long)v31 <= v36)
              v11 = v36;
          }
        }
        else {
          ...
          v11 = (unsigned long)v31;
          if (((v31 < v35) && (v32 != 0x2d)) || (v36 = 0, v19 != 0x2d)) goto label_7d87;
        }
        v38 = (unsigned long)v31;
        if (~v41 <= v11) goto label_7388;
        if (a0) {
          if (v38 < v36) {
            if ((v19 != 0x30) && (v21 = 0, v19 != 0x2b)) {
              do {
                v21 += 1;
                fputc(0x20,a0);
              } while (v36 - v38 != v21);
...
label_7643:
      ...
      *v39 = v15;
      v37 = &v23[1];
      v39[1] = '\0';
      v36 = strftime(v37,0x400,(char *)&v24,a2);
      if (v36) {
        v11 = v36 - 1;
        v47 = v11;
        if ((v32 != 0x2d) && (0 <= v35)) {
          v38 = (unsigned long)v35;
          if (v11 < v38)
            v47 = v38;
        }
        else {
...
label_7770:
  ...
  if ((char *)~v41 <= v46) goto label_7388;
  if (a0) {
    if (v39 < v37) {
      if ((v32 != 0x30) && (v32 != 0x2b)) {
        v21 = 0;
    ...
    if (v8) { // branch-flip
      ...
      fwrite(a1,(unsigned long)v39,1,a0);
    }
  }
  v41 += (long)v46;
  goto label_735f;
label_79f1:
  v11 = (unsigned long)v34;
  v36 = v11;
  if (v34) { // branch-flip
label_7a00:
    v39 = &v23[v36 + 1];
    do {
      ...
      *v39 = (char)v14 + (char)(v14 / 10) * '\xf6' + '0';
      v14 /= 10;
    } while (v39 != &v23[v36 - (unsigned int)(v34 - 1)]);
  }
  else {
    v11 = 0;
  }
  ...
  if (a0) { // branch-flip
    if (!v8) {
      fwrite(&v23[1],v11,1,a0);
      goto label_7aec;
    }
    if (v11) {
      v12 = __ctype_toupper_loc();
      v29 = (unsigned char *)&v23[1];
      v28 = &v29[v11];
      do {
        v13 = *v29;
        v29 = &v29[1];
...
unsigned long sub_9170(struct_18 *a0,struct_18 *a1)
{
...
int sub_9200(long a0,long a1,bool a2) // early-return x3
{
  stat *v1;
  unsigned long *v2;
  char *v3;
...
void sub_9690(long a0,int a1,bool a2)
{
  int v1;
...
unsigned long sub_97d0(long a0,struct_20 *a1) // return-dupe x2
{
  long v1;
  struct_21 *v2; // rax
  struct_21 *v3; // rax
  ...
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    v4 = sub_136b0(*(struct_19 **)(a0 + 0x58),&a1->field_0x70);
    if (!(char)v4)
      return 1;
    a1->field_0x0 = a1;
    a1->field_0x68 = 2;
...
void sub_9880(long a0,long a1)
{
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x102) { // branch-flip
    ...
    v4 = (void *)sub_c780(*(long *)(a0 + 0x58),&v5);
    if (!v4)
...
label_9d32:
    ...
    v15 = sub_eac0(v7,*(char **)(v2 + 0x30),v8,&v18);
    *(long *)(v2 + 0x18) = v15;
    if (!v15) {
      if (a1 == 3) {
        *(unsigned short *)(v2 + 0x68) = 4;
...
label_a205:
      ...
      v15 = sub_9560(v2,v18);
      v8 = v18;
      if (v15 == 0x9fa0) goto label_a205;
      if (v15 <= 0x9fa0) {
        if ((v15) && (v15 != 0x6969)) goto label_a3a1;
        goto label_a205;
      }
      if ((v15 == 0x5346414f) || (v15 == 0xff534d42)) goto label_a205;
label_a3a1:
    ...
    if (*(unsigned char *)((long)a0 + 0x49) & 2) {
      v8 = sub_13740(v8,0x406,3);
      v18 = v8;
    }
    if ((0 <= v8) && (!sub_99d0(a0,v2,v8,NULL))) goto label_9d32;
    if ((v23) && (v4))
      *(int *)(v2 + 0x40) = *__errno_location();
...
label_9e04:
      ...
      v12 = (void *)sub_94c0(a0,&v10->field_0x13,v11);
      if (!v12) {
label_a2a8:
        v8 = *v9;
        free(v12);
      ...
      if (v22 <= v11) {
        v14 = a0[4];
        v5 = sub_96f0(a0,v29 + 2 + v11);
        if (!v5) goto label_a2a8;
        if (a0[4] != v14) {
          v19 = (char *)(a0[4] + v24);
      ...
      *(unsigned long *)((long)v12 + 0x78) = *(unsigned long *)v10;
      ...
      if ((a0[8]) && (!(v16 & 0x400)))
        *(unsigned short *)((long)v12 + 0x68) = sub_9200(a0,v12,0);
      else {
        v1 = v10->field_0x12;
...
label_a068:
          ...
          v7 = *(unsigned int *)((unsigned long)v6 * 4 + 0x15a00);
        }
        else {
          *(unsigned short *)((long)v12 + 0x68) = 0xb;
          if (v6 <= 0xb) goto label_a068;
          v7 = 0;
          v17 = 2;
        }
label_9ef8:
...
label_a42b:
    ...
    v26 = NULL;
    if (!(bool)(v23 & v3 == NULL)) goto label_a4d5;
    v4 = 0;
    v21 = NULL;
label_a4b0:
    if (*(long *)(v2 + 0x58)) // branch-flip
      v8 = sub_99d0(a0,*(long *)(v2 + 8),0xffffffff,"..");
    else {
      v8 = sub_9940(a0);
    }
    if (v8) {
...
label_aadf:
          ...
          sub_d710((struct_25 *)&v4[0xc],0xffffffff);
          return v4;
        }
      }
label_aa0d:
...
unsigned int sub_abe0(struct_17 *a0) // return-dupe
{
  long v1;
  void *v2;
  struct_7 *v3;
          ...
          if (*(short *)((long)v12 + 0x68) != 0xb) {
            *(char *)(a0->field_0x20 + *(long *)((long)v12 + 0x48)) = 0;
            if (*(long *)((long)v12 + 0x58)) { // branch-flip
              ...
              v8 = sub_99d0(a0,*(long *)((long)v12 + 8),0xffffffff,"..");
            }
            else {
              v8 = sub_9940(a0);
            }
...
int * sub_b550(struct_30 *a0,unsigned int a1) // early-return x2
{
  unsigned int v1;
  long v2;
  void *v3;
...
unsigned long sub_b810(struct_9 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  long *v1;
  long v2;
  char v3; // al
...
unsigned long sub_ba60(struct_10 *a0,struct_31 *a1,bool a2) // return-dupe x2
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
unsigned long sub_bc00(struct_31 *a0)
{
  long v1;
  long *v2;
  unsigned long v3;
...
long sub_be30(struct_15 *a0,long a1) // return-dupe
{
  void *v1;
  unsigned long v2; // rax
  long *v3;
...
long sub_bef0(struct_32 *a0,long a1)
{
  long v1;
  unsigned long v2; // rax
  long *v3; // rax
...
void sub_bf80(struct_31 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_bfd0(struct_31 *a0,void *a1,unsigned long a2)
{
  long *v1;
  long v2;
  long v3; // r12
...
unsigned long * sub_c0c0(unsigned long a0,long a1,void *a2,void *a3,unsigned long a4) // return-dupe
{
  ...
  v1[5] = a1;
  if (sub_b780(v1)) {
    v2 = sub_b920(*(float *)(a1 + 8),a0,(unsigned char)*(char *)(a1 + 0x10));
    v1[2] = v2;
    if (v2) {
      v3 = calloc(v2,0x10);
      *v1 = v3;
...
unsigned int sub_c370(struct_12 *a0,unsigned long a1) // return-dupe
{
  unsigned int v1; // eax
...
unsigned long sub_c720(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
...
long sub_c780(long a0,long a1) // ternary x2
{
  unsigned long v1;
  float *v2;
  void *v3;
...
void sub_d710(struct_25 *a0,unsigned int a1)
{
...
void sub_d9f0(struct_35 *a0,struct_36 *a1) // return-dupe
{
  char v1;
  long v2;
  struct_36 *v3;
  
  v3 = (struct_36 *)a1->field_0x0;
  if (v3 == &a1[1])
...
void sub_11a10(FILE *a0,char *a1,char *a2,char *a3,struct_37 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_136b0(struct_19 *a0,struct_18 *a1)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
