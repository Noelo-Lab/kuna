...
{
  *(bool *)a0 = pthread_sigmask(0,(void *)0x236a0,(void *)(a0 + 8)) == 0;
}
...
long sub_5372(long *a0,char a1) // early-return
{
  ...
  v5 = sub_4c3d(&v3,(unsigned char)a1);
  if (!v5)
    return 0;
  *(char *)(v5 + 0xc) = 0;
  if (dat_23690) {
...
FILE * sub_551c(long a0) // early-return
{
  int v1;
  int v2; // eax
  unsigned long v3; // rax
...
char * sub_6898(struct_4 *a0,long a1)
{
  long v1;
  long v2;
  char *v3;
  ...
  *a2 = sub_1819d(a1,8);
  ...
  for (v3 = 0; (unsigned long)(long)v3 < a1; v3 = v3 + 1) {
    if ((*(long *)(a0 + (long)v3 * 0x10 + 8)) && (*(char *)(*(long *)(a0 + (long)v3 * 0x10 + 8) + 0xc)))
      v2 = sub_551c(*(long *)(a0 + (long)v3 * 0x10 + 8));
    else {
...
unsigned long * sub_b7b6(unsigned long a0,long a1,long a2)
{
  ...
  *(char *)((long)v1 + 0x54) = 0;
  ...
  sub_b911(v1,(struct_13 *)&v1[0x10],a2,a0,a1,0);
  return v1;
}
...
unsigned long * sub_b911(long a0,struct_13 *a1,long a2,unsigned long a3,long a4,bool a5) // ternary x2
{
  unsigned long v1;
  unsigned long v2; // rax
  long v3; // rax
...
void sub_bde5(struct_15 *a0,unsigned long a1,FILE *a2,char *a3)
{
  long v1;
  long v10; // stack - 0x38
...
void sub_c28e(unsigned long *a0,struct_16 *a1) // return-dupe x2
{
  bool v1;
...
void sub_c34c(unsigned long *a0,long a1) // return-dupe
{
  if (2 <= *(unsigned int *)(a1 + 0x50)) {
    ...
    sub_c28e(a0,*(struct_16 **)(a1 + 0x38));
    sub_bba6(*(long *)(a1 + 0x38));
    return;
  }
  if (!(*(long *)(a1 + 0x30) + *(long *)(a1 + 0x28))) {
    sub_bc6b(a0,*(long *)(a1 + 0x38));
    return;
  }
}
...
void sub_c4e8(long a0,unsigned long a1,unsigned long a2,struct_17 *a3,unsigned long *a4,FILE *a5,char *a6) // return-dupe
{
  char *v1;
...
label_d4c6:
    ...
    while (v2 = sub_6a5e(&v5,v4,v17), v2) {
      ...
      if (2 <= v22) { // branch-flip
        ...
        sub_c4e8(v18,a3,v22,(struct_17 *)((long)v19 + 0x80),v7,v6,v11);
        sub_b8b3(a3,v19);
        sub_bbc5(v7);
      }
      else {
...
struct_18 * sub_da55(struct_18 *a0)
{
  memset(a0,0,0x48);
...
unsigned long sub_fc0d(struct_22 *a0,unsigned long a1)
{
...
unsigned long sub_10896(struct_23 *a0)
{
  long *v1; // stack - 0x28
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
unsigned long sub_10918(struct_23 *a0) // return-dupe
{
  long *v1; // stack - 0x28
  long v2; // stack - 0x20
  long v3; // stack - 0x18
...
void sub_109b6(unsigned long a0,FILE *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
long sub_10afd(struct_8 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
long sub_10bef(struct_23 *a0) // early-return
{
  long *v1; // stack - 0x10
...
unsigned long sub_10ced(struct_23 *a0,long a1,unsigned long a2)
{
  unsigned long v1;
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
long sub_10d8d(struct_23 *a0,void *a1,unsigned long a2)
{
  long v1;
  long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
void sub_1160b(long a0,struct_9 *a1)
{
  a1->field_0x0 = 0;
...
long sub_11645(long a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long v2;
  struct_9 *v3;
...
unsigned long sub_117de(long a0,struct_23 *a1,bool a2)
{
  long *v1;
  long v2;
  struct_11 *v3; // rax
...
unsigned long sub_119b2(struct_12 *a0,unsigned long a1) // return-dupe x4
{
  void *v1; // stack - 0x68
...
unsigned long sub_11f4e(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_11fbe(long a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
...
void sub_122c4(long a0,long a1)
{
  sub_11fbe(a0,a1);
}
...
unsigned long sub_12474(struct_14 *a0) // early-return
{
  unsigned long v1;
  long v2;
...
unsigned long sub_16b8b(FILE *a0,long a1)
{
  char *v1;
  long v2;
  int v3; // eax
...
void sub_17d3e(FILE *a0,char *a1,char *a2,char *a3,struct_21 *a4)
{
  long *v1;
  long v2 [11];
...
unsigned long sub_1a0a0(struct_11 *a0,timespec *a1) // early-return
{
  unsigned int v1; // eax
...
unsigned long sub_1a24f(struct_19 *a0,long a1,long a2)
{
  long v1;
  long *v2;
  long v3; // stack - 0x30
