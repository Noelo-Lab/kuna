...
void sub_5297(long a0,struct_4 *a1)
{
  unsigned int v1;
  unsigned int v2;
  char v3 [16];
...
bool sub_104b5(long *a0,char *a1,struct_6 *a2)
{
  long v1;
  bool v2; // zf
...
long sub_1056e(char *a0,unsigned int a1,struct_10 *a2) // early-return x4, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_1056e
{
  long *v1;
  ...
  struct_10 *v32; // stack - 0x900
  struct_10 *v33; // stack - 0x8f8
  char **v34; // stack - 0x8f0
  void **v35; // stack - 0x8e8
  struct_10 *v36; // stack - 0x8e0
...
void sub_112dd(long a0,char *a1,struct_6 *a2) // return-dupe x2
{
  unsigned long *v1; // rax
  unsigned long *v2; // rax
...
unsigned long sub_1137d(long a0,unsigned long a1,struct_6 *a2) // early-return
{
  unsigned long v1; // rax
...
void sub_1167b(long a0,char *a1)
{
...
unsigned long sub_13a6f(struct_11 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
unsigned long sub_188ee(struct_14 *a0,long a1,long a2)
{
  long v1;
  long *v2;
  long v3; // stack - 0x30
...
struct_10 * sub_1aeed(struct_10 *a0,unsigned long a1) // early-return
{
  void *v1; // rax
  struct_10 *v2;
  struct_10 *v3; // rax
  
  v2 = (struct_10 *)a0->field_0x0;
...
unsigned long sub_1b0a1(struct_10 *a0) // return-dupe x2
{
  long *v1;
  unsigned long v2;
  long *v3; // stack - 0x18
  ...
  v2 = a0->field_0x8 * 2;
  if ((struct_10 *)a0->field_0x0 != &a0[1]) { // branch-flip
...
unsigned long sub_1b5da(long *a0,struct_16 *a1) // return-dupe
{
  struct_16 *v1;
  long v2;
  long v3; // rax
...
unsigned long * sub_1b86c(long a0) // early-return x2
{
  int v1;
  char *v2; // rax
  unsigned long *v3; // rax
...
struct_16 * sub_1b9a5(long a0,void *a1,struct_16 *a2) // early-return, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_1b9a5
{
  bool v1; // al
  long v2; // rax
  
  if (!a0)
    return (struct_16 *)gmtime_r(a1,(tm *)a2);
  v2 = sub_1b86c(a0);
  if (v2) {
...
void sub_1c3a5(FILE *a0,char *a1,char *a2,char *a3,struct_23 *a4)
{
  long *v1;
  long v2 [11];
