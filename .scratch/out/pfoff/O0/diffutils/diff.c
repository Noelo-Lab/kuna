...
unsigned long sub_140a1(long a0,char *a1)
{
  long v1;
  long v2;
  long v3; // stack - 0x20
...
unsigned long sub_14622(void *a0,long a1,FILE *a2,unsigned int a3,unsigned char a4,unsigned long a5) // return-dupe, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_14622
{
  long v1;
...
unsigned int sub_148b2(unsigned long a0,long a1,char *a2,unsigned int a3,char a4) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_148b2
{
...
unsigned long sub_14dcb(struct_25 *a0)
{
  long *v1; // stack - 0x28
...
unsigned long sub_14e4d(struct_25 *a0) // return-dupe
{
  long *v1; // stack - 0x28
  long v2; // stack - 0x20
  long v3; // stack - 0x18
...
void sub_14eeb(unsigned long a0,FILE *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
long sub_1508d(long a0,char *a1) // return-dupe
{
  void *v1;
  long v2;
  long *v3; // stack - 0x18
  ...
  while( true ) {
    if (!v3)
      return 0;
    if ((a1 == (char *)*v3) || (v1 = *(void **)(a0 + 0x38), v2 = *v3, (*v1)(a1,v2))) break;
    v3 = (long *)v3[1];
  }
  return *v3;
}
...
long sub_15124(struct_25 *a0) // early-return
{
  long *v1; // stack - 0x10
...
unsigned long sub_15222(struct_25 *a0,long a1,unsigned long a2)
{
  unsigned long v1;
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
long sub_152c2(struct_25 *a0,void *a1,unsigned long a2)
{
  long v1;
  long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
void sub_15b40(long a0,struct_19 *a1)
{
  a1->field_0x0 = 0;
  a1->field_0x8 = *(unsigned long *)(a0 + 0x48);
  *(struct_19 **)(a0 + 0x48) = a1;
}

// Function: sub_15b7a @ 0x15b7a
long sub_15b7a(long a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long v2;
  struct_19 *v3;
...
unsigned long sub_15d13(long a0,struct_25 *a1,bool a2)
{
  long *v1;
  long v2;
  struct_2 *v3; // rax
...
unsigned long sub_15ee7(struct_24 *a0,unsigned long a1) // return-dupe x4
{
  void *v1; // stack - 0x68
  unsigned long v10; // stack - 0x20
  void *v2; // stack - 0x60
...
unsigned long sub_16483(long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_164f3(long a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
...
void sub_167f9(long a0,long a1)
{
  sub_164f3(a0,a1);
}
...
void sub_16f76(struct_30 *a0,struct_30 *a1)
{
  ...
  sub_1e1f0((struct_28 *)&a0[1].field_0x1[2],(struct_29 *)&a1[1].field_0x1[2]);
}
...
bool sub_1ad60(long a0,struct_11 *a1)
{
  return (unsigned long)(a1->field_0x0 - a0) <= (unsigned long)(a1->field_0x0 - a1->field_0x18) >> 1;
}

// Function: sub_1ada1 @ 0x1ada1
unsigned long sub_1ada1(struct_12 *a0,char *a1) // return-dupe x3, return-dupe
{
  void *v1;
  long v2;
  long v3;
...
unsigned long sub_1b0de(struct_13 *a0) // early-return
{
...
unsigned long sub_1b166(struct_13 *a0,long *a1) // return-dupe
{
  int v1; // eax
  int v2; // stack - 0x18
  long v3; // stack - 0x10
...
unsigned long sub_1b27d(struct_14 *a0) // return-dupe
{
  bool v1;
  int v2; // eax
  char v3 [48];
...
unsigned long sub_1b41e(struct_14 *a0) // return-dupe
{
  if (!sub_1b27d(a0))
    return 0;
  return 0xffffffff;
...
unsigned long sub_1ba02(struct_14 *a0,unsigned long a1,unsigned long a2) // return-dupe
{
...
void sub_1c616(FILE *a0,char *a1,char *a2,char *a3,struct_32 *a4)
{
  long *v1;
  long v2 [11];
...
unsigned long sub_1d508(long *a0,struct_33 *a1) // return-dupe
{
  struct_33 *v1;
  long v2;
  long v3; // rax
...
unsigned long * sub_1d79a(long a0) // early-return x2
{
  int v1;
  char *v2; // rax
  unsigned long *v3; // rax
...
struct_33 * sub_1d8d3(long a0,void *a1,struct_33 *a2) // early-return, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_1d8d3
{
  bool v1; // al
  long v2; // rax
  
  if (!a0)
    return (struct_33 *)gmtime_r(a1,(tm *)a2);
  v2 = sub_1d79a(a0);
  if (v2) {
...
void sub_1e1f0(struct_28 *a0,struct_29 *a1) // return-dupe
{
  if ((struct_29 *)a1->field_0x0 != &a1[1]) // branch-flip
    a0->field_0x0 = a1->field_0x0;
  else {
...
void sub_1e4f5(struct_11 *a0,long a1)
{
...
void sub_1e534(struct_34 *a0,struct_34 *a1)
{
  a0->field_0x0 = a1->field_0x0;
  a0->field_0x8 = a1->field_0x8;
  ...
  a0->field_0x14 = a1->field_0x14;
  sub_1e1f0((struct_28 *)&a0[1],(struct_29 *)&a1[1]);
}
  ...
  *(unsigned long *)&v12[-8] = 0x1eab9;
  ...
  while( true ) {
    ...
    *(unsigned long *)&v12[-8] = 0x1eaf3;
    sub_1e1f0((struct_28 *)(v24 + v17 * 0x30),&v7);
    v7 = (void *)(v34 + (long)v7);
    v17 += 1;
  }
...
void * sub_20ea3(int a0,char *a1,unsigned long a2,struct_35 *a3)
{
  int v1;
  unsigned int v2; // eax
  unsigned long *v3;
...
{
  sub_20ea3(a0,a1,0xffffffffffffffff,(struct_35 *)0x3d900);
}

// Function: sub_21186 @ 0x21186
void sub_21186(unsigned int a0,char *a1,unsigned long a2)
{
  sub_20ea3(a0,a1,a2,(struct_35 *)0x3d900);
}
...
{
  sub_20ea3(a0,a1,a2,(struct_35 *)0x2d100);
}
