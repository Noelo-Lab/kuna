...
dirent * readdir(DIR *a0)
{
  ...
  v1 = (dirent *)(*dat_18f10)(); // jump-as-call
  return v1;
}
...
void sub_3940(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_18fc8)(main,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_870d(void *a0) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_870d
{
  unsigned int v1;
  bool v2; // al
  int v3;
...
label_8897:
  sub_86dc(dat_dd864,0xdd460,0xffffffff,*(unsigned int *)((long)a0 + 0x20));
  ...
  sub_86dc(dat_dd864,0xdd460,*(unsigned int *)((long)a0 + 0x1c),0xffffffff);
}
...
unsigned long sub_975b(void *a0)
{
  void *v1; // rbx
...
void sub_b363(struct_2 *a0) // return-dupe
{
  unsigned short v1;
  int v10; // stack - 0x44
  unsigned int v11; // stack - 0x40
...
void sub_b868(struct_3 *a0) // ternary
{
  char v1;
  long v2;
  int v3;
...
void sub_bc5c(void *a0,int a1) // ternary
{
  unsigned short v1;
  unsigned int v2; // eax
  int v3; // stack - 0x24
  ...
  *(unsigned short *)((long)a0 + ((long)a1 + 1) * 4 + 2) = 0xffff;
  v3 = 0;
  v5 = (unsigned int)v1;
  while (v3 <= a1) {
    v2 = (unsigned int)*(unsigned short *)((long)a0 + ((long)v3 + 1) * 4 + 2);
    v6 += 1;
    if ((v7 <= v6) || (v5 != v2)) {
...
void sub_be31(void *a0,int a1)
{
  ...
  v7 = 7;
  v8 = 4;
  if (!(*(unsigned short *)((long)a0 + 2))) {
    v7 = 0x8a;
    v8 = 3;
  }
  v3 = 0;
  v5 = (unsigned int)*(unsigned short *)((long)a0 + 2);
  while (v3 <= a1) {
    v2 = (unsigned int)*(unsigned short *)((long)a0 + ((long)v3 + 1) * 4 + 2);
    v1 = v6 + 1;
    if ((v7 <= v1) || (v5 != v2)) {
...
int sub_c06c(void)
{
  ...
  sub_bc5c((void *)0xde240,dat_194c4);
  sub_bc5c((void *)0xdeb40,dat_19504);
  sub_b868((struct_3 *)0x19520);
  v1 = 0x12;
...
void sub_c120(int a0,int a1,int a2)
{
  ...
  sub_be31((void *)0xde240,a0 + -1);
  sub_be31((void *)0xdeb40,a1 + -1);
}
...
long sub_c1ea(char *a0,unsigned long a1,int a2,int a3)
{
  ...
  *(char *)((unsigned long)dat_e1148 + 0xe0140) = dat_e114c;
  if (*dat_e1170 == -1)
    sub_c97c();
  sub_b868((struct_3 *)0x194a0);
  sub_b868((struct_3 *)0x194e0);
  v1 = sub_c06c();
  v3 = dat_e1150 + 10U >> 3;
  v2 = dat_e1158 + 10U >> 3;
  ...
  if ((a1 + 4 <= v3) && (a0)) {
    ...
    sub_c6f9((void *)0xde240,0xdeb40);
    dat_e1160 = dat_e1160 + dat_e1150 + 3;
  }
  else {
    sub_3a6c(a3 + 2,3);
    sub_c6f9((void *)0xdec40,0xdf0c0);
...
void sub_c6f9(void *a0,long a1) // ternary
{
  unsigned int v1;
  ...
  if (dat_e1140) {
    do {
      ...
      if (v8 & 1) { // branch-flip
        ...
        sub_3a6c(*(unsigned short *)((long)a0 + (unsigned long)(v6 + 0x101) * 4),*(unsigned short *)((long)a0 + (unsigned long)(v6 + 0x101) * 4 + 2));
        ...
        sub_3a6c(*(unsigned short *)((long)a0 + (long)v5 * 4),*(unsigned short *)((long)a0 + (long)v5 * 4 + 2));
      }
      v8 >>= 1;
      v9 = v1;
    } while (v1 < dat_e1140);
  }
  sub_3a6c(*(unsigned short *)((long)a0 + 0x400),*(unsigned short *)((long)a0 + 0x402));
}
...
unsigned long sub_10304(FILE *a0)
{
  int v1; // eax
  int v2; // stack - 0x14
...
unsigned long sub_1129e(void *a0,long *a1) // return-dupe x2
{
  unsigned long *v1;
  char v2 [16];
...
void sub_11d1d(void *a0,unsigned long a1,unsigned long a2)
{
  sub_11e56(a0,a1,a2);
}
