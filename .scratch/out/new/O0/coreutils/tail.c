...
unsigned int sub_2d62(struct_13 *a0) // return-dupe
{
  if (((a0->field_0x18 & 0xf000) != 0x8000) && ((a0->field_0x18 & 0xf000) != 0xa000))
    return 0;
  return 1;
}
...
unsigned long sub_705a(void *a0,unsigned long a1)
{
  return (unsigned long)(long)*(int *)((long)a0 + 0x44) % a1;
}

// Function: sub_7089 @ 0x7089
unsigned int sub_7089(void *a0,void *a1)
{
...
void sub_7379(double a0,unsigned int a1,long a2,unsigned long a3,long *a4) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_7379
{
  ...
  v22 = 0;
  v23 = 0;
  v27 = (struct_6 *)sub_b9fe(a3,NULL,sub_705a,sub_7089,0);
  if (!v27)
    sub_ffa4(); // no-return
  *a4 = (long)v27;
  v17 = 2;
...
unsigned char sub_8bca(struct_14 *a0,unsigned long a1) // ternary, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_8bca
{
  char v1; // al
  int v10; // stack - 0xc4
  unsigned long v2; // rax
...
unsigned char * sub_90f5(int a0,void *a1,long *a2) // return-dupe x5, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_90f5
{
  unsigned char *v1;
  ...
  v13 = 10;
  v12 = 1;
  if (((a0 != 2) && ((a0 != 3 || ((v10 = (unsigned long *)((long)a1 + 0x10), **(char **)v10 == '-' && (v10 = (long *)((long)a1 + 0x10), v10 = (char *)(*(long *)v10 + 1), *v10)))))) && ((a0 <= 2 || ((5 <= a0 || (v10 = (unsigned long *)((long)a1 + 0x10), v9 = strcmp(*(char **)v10,"--"), v9)))))) {
    v10 = NULL;
    return v10;
  }
  v9 = sub_cc1c();
  ...
  v1 = (unsigned char *)&(*(char **)((long)a1 + 8))[1];
  v2 = **(char **)((long)a1 + 8);
  v14 = v1;
  if (v2 != '+') { // branch-flip
    if (v2 != '-') {
...
int main(int argc,char **argv,char **envp) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in main
{
  ...
  if (((v10) || (dat_1812e == '\x01')) || (dat_18130 == '\x01')) {
    ...
    sub_ffef(1,0);
    for (v19 = 0; v19 < v17; v19 = v19 + 1) {
      v1 = sub_8bca((struct_14 *)(v20 + v19 * 0x60),v10);
      v15 = (v1 & v15) != 0;
    }
...
unsigned long sub_b045(struct_17 *a0)
{
  return a0->field_0x10;
}

// Function: sub_b05b @ 0xb05b
unsigned long sub_b05b(struct_18 *a0)
{
  return a0->field_0x18;
}

// Function: sub_b071 @ 0xb071
unsigned long sub_b071(struct_4 *a0)
{
  return a0->field_0x20;
}

// Function: sub_b087 @ 0xb087
unsigned long sub_b087(struct_19 *a0)
{
  long *v1; // stack - 0x28
...
unsigned long sub_b109(struct_19 *a0) // return-dupe
{
  long *v1; // stack - 0x28
  long v2; // stack - 0x20
  long v3; // stack - 0x18
...
void sub_b1a7(struct_4 *a0,FILE *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
long sub_b2ee(struct_5 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
long sub_b349(struct_6 *a0,long a1) // return-dupe
{
  void *v1;
  long v2;
  long *v3; // stack - 0x18
...
long sub_b3e0(struct_19 *a0) // early-return
{
  long *v1; // stack - 0x10
...
long sub_b440(void *a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_b4de(struct_19 *a0,long a1,unsigned long a2)
{
  unsigned long v1;
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
long sub_b57e(struct_19 *a0,void *a1,unsigned long a2)
{
  long v1;
  long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
unsigned long sub_b7d8(struct_7 *a0) // return-dupe x2
{
  float *v1;
  ...
  if ((((dat_1368c < v1[2]) && (v1[2] < dat_13680 - dat_1368c)) && (dat_1368c + dat_13680 < v1[3])) && (((0.0 <= *v1 && (*v1 + dat_1368c < v1[1])) && ((v1[1] <= dat_13680 && (*v1 + dat_1368c < v1[2]))))))
    return 1;
  a0->field_0x28 = (float *)0x135f0;
  return 0;
}

// Function: sub_b8e5 @ 0xb8e5
unsigned long sub_b8e5(unsigned long a0,void *a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
...
long * sub_b9fe(unsigned long a0,void *a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
void sub_bdfc(struct_8 *a0,struct_9 *a1)
{
  a1->field_0x0 = 0;
...
long sub_be36(struct_6 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long v2;
  struct_9 *v3;
...
unsigned long sub_bfcf(struct_11 *a0,struct_19 *a1,bool a2)
{
  long *v1;
  long v2;
  struct_3 *v3; // rax
...
unsigned long sub_c1a3(struct_12 *a0,unsigned long a1) // return-dupe x4
{
  void *v1; // stack - 0x68
...
unsigned long sub_c3ce(void *a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
  ...
  if (((float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18)) && (sub_b7d8(a0), (float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18))) {
...
unsigned long sub_c73f(struct_6 *a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_c7af(void *a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
  ...
  if (!v5)
    return 0;
  *(long *)((long)a0 + 0x20) = *(long *)((long)a0 + 0x20) + -1;
  if (((!*v2) && (*(long *)((long)a0 + 0x18) = *(long *)((long)a0 + 0x18) + -1, (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) && (sub_b7d8(a0), (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) {
    v6 = *(long *)((long)a0 + 0x28);
...
void sub_cab5(void *a0,long a1)
{
  sub_c7af(a0,a1);
}

// Function: sub_cade @ 0xcade
char * sub_cade(long a0,void *a1)
{
  char *v1;
  long v2; // stack - 0x20
  char *v3; // stack - 0x10
...
unsigned int sub_cee9(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
void sub_f686(FILE *a0,char *a1,char *a2,char *a3,struct_15 *a4)
{
  long *v1;
  long v2 [11];
