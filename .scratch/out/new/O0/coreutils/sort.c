...
FILE * fopen(char *a0,char *a1)
{
  ...
  v1 = (FILE *)(*dat_22d18)(); // jump-as-call
  return v1;
}
...
FILE * fdopen(int a0,char *a1)
{
  ...
  v1 = (FILE *)(*dat_22dd0)(); // jump-as-call
  return v1;
}
...
char * ngettext(char *a0,char *a1,unsigned long a2)
{
  char *v1; // rax
  
  v1 = (char *)(*dat_22df0)(); // jump-as-call
  return v1;
}
...
lconv * localeconv(void)
{
  ...
  v1 = (lconv *)(*dat_22ed8)(); // jump-as-call
  return v1;
}
...
void sub_3f40(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_22ff8)(main,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_4464(char *a0,char *a1)
{
  char *v1; // rax
  
  if (!a1)
    a1 = gettext("standard output");
  v1 = (char *)sub_151eb(0,3,a1);
...
void sub_47f1(void *a0)
{
  *(bool *)a0 = pthread_sigmask(0,(void *)0x236a0,(void *)((long)a0 + 8)) == 0;
}
...
void sub_4833(char *a0) // return-dupe
{
  if (!*a0)
    return;
  pthread_sigmask(2,&a0[8],NULL);
}

// Function: sub_486b @ 0x486b
unsigned long sub_486b(void *a0,unsigned long a1)
{
  return (unsigned long)(long)*(int *)((long)a0 + 8) % a1;
}

// Function: sub_489a @ 0x489a
unsigned int sub_489a(void *a0,void *a1)
{
  ...
  if (0 <= v6) {
    if ((1 <= v6) && ((1 <= a0 || (v1 = sub_4a90(v6), v1)))) {
      if ((v5 & 0x7f) || ((int)v5 >> 8 & 0xffU)) {
        v4 = (char *)sub_15059(4,dat_23690);
        error(2,0,gettext("%s [-d] terminated abnormally"),v4); // no-return
      }
      dat_23730 -= 1;
    }
    return v6;
...
void sub_4a08(void *a0)
{
  if (!dat_23728) {
    dat_23728 = sub_1120d(0x2f,NULL,sub_486b,sub_489a,0);
    if (!dat_23728)
      sub_1865c(); // no-return
  }
  *(char *)((long)a0 + 0xc) = 1;
  if (!sub_11f4e(dat_23728,a0))
    sub_1865c(); // no-return
}
...
{
  if (!dat_237a8) {
    if (fstat(1,(stat *)0x237c0)) // branch-flip
...
void sub_50b7(FILE *a0,char *a1) // return-dupe x2
{
  int v1; // eax
...
void * sub_5372(long *a0,char a1) // early-return
{
  char *v1;
  unsigned int v2; // eax
  int v3; // stack - 0x34
  ...
  v5 = (void *)sub_4c3d(&v3,(unsigned char)a1);
  if (!v5)
    return NULL;
  *(char *)((long)v5 + 0xc) = 0;
  if (dat_23690) {
    v2 = sub_5193(&v4,4);
    *(unsigned int *)((long)v5 + 8) = v2;
    if (1 <= *(int *)((long)v5 + 8)) { // branch-flip
      close(v3);
      close(v4);
      v3 = v6;
      sub_4a08(v5);
    }
    else if (!*(int *)((long)v5 + 8)) {
      close(v6);
      sub_515d(v3,1);
      sub_515d(v4,0);
...
void sub_54f9(long *a0)
{
  sub_5372(a0,0);
}

// Function: sub_551c @ 0x551c
FILE * sub_551c(void *a0) // early-return
{
  int v1;
  int v2; // eax
  unsigned long v3; // rax
  ...
  v6 = NULL;
  if (*(char *)((long)a0 + 0xc) == '\x01')
    sub_4aff(*(unsigned int *)((long)a0 + 8));
  v1 = open((char *)((long)a0 + 0xd),0);
  if (v1 <= -1)
    return NULL;
  v2 = sub_5193(&v5,9);
  if (v2 != -1) { // branch-flip
...
void sub_570f(unsigned long a0)
{
  ...
  if (dat_23670 == dat_23678)
    dat_23668 = sub_18221(dat_23668,(unsigned long *)0x23678,8);
  v1 = dat_23670;
  dat_23670 += 1;
...
void sub_5ba8(int a0,char a1,unsigned char *a2) // ternary
{
  char *v1;
  unsigned int v2; // eax
  char *v3; // rax
  ...
  if (!v6) {
    ...
    if ((v4 & 0xffffffff) != v4) // branch-flip
      ...
      if (dat_23024 <= 1) {
        v3 = (char *)sub_154a0(a2);
        v1 = *(char **)((long)a0 * 0x20 + 0x22560);
...
void sub_5e0c(unsigned int a0,char a1,unsigned char *a2) // return-dupe, ternary
{
...
long sub_6042(unsigned int a0,char a1,unsigned char *a2) // early-return
{
  int v1; // eax
  long v2; // stack - 0x18
  
  v1 = sub_18b54(a2,NULL,10,&v2,"");
  if (v1 == 1)
    return -1;
  if (!v1) {
    if (v2)
...
long sub_637c(long a0,unsigned long a1,long a2,unsigned long a3,long a4)
{
  ...
  while( true ) {
    ...
    if (a1 <= v7) { // branch-flip
      ...
      v2 = fileno(*(FILE **)(a0 + v7 * 8));
      v5 = fstat(v2,&v4) != 0;
    }
    if (v5) {
      v1 = *(char **)(a2 + v7 * 8);
      sub_4464(gettext("stat failed"),v1); // no-return
    }
    if ((v4._24_4_ & 0xf000) != 0x8000) { // branch-flip
      if (dat_23660)
        return dat_23660;
      v8 = 0x20000;
    }
    ...
    if ((!dat_23850) && (dat_23850 = dat_23660, !dat_23660))
      dat_23850 = sub_610d();
    v3 = v8 * (a4 + 1U) + 1;
    if ((v3 / (a4 + 1U) != v8) || ((unsigned long)(dat_23850 - v6) <= v3)) break;
    v6 += v3;
    v7 += 1;
  }
  return dat_23850;
...
void sub_6618(struct_1 *a0,long a1,unsigned long a2)
{
  ...
  do {
    ...
    a0->field_0x0 = (long)malloc(v1);
    if (a0->field_0x0) {
      a0->field_0x28 = a1;
      a0->field_0x18 = v1;
      a0->field_0x10 = 0;
      a0->field_0x20 = a0->field_0x10;
      a0->field_0x8 = a0->field_0x20;
      a0->field_0x30 = 0;
      return;
    }
    v1 >>= 1;
...
long sub_66d0(struct_2 *a0)
{
  return a0->field_0x18 + a0->field_0x0;
}

// Function: sub_66f4 @ 0x66f4
char * sub_66f4(struct_4 *a0,struct_3 *a1)
{
  long v1;
  char v2;
  long v3;
...
char * sub_6898(struct_4 *a0,void *a1)
{
  long v1;
  long v2;
  char *v3;
  ...
  v7 = a0->field_0x0;
  v6 = &v7[a0->field_0x8 + -1];
  v3 = v6;
  v8 = *(long *)((long)a1 + 0x10);
  v2 = *(long *)((long)a1 + 0x18);
  if (!v2)
    v8 += 1;
  if (dat_23020 != 0x80) { // branch-flip
    ...
    while ((v7 < v3 && (v1 = v8 + -1, v8))) {
      while ((v7 < v3 && (v5 = (int)*v7, v4 = sub_4042(v5), v5 = (unsigned int)v4, v6 = (long)(long)v5, *(char *)((long)v6 + 0x23260)))) {
        v7 = &v7[1];
      }
      while ((v8 = v1, v7 < v3 && (v5 = (int)*v7, v4 = sub_4042(v5), v5 = (unsigned int)v4, v6 = (long)(long)v5, *(char *)((long)v6 + 0x23260) != '\x01'))) {
        v7 = &v7[1];
      }
    }
  }
  if (v2) {
    if (*(char *)((long)a1 + 0x31)) {
      while ((v7 < v3 && (v5 = (int)*v7, v4 = sub_4042(v5), v5 = (unsigned int)v4, v6 = (long)(long)v5, *(char *)((long)v6 + 0x23260)))) {
        v7 = &v7[1];
      }
    }
...
unsigned long sub_6a5e(struct_5 *a0,FILE *a1,char *a2)
{
  char *v1;
  ...
  if (a0->field_0x30)
    return 0;
  if (a0->field_0x8 != a0->field_0x20) {
    memmove((void *)a0->field_0x0,(void *)((a0->field_0x8 - a0->field_0x20) + a0->field_0x0),a0->field_0x20);
    a0->field_0x8 = a0->field_0x20;
    a0->field_0x10 = 0;
  }
  do {
    v11 = (char *)(a0->field_0x8 + a0->field_0x0);
    v18 = sub_66d0(a0);
    v12 = (long *)(v18 + a0->field_0x10 * -0x20);
    v13 = (v18 - a0->field_0x10 * v17) - (long)v11;
    if (a0->field_0x10) // branch-flip
      v14 = (char *)(v12[1] + *v12);
    else {
      v14 = (char *)a0->field_0x0;
    }
    do {
      if (v13 <= v17 + 1U) break;
      v19 = (v13 - 1) / (v17 + 1U);
      v20 = fread_unlocked(v11,1,v19,a1);
      v15 = &v11[v20];
      v13 -= v20;
      if (v20 != v19) {
      ...
      while( true ) {
        v8 = memchr(v11,(int)v5,(long)v15 - (long)v11);
        v21 = v8;
        if (!v8) break;
        *v8 = 0;
        v11 = &v8[1];
        v2 = &v12[-4];
        *v2 = (long)v14;
        v12[-3] = (long)v11 - (long)v14;
        v6 = v12[-3];
        if ((unsigned long)v12[-3] <= v10)
          v6 = v10;
        v13 -= v17;
        v10 = v6;
        v12 = v2;
        if (v16) {
          ...
          if (*v16 != -1) { // branch-flip
            ...
            if ((char)v16[6]) {
              while (v3 = *v14, *(char *)((long)(int)(unsigned int)(unsigned char)sub_4042((int)v3) + 0x23260)) {
                v14 = &v14[1];
              }
            }
            v12[2] = (long)v14;
    ...
    a0->field_0x8 = (long)v11 - a0->field_0x0;
    a0->field_0x10 = sub_66d0(a0) - (long)v12 >> 5;
    if (a0->field_0x10) {
      a0->field_0x20 = (long)v11 - (long)v14;
      dat_23018 = v10 + 0x22;
      return 1;
    }
    v9 = (unsigned long)a0->field_0x18 >> 5;
    v4 = (void *)a0->field_0x0;
    a0->field_0x0 = sub_18221(v4,&v9,0x20);
    a0->field_0x18 = v9 << 5;
  } while( true );
}
...
int sub_7042(char *a0) // early-return
{
  ...
  if ('1' > (char)sub_6f64(&v3))
    return 0;
  v2 = (int)*(char *)((long)(int)(unsigned int)(unsigned char)*v3 + 0x1c5c0);
  if (v1 == '-')
    v2 = -v2;
  return v2;
}
...
unsigned long sub_70e2(unsigned char *a0,unsigned char *a1)
{
  int v1;
  unsigned char v2; // al
  unsigned int v3; // eax
  ...
  v6 = a0;
  while (v3 = (int)(char)*v6, v2 = sub_4042(v3), v3 = (unsigned int)v2, v4 = (long)(int)v3, v5 = a1, *(char *)(v4 + 0x23260)) {
    v6 = &v6[1];
  }
  while (v3 = (int)(char)*v5, v2 = sub_4042(v3), v3 = (unsigned int)v2, v4 = (long)(int)v3, *(char *)(v4 + 0x23260)) {
    v5 = &v5[1];
  }
  v3 = sub_7042(v6);
  v1 = v3;
...
void sub_71a3(unsigned char *a0,unsigned char *a1)
{
  unsigned char v1;
  unsigned char *v2; // stack - 0x18
  unsigned char *v3; // stack - 0x10
  
  v3 = a0;
  while (v1 = *v3, v2 = a1, *(char *)((long)(int)(unsigned int)(unsigned char)sub_4042((int)(char)v1) + 0x23260)) {
    v3 = &v3[1];
  }
  while (v1 = *v2, *(char *)((long)(int)(unsigned int)(unsigned char)sub_4042((int)(char)v1) + 0x23260)) {
    v2 = &v2[1];
  }
...
unsigned long sub_72d6(char *a0,char *a1) // early-return x8
{
  char *v1; // stack - 0x48
  char *v2; // stack - 0x40
  long double v3; // st0
...
unsigned long sub_7668(char *a0,char *a1,unsigned long a2)
{
  unsigned long v1; // rax
  char *v2; // rax
...
{
  unsigned long v1;
  char *v10; // stack - 0x1100
  unsigned long v11; // stack - 0x10f8
  char *v12; // stack - 0x10f0
  int v13; // stack - 0x10e0
  int v14; // stack - 0x10dc
  char *v15; // stack - 0x10d8
  unsigned long v16; // stack - 0x10d0
  char *v17; // stack - 0x10c8
  unsigned long v18; // stack - 0x1070
  unsigned long v19; // stack - 0x1068
  unsigned long v2; // rax
  unsigned long v20; // stack - 0x1060
  unsigned long v21; // stack - 0x1058
  unsigned long v22; // stack - 0x1050
  unsigned long v23; // stack - 0x1048
  unsigned long v24; // stack - 0x1040
  unsigned long v25; // stack - 0x1038
  unsigned long v26; // stack - 0x1030
  unsigned long v27; // stack - 0x1028
  unsigned int v28; // stack - 0x1020
  unsigned long v29; // stack - 0x1014
  char *v3; // rcx
  unsigned int v30; // stack - 0x100c
  unsigned int v31; // stack - 0x1008
  unsigned int v32; // stack - 0x1004
  unsigned int v33; // stack - 0x1000
  unsigned long v34; // stack - 0xffc
  unsigned long v35; // stack - 0xff4
  unsigned long v36; // stack - 0xfec
  unsigned long v37; // stack - 0xfe4
  unsigned long v38; // stack - 0xfdc
  unsigned long v39; // stack - 0xfd4
  char v4 [4008];
  unsigned long v40; // stack - 0xfcc
  unsigned int v41; // stack - 0xfc4
  unsigned long v5; // stack - 0x1078
  unsigned long v6; // stack - 0x101c
  char v7 [16];
  char v8 [16];
  unsigned long v9; // stack - 0x1108
  ...
  v6 = dat_23740;
  v29 = dat_23748;
  v31 = (unsigned int)((unsigned long)dat_23750 >> 0x20);
  v30 = (unsigned int)dat_23750;
  v33 = (unsigned int)((unsigned long)dat_23758 >> 0x20);
  v32 = (unsigned int)dat_23758;
  v34 = dat_23760;
  v35 = dat_23768;
  v36 = dat_23770;
  v37 = dat_23778;
  ...
  if (dat_23229) {
    ...
    while( true ) {
      ...
      v11 = (a0 <= v12) ? 0 : sub_7668(v15,v12,v16) + 1; // branch-flip
      if (a2 <= v10) // branch-flip
        v9 = 0;
      else {
        if (v16 < v11) {
          v1 = 0;
        ...
        v9 = sub_7668(v3,v10,v1) + 1;
      }
      if ((v16 < v11) || (v16 < v9 + v11)) {
        v16 = v9 + v11;
        if (v16 <= 0x5555555555555554)
          v16 = v16 * 3 >> 1;
        free(v17);
        v15 = (char *)sub_18024(v16);
        v17 = v15;
        if (v12 < a0)
          strxfrm(v15,v12,v11);
        if (v10 < a2)
          strxfrm(&v15[v11],v10,v9);
      }
      if (v12 < a0)
        v12 = &v12[strlen(v12) + 1];
      if (v10 < a2)
        v10 = &v10[strlen(v10) + 1];
      if ((a0 <= v12) && (a2 <= v10)) break;
      sub_fb4b(v15,v11,&v5);
      sub_fb4b(&v15[v11],v9,&v6);
      if (!v13) {
        v1 = v9;
        if (v11 < v9)
          v1 = v11;
        v13 = memcmp(v15,&v15[v11],v1);
        if (!v13)
          v13 = (unsigned int)(v9 < v11) - (unsigned int)(v11 < v9);
      }
    }
    v12 = v15;
    v10 = &v15[v11];
  ...
  sub_fb4b(v10,v9,&v6);
  sub_fbaf(&v6,v8);
  v14 = memcmp(v7,v8,0x10);
  if (!v14) {
    if (!v13) {
      v1 = v9;
      if (v11 < v9)
        v1 = v11;
      v13 = memcmp(v12,v10,v1);
      if (!v13)
        v13 = (unsigned int)(v9 < v11) - (unsigned int)(v11 < v9);
    }
    v14 = v13;
...
unsigned int sub_7fc5(void *a0) // return-dupe
{
  if (((!*(char *)((long)a0 + 0x32)) && (!*(char *)((long)a0 + 0x34))) && (!*(char *)((long)a0 + 0x35)))
    return 0;
  return 1;
}

// Function: sub_8002 @ 0x8002
void sub_8002(struct_4 *a0,struct_7 *a1) // warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_8002
{
  char v1;
  long v10; // stack - 0x38
  long v11; // stack - 0x30
  ...
  v7 = a0->field_0x0;
  v8 = &v7[a0->field_0x8 + -1];
  v9 = v7;
  if (a1) {
    if (a1->field_0x0 != -1)
      v7 = (char *)sub_66f4(a0,a1);
    if (a1->field_0x10 != -1)
      v8 = (char *)sub_6898(a0,a1);
    if (((a1->field_0x30) && (a1->field_0x0 == -1)) || ((a1->field_0x36 || (sub_7fc5(a1))))) {
      v1 = *v8;
      *v8 = '\0';
      while (v2 = *v7, *(char *)((long)(int)(unsigned int)(unsigned char)sub_4042((int)v2) + 0x23260)) {
        v7 = &v7[1];
      }
      v4 = v7;
      if (v7 <= v8) { // branch-flip
        if (a1->field_0x36) // branch-flip
          sub_73f3(v7,&v4);
        else if (a1->field_0x34) { // branch-flip
          strtold(v7,&v4);
          v12 = v6;
        }
        else if ((a1->field_0x32) || (a1->field_0x35)) {
          v3 = !((v8 <= v7) || (*v7 != '-'));
          v5 = &v7[v3];
          if ('0' <= (char)sub_6f64(&v5)) {
            v3 = ((a1->field_0x35) && (*(char *)((long)(int)(unsigned int)(unsigned char)*v5 + 0x1c5c0)));
            v4 = &v5[v3];
          }
        }
        else {
...
unsigned int sub_8305(void *a0) // return-dupe
{
  if (((((!*(long *)((long)a0 + 0x20)) && (!*(long *)((long)a0 + 0x28))) && (*(char *)((long)a0 + 0x30) != '\x01')) && ((*(char *)((long)a0 + 0x31) != '\x01' && (sub_7fc5(a0) != '\x01')))) && ((*(char *)((long)a0 + 0x36) != '\x01' && ((*(char *)((long)a0 + 0x38) != '\x01' && (*(char *)((long)a0 + 0x33) != '\x01'))))))
    return 1;
  return 0;
}

// Function: sub_839e @ 0x839e
void sub_839e(void *a0,char *a1)
{
  char *v1;
  char *v2; // stack - 0x18
  
  if ((*(char *)((long)a0 + 0x30)) || (v2 = a1, *(char *)((long)a0 + 0x31))) {
    v2 = &a1[1];
    *a1 = 0x62;
  }
  if (*(long *)((long)a0 + 0x20) == 0x23460) {
    v1 = &v2[1];
    *v2 = 100;
    v2 = v1;
  }
...
void sub_84fe(unsigned long *a0,char a1) // warn: iteboolean: re-rolled 3 0/1 select diamond(s) to a boolean assignment in sub_84fe
{
  bool v1;
  char v10 [48];
  char v11 [56]; // stack - 0x58
  char v12 [32];
  unsigned long v13; // stack - 0xf8
  unsigned long *v14; // stack - 0x138
  unsigned long v15; // stack - 0x130
  unsigned long v16; // stack - 0x128
  unsigned long v17; // stack - 0x120
  ...
  while( true ) {
    if (!v14) {
      if ((v1) || (v2)) {
        v11[0] = dat_23220;
        v11[1] = 0;
        v7 = (char *)sub_154a0(v11);
        if (dat_23220 != dat_23020) // branch-flip
          v8 = gettext("note ");
        else {
          v8 = "";
        }
        error(0,0,gettext("%snumbers use %s as a decimal point in this locale"),v8,v7); // no-return
      }
      v5 = sub_8305(&v13);
      if ((v5 == '\x01') && ((!v23._7_1_ || (((!dat_23681 && (!dat_23682)) || (!dat_23688)))))) {
        if ((((v23._7_1_) && (dat_23681 != '\x01')) && (dat_23682 != '\x01')) && (dat_23688))
          error(0,0,gettext("option \'-r\' only applies to last-resort comparison")); // no-return
        return;
      }
      if ((dat_23681 != '\x01') && (dat_23682 != '\x01'))
        v23 &= 0xffffffffffffff;
      sub_839e(&v13,v11);
      v9 = sub_4094(strlen(v11));
      error(0,0,ngettext("option \'-%s\' is ignored","options \'-%s\' are ignored",v9),v11); // no-return
    }
    if (sub_7fc5(v14)) {
      if (*(char *)((long)v14 + 0x34)) // branch-flip
        v2 = 1;
      else {
        v1 = 1;
      }
    }
    if (*(char *)((long)v14 + 0x39)) {
      v16 = *v14;
      v9 = v14[2];
      if (v16 == 0xffffffffffffffff)
        v16 = 0;
      v7 = (char *)sub_1287e(v16,v12);
      v7 = stpcpy(stpcpy(v10,"+"),v7);
      v8 = (char *)sub_1287e(v16 + 1,v12);
      v8 = stpcpy(stpcpy(v11,"-k "),v8);
      if (v14[2] != 0xffffffffffffffff) {
        v6 = (char *)sub_1287e(v9 + 1,v12);
        stpcpy(stpcpy(v7," -"),v6);
        v7 = (char *)sub_1287e(v9 + (v14[3] == 0xffffffffffffffff) + 1,v12);
        stpcpy(stpcpy(v8,","),v7);
      }
      v7 = (char *)sub_15473(1,v11);
      v8 = (char *)sub_15473(0,v10);
      error(0,0,gettext("obsolescent key %s used; consider %s instead"),v8,v7); // no-return
    }
    v3 = ((*v14 != 0xffffffffffffffff) && (v14[2] < *v14));
    if (v3) break;
    v3 = ((sub_7fc5(v14)) || (*(char *)((long)v14 + 0x36)));
    v4 = !((v14[2]) || (!v14[3]));
    if ((((a1 != '\x01') && (dat_23020 == 0x80)) && (!v4)) && (((((char)v14[6] != '\x01' && (!v3)) || (((char)v14[6] != '\x01' && (v14[1])))) || ((*(char *)((long)v14 + 0x31) != '\x01' && (v14[3]))))))
      error(0,0,gettext("leading blanks are significant in key %lu; consider also specifying \'b\'"),v15); // no-return
    if ((a1 != '\x01') && (sub_7fc5(v14))) {
      v17 = *v14 + 1;
      if (!v17)
        v17 = *v14 + 2;
      if ((v14[2] == 0xffffffffffffffff) || (v17 < v14[2] + 1))
        error(0,0,gettext("key %lu is numeric and spans multiple fields"),v15); // no-return
    }
    if ((v21) && (v21 == v14[4]))
      v21 = 0;
    if ((v22) && (v22 == v14[5]))
      v22 = 0;
    v23._0_2_ = CONCAT11(((*(unsigned char *)((long)v14 + 0x31) ^ 1) & v23._1_1_) != 0,(((unsigned char)v14[6] ^ 1) & (unsigned char)v23) != 0);
    v23._0_3_ = CONCAT12(((*(unsigned char *)((long)v14 + 0x32) ^ 1) & v23._2_1_) != 0,(unsigned short)v23);
    v23._0_4_ = CONCAT13(((*(unsigned char *)((long)v14 + 0x33) ^ 1) & v23._3_1_) != 0,(undefined3)v23);
    v23 = CONCAT44(CONCAT22(CONCAT11(v23._7_1_,((*(unsigned char *)((long)v14 + 0x36) ^ 1) & v23._6_1_) != 0),CONCAT11(((*(unsigned char *)((long)v14 + 0x35) ^ 1) & v23._5_1_) != 0,((*(unsigned char *)((long)v14 + 0x34) ^ 1) & v23._4_1_) != 0)),(unsigned int)v23);
    v24 = CONCAT71(v24._1_7_,(((unsigned char)v14[7] ^ 1) & (unsigned char)v24) != 0);
    v23 = CONCAT17(((*(unsigned char *)((long)v14 + 0x37) ^ 1) & v23._7_1_) != 0,(undefined7)v23);
    v14 = (unsigned long *)v14[8];
    v15 += 1;
  }
  error(0,0,gettext("key %lu has zero width and will be ignored"),v15); // no-return
}
...
label_9469:
      ...
      if (*(char *)((long)v17 + 0x32)) // branch-flip
        ...
        v7 = sub_73f3(v22,NULL);
        v16 = v7 - sub_73f3(v23,NULL);
      }
...
unsigned int sub_9e2a(struct_6 *a0,struct_6 *a1) // ternary
{
  unsigned long v1;
  char *v2;
  char *v3;
  ...
  unsigned long v6; // rax
  unsigned long v7;
  unsigned int v8; // stack - 0x1c
  
  if ((dat_23688) && (((v4 = sub_9116(a0,a1), v4 || (dat_23682)) || (dat_23681))))
    return v4;
  v7 = a0->field_0x8;
  v5 = v7 - 1;
  v1 = a1->field_0x8;
  ...
  if (v5) { // branch-flip
    if (v6) { // branch-flip
      if (dat_23229) { // branch-flip
        v2 = a1->field_0x0;
        v3 = a0->field_0x0;
        v8 = sub_187ec(v3,v7,v2,v1);
      }
      else {
        v7 = v6;
        if (v5 < v6)
          v7 = v5;
        v8 = memcmp(a0->field_0x0,a1->field_0x0,v7);
        if (!v8) {
          v8 = (v6 <= v5) ? (unsigned int)(v5 != v6) : 0xffffffff; // branch-flip
        }
      }
    }
    else {
...
void sub_9f73(struct_4 *a0,FILE *a1,char *a2) // return-dupe
{
  unsigned long v1;
  char *v2; // rax
  char v3; // stack - 0x29
  ...
  if ((!a2) && (dat_23698)) {
    ...
    sub_4464(gettext("write failed"),NULL); // no-return
  }
  v2[-1] = dat_23010;
...
label_a446:
    ...
    v6 = &v16[v20 * -4];
    if ((v14) && ((int)(unsigned int)v12 <= (int)sub_9e2a(&v10,(struct_6 *)&v16[-4]))) {
label_a1f4:
      if (a1 == 'c') {
        v7 = (char *)sub_1287e(v15 + (sub_66d0(v9) - (long)&v16[-4] >> 5),v11);
        v4 = dat_23868;
  ...
  *a2 = sub_1819d(a1,8);
  ...
  for (v3 = 0; (unsigned long)(long)v3 < a1; v3 = v3 + 1) {
    if ((*(long *)(a0 + (long)v3 * 0x10 + 8)) && (*(char *)(*(long *)(a0 + (long)v3 * 0x10 + 8) + 0xc)))
      v2 = sub_551c(*(void **)(a0 + (long)v3 * 0x10 + 8));
    else {
      v2 = sub_4ee4(*(char **)(a0 + (long)v3 * 0x10),"r");
    }
...
void sub_a5c0(long a0,unsigned long a1,unsigned long a2,FILE *a3,char *a4,void *a5)
{
  struct_6 *v1;
  void *v10; // rax
  void *v11; // rax
  ...
  unsigned long v16;
  void *v17; // stack - 0x48
  unsigned long v18; // stack - 0x100
  unsigned long v19; // stack - 0xf8
  struct_6 *v2;
  void **v20; // stack - 0xd8
  ...
  v9 = (void *)sub_1819d(a2,0x38);
  v20 = NULL;
  v21 = 0;
  v10 = (void *)sub_1819d(a2,8);
  v11 = (void *)sub_1819d(a2,8);
  v12 = (unsigned long *)sub_1819d(a2,8);
  v7 = dat_23688;
  v17 = NULL;
  v22 = 0;
  v18 = a2;
  ...
  while (v22 < v18) {
    v16 = dat_23660 / v18;
    if (dat_23660 / v18 < dat_23018)
      v16 = dat_23018;
    sub_6618((struct_1 *)((long)v9 + v22 * 0x38),0x20,v16);
    v4 = *(char **)(a0 + v22 * 0x10);
    v5 = *(FILE **)((long)a5 + v22 * 8);
    if (sub_6a5e((struct_5 *)((long)v9 + v22 * 0x38),v5,v4)) { // branch-flip
      v13 = sub_66d0((struct_2 *)((long)v9 + v22 * 0x38));
      *(long *)((long)v10 + v22 * 8) = v13 + -0x20;
      *(long *)((long)v11 + v22 * 8) = v13 + *(long *)((long)v9 + v22 * 0x38 + 0x10) * -0x20;
      v22 += 1;
    }
    else {
      sub_50b7(*(FILE **)((long)a5 + v22 * 8),*(char **)(a0 + v22 * 0x10));
      if (v22 < v19) {
        v19 -= 1;
        sub_5782(*(char **)(a0 + v22 * 0x10));
      }
      free(*(void **)((long)v9 + v22 * 0x38));
      v18 -= 1;
      for (v23 = v22; v23 < v18; v23 = v23 + 1) {
        v14 = (unsigned long *)(a0 + (v23 + 1) * 0x10);
        v15 = (unsigned long *)(v23 * 0x10 + a0);
        v6 = v14[1];
        *v15 = *v14;
        v15[1] = v6;
        *(unsigned long *)((long)a5 + v23 * 8) = *(unsigned long *)((long)a5 + (v23 + 1) * 8);
      }
    }
  }
  for (v22 = 0; v22 < v18; v22 = v22 + 1) {
    v12[v22] = v22;
  }
  for (v22 = 1; v22 < v18; v22 = v22 + 1) {
    v1 = *(struct_6 **)((long)v10 + v12[v22] * 8);
    v2 = *(struct_6 **)((long)v10 + v12[v22 - 1] * 8);
    if (1 <= (int)sub_9e2a(v2,v1)) {
      v16 = v12[v22 - 1];
      v12[v22 - 1] = v12[v22];
      v12[v22] = v16;
      v22 = 0;
...
label_b27c:
  do {
    ...
    v3 = *(long **)((long)v10 + *v12 * 8);
    if (dat_23682) { // branch-flip
      if ((v20) && (sub_9e2a(v20,v3))) {
        v20 = NULL;
        sub_9f73(&v17,a3,a4);
      }
      if (!v20) {
        v20 = &v17;
        if (v21 < (unsigned long)v3[1]) {
          do {
            if (!v21) {
              v21 = v3[1];
              break;
            ...
            v21 <<= 1;
          } while (v21 < (unsigned long)v3[1]);
          free(v17);
          v17 = (void *)sub_18024(v21);
        }
        v27 = v3[1];
        memcpy(v17,(void *)*v3,v27);
        if (v7) {
          v28 = (v3[2] - *v3) + (long)v17;
          v29 = (v3[3] - *v3) + (long)v17;
        }
      }
    }
    else {
    ...
    if (v3 <= *(long **)((long)v11 + *v12 * 8)) { // branch-flip
      v4 = *(char **)(a0 + *v12 * 0x10);
      v5 = *(FILE **)((long)a5 + *v12 * 8);
      v16 = *v12;
      if (!sub_6a5e((struct_5 *)((long)v9 + v16 * 0x38),v5,v4)) {
        for (v22 = 1; v22 < v18; v22 = v22 + 1) {
          if (*v12 < v12[v22])
            v12[v22] = v12[v22] - 1;
        }
        v18 -= 1;
        sub_50b7(*(FILE **)((long)a5 + *v12 * 8),*(char **)(a0 + *v12 * 0x10));
        if (*v12 < v19) {
          v19 -= 1;
          sub_5782(*(char **)(a0 + *v12 * 0x10));
        }
        free(*(void **)((long)v9 + *v12 * 0x38));
        for (v22 = *v12; v22 < v18; v22 = v22 + 1) {
          *(unsigned long *)((long)a5 + v22 * 8) = *(unsigned long *)((long)a5 + (v22 + 1) * 8);
          v14 = (unsigned long *)(a0 + (v22 + 1) * 0x10);
          v15 = (unsigned long *)(v22 * 0x10 + a0);
          v6 = v14[1];
          *v15 = *v14;
          v15[1] = v6;
          v15 = (unsigned long *)((v22 + 1) * 0x38 + (long)v9);
          v14 = (unsigned long *)((long)v9 + v22 * 0x38);
          v6 = v15[1];
          *v14 = *v15;
          v14[1] = v6;
          v6 = v15[3];
          ...
          v14[5] = v6;
          v14[6] = v15[6];
          *(unsigned long *)((long)v10 + v22 * 8) = *(unsigned long *)((long)v10 + (v22 + 1) * 8);
          *(unsigned long *)((long)v11 + v22 * 8) = *(unsigned long *)((long)v11 + (v22 + 1) * 8);
        }
        for (v22 = 0; v22 < v18; v22 = v22 + 1) {
          v12[v22] = v12[v22 + 1];
        }
      ...
      v13 = sub_66d0((struct_2 *)((long)v9 + *v12 * 0x38));
      *(long *)((long)v10 + *v12 * 8) = v13 + -0x20;
      *(long *)((long)v11 + *v12 * 8) = v13 + *(long *)((long)v9 + *v12 * 0x38 + 0x10) * -0x20;
    }
    else {
      *(long **)((long)v10 + *v12 * 8) = &v3[-4];
    }
    v24 = 1;
    v25 = v18;
    v26 = 1;
    v16 = *v12;
    while (v24 < v25) {
      v8 = sub_9e2a(*(struct_6 **)((long)v10 + v16 * 8),*(struct_6 **)((long)v10 + v12[v26] * 8));
      if ((0 <= v8) && ((v8 || (v12[v26] <= v16))))
        v24 = v26 + 1;
      else {
        v25 = v26;
      }
...
unsigned long sub_b344(long a0,unsigned long a1,unsigned long a2,FILE *a3,char *a4)
{
  char *v1;
...
void sub_b413(unsigned long *a0,unsigned long a1,unsigned long *a2) // return-dupe
{
  ...
  v7 = &a0[v5 * -4];
  do {
    while ((int)sub_9e2a((struct_6 *)&v3[-4],(struct_6 *)&v7[-4]) <= 0) {
      v1 = &v4[-4];
      v2 = v3[-3];
      *v1 = v3[-4];
      v4[-3] = v2;
...
void sub_b536(unsigned long *a0,unsigned long a1,unsigned long *a2,char a3) // return-dupe x2
{
  unsigned long *v1;
  unsigned long v2;
  int v3; // eax
  ...
  if (a1 != 2) {
    ...
    sub_b536(&a0[v4 * -4],a1 - v4,v5 + (long)a2,(unsigned char)a3);
    if (2 <= v4) // branch-flip
  ...
  v3 = (unsigned int)(0 < (int)sub_9e2a((struct_6 *)&a0[-4],(struct_6 *)&a0[-8]));
  if (a3) {
    v1 = &a0[(long)(int)~v3 * 4];
    v2 = v1[1];
    a2[-4] = *v1;
...
unsigned long * sub_b7b6(unsigned long a0,long a1,long a2)
{
  unsigned long *v1; // rax
  ...
  *(char *)((long)v1 + 0x54) = 0;
  pthread_mutex_init((pthread_mutex_t *)&v1[0xb],NULL);
  sub_b911(v1,(struct_17 *)&v1[0x10],a2,a0,a1,0);
  return v1;
}
...
void sub_b8b3(long a0,void *a1)
{
  ...
  v3 = a1;
  while (v1 = v2 + -1, v2) {
    pthread_mutex_destroy((void *)((long)v3 + 0x58));
...
unsigned long * sub_b911(void *a0,struct_17 *a1,long a2,unsigned long a3,long a4,bool a5) // ternary x2
{
  unsigned long v1;
  unsigned long v2; // rax
  long v3; // rax
  ...
  v1 = (a5) ? *(unsigned long *)((long)a0 + 0x28) : *(unsigned long *)((long)a0 + 0x30); // branch-flip
  v2 = v1 >> 1;
  a2 += a4 * -0x20;
  v3 = a2 + v2 * -0x20;
  v4 = (a5) ? (long)a0 + 0x10 : (long)a0 + 0x18; // branch-flip
  v6 = &a1[1].field_0x28;
  a1->field_0x10 = a2;
  a1->field_0x0 = a1->field_0x10;
  a1->field_0x18 = v3;
  a1->field_0x8 = a1->field_0x18;
  a1->field_0x20 = v4;
  a1->field_0x28 = v2;
  a1->field_0x30 = v1 - v2;
  a1->field_0x38 = a0;
  a1->field_0x50 = *(int *)((long)a0 + 0x50) + 1;
  a1->field_0x54 = 0;
  pthread_mutex_init((pthread_mutex_t *)&a1[1],NULL);
  if (2 <= a3) { // branch-flip
    a1->field_0x40 = v6;
...
bool sub_bb0c(void *a0,void *a1) // ternary
{
  bool v1; // cf
  
  v1 = (*(int *)((long)a0 + 0x50) != *(int *)((long)a1 + 0x50)) ? *(unsigned int *)((long)a0 + 0x50) < *(unsigned int *)((long)a1 + 0x50) : (unsigned long)(*(long *)((long)a0 + 0x28) + *(long *)((long)a0 + 0x30)) < (unsigned long)(*(long *)((long)a1 + 0x30) + *(long *)((long)a1 + 0x28)); // branch-flip
  return v1;
}
...
{
  pthread_mutex_lock((pthread_mutex_t *)(a0 + 0x58));
}

// Function: sub_bba6 @ 0xbba6
void sub_bba6(long a0)
{
  pthread_mutex_unlock((pthread_mutex_t *)(a0 + 0x58));
}

// Function: sub_bbc5 @ 0xbbc5
void sub_bbc5(unsigned long *a0)
{
  sub_12398((unsigned long *)*a0);
...
void sub_bc07(unsigned long *a0,long a1)
{
  *a0 = sub_122ed(sub_bb0c,a1 * 2);
  pthread_mutex_init((pthread_mutex_t *)&a0[1],NULL);
  pthread_cond_init(&a0[6],NULL);
}

// Function: sub_bc6b @ 0xbc6b
void sub_bc6b(unsigned long *a0,void *a1)
{
  pthread_mutex_lock((pthread_mutex_t *)&a0[1]);
  sub_123c6((long *)*a0,a1);
  *(char *)((long)a1 + 0x54) = 1;
  pthread_cond_signal(&a0[6]);
  pthread_mutex_unlock((pthread_mutex_t *)&a0[1]);
}
...
void sub_bd51(long *a0,FILE *a1,char *a2)
{
  if (dat_23682) {
    if ((dat_23240) && (!sub_9e2a(a0,(struct_6 *)0x23240)))
      return;
    dat_23240 = *a0;
    dat_23248 = a0[1];
    dat_23250 = a0[2];
...
void sub_bde5(struct_19 *a0,unsigned long a1,FILE *a2,char *a3)
{
  long v1;
  long v10; // stack - 0x38
  ...
  v3 = a0->field_0x0;
  v4 = a0->field_0x8;
  v10 = (a1 >> (((char)a0->field_0x50 + '\x01') * '\x02' & 0x3fU)) + 1;
  if (2 <= (unsigned int)a0->field_0x50) { // branch-flip
    v11 = (unsigned long *)*a0->field_0x20;
    while (((a0->field_0x0 != a0->field_0x10 && (a0->field_0x8 != a0->field_0x18)) && (v1 = v10 + -1, v9 = v10 != 0, v10 = v1, v9))) {
      v1 = a0->field_0x8;
      v5 = a0->field_0x0;
      if (1 <= (int)sub_9e2a((struct_6 *)(v5 + -0x20),(struct_6 *)(v1 + -0x20))) { // branch-flip
        a0->field_0x8 = a0->field_0x8 + -0x20;
        v6 = (unsigned long *)a0->field_0x8;
        v2 = &v11[-4];
        v7 = v6[1];
        *v2 = *v6;
        v11[-3] = v7;
        ...
        a0->field_0x0 = a0->field_0x0 + -0x20;
        v6 = (unsigned long *)a0->field_0x0;
        v2 = &v11[-4];
        v7 = v6[1];
        *v2 = *v6;
        v11[-3] = v7;
    ...
    if (v4 - a0->field_0x8 >> 5 != a0->field_0x30) { // branch-flip
      if (v3 - a0->field_0x0 >> 5 == a0->field_0x28) {
        while ((a0->field_0x8 != a0->field_0x18 && (v1 = v10 + -1, v10))) {
          a0->field_0x8 = a0->field_0x8 + -0x20;
          v6 = (unsigned long *)a0->field_0x8;
          v2 = &v11[-4];
          v7 = v6[1];
      ...
      while ((a0->field_0x0 != a0->field_0x10 && (v1 = v10 + -1, v10))) {
        a0->field_0x0 = a0->field_0x0 + -0x20;
        v6 = (unsigned long *)a0->field_0x0;
        v2 = &v11[-4];
        v7 = v6[1];
    ...
    *a0->field_0x20 = v11;
    ...
    while (((a0->field_0x0 != a0->field_0x10 && (a0->field_0x8 != a0->field_0x18)) && (v1 = v10 + -1, v9 = v10 != 0, v10 = v1, v9))) {
      v5 = a0->field_0x8;
      v8 = a0->field_0x0;
      if (1 <= (int)sub_9e2a((struct_6 *)(v8 + -0x20),(struct_6 *)(v5 + -0x20))) { // branch-flip
        a0->field_0x8 = a0->field_0x8 + -0x20;
        sub_bd51((long *)a0->field_0x8,a2,a3);
      }
      else {
        a0->field_0x0 = a0->field_0x0 + -0x20;
        sub_bd51((long *)a0->field_0x0,a2,a3);
      }
    }
    if (v4 - a0->field_0x8 >> 5 != a0->field_0x30) { // branch-flip
      if (v3 - a0->field_0x0 >> 5 == a0->field_0x28) {
  ...
  a0->field_0x28 = a0->field_0x28 - (v3 - a0->field_0x0 >> 5);
  a0->field_0x30 = a0->field_0x30 - (v4 - a0->field_0x8 >> 5);
}

// Function: sub_c28e @ 0xc28e
void sub_c28e(unsigned long *a0,struct_20 *a1) // return-dupe x2
{
  bool v1;
  
  if (a1->field_0x54 == '\x01')
    return;
  v1 = a1->field_0x8 != a1->field_0x18;
...
void sub_c34c(unsigned long *a0,void *a1) // return-dupe
{
  if (2 <= *(unsigned int *)((long)a1 + 0x50)) {
    sub_bb87(*(long *)((long)a1 + 0x38));
    sub_c28e(a0,*(struct_20 **)((long)a1 + 0x38));
    sub_bba6(*(long *)((long)a1 + 0x38));
    return;
  }
  if (!(*(long *)((long)a1 + 0x30) + *(long *)((long)a1 + 0x28))) {
    sub_bc6b(a0,*(void **)((long)a1 + 0x38));
    return;
  }
}

// Function: sub_c3d7 @ 0xc3d7
void sub_c3d7(unsigned long *a0,unsigned long a1,FILE *a2,char *a3)
{
  long v1; // rax
...
void sub_c4e8(long a0,unsigned long a1,unsigned long a2,struct_21 *a3,unsigned long *a4,FILE *a5,char *a6) // return-dupe
{
  char *v1;
  ...
  v1 = a6;
  v4 = a3->field_0x30 + a3->field_0x28;
  v5 = a1 >> 1;
  v6 = a1 - v5;
  v12 = a3->field_0x40;
  v15 = a6;
  ...
  if (((2 <= a1) && (0x20000 <= v4)) && (!pthread_create(&v3,0,sub_c481,&v2))) {
    sub_c4e8(a3->field_0x28 * -0x20 + a0,v6,a2,a3->field_0x48,a4,a5,v1);
    pthread_join(v3,0);
    return;
  }
  v7 = a3->field_0x28;
  v8 = a3->field_0x30;
  v9 = (unsigned long *)(a0 + a2 * -0x20);
  if (2 <= v8)
    sub_b536((unsigned long *)(v7 * -0x20 + a0),v8,&v9[(v7 >> 1) * -4],0);
  if (2 <= v7)
    sub_b536(a0,v7,v9,0);
  a3->field_0x0 = a0;
  a3->field_0x8 = v7 * -0x20 + a0;
  a3->field_0x10 = v7 * -0x20 + a0;
  a3->field_0x18 = v7 * -0x20 + v8 * -0x20 + a0;
  sub_bc6b(a4,a3);
...
void sub_c7fa(long a0,unsigned long a1,unsigned long a2,char *a3) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_c7fa
{
  ...
  do {
    ...
    if (((!a3) || (v1 = *(char **)(a0 + v7 * 0x10), strcmp(a3,v1))) || (v5)) {
      ...
      v5 = !(((v2) || (v3._8_8_ != v8[1])) || (v3._0_8_ != *v8));
    }
    else {
      v5 = 1;
    }
    if (v5) {
      if (!v6) {
        v6 = sub_54f9(&v4);
        sub_b344(v7 * 0x10 + a0,0,1,v4,(char *)(v6 + 0xd));
      }
...
void sub_ca81(long a0,unsigned long a1)
{
  ...
  do {
    ...
    if (strcmp(v1,"-")) {
      ...
      if (euidaccess(v1,4)) {
        v1 = *(char **)(a0 + v2 * 8);
        sub_4464(gettext("cannot read"),v1); // no-return
      }
    }
    v2 += 1;
  } while( true );
...
void sub_cbb9(long *a0,unsigned long a1,unsigned long a2,char *a3)
{
  char *v1;
  FILE *v10; // stack - 0x68
  long v11; // stack - 0x60
  ...
  for (v5 = a2; dat_23024 < v5; v5 = v5 + (v8 - v7)) {
    ...
    for (v7 = 0; (unsigned long)dat_23024 <= v5 - v7; v7 = v7 + v18) {
      ...
      v18 = sub_b344(&a0[v7 * 2],v2,dat_23024,v3,(char *)(v17 + 0xd));
      v2 = v6;
      if (v18 <= v6)
        v2 = v18;
      v6 -= v2;
    ...
    if (v13 < v12) {
      ...
      if (v14 <= v6)
        v2 = v14;
      v16 = sub_b344(&a0[v7 * 2],v2,v14,v3,(char *)(v15 + 0xd));
      v2 = v6;
      if (v16 <= v6)
        v2 = v16;
      v6 -= v2;
  ...
  do {
    ...
    do {
      v9 -= 1;
      sub_50b7(*(FILE **)(v9 * 8 + v4),(char *)a0[v9 * 2]);
      v11 = sub_5372(&v3,3 <= v9);
    } while (!v11);
    v2 = v6;
    if (v9 <= v6)
      v2 = v9;
    sub_a5c0(a0,v2,v9,v3,(char *)(v11 + 0xd),v4);
    v2 = v6;
    if (v9 <= v6)
      v2 = v9;
    *a0 = v11 + 0xd;
...
void sub_d0f9(unsigned long *a0,unsigned long a1,char *a2,unsigned long a3)
{
  bool v1;
  unsigned long v10; // stack - 0x110
  char *v11; // stack - 0x108
...
label_d4c6:
      ...
      if (!v1) {
        v15 = dat_23720;
        v20 = (long *)sub_1819d(v10,0x10);
        v16 = 0;
        for (; v15; v15 = (unsigned long *)*v15) {
          v20[v16 * 2] = (long)v15 + 0xd;
          v20[v16 * 2 + 1] = (long)v15;
          v16 += 1;
        }
    ...
    while (v2 = sub_6a5e(&v5,v4,v17), v2) {
      ...
      if (((v25) && (!v8)) && ((!v10 && (!v24)))) {
        ...
        v10 += 1;
        v11 = (char *)(sub_54f9(&v6) + 0xd);
      }
      if (2 <= v22) { // branch-flip
        sub_bc07(v7,a3);
        v19 = (void *)sub_b7b6(a3,v22,v18);
        sub_c4e8(v18,a3,v22,(struct_21 *)((long)v19 + 0x80),v7,v6,v11);
        sub_b8b3(a3,v19);
        sub_bbc5(v7);
      }
      else {
        sub_bd51((long *)(v18 + -0x20),v6,v11);
      }
      sub_50b7(v6,v11);
...
unsigned long sub_d7de(unsigned char *a0,long *a1,char *a2)
{
  unsigned long v1; // rax
  char *v2; // rax
  long v3; // stack - 0x28
...
char * sub_d929(char *a0,void *a1,int a2)
{
  char *v1; // stack - 0x10
  ...
  for (v1 = a0; *v1; v1 = &v1[1]) {
    switch(*v1) {
      ...
      case 0x62:
        ...
        break;
      case 100:
        *(unsigned long *)((long)a1 + 0x20) = 0x23460;
        break;
      case 0x66:
        *(unsigned long *)((long)a1 + 0x28) = 0x23560;
        break;
      case 0x67:
        *(char *)((long)a1 + 0x34) = 1;
        break;
      ...
      case 0x69:
        if (!*(long *)((long)a1 + 0x20))
          *(unsigned long *)((long)a1 + 0x20) = 0x23360;
        break;
      case 0x6e:
        *(char *)((long)a1 + 0x32) = 1;
        break;
...
struct_22 * sub_da55(struct_22 *a0)
{
  memset(a0,0,0x48);
  a0->field_0x10 = 0xffffffffffffffff;
  return a0;
}
...
int main(int argc,char **argv,char **envp) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in main
{
  ...
  long *v13; // rax
  unsigned long v14;
  void *v15 [17]; // stack - 0xc8
  unsigned long v16 [4]; // stack - 0x238
  int v17; // stack - 0x1e8
  char v18 [80];
  char v19; // stack - 0x22
  bool v2;
  ...
  bool v22; // zf
  bool v23;
  char v24; // stack - 0x338
  char v25; // stack - 0x333
  int v26; // stack - 0x330
  long *v27; // stack - 0x328
  char *v28; // stack - 0x320
  char *v29; // stack - 0x318
  bool v3;
  unsigned long v30; // stack - 0x310
  unsigned long v31; // stack - 0x308
  unsigned long *v32; // stack - 0x300
  char *v33; // stack - 0x2f8
  char *v34; // stack - 0x2f0
  unsigned long v35; // stack - 0x2e8
  char *v36; // stack - 0x2e0
  unsigned long v37; // stack - 0x2d8
  unsigned long v38; // stack - 0x2d0
  unsigned long v39; // stack - 0x218
  bool v4;
  unsigned long v40; // stack - 0x210
  char v41; // stack - 0x208
  char v42; // stack - 0x207
  char v43; // stack - 0x206
  char v44; // stack - 0x205
  char v45; // stack - 0x204
  char v46; // stack - 0x203
  char v47; // stack - 0x202
  char v48; // stack - 0x201
  char v49; // stack - 0x200
  char v5; // al
  unsigned int v50; // stack - 0x1e4
  unsigned long *v51; // stack - 0x1e0
  undefined4 v52; // stack - 0x40
  char v53; // stack - 0x21
  long v54; // stack - 0x20
  bool v6; // al
  int v7;
  ...
  v30 = 0;
  v31 = 0;
  v21 = getenv("POSIXLY_CORRECT") != NULL;
  v7 = sub_133ab();
  if ((0x30db0 <= v7) && (v7 <= 0x31068))
    v3 = 0;
  else {
    v3 = 1;
  }
  ...
  v9 = localeconv();
  dat_23220 = **(char **)v9;
  if ((!dat_23220) || (*(char *)(*(long *)v9 + 1)))
    dat_23220 = '.';
  dat_23224 = (int)**(char **)&v9->field_0x8;
  if ((dat_23224) && (*(char *)(*(long *)&v9->field_0x8 + 1)))
    dat_23228 = 1;
  if ((!dat_23224) || (*(char *)(*(long *)&v9->field_0x8 + 1)))
    dat_23224 = 0x80;
  dat_23683 = '\0';
  sub_594a();
  sigemptyset((sigset_t *)0x236a0);
  for (v35 = 0; v35 <= 10; v35 = v35 + 1) {
    sigaction(*(int *)(v35 * 4 + 0x1d100),NULL,(sigaction *)v15);
    if (v15[0] != (void *)0x1)
      sigaddset((sigset_t *)0x236a0,*(int *)(v35 * 4 + 0x1d100));
  }
  v15[0] = sub_d8f9;
  v15[1] = (void *)dat_236a0;
  v15[2] = (void *)dat_236a8;
  v15[3] = (void *)dat_236b0;
  v15[4] = (void *)dat_236b8;
  v15[5] = (void *)dat_236c0;
  v15[6] = (void *)dat_236c8;
  v15[7] = (void *)dat_236d0;
  v15[8] = (void *)dat_236d8;
  v15[9] = (void *)dat_236e0;
  v15[10] = (void *)dat_236e8;
  v15[0xb] = (void *)dat_236f0;
  v15[0xc] = (void *)dat_236f8;
  v15[0xd] = (void *)dat_23700;
  v15[0xe] = (void *)dat_23708;
  v15[0xf] = (void *)dat_23710;
  v15[0x10] = (void *)dat_23718;
  v52 = 0;
  for (v35 = 0; v35 <= 10; v35 = v35 + 1) {
    v7 = *(int *)(v35 * 4 + 0x1d100);
    if (sigismember((void *)0x236a0,v7))
      sigaction(*(int *)(v35 * 4 + 0x1d100),(sigaction *)v15,NULL);
  }
  signal(0x11,0);
  sub_1a960(sub_4bd4);
  sub_da55(v16);
  v16[0] = 0xffffffffffffffff;
  v32 = (unsigned long *)sub_1819d((long)argc,8);
label_dee8:
  do {
    v17 = -1;
    if ((v26 != -1) && (((!v21 || (!v31)) || (((v3 && ((((!v24 && (argc != optind)) && (*argv[optind] == '-')) && (argv[optind][1] == 'o')))) && ((argv[optind][2] || (argc != optind + 1)))))))) {
      v26 = getopt_long(argc,argv,"-bcCdfghik:mMno:rRsS:t:T:uVy:z",(option *)0x22560,&v17);
      if (v26 != -1) {
        if (0x88 > v26) {
          if (1 <= v26) { // branch-flip
            v5 = (char)v26;
            switch(v26) {
              case 1:
                v27 = NULL;
                if (*optarg == '+') {
                  v6 = (((argc != optind) && (*argv[optind] == '-')) && ((unsigned int)((int)argv[optind][1] - 0x30U) <= 9));
                  if ((!v6) || (v21))
                    v2 = 0;
                  else {
                    v2 = 1;
                  ...
                  v3 = v22;
                  if (v2) {
                    v27 = (long *)sub_da55(v18);
                    v28 = (char *)sub_d7de(&optarg[1],v27,0);
                    if ((v28) && (*v28 == '.'))
                      v28 = (char *)sub_d7de(&v28[1],&v27[1],0);
                    if ((!*v27) && (!v27[1]))
                      *v27 = -1;
                    if ((v28) && (!*(char *)sub_d929(v28,v27,0))) {
                      if (v6) {
                        v7 = optind + 1;
                        v1 = argv[optind];
                        optind = v7;
                        v28 = (char *)sub_d7de(&v1[1],&v27[2],"invalid number after \'-\'");
                        if (!v28)
                          __assert_fail("s","src/sort.c",0x1161,"main"); // no-return
                        if (*v28 == '.')
                          v28 = (char *)sub_d7de(&v28[1],&v27[3],"invalid number after \'.\'");
                        if ((!v27[3]) && (v27[2]))
                          v27[2] = v27[2] + -1;
                        if (*(char *)sub_d929(v28,v27,1))
                          sub_d640(v1,"stray character in field spec"); // no-return
                      }
                      *(char *)((long)v27 + 0x39) = 1;
                      sub_d5d8(v27);
                    }
                    else {
                      v27 = NULL;
...
label_e4c9:
                ...
                goto label_dee8;
              case 0x53:
                sub_5e0c(v17,(int)v5,optarg);
                goto label_dee8;
              case 0x54:
                sub_570f(optarg);
                goto label_dee8;
              case 0x6b:
                v13 = (long *)sub_da55(v18);
                v28 = (char *)sub_d7de(optarg,v13,"invalid number at field start");
                v10 = *v13;
                *v13 = v10 + -1;
                if (!v10)
                  sub_d640(optarg,"field number is zero"); // no-return
                if (*v28 == '.') {
                  v28 = (char *)sub_d7de(&v28[1],&v13[1],"invalid number after \'.\'");
                  v10 = v13[1];
                  v13[1] = v10 + -1;
                  if (!v10)
                ...
                if ((!*v13) && (!v13[1]))
                  *v13 = -1;
                v28 = (char *)sub_d929(v28,v13,0);
                if (*v28 != ',') { // branch-flip
                  v13[2] = -1;
                  v13[3] = 0;
                }
                else {
                  v28 = (char *)sub_d7de(&v28[1],&v13[2],"invalid number after \',\'");
                  v10 = v13[2];
                  v13[2] = v10 + -1;
                  if (!v10)
                    sub_d640(optarg,"field number is zero"); // no-return
                  if (*v28 == '.')
                    v28 = (char *)sub_d7de(&v28[1],&v13[3],"invalid number after \'.\'");
                  v28 = (char *)sub_d929(v28,v13,1);
                }
                if (*v28)
              ...
              case 0x74:
                ...
                if ((dat_23020 != 0x80) && (v25 != dat_23020))
              ...
              case 0x75:
                ...
                goto label_dee8;
              case 0x79:
                if (argv[(long)optind + -1] == optarg) {
                  for (v36 = optarg; (unsigned int)((int)*v36 - 0x30U) <= 9; v36 = &v36[1]) {
                  }
                  optind -= (unsigned int)(*v36 != '\0');
                }
                goto label_dee8;
              case 0x7a:
                dat_23010 = 0;
              ...
              case 0x80:
                if (optarg) { // branch-flip
                  v10 = sub_f8c1("--check",optarg,0x22940,"CCcgeneral-numeric",1,dat_23110,1);
                  v26 = (int)"CCcgeneral-numeric"[v10];
                }
                else {
                  v26 = 99;
                }
                goto label_e561;
              case 0x81:
                if ((dat_23690) && (strcmp(dat_23690,optarg)))
              ...
              case 0x83:
                ...
                goto label_dee8;
              case 0x84:
                sub_5ba8(v17,(int)v5,optarg);
                goto label_dee8;
              case 0x85:
                if ((v29) && (strcmp(v29,optarg)))
                  error(2,0,gettext("multiple random sources specified")); // no-return
                v29 = optarg;
                goto label_dee8;
              case 0x86:
                v10 = sub_f8c1("--sort",optarg,0x22960,"ghMnRVwaiting for %s [-d]",1,dat_23110,1);
                v26 = (int)"ghMnRVwaiting for %s [-d]"[v10];
                goto label_e4c9;
              case 0x87:
                v30 = sub_6042(v17,(int)v5,optarg);
                goto label_dee8;
    ...
    if (argc <= optind) {
      if (v33) {
        if (v31) {
          v8 = (char *)sub_15059(4,(char *)*v32);
          error(0,0,gettext("extra operand %s"),v8); // no-return
        }
        v12 = (FILE *)sub_505e(v33,"r");
        sub_1676c(&v17);
        if (sub_16b8b(v12,&v17) != '\x01') {
          v8 = (char *)sub_15059(4,v33);
          error(2,0,gettext("cannot read file names from %s"),v8); // no-return
        }
        sub_50b7(v12,v33);
        if (!CONCAT44(v50,v17)) {
          v8 = (char *)sub_15059(4,v33);
          error(2,0,gettext("no input from %s"),v8); // no-return
        }
        free(v32);
        v32 = v51;
        v31 = CONCAT44(v50,v17);
        for (v37 = 0; v37 < v31; v37 = v37 + 1) {
          v1 = (char *)v51[v37];
          if (!strcmp(v1,"-")) {
            v8 = (char *)sub_15059(4,(char *)v51[v37]);
            error(2,0,gettext("when reading file names from stdin, no file name of %s allowed"),v8); // no-return
          }
          if (!*(char *)v51[v37]) {
            v8 = (char *)sub_151eb(0,3,v33);
            error(2,0,gettext("%s:%lu: invalid zero-length file name"),v8,v37 + 1); // no-return
          }
        }
      }
      for (v27 = (long *)dat_23688; v27; v27 = *(long **)((long)v27 + 0x40)) {
        if ((sub_8305(v27)) && (*(char *)((long)v27 + 0x37) != '\x01')) {
          *(unsigned long *)((long)v27 + 0x20) = v39;
          *(unsigned long *)((long)v27 + 0x28) = v40;
          *(char *)((long)v27 + 0x30) = v41;
          *(char *)((long)v27 + 0x31) = v42;
          *(char *)((long)v27 + 0x36) = v47;
          *(char *)((long)v27 + 0x32) = v43;
          *(char *)((long)v27 + 0x34) = v45;
          *(char *)((long)v27 + 0x35) = v46;
          *(char *)((long)v27 + 0x38) = v49;
          *(char *)((long)v27 + 0x33) = v44;
          *(char *)((long)v27 + 0x37) = v48;
        }
        v23 = *(char *)((long)v27 + 0x33) || v23;
      }
      if ((!dat_23688) && (sub_8305(v16) != '\x01')) {
        sub_d5d8(v16);
        v23 = v44 || v23;
      }
      sub_d6de();
      if (!dat_23698) {
        ...
        if (!v24) {
          ...
          sub_cb44(v34);
          if (v4) {
            v13 = (long *)sub_18502(v31,0x10);
            for (v38 = 0; v38 < v31; v38 = v38 + 1) {
              v13[v38 * 2] = v32[v38];
            }
            sub_cbb9(v13,0,v31,v34);
          }
          else {
            if ((!v30) && (v30 = sub_12de4(2), 9 <= v30))
              v30 = 8;
            v14 = 0xffffffffffffff;
            if (v30 <= 0xffffffffffffff)
              v14 = v30;
            sub_d0f9(v32,v31,v34,v14);
          }
          if ((dat_23683) && (v7 = sub_ff17(stdin), v7 == -1))
            sub_4464(gettext("close failed"),"-"); // no-return
          if (v54 == *(long *)(v20 + 0x28))
            return 0;
          __stack_chk_fail(); // no-return
        }
        if (2 <= v31) {
          v8 = (char *)sub_15059(4,(char *)v32[1]);
          error(2,0,gettext("extra operand %s not allowed with -%c"),v8,v24); // no-return
        }
        if (!v34) {
          v8 = (char *)*v32;
          exit((sub_a0b1(v8,(int)v24) ^ 1) & 0xff); // no-return
        }
        dat_23032 = v24;
        sub_d6a1((char *)0x23032); // no-return
      }
      if ((v24) || (v34)) {
        if (!v24)
          v24 = 'o';
      ...
      v23 = 0;
      if (v8)
        v23 = setlocale(3,"") != NULL;
      if (v23) {
        if (!dat_23229)
          error(0,0,"%s",gettext("text ordering performed using simple byte comparison")); // no-return
        v8 = (char *)sub_154a0(setlocale(3,NULL));
        error(0,0,gettext("text ordering performed using %s sorting rules"),v8); // no-return
      }
...
void sub_f6d1(char *a0,char *a1,long a2)
{
  char *v1; // rax
  unsigned long v2; // rax
...
void sub_f76a(long a0,long a1,unsigned long a2)
{
  ...
  do {
    ...
    if (v3) { // branch-flip
      ...
      v1 = *(char **)(a0 + v3 * 8);
      fprintf(stderr,", %s",(char *)sub_154a0(v1));
    }
    else {
label_f7eb:
      v1 = *(char **)(a0 + v3 * 8);
...
long sub_f8c1(char *a0,char *a1,long a2,long a3,unsigned long a4,void *a5,unsigned int a6) // early-return, ternary
{
  long v1; // stack - 0x10
...
unsigned long sub_fc0d(struct_26 *a0,unsigned long a1)
{
...
unsigned long sub_fcf0(FILE *a0,unsigned long a1) // return-dupe x2
{
  int v1; // eax
  void *v2; // rax
  unsigned long v3; // rax
  ...
  do {
    ...
    while( true ) {
      ...
      v3 = fread_unlocked((void *)((long)v2 + v5),1,0x8000 - v5,a0);
      v5 += v3;
      if (v5 == 0x8000) break;
      if (!v3) {
...
void sub_fed8(FILE *a0,unsigned int a1) // return-dupe
{
  if (!a0)
    return;
...
unsigned long sub_ff17(FILE *a0)
{
  int v1; // eax
  int v2; // stack - 0x14
...
void sub_ffd0(FILE *a0) // return-dupe
{
...
unsigned long sub_10057(char *a0,unsigned long *a1) // ternary
{
  char v1;
  unsigned long v2;
  unsigned long v3;
  ...
  v3 = v5;
  while( true ) {
    while (((v5 + 1 < v2 && (a0[v5] == '.')) && ((v1 = a0[v5 + 1], sub_191b0((int)v1) || (a0[v5 + 1] == '~'))))) {
      for (v5 = v5 + 2; (v5 < v2 && ((v1 = a0[v5], sub_19172((int)v1) || (a0[v5] == '~')))); v5 = v5 + 1) {
      }
    }
...
void sub_1042d(char *a0,char *a1)
{
  sub_10461(a0,-1,a1,-1);
}
...
unsigned long sub_106ec(FILE *a0,long a1,int a2) // early-return x2
{
  long v1; // rax
...
unsigned long sub_10854(struct_22 *a0)
{
  return a0->field_0x10;
}

// Function: sub_1086a @ 0x1086a
unsigned long sub_1086a(struct_27 *a0)
{
  return a0->field_0x18;
}

// Function: sub_10880 @ 0x10880
unsigned long sub_10880(struct_28 *a0)
{
  return a0->field_0x20;
}

// Function: sub_10896 @ 0x10896
unsigned long sub_10896(struct_29 *a0)
{
  long *v1; // stack - 0x28
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
unsigned long sub_10918(struct_29 *a0) // return-dupe
{
  long *v1; // stack - 0x28
  long v2; // stack - 0x20
  long v3; // stack - 0x18
...
void sub_109b6(struct_28 *a0,FILE *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
long sub_10b58(void *a0,long a1) // return-dupe
{
  void *v1;
  long v2;
  long *v3; // stack - 0x18
  ...
  while( true ) {
    if (!v3)
      return 0;
    if ((a1 == *v3) || (v1 = *(void **)((long)a0 + 0x38), v2 = *v3, (*v1)(a1,v2))) break;
    v3 = (long *)v3[1];
  }
  return *v3;
}
...
long sub_10bef(struct_29 *a0) // early-return
{
  long *v1; // stack - 0x10
...
long sub_10c4f(void *a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_10ced(struct_29 *a0,long a1,unsigned long a2)
{
  unsigned long v1;
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
long sub_10d8d(struct_29 *a0,void *a1,unsigned long a2)
{
  long v1;
  long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
void sub_10f39(struct_30 *a0)
{
  a0->field_0x0 = 0;
  a0->field_0x4 = dat_1d280;
  a0->field_0x8 = dat_1d284;
  a0->field_0xc = dat_1d288;
  a0->field_0x10 = 0;
}
...
unsigned long sub_10fe7(struct_8 *a0) // return-dupe x2
{
  float *v1;
  ...
  if ((((dat_1d28c < v1[2]) && (v1[2] < dat_1d280 - dat_1d28c)) && (dat_1d28c + dat_1d280 < v1[3])) && (((0.0 <= *v1 && (*v1 + dat_1d28c < v1[1])) && ((v1[1] <= dat_1d280 && (*v1 + dat_1d28c < v1[2]))))))
    return 1;
  a0->field_0x28 = (float *)0x1d1f0;
  return 0;
}

// Function: sub_110f4 @ 0x110f4
unsigned long sub_110f4(unsigned long a0,void *a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
...
long * sub_1120d(unsigned long a0,void *a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
void sub_1160b(struct_9 *a0,struct_11 *a1)
{
  a1->field_0x0 = 0;
...
long sub_11645(struct_12 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long v2;
  struct_11 *v3;
...
unsigned long sub_117de(struct_15 *a0,struct_29 *a1,bool a2)
{
  long *v1;
  long v2;
  struct_14 *v3; // rax
...
unsigned long sub_119b2(struct_16 *a0,unsigned long a1) // return-dupe x4
{
  void *v1; // stack - 0x68
...
unsigned long sub_11bdd(void *a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
  ...
  if (((float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18)) && (sub_10fe7(a0), (float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18))) {
...
unsigned long sub_11f4e(void *a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_11fbe(void *a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
  ...
  if (!v5)
    return 0;
  *(long *)((long)a0 + 0x20) = *(long *)((long)a0 + 0x20) + -1;
  if (((!*v2) && (*(long *)((long)a0 + 0x18) = *(long *)((long)a0 + 0x18) + -1, (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) && (sub_10fe7(a0), (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) {
    v6 = *(long *)((long)a0 + 0x28);
...
void sub_122c4(void *a0,long a1)
{
  sub_11fbe(a0,a1);
}

// Function: sub_122ed @ 0x122ed
unsigned long * sub_122ed(void *a0,unsigned long a1)
{
  unsigned long *v1; // rax
...
unsigned long sub_123c6(long *a0,unsigned long a1)
{
  ...
  *(unsigned long *)(*a0 + a0[2] * 8) = a1;
  sub_12637(*a0,a0[2],(void *)a0[3]);
  return 0;
}

// Function: sub_12474 @ 0x12474
unsigned long sub_12474(struct_18 *a0) // early-return
{
  unsigned long v1;
  long v2;
  ...
  if (!a0->field_0x10)
    return 0;
  v1 = *(unsigned long *)(a0->field_0x0 + 8);
  v2 = a0->field_0x10;
  a0->field_0x10 = v2 + -1;
  *(unsigned long *)(a0->field_0x0 + 8) = *(unsigned long *)(a0->field_0x0 + v2 * 8);
  sub_12508(a0->field_0x0,a0->field_0x10,1,a0->field_0x18);
  return v1;
}
...
char * sub_12802(unsigned int a0,void *a1)
{
...
char * sub_1287e(unsigned long a0,void *a1)
{
  unsigned long v1; // stack - 0x20
  char *v2; // stack - 0x10
...
int sub_1293d(char *a0,long a1,unsigned int a2)
{
  char *v1;
  char *v10; // stack - 0x20
  char v2;
...
long sub_12bc5(void) // return-dupe
{
  ...
  if (sched_getaffinity(0,0x80,v2))
    return 0;
  v1 = (long)__sched_cpucount(0x80,v2);
  if (!v1)
    return 0;
  return v1;
}
...
int sub_1311d(int *a0,unsigned int a1) // early-return x3
{
  ...
  if (0 <= pipe(a0)) {
    if (((!(a1 & 0x800)) || ((((v4 = sub_1967a(a0[1],3,0), 0 <= v4 && (v3 = a0[1], sub_1967a(v3,4,v4 | 0x800) != -1)) && (v4 = sub_1967a(*a0,3,0), 0 <= v4)) && (v3 = *a0, sub_1967a(v3,4,v4 | 0x800) != -1)))) && ((!(a1 & 0x80000) || (((v4 = sub_1967a(a0[1],1,0), 0 <= v4 && (v3 = a0[1], sub_1967a(v3,2,v4 | 1) != -1)) && ((v4 = sub_1967a(*a0,1,0), 0 <= v4 && (v3 = *a0, sub_1967a(v3,2,v4 | 1) != -1))))))))
      return 0;
    v3 = *__errno_location();
    close(*a0);
    close(a0[1]);
...
unsigned long sub_1354a(void *a0)
{
  int v1;
  unsigned long v2; // rax
...
unsigned int sub_13678(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
label_14340:
    if ((v29 <= 1) && ((!v2 || (v16)))) goto label_145a3;
    v32 = v29 + v24;
    while( true ) {
      if ((!v2) || (v16)) {
        if (v4) {
...
label_1404b:
  ...
  if (0x3f < v22) {
    ...
    v23 = v22;
    if (((!v2) || (!v14)) || (!v28)) goto label_14021;
    goto label_146c9;
  }
  switch(v22) {
    case 0:
...
label_145a3:
    if (((((v2) && (v19 != 2)) || (v14)) && ((v8 && (*(unsigned int *)(v8 + (unsigned long)(v22 >> 5) * 4) >> (v22 & 0x1f) & 1)))) || (v4)) goto label_1460e;
  }
label_146c9:
  if ((v3) && (!v5)) {
    if (v25 < v21)
...
label_148da:
  ...
  if (((v19 == 2) && (!v14)) && (v6)) {
    if (v7)
      return sub_1389e(a0,v26,a2,v20,5,a5,v8,v18,v17);
    if ((!v21) && (v26)) {
      v21 = v26;
      v25 = 0;
      goto label_13958;
...
unsigned long sub_1495f(long a0,unsigned long a1,char *a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  unsigned long v2; // rax
  ...
  v1 = *__errno_location();
  v2 = sub_1389e(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(char **)&a4[10],*(char **)&a4[0xc]);
  *__errno_location() = v1;
  return v2;
}

// Function: sub_14a07 @ 0x14a07
void sub_14a07(char *a0,unsigned long a1,unsigned int *a2)
{
  sub_14a3d(a0,a1,NULL,a2);
}

// Function: sub_14a3d @ 0x14a3d
long sub_14a3d(char *a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  unsigned int v2; // eax
  long v3; // rax
  ...
  v3 = sub_1389e(0,0,a0,a1,*a3,v2,&a3[2],*(char **)&a3[10],*(char **)&a3[0xc]);
  v4 = sub_18070(v3 + 1U);
  sub_1389e(v4,v3 + 1U,a0,a1,*a3,v2,&a3[2],*(char **)&a3[10],*(char **)&a3[0xc]);
  *__errno_location() = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void * sub_14c28(int a0,char *a1,unsigned long a2,struct_0 *a3)
{
  int v1;
  unsigned int v2; // eax
  unsigned long *v3;
  ...
  if ((0 <= a0) && (a0 <= 0x7ffffffe)) {
    ...
    v2 = a3->field_0x4 | 1;
    v9 = sub_1389e(v7,v8,a1,a2,a3->field_0x0,v2,a3->field_0x8,a3->field_0x28,a3->field_0x30);
    if (v8 <= v9) {
      v8 = v9 + 1;
      v6[(long)a0 * 2] = v8;
      if (v7 != (void *)0x238c0)
      ...
      v6[(long)a0 * 2 + 1] = v7;
      sub_1389e(v7,v8,a1,a2,a3->field_0x0,v2,a3->field_0x8,a3->field_0x28,a3->field_0x30);
    }
    *__errno_location() = v1;
    return v7;
  }
...
void sub_14ed7(unsigned int a0,char *a1)
{
  sub_14c28(a0,a1,0xffffffffffffffff,(struct_0 *)0x23880);
}

// Function: sub_14f0b @ 0x14f0b
void sub_14f0b(unsigned int a0,char *a1,unsigned long a2)
{
  sub_14c28(a0,a1,a2,(struct_0 *)0x23880);
}

// Function: sub_14f3d @ 0x14f3d
void sub_14f3d(char *a0)
{
  sub_14ed7(0,a0);
}

// Function: sub_14f60 @ 0x14f60
void sub_14f60(char *a0,unsigned long a1)
{
  sub_14f0b(0,a0,a1);
}

// Function: sub_14f8b @ 0x14f8b
void sub_14f8b(unsigned int a0,unsigned int a1,char *a2)
{
  char v1 [56];
...
void sub_14ff3(unsigned int a0,unsigned int a1,char *a2,unsigned long a3)
{
  char v1 [56];
...
void sub_15059(unsigned int a0,char *a1)
{
  sub_14f8b(0,a0,a1);
}

// Function: sub_15081 @ 0x15081
void sub_15081(unsigned int a0,char *a1,unsigned long a2)
{
  sub_14ff3(0,a0,a1,a2);
}

// Function: sub_150b1 @ 0x150b1
void sub_150b1(char *a0,unsigned long a1,char a2)
{
...
void sub_1516c(char *a0,char a1)
{
  sub_150b1(a0,0xffffffffffffffff,(int)a1);
}

// Function: sub_1519a @ 0x1519a
void sub_1519a(char *a0)
{
  sub_1516c(a0,0x3a);
}

// Function: sub_151bd @ 0x151bd
void sub_151bd(char *a0,unsigned long a1)
{
  sub_150b1(a0,a1,0x3a);
}

// Function: sub_151eb @ 0x151eb
void sub_151eb(unsigned int a0,unsigned int a1,char *a2)
{
...
void sub_152ad(unsigned int a0,long a1,long a2,char *a3)
{
  sub_152e7(a0,a1,a2,a3,0xffffffffffffffff);
}

// Function: sub_152e7 @ 0x152e7
void sub_152e7(unsigned int a0,long a1,long a2,char *a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned long v3; // stack - 0x38
...
void sub_153a5(long a0,long a1,char *a2)
{
  sub_152ad(0,a0,a1,a2);
}

// Function: sub_153d8 @ 0x153d8
void sub_153d8(long a0,long a1,char *a2,unsigned long a3)
{
  sub_152e7(0,a0,a1,a2,a3);
}

// Function: sub_15416 @ 0x15416
void sub_15416(unsigned int a0,char *a1,unsigned long a2)
{
  sub_14c28(a0,a1,a2,(struct_0 *)0x23140);
}

// Function: sub_15448 @ 0x15448
void sub_15448(char *a0,unsigned long a1)
{
  sub_15416(0,a0,a1);
}

// Function: sub_15473 @ 0x15473
void sub_15473(unsigned int a0,char *a1)
{
  sub_15416(a0,a1,0xffffffffffffffff);
}

// Function: sub_154a0 @ 0x154a0
void sub_154a0(char *a0)
{
  sub_15473(0,a0);
}

// Function: sub_154c3 @ 0x154c3
void sub_154c3(char *a0)
{
  unsigned long v1; // rax
  char *v2; // rax
...
unsigned long sub_15614(unsigned long *a0) // early-return
{
  FILE *v1;
...
unsigned long * sub_15668(char *a0,unsigned long a1)
{
  int v1;
  unsigned long v2;
  FILE *v3; // stack - 0x18
  ...
  if (a1) { // branch-flip
    v3 = NULL;
    if (a0) {
      v3 = (FILE *)sub_19bbb(a0,"rb");
      if (!v3)
        return NULL;
    }
    v4 = (unsigned long *)sub_15541(v3,a0);
    if (v3) { // branch-flip
      v2 = 0x1000;
      if (a1 <= 0x1000)
        v2 = a1;
      setvbuf(v3,(char *)&v4[3],0,v2);
    }
    else {
      v4[3] = 0;
      if (0x801 <= a1)
        a1 = 0x800;
      if (sub_1558f(&v4[4],a1) != '\x01') {
        v1 = *__errno_location();
        sub_15614(v4);
        *__errno_location() = v1;
        return NULL;
    ...
    v4 = (unsigned long *)sub_15541(0,0);
  }
  return v4;
}

// Function: sub_15790 @ 0x15790
void sub_15790(void *a0,unsigned long a1)
{
  *(unsigned long *)((long)a0 + 8) = a1;
}

// Function: sub_157af @ 0x157af
void sub_157af(void *a0,unsigned long a1)
{
  *(unsigned long *)((long)a0 + 0x10) = a1;
}

// Function: sub_157ce @ 0x157ce
void sub_157ce(unsigned long *a0,void *a1,unsigned long a2)
{
  FILE *v1;
  unsigned long v2; // rax
  int v3;
  ...
  v5 = a1;
  while( true ) {
    v2 = fread_unlocked(v5,1,v4,(FILE *)*a0);
    v3 = *__errno_location();
    v5 = (void *)((long)v5 + v2);
    v4 -= v2;
    if (!v4) break;
...
void sub_159b4(long *a0,void *a1,unsigned long a2) // return-dupe
{
  if (*a0) {
    sub_157ce(a0,a1,a2);
    return;
...
void sub_161e0(void *a0)
{
  ...
  for (v11 = 0; v11 <= 0xff; v11 = v11 + 8) {
    v6 = *(long *)((long)a0 + (long)(v11 + 1) * 8);
    v7 = *(long *)((long)a0 + (long)(v11 + 2) * 8);
    v8 = *(long *)((long)a0 + (long)(v11 + 3) * 8);
    v1 = v17 + *(long *)((long)a0 + (long)(v11 + 4) * 8);
    v9 = *(long *)((long)a0 + (long)(v11 + 5) * 8);
    v10 = *(long *)((long)a0 + (long)(v11 + 6) * 8);
    v20 += *(long *)((long)a0 + (long)(v11 + 7) * 8);
    v2 = (v13 + *(long *)((long)a0 + (long)v11 * 8)) - v1;
    ...
    v19 += v20;
    *(unsigned long *)((long)a0 + (long)v11 * 8) = v13;
    *(unsigned long *)((long)a0 + (long)(v11 + 1) * 8) = v14;
    *(unsigned long *)((long)a0 + (long)(v11 + 2) * 8) = v15;
    *(unsigned long *)((long)a0 + (long)(v11 + 3) * 8) = v16;
    *(unsigned long *)((long)a0 + (long)(v11 + 4) * 8) = v17;
    *(long *)((long)a0 + (long)(v11 + 5) * 8) = v18;
    *(long *)((long)a0 + (long)(v11 + 6) * 8) = v19;
    *(long *)((long)a0 + (long)(v11 + 7) * 8) = v20;
  }
  for (v12 = 0; v12 <= 0xff; v12 = v12 + 8) {
    v6 = *(long *)((long)a0 + (long)(v12 + 1) * 8);
    v7 = *(long *)((long)a0 + (long)(v12 + 2) * 8);
    v8 = *(long *)((long)a0 + (long)(v12 + 3) * 8);
    v1 = v17 + *(long *)((long)a0 + (long)(v12 + 4) * 8);
    v9 = *(long *)((long)a0 + (long)(v12 + 5) * 8);
    v10 = *(long *)((long)a0 + (long)(v12 + 6) * 8);
    v20 += *(long *)((long)a0 + (long)(v12 + 7) * 8);
    v2 = (v13 + *(long *)((long)a0 + (long)v12 * 8)) - v1;
    v3 = v18 + v9 ^ (unsigned long)sub_15a2d(v20) >> 9;
    v6 = (v14 + v6) - v3;
    v4 = v19 + v10 ^ v2 * 0x200;
    v7 = (v15 + v7) - v4;
    ...
    v17 = v1 + v2 ^ v19 * 0x4000;
    v19 += v20;
    *(unsigned long *)((long)a0 + (long)v12 * 8) = v13;
    *(unsigned long *)((long)a0 + (long)(v12 + 1) * 8) = v14;
    *(unsigned long *)((long)a0 + (long)(v12 + 2) * 8) = v15;
    *(unsigned long *)((long)a0 + (long)(v12 + 3) * 8) = v16;
    *(unsigned long *)((long)a0 + (long)(v12 + 4) * 8) = v17;
    *(long *)((long)a0 + (long)(v12 + 5) * 8) = v18;
    *(long *)((long)a0 + (long)(v12 + 6) * 8) = v19;
    *(long *)((long)a0 + (long)(v12 + 7) * 8) = v20;
  }
  *(unsigned long *)((long)a0 + 0x810) = 0;
  *(unsigned long *)((long)a0 + 0x808) = *(unsigned long *)((long)a0 + 0x810);
  *(unsigned long *)((long)a0 + 0x800) = *(unsigned long *)((long)a0 + 0x808);
}
...
void sub_1676c(unsigned long *a0)
{
  *a0 = 0;
  a0[1] = 0;
  a0[2] = 0;
  _obstack_begin((obstack *)&a0[3],0,0,dat_22fd0,dat_22fe0);
  _obstack_begin((obstack *)&a0[0xe],0,0,dat_22fd0,dat_22fe0);
  _obstack_begin((obstack *)&a0[0x19],0,0,dat_22fd0,dat_22fe0);
}
...
unsigned long sub_16b8b(FILE *a0,void *a1)
{
  char *v1;
  long v2;
  int v3; // eax
  ...
  while( true ) {
    v3 = fgetc(a0);
    if (v3 == -1) break;
    if (*(long *)((long)a1 + 0x38) == *(long *)((long)a1 + 0x30))
      _obstack_newchunk((obstack *)((long)a1 + 0x18),1);
    v1 = *(char **)((long)a1 + 0x30);
    *(char **)((long)a1 + 0x30) = &v1[1];
    *v1 = (char)v3;
    if (!v3)
      sub_16967(a1);
  }
  ...
  if ((unsigned long)(*(long *)((long)a1 + 0x90) - *(long *)((long)a1 + 0x88)) <= 7)
    _obstack_newchunk((obstack *)((long)a1 + 0x70),8);
  **(unsigned long **)((long)a1 + 0x88) = 0;
  *(long *)((long)a1 + 0x88) = *(long *)((long)a1 + 0x88) + 8;
  v2 = *(long *)((long)a1 + 0x80);
  if (v2 == *(long *)((long)a1 + 0x88))
    *(unsigned char *)((long)a1 + 0xc0) = *(unsigned char *)((long)a1 + 0xc0) | 2;
  *(unsigned long *)((long)a1 + 0x88) = ~*(unsigned long *)((long)a1 + 0xa0) & *(long *)((long)a1 + 0x88) + *(long *)((long)a1 + 0xa0);
  if ((unsigned long)(*(long *)((long)a1 + 0x90) - *(long *)((long)a1 + 0x78)) < (unsigned long)(*(long *)((long)a1 + 0x88) - *(long *)((long)a1 + 0x78)))
    *(unsigned long *)((long)a1 + 0x88) = *(unsigned long *)((long)a1 + 0x90);
  *(unsigned long *)((long)a1 + 0x80) = *(unsigned long *)((long)a1 + 0x88);
  *(long *)((long)a1 + 8) = v2;
  v2 = *(long *)((long)a1 + 0xd8);
  if (v2 == *(long *)((long)a1 + 0xe0))
    *(unsigned char *)((long)a1 + 0x118) = *(unsigned char *)((long)a1 + 0x118) | 2;
  *(unsigned long *)((long)a1 + 0xe0) = ~*(unsigned long *)((long)a1 + 0xf8) & *(long *)((long)a1 + 0xe0) + *(long *)((long)a1 + 0xf8);
  if ((unsigned long)(*(long *)((long)a1 + 0xe8) - *(long *)((long)a1 + 0xd0)) < (unsigned long)(*(long *)((long)a1 + 0xe0) - *(long *)((long)a1 + 0xd0)))
    *(unsigned long *)((long)a1 + 0xe0) = *(unsigned long *)((long)a1 + 0xe8);
  *(unsigned long *)((long)a1 + 0xd8) = *(unsigned long *)((long)a1 + 0xe0);
  *(long *)((long)a1 + 0x10) = v2;
  v3 = ferror(a0);
...
void sub_16fdf(unsigned int a0,char *a1,unsigned long a2)
{
  sub_16f27(a0,a1,a2);
}
...
void sub_17028(char *a0)
{
  sub_1767e(mkstemp(a0));
}

// Function: sub_1704d @ 0x1704d
void sub_1704d(char *a0,int a1)
{
...
void sub_1764c(unsigned char *a0,unsigned char *a1,unsigned int a2,unsigned int a3)
{
...
void sub_176cf(FILE *a0,char *a1,char *a2,char *a3,unsigned long *a4,unsigned long a5) // return-dupe x10
{
  unsigned long v1;
  char *v10;
  char *v11;
...
void sub_17ccb(FILE *a0,char *a1,char *a2,char *a3,unsigned long *a4)
{
  long v1; // stack - 0x10
...
void sub_17d3e(FILE *a0,char *a1,char *a2,char *a3,struct_25 *a4)
{
  long *v1;
  long v2 [11];
...
void sub_17e44(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,FILE *a8,char *a9,char *a10,char *a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_17fd1(void *a0,unsigned long a1,unsigned long a2)
{
  sub_1810a(a0,a1,a2);
}
...
void sub_180d9(void *a0,unsigned long a1)
{
...
void sub_18164(void *a0,unsigned long a1,unsigned long a2)
{
...
{
  sub_1810a(NULL,a0,a1);
}

// Function: sub_181c8 @ 0x181c8
void sub_181c8(unsigned long a0,unsigned long a1)
{
  sub_18164(NULL,a0,a1);
}

// Function: sub_181f3 @ 0x181f3
void sub_181f3(void *a0,unsigned long *a1)
{
  sub_18221(a0,a1,1);
}

// Function: sub_18221 @ 0x18221
unsigned long sub_18221(void *a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_18300(void *a0,long *a1,long a2,long a3,long a4) // ternary
{
  long v1;
  long v2; // rax
  unsigned long v3; // rax
...
unsigned int sub_18783(char *a0,unsigned long a1,char *a2,unsigned long a3)
{
  int v1;
  unsigned int v2; // eax
...
unsigned int sub_187ec(char *a0,unsigned long a1,char *a2,unsigned long a3)
{
  int v1;
  unsigned int v2; // eax
...
void sub_18a33(unsigned int a0,unsigned int a1,char a2,long a3,unsigned long a4)
{
...
int sub_19411(char *a0,char *a1) // early-return
{
  ...
  if (a0 == a1)
    return 0;
  do {
    v1 = sub_193cb((unsigned char)*a0);
    v2 = sub_193cb((unsigned char)*a1);
    if (!v1) break;
    a0 = &a0[1];
    a1 = &a1[1];
  } while (v1 == v2);
...
unsigned long sub_1948b(FILE *a0)
{
  int v1; // eax
  unsigned long v2; // rax
  bool v3; // zf
...
FILE * sub_19bbb(char *a0,char *a1)
{
  int v1;
  int v2;
  FILE *v3; // rax
...
unsigned long sub_19dd4(unsigned int *a0,char *a1,unsigned long a2,mbstate_t *a3) // early-return
{
  long v1;
...
unsigned int sub_19f53(char *a0,unsigned long a1,char *a2,unsigned long a3)
{
  char v1;
  char v2;
  unsigned int v3; // stack - 0xc
...
unsigned long sub_1a033(char *a0,unsigned long a1,char *a2,unsigned long a3) // early-return
{
...
unsigned long sub_1a0a0(struct_14 *a0,timespec *a1) // early-return
{
  unsigned int v1; // eax
...
void sub_1a1a6(void *a0,unsigned long a1) // return-dupe
{
...
void sub_1a1fa(void *a0,unsigned long a1) // return-dupe
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
...
unsigned long sub_1a24f(struct_23 *a0,long a1,long a2)
{
  long v1;
  long *v2;
  long v3; // stack - 0x30
  ...
  a0->field_0x30 = v3 + -1;
  v1 = a0->field_0x0;
  a0->field_0x8 = (long *)sub_1a1a6(a0,v1);
  v2 = a0->field_0x8;
  if (!v2)
...
void _obstack_newchunk(obstack *a0,unsigned long a1)
{
  ...
  if (v6 < *(unsigned long *)a0)
    v6 = *(unsigned long *)a0;
  if ((v2 <= a1) && (a1 <= v3))
    v5 = (unsigned long *)sub_1a1a6(a0,v6);
  if (!v5)
    (*obstack_alloc_failed_handler)();
