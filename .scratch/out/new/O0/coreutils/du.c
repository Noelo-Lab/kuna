...
unsigned long sub_759b(void *a0,char *a1)
{
  long v1;
  long v2;
  long v3; // stack - 0x20
...
unsigned long sub_761d(void *a0,char *a1,char *a2) // return-dupe
{
  unsigned int v1;
  struct_6 *v2;
  char *v3; // rax
...
unsigned long sub_ae5b(void *a0,unsigned long a1)
{
  return *(unsigned long *)((long)a0 + 8) % a1;
}

// Function: sub_ae89 @ 0xae89
unsigned long sub_ae89(void *a0) // return-dupe x2, return-dupe
{
  if (!(*(unsigned int *)((long)a0 + 0x48) & 0x102)) {
    *(void **)((long)a0 + 0x58) = malloc(0x20);
    if (*(long *)((long)a0 + 0x58)) {
      sub_1782e(*(void **)((long)a0 + 0x58));
      return 1;
    }
    return 0;
  }
  *(unsigned long *)((long)a0 + 0x58) = sub_e361(0x1f,NULL,sub_ae5b,sub_ae02,dat_20fa8);
  if (*(long *)((long)a0 + 0x58))
    return 1;
  return 0;
}
...
unsigned long sub_af35(void *a0,struct_18 *a1) // return-dupe x3
{
  struct_17 *v1;
  struct_19 *v2; // rax
  struct_19 *v3; // rax
  ...
  *(unsigned long *)((long)v2->field_0x0 + 8) = a1->field_0x78;
  v2->field_0x10 = a1;
  v3 = (struct_19 *)sub_f0a2(*(void **)((long)a0 + 0x58),v2);
  if (v3 == v2)
    return 1;
  free(v2);
  if (v3) {
...
void sub_b047(void *a0,void *a1)
{
  ...
  if (*(unsigned int *)((long)a0 + 0x48) & 0x102) { // branch-flip
    ...
    v2 = (void *)sub_f112(*(void **)((long)a0 + 0x58),&v3);
    if (!v2)
      abort(); // no-return
    free(v2);
  }
...
void sub_b179(void *a0) // return-dupe
{
  if (!(*(unsigned int *)((long)a0 + 0x48) & 0x102)) {
  ...
  if (*(long *)((long)a0 + 0x58)) {
    sub_e5e1(*(struct_14 **)((long)a0 + 0x58));
    return;
  }
}

// Function: sub_b1cb @ 0xb1cb
void sub_b1cb(void *a0)
{
  int v1; // eax
...
void sub_b213(void *a0,bool a1) // ternary
{
...
void sub_b25b(void *a0,int a1,bool a2)
{
  int v1;
  ...
  if ((v1 == a1) && (v1 != -100))
    abort(); // no-return
  if (a2) { // branch-flip
    v1 = sub_10396((void *)((long)a0 + 0x60),v1);
    if (0 <= v1)
      close(v1);
  }
...
unsigned int sub_b2eb(void *a0)
{
  ...
  if (!(*(unsigned int *)((long)a0 + 0x48) & 4)) {
    if (*(unsigned int *)((long)a0 + 0x48) & 0x200) { // branch-flip
      ...
      if (fchdir(v2)) {
        v1 = 1;
        sub_b1cb((void *)((long)a0 + 0x60)); // return-dupe
        return v1;
      }
    }
  }
  v1 = 0;
  sub_b1cb((void *)((long)a0 + 0x60));
  return v1;
}

// Function: sub_b399 @ 0xb399
unsigned int sub_b399(void *a0,char *a1)
{
  unsigned int v1; // eax
  unsigned int v2; // eax
  ...
  if (*(unsigned int *)((long)a0 + 0x48) & 0x200) // branch-flip
    v2 = sub_11e0a(*(unsigned int *)((long)a0 + 0x2c),a1,v1);
  else {
    v2 = sub_17de1(a1,v1);
  }
  return v2;
...
label_b570:
    ...
    for (v6 = a0; *v6; v6 = &v6[1]) {
      ...
      v4 = (void *)sub_d3a4(v2,(void *)*v6,v9);
      ...
      *(long *)((long)v4 + 0x30) = (long)v4 + 0x100;
      if ((v1) && (v5)) {
        ...
        *(unsigned short *)((long)v4 + 0x68) = sub_d069(v2,v4,0);
      }
      if (a2) { // branch-flip
...
void sub_b7dc(struct_25 *a0,void *a1)
{
  char *v1; // rax
  unsigned long v2; // rax
...
unsigned long sub_ba93(void *a0,int a1) // early-return x2
{
  long v1;
  struct_5 *v2; // rax
  struct_5 *v3; // rax
...
unsigned long sub_bc8c(void *a0,unsigned int a1) // early-return
{
  long v1; // rax
...
unsigned long sub_bce2(void *a0,unsigned int a1) // early-return
{
  long v1; // rax
...
void * sub_bd55(struct_25 *a0) // early-return x7, ternary
{
  char *v1;
  short v2;
  int v3;
            ...
            if (*(short *)((long)v6 + 0x68) != 0xb) {
              *(char *)(*(long *)((long)v6 + 0x48) + a0->field_0x20) = 0;
              if (*(long *)((long)v6 + 0x58)) { // branch-flip
                ...
                else if ((!(*(unsigned short *)((long)v6 + 0x6a) & 1)) && (v8 = *(void **)((long)v6 + 8), sub_d6d9(a0,v8,0xffffffff,".."))) {
                  *(int *)((long)v6 + 0x40) = *__errno_location();
                  a0->field_0x48 = a0->field_0x48 | 0x2000;
                }
              }
...
unsigned long sub_c3cb(unsigned long a0,void *a1,int a2) // return-dupe
{
...
void * sub_c6a5(struct_24 *a0,int a1) // early-return, return-dupe x2, ternary, warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_c6a5
{
  bool v1;
  void *v10; // rax
  int v11; // stack - 0x98
  ...
  if (v15) {
    ...
    v12 = sub_11f48(v6,*(char **)((long)v21 + 0x30),v12,&v11);
  ...
  if (v15)
    ...
    v3 = ((a1 != 2) && ((((!(a0->field_0x48 & 8) || (!(a0->field_0x48 & 0x10))) || (a0->field_0x48 & 0x20)) || ((*(long *)((long)v21 + 0x80) != 2 || (v7 = sub_bce2(v21,v11), !v7))))));
    if ((v3) || (v1 = 0, a1 == 3)) {
    ...
    *(unsigned long *)((long)v10 + 0x78) = *(unsigned long *)v26;
    ...
    if ((a0->field_0x40) && (!(a0->field_0x48 & 0x400)))
      ...
      *(unsigned short *)((long)v10 + 0x68) = 0xb;
      sub_c619((struct_21 *)((long)v10 + 0x70),(unsigned char)v26->field_0x12);
      sub_b213(v10,!v4);
    }
...
label_cee4:
  ...
  if (((!v15) && (v1)) && ((a1 == 1 || (!v14)))) {
    if (*(long *)((long)v21 + 0x58)) // branch-flip
      v7 = sub_d6d9(a0,*(void **)((long)v21 + 8),0xffffffff,"..");
    else {
      v7 = sub_b2eb(a0);
    }
    if (v7) {
...
unsigned long sub_d069(void *a0,void *a1,bool a2) // early-return x7, ternary
{
  stat *v1;
  int v2;
  char *v3;
...
void * sub_d236(void *a0,void *a1,unsigned long a2)
{
  unsigned long *v1;
  unsigned long v2;
  void *v3;
...
unsigned long sub_d49b(void *a0,long a1) // return-dupe x2
{
  unsigned long v1; // rax
  void *v2; // rax
...
void sub_d56c(void *a0,void *a1) // ternary
{
  long v1;
  void *v2; // stack - 0x18
...
int sub_d6d9(struct_23 *a0,void *a1,int a2,char *a3) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_d6d9
{
  bool v1; // al
  int v2;
  stat v3; // stack - 0xa8
...
long sub_dda3(void *a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_e248(unsigned long a0,void *a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
  unsigned long v3; // stack - 0x20
...
long * sub_e361(unsigned long a0,void *a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
unsigned long sub_ed31(void *a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
  ...
  if (((float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18)) && (sub_e13b(a0), (float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18))) {
...
unsigned long sub_f0a2(void *a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_f112(void *a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
  ...
  if (!v5)
    return 0;
  *(long *)((long)a0 + 0x20) = *(long *)((long)a0 + 0x20) + -1;
  if (((!*v2) && (*(long *)((long)a0 + 0x18) = *(long *)((long)a0 + 0x18) + -1, (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) && (sub_e13b(a0), (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) {
    v6 = *(long *)((long)a0 + 0x28);
...
void sub_10323(void *a0,unsigned int a1)
{
  int v1; // stack - 0xc
...
char sub_10380(void *a0)
{
  return *(char *)((long)a0 + 0x1c);
}

// Function: sub_10396 @ 0x10396
unsigned int sub_10396(void *a0,unsigned int a1)
{
  unsigned int v1;
  unsigned int v2; // eax
...
unsigned int sub_10422(void *a0)
{
  unsigned int v1;
...
char * sub_10715(long a0,void *a1)
{
  char *v1;
  long v2; // stack - 0x20
  char *v3; // stack - 0x10
...
void sub_10e51(void *a0,long a1)
{
...
unsigned int sub_121f3(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
bool sub_144a0(void *a0) // ternary
{
  char *v1; // rax
  bool v2; // zf
...
unsigned long * sub_144ea(void *a0) // early-return x2
{
  int v1;
  char *v2; // rax
  unsigned long *v3; // rax
