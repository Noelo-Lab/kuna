...
unsigned int sub_2c40(struct_1 *a0) // return-dupe
{
...
struct_12 * sub_5165(char **a0) // early-return
{
  struct_12 *v1; // rax
...
long sub_5227(struct_4 *a0,unsigned int *a1) // early-return x2, ternary
{
  FILE *v1;
  long *v2;
  long v3; // rax
...
char * sub_5729(unsigned long a0,void *a1)
{
...
void sub_57ed(struct_10 *a0,struct_11 *a1) // return-dupe
{
  if ((struct_11 *)a1->field_0x0 != &a1[1]) // branch-flip
...
unsigned int sub_5e34(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
unsigned long sub_809e(FILE *a0,void *a1)
{
  char *v1;
  long v2;
  int v3; // eax
...
void sub_8af5(FILE *a0,char *a1,char *a2,char *a3,struct_9 *a4)
{
  long *v1;
  long v2 [11];
...
void sub_97a5(void *a0,unsigned long a1) // return-dupe
{
...
void sub_97f9(void *a0,unsigned long a1) // return-dupe
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
...
unsigned long sub_984e(struct_7 *a0,long a1,long a2)
{
  long v1;
  long *v2;
  long v3; // stack - 0x30
