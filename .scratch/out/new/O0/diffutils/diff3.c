...
void sub_6d30(unsigned long a0,void *a1,void *a2) // return-dupe x2, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_6d30
{
  unsigned long v1;
  unsigned long v2;
  int v3;
  ...
  if ((dat_24170) && (v3 = (*dat_24170)(v1,0), v3))
    return;
  if ((dat_24158) && (v2 = *(unsigned long *)((long)a2 + 0xa0), dat_24150)) {
    v3 = *__errno_location();
...
void sub_7832(void *a0) // return-dupe
{
...
unsigned int sub_b29e(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
void sub_e346(void *a0) // return-dupe
{
