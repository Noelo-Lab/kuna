...
void sub_5525(unsigned long a0,void *a1,void *a2) // return-dupe x2, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_5525
{
  unsigned long v1;
  unsigned long v2;
  int v3;
  ...
  if ((dat_20290) && (v3 = (*dat_20290)(v1,0), v3))
    return;
  if ((dat_20278) && (v2 = *(unsigned long *)((long)a2 + 0xa0), dat_20270)) {
    v3 = *__errno_location();
...
void sub_6027(void *a0) // return-dupe
{
...
void sub_aeea(void *a0) // return-dupe
{
