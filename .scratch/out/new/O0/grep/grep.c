...
void sub_51b4(struct_36 *a0) // return-dupe
{
  char v1;
  char *v2; // rax
...
unsigned long sub_5428(struct_37 *a0,char *a1,unsigned long a2,long a3,long a4,unsigned long a5,unsigned int a6) // return-dupe, return-dupe x2, ternary x2
{
  char v1; // al
  ...
  v2 = (unsigned long *)(a3 * 0x40 + a0->field_0x10);
  *v2 = v3._0_8_;
  v2[1] = v3._8_8_;
  v2[2] = v3._16_8_;
  v2[3] = v3._24_8_;
...
long sub_5661(char *a0,unsigned long a1,unsigned long a2,bool a3) // ternary x5
{
  ...
  *(unsigned long *)(v21 + 0x18) = 0;
  ...
  if (!v3) {
    ...
    sub_14b84(v14,v13,*(void **)(v21 + 8));
    sub_51b4(v21);
    sub_1a490(0,0,*(unsigned long **)(v21 + 8),1);
    if (v18) {
      if ((a3) || (v1 = *(void **)(v21 + 8), sub_19e86(v1) != '\x01')) {
        *(long *)(v21 + 0x10) = *(long *)(v21 + 0x10) + -0x40;
        *(long *)(v21 + 0x18) = *(long *)(v21 + 0x18) + 1;
...
long sub_5d23(long *a0,char *a1,long a2,long *a3,char *a4)
{
  ...
  char *v6; // rax
  int v7; // ecx
  long v8 [3]; // stack - 0x28
  char *v9; // stack - 0xb0
  
  v13 = dat_33183;
  v1 = (struct_47 *)a0[1];
  v26 = a0;
  v27 = (struct_46 *)sub_19da3(v1);
  v2 = (void *)v26[1];
  v14 = sub_19dbc(v2);
  v28 = &a1[a2];
  v9 = a1;
  ...
  do {
    ...
    if (a4) { // branch-flip
      v19 = a4;
label_6255:
      if (0x80000001 <= (long)v18 - (long)v17)
        sub_27122(); // no-return
      v21 = v18;
      v23 = NULL;
      for (v24 = 0; v24 < v26[3]; v24 = v24 + 1) {
        v5 = v24 * 0x40 + v26[2];
        *(unsigned char *)(v5 + 0x38) = *(unsigned char *)(v5 + 0x38) & 0xbf;
        v5 = v24 * 0x40 + v26[2];
        *(unsigned char *)(v5 + 0x38) = *(unsigned char *)(v5 + 0x38) & 0x7f | (dat_33183 == '\n') << 7;
        v16 = re_search((re_pattern_buffer *)(v26[2] + v24 * 0x40),v17,((int)v18 - (int)v17) + -1,(int)v19 - (int)v17,((int)v18 - (int)v19) + -1,&v26[4]);
        if (v16 <= -2)
          sub_27122(); // no-return
        if (0 <= v16) {
          v22 = (char *)(long)(*(int *)v26[6] - v16);
          v20 = &v17[v16];
          if (v20 <= v21) {
            if ((!a4) || (dat_33181 == '\x01')) {
              if (((dat_33182 == '\x01') || (dat_33181 == '\x01')) && ((!dat_33182 || (v22 != &v18[0xffffffffffffffff - (long)v19])))) {
                if ((dat_33182 != '\x01') && (dat_33181)) {
                  while (v20 <= v21) {
                    v15 = 0;
                    v3 = &v18[-1];
                    v6 = &v20[(long)v22];
                    if ((!sub_fbe0(v6,v3)) && (v3 = &v18[-1], !sub_fc0e(v17,v20,v3))) goto label_6645;
                    if (1 <= (long)v22) {
                      v22 = &v22[-1];
                      v5 = v24 * 0x40 + v26[2];
                      *(unsigned char *)(v5 + 0x38) = *(unsigned char *)(v5 + 0x38) | 0x40;
                      v15 = re_match((re_pattern_buffer *)(v26[2] + v24 * 0x40),v17,((int)v20 + (int)v22) - (int)v19,(int)v20 - (int)v17,&v26[4]);
                      if (v15 <= -2)
                        sub_27122(); // no-return
                    }
                    if (1 <= v15) // branch-flip
                      v22 = (char *)(long)v15;
                    else {
                      if (v20 == &v18[-1]) break;
                      v20 = &v20[1];
                      v5 = v24 * 0x40 + v26[2];
                      *(unsigned char *)(v5 + 0x38) = *(unsigned char *)(v5 + 0x38) & 0xbf;
                      v16 = re_search((re_pattern_buffer *)(v26[2] + v24 * 0x40),v17,((int)v18 - (int)v17) + -1,(int)v20 - (int)v17,((int)v18 - (int)v20) + -1,&v26[4]);
                      if (v16 <= -1) {
                        if (v16 <= -2)
                          sub_27122(); // no-return
                        break;
...
label_6645:
            ...
            if ((v20 < v21) || ((v20 == v21 && ((long)v23 < (long)v22)))) {
              v21 = v20;
              v23 = v22;
            }
          }
...
label_6687:
      ...
      v11 = '\0';
      if (*v26) {
        v29 = sub_f585((struct_45 *)*v26,(long)v17 - (unsigned long)*(unsigned char *)&v26[8],&v28[(unsigned long)*(unsigned char *)&v26[8] - (long)v17],v8,1);
        if (v29 <= -1)
          return v29;
        v20 = &v17[v29];
        v30 = v17;
        v2 = memrchr(a1,(int)v13,(long)v20 - (long)a1);
        if (v2) // branch-flip
          v17 = (char *)((long)v2 + 1);
        else {
          v17 = a1;
...
label_5f74:
          v7 = (int)v13;
          v18 = (char *)((long)rawmemchr(v20,v7) + 1);
        }
        else {
          v5 = 0x10;
          if (0x10 <= (long)v20 - (long)v17)
            v5 = (long)v20 - (long)v17;
          if (v5 < (long)v20 - (long)v30 >> 2) goto label_5f74;
          v5 = 0x10;
          if (0x10 <= (long)v20 - (long)v17)
            v5 = (long)v20 - (long)v17;
          if ((long)v28 - (long)v30 >> 2 <= v5) // branch-flip
            v18 = v28;
          else {
            v7 = (int)v13;
            v5 = (long)v20 - (long)v17;
            if (v5 <= 0xf)
              v5 = 0x10;
            v3 = &v30[v5 * 4];
            v18 = (char *)((long)rawmemchr(v3,v7) + 1);
          }
        }
        if (!v12) goto label_6088;
        if (!dat_331a2 && dat_331a0 == '\x01') {
          if (v9 < v17)
            v9 = v17;
          if (sub_f84a(&v9,NULL,v20,v28)) {
            v25 = v9;
            goto label_6088;
          }
        }
...
label_6708:
        *a3 = (long)v22;
        return (long)v17 - (long)a1;
      }
label_6088:
      if ((v27) && (v12 != '\x01')) {
        v31 = (char *)sub_19d4d(v27,v25,v18,0,&v10,0);
        if ((v31) && (v31 != v18)) {
          if (v10) {
            v4 = (long)v31 - (long)a1;
            v7 = (int)v13;
            v17 = (char *)((long)memrchr(a1,v7,v4) + 1);
            v25 = v17;
          }
          v7 = (int)v13;
          v18 = (char *)((long)rawmemchr(v31,v7) + 1);
          v10 = 0;
          goto label_616c;
        }
      }
...
label_616c:
        v31 = (char *)sub_19d4d((struct_46 *)v26[1],v25,v18,0,&v10,&v11);
        if ((v31) && (v31 != v18)) {
          if (v10) {
            v4 = (long)v31 - (long)a1;
            v7 = (int)v13;
...
unsigned int sub_6e8a(struct_12 *a0)
{
  unsigned int v1; // eax
  
  v1 = a0->field_0x18 & 0xf000;
...
unsigned long sub_71a6(long a0,int a1,struct_13 *a2)
{
  long v1; // rax
  long v2; // stack - 0x18
  
  if (((dat_337d0 != '\x01') && (sub_6e8a(a2))) && (a0 < a2->field_0x30)) {
    v2 = a0;
    if (!a1) {
      v2 = lseek(0,0,1);
      if (v2 <= -1)
...
char sub_7608(long a0,struct_13 *a1)
{
  long v1;
  long v10; // stack - 0x50
  long v11; // stack - 0x48
  ...
  if (v1 <= (long)dat_337f0 + (dat_337f8 - (long)dat_33810)) // branch-flip
    ...
    if (1 <= v5) { // branch-flip
      v9 = -1;
      if (((sub_6e8a(a1)) && (v2 = a1->field_0x30 - dat_33820, 0 <= v2)) && (v3 = v2 + a0 + v1, !SCARRY8(v2,a0 + v1))) {
        v9 = v3;
        if (v3 <= dat_337f8 + v5)
          v9 = dat_337f8 + v5;
      }
  ...
  while( true ) {
    ...
    if (dat_337d1 != '\x01') {
      ...
      if (((v11 <= -1) && (*__errno_location() == 6)) && ((sub_6e8a(a1) && (dat_33820 < a1->field_0x30))))
...
void * sub_7f87(void *a0,void *a1,char *a2) // warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_7f87
{
  int v1; // eax
  unsigned long v2; // rax
  void *v3; // stack - 0x20
  
  v1 = !((a1 <= a0) || (*(char *)((long)a1 + -1) != dat_33183));
  v2 = (unsigned long)v1;
  v1 = !(((void *)((long)a1 - v2) <= a0) || (*(char *)((long)a1 + ~v2) != '\r'));
  v2 = (long)a1 + (-(long)a0 - (v2 + (long)v1));
  v3 = a0;
  if (1 <= (long)v2) {
    sub_6b1e(a2);
    sub_6d74(a0,1,v2);
...
long sub_87e9(unsigned int a0,struct_13 *a1,char *a2) // early-return x3, warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_87e9
{
  bool v1;
  char v10; // stack - 0x5e
  long v11; // stack - 0x58
...
unsigned long sub_8e14(void *a0,void *a1,unsigned char a2) // return-dupe, ternary, warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_8e14
{
  int v1;
  stat *v10; // stack - 0xc0
  char *v2;
  ...
  v9 = (*(long *)((long)a1 + 0x58) == 0 & a2) != 0;
  if (*(short *)((long)a1 + 0x68) == 6)
    return 1;
  if (!v9) {
    v5 = !(((*(short *)((long)a1 + 0x68) != 1) && (*(short *)((long)a1 + 0x68) != 2)) && (*(short *)((long)a1 + 0x68) != 4));
    if (sub_7337((char *)((long)a1 + 0x100),0,v5)) {
      sub_1e92f(a0,a1,4);
      return 1;
    }
  }
  dat_337c0 = *(long *)((long)a1 + 0x38);
  if ((dat_337c8) && (*(char *)(dat_337c0 + 1)))
    dat_337c0 += 2;
  v3 = dat_337c0;
  v4 = ((*(unsigned int *)((long)a0 + 0x48) & 2) || ((*(unsigned int *)((long)a0 + 0x48) & 1 && (v9))));
  switch(*(unsigned short *)((long)a1 + 0x68)) {
    default:
      abort(); // no-return
    case 1:
      if (dat_33010 == 3)
    ...
    case 7:
    case 10:
      sub_6edf(*(unsigned int *)((long)a1 + 0x40));
      return 1;
    case 8:
    case 0xd:
      break;
  ...
  v7 = sub_91bc(*(unsigned int *)((long)a0 + 0x2c),*(unsigned long *)((long)a1 + 0x30),v4,v9);
  return v7;
}
...
void sub_9361(int a0,struct_12 *a1,char a2) // return-dupe
{
  bool v1;
...
unsigned char sub_9456(int a0,unsigned char a1) // ternary
{
  ...
  if (fstat(a0,&v5)) // branch-flip
    ...
    if (((a0) && (dat_33010 == 3)) && ((v5._24_4_ & 0xf000) == 0x4000)) {
      ...
      v6 = dat_337c0;
      v13 = 0;
      v10 = (struct_16 *)sub_1d975(&v6,v9,0);
      if (v10) {
        while( true ) {
          v11 = (void *)sub_1e2b9(v10);
          if (!v11) break;
...
int main(int argc,char **argv,char **envp) // ternary x3, warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in main
{
  ...
  sub_112dd(NULL);
  v23 = 0;
  dat_33790 = sub_208d6(0,NULL,sub_6760,sub_67f8,0);
  if (!dat_33790)
    sub_27122(); // no-return
label_b57f:
  do {
...
unsigned long * sub_c03f(char *a0,long a1)
{
  ...
  struct_48 *v6; // stack - 0x30
  void *v7; // stack - 0x28
  unsigned long v8; // stack - 0x20
  
  v3 = NULL;
  v2 = 0;
  v6 = (struct_48 *)sub_f7c8(1);
  v4 = a0;
  do {
    v7 = rawmemchr(v4,10);
    v5 = (long)v7 - (long)v4;
...
long sub_c23c(unsigned long *a0,void *a1,long a2,long *a3,void *a4)
{
  long *v1;
  long v10; // stack - 0x88
  void *v11; // stack - 0x90
  ...
  v2 = dat_33183;
  v18 = (struct_45 *)*a0;
  v13 = (unsigned char)((dat_33182 ^ 1) & dat_331a0 & (dat_331a2 ^ 1)) != 0;
  v6 = (v13 || a4) | dat_33181;
  v3 = dat_33182 ^ 1;
  if (a4) // branch-flip
    v11 = a4;
  ...
  v17 = a0;
  do {
    if (((void *)((long)a1 + a2) < v14) || (v19 = sub_f585(v18,(long)v14 - (unsigned long)dat_33182,(long)a1 + (unsigned long)dat_33182 + (a2 - (long)v14),v9,(v3 & v6) != 0), v19 < 0))
      return -1;
    v16 = v21 - (int)((unsigned int)dat_33182 * 2);
    v10 = 0;
    if ((v13) && (v7 = (char *)(v19 + (long)v14), sub_f84a(&v11,&v10,v7,a2 + (long)a1)))
      v14 = (void *)((long)v11 + -1);
    else {
      v14 = (void *)((long)v14 + v19);
...
label_c7f0:
      ...
      if (dat_33182) {
        v16 += (unsigned long)(a4 == NULL);
        goto label_c7f0;
      }
      if (dat_33181 != 1) {
label_c73e:
        if ((unsigned long)((long)a1 + a2) <= (unsigned long)(v16 + (long)v14)) // branch-flip
          v15 = (long)a1 + a2;
        else {
          v8 = (void *)((long)v14 + v16);
          v15 = (long)rawmemchr(v8,(int)v2) + 1;
        }
label_c79b:
        v8 = memrchr(a1,(int)v2,(long)v14 - (long)a1);
        if (v8) // branch-flip
          v14 = (void *)((long)v8 + 1);
        else {
          v14 = a1;
      ...
      if (!v10) {
        v20 = memrchr(v11,(int)v2,(long)v14 - (long)v11);
        if (v20)
          v11 = (void *)((long)v20 + 1);
      }
      if (1 <= v10) // branch-flip
        v4 = sub_fbe0((long)v14 - v10,a2 + (long)a1);
      else {
        v4 = sub_fc0e(v11,v14,a2 + (long)a1);
      }
      if (!v4) {
        while( true ) {
          v4 = (long)v14 + v16;
          ...
          if (!v16) goto label_c6dc;
          v16 -= 1;
          if (sub_f585(v18,v14,v16,v12,1)) goto label_c6dc;
          v16 = v22;
        }
        if (!v17[4]) {
          sub_a32f(&v17[2],&v17[3]);
          v5 = sub_5661((char *)v17[2],v17[3],0x10a46,0);
          v17[4] = v5;
        }
        if ((unsigned long)((long)a1 + a2) <= (unsigned long)(v16 + (long)v14)) // branch-flip
          v15 = (long)a1 + a2;
        ...
        v4 = v15 - (long)v14;
        v1 = (long *)v17[4];
        if (0 <= (long)sub_5d23(v1,v14,v4,a3,NULL)) goto label_c79b;
        v14 = (void *)(v15 + -1);
      }
label_c6dc:
      v4 = sub_fbb2(v14,a2 + (long)a1);
      v11 = (void *)((long)v14 + v4);
      v14 = v11;
    }
    v14 = (void *)((long)v14 + 1);
  } while( true );
...
unsigned long sub_d633(struct_48 *a0)
{
...
void sub_d6b4(struct_31 *a0,void *a1,unsigned long a2,char a3) // return-dupe, ternary
{
  void *v1; // stack - 0x28
...
void sub_d7f4(struct_33 *a0,long a1,long a2) // return-dupe x2
{
  if (!a0)
    return;
...
unsigned long sub_d883(unsigned long *a0,struct_31 *a1) // early-return x3
{
  unsigned long v1;
  unsigned int v2; // eax
  unsigned long *v3;
...
void sub_d943(struct_33 *a0,long a1) // return-dupe
{
  if (!a0)
    return;
...
void sub_d9b5(unsigned long *a0) // return-dupe
{
  ...
  for (v18 = v8; v18; v18 = (long *)v18[3]) {
    sub_d649((unsigned long *)v18[1],&v8);
    sub_d7f4((struct_33 *)v18[1],v18[5],v24);
    sub_d6b4((struct_31 *)v18[1],(void *)v18[4],a0[0xc],v12);
    if (v12) {
      v18[6] = a0[0xd];
      v18[7] = a0[0xd];
  ...
  memset(v34,0,0x800);
  sub_d943(*(struct_33 **)(a0[0xc] + 8),v34);
  v13 = 0xfffffffe;
  v14 = 0xffffffff;
...
unsigned long sub_e78b(unsigned long *a0,unsigned long a1,long a2,long a3,long a4,char a5,unsigned int a6,long a7,void *a8) // return-dupe
{
  char v1;
  char v2;
  char v3; // al
  ...
  do {
    ...
    v5 = *(long *)(v7 * 8 + -0x10 + *(long *)((long)a8 + 0x978));
    v4 += v5;
...
char * sub_e9c2(char *a0,long a1,void *a2) // early-return
{
  char v1;
  unsigned int v2;
  unsigned int v3;
  ...
  v4 = &a0[a1];
  v5 = a0;
  if (0 <= *(int *)((long)a2 + 0x98c)) {
    while( true ) {
      if (v4 <= v5)
        return NULL;
      v1 = *v5;
      if (*(long *)((long)a2 + ((long)(int)(unsigned int)(unsigned char)sub_c845((int)v1) + 0x2e) * 8)) break;
      v5 = &v5[1];
      if (!((unsigned long)v5 % 0x10)) {
        v2 = *(unsigned int *)((long)a2 + 0x98c);
...
long sub_eae1(void *a0,long a1,long a2) // early-return x3
{
  char v1;
  long v10; // stack - 0x38
  long v11; // stack - 0x30
  ...
  v9 = *(long *)((long)a0 + 0x68);
  v10 = *(long *)((long)a0 + 0x980);
  if (!v9)
    return 0;
  if (a2 < v9)
    return -1;
  if (v9 != 1) { // branch-flip
    v11 = (long)a0 + 0x70;
    v12 = v9 + *(long *)((long)a0 + 0x970);
    v6 = a1 + v9;
    v2 = (char)*(unsigned int *)((long)a0 + 0x988);
    v1 = *(char *)((long)a0 + 0x990);
    v8 = v9 * 0xc;
...
unsigned long sub_f061(void *a0,long a1,long a2,unsigned long *a3)
{
  unsigned long v1; // rax
  
  if (*(long *)((long)a0 + 0x980)) // branch-flip
  ...
  *a3 = 0;
  a3[1] = v1;
  a3[2] = *(unsigned long *)((long)a0 + 0x68);
  return v1;
}

// Function: sub_f0f4 @ 0xf0f4
long sub_f0f4(void *a0,char *a1,long a2,long *a3,bool a4) // early-return x5, ternary x2
{
  char v1;
...
label_f17b:
    if (0 <= v2) { // branch-flip
      ...
      if (!v6)
        return -1;
      v1 = *v6;
      v7 = *(long **)((long)a0 + ((long)(int)(unsigned int)(unsigned char)sub_c863(v3,(int)v1) + 0x2e) * 8);
      v9 = &v6[1];
    }
    else {
      while( true ) {
    ...
    do {
      ...
      while (v4 != *(unsigned char *)&v11[3]) {
        ...
        if (!v11) {
          v7 = (long *)v7[4];
          if (!v7) {
            v7 = *(long **)((long)a0 + ((long)(int)(unsigned int)v4 + 0x2e) * 8);
            v9 = v6;
...
void sub_f50c(void *a0,char *a1,long a2,long *a3,char a4) // return-dupe
{
  if (*(long *)((long)a0 + 0x980)) {
...
void sub_f585(struct_45 *a0,unsigned long a1,unsigned long a2,unsigned long a3,char a4)
{
  (*a0->field_0x998)(a0,a1,a2,a3,(unsigned char)a4);
}
...
unsigned long sub_fc0e(void *a0,void *a1,long a2) // early-return
{
  unsigned char *v1;
  unsigned char v2; // al
  unsigned long v3; // rax
...
unsigned short sub_11696(long a0,struct_43 *a1)
{
  short v1;
  
  v1 = *(short *)(a0 * 0x48 + a1->field_0x128 + 0x22);
  return CONCAT11((char)((unsigned short)v1 >> 8),v1 != 0);
}

// Function: sub_116d2 @ 0x116d2
void sub_116d2(unsigned int a0,unsigned int a1,long a2,struct_43 *a3)
{
  sub_115e0(*(unsigned short *)(a2 * 0x48 + a3->field_0x128 + 0x22),a0,a1);
}
...
long sub_11a76(struct_38 *a0,unsigned long *a1)
{
  unsigned long *v1;
  long v2;
  void *v3;
...
long sub_11e3e(void *a0) // early-return x2, ternary x3
{
  unsigned int v1;
  char v10 [32];
  ...
  *(unsigned long *)((long)a0 + 0x68) = 0;
  ...
  if (v13) {
    v16 = sub_11d5f(a0);
    v15 = *(char *)((long)a0 + 0x419);
  }
  v17 = *(int *)((long)a0 + 0x48);
  v14 = v16 == 0x3a;
  do {
    v18 = 0x100;
    v14 &= 0xfd;
...
label_1217c:
      if ((v16 == 0x5c) && (*(unsigned long *)((long)a0 + 0x1c0) & 1)) {
        v16 = sub_11d5f(a0);
        v17 = *(int *)((long)a0 + 0x48);
      }
      if (v18 == 0x100) {
      ...
      if (v18 == 0x2d) {
        ...
        if ((v22 == 0x5b) && (**(char **)((long)a0 + 0x20) == '.')) {
          v15 = '\0';
          v22 = 0x5d;
        }
        if (v22 != 0x5d) { // branch-flip
          if ((v22 == 0x5c) && (*(unsigned long *)((long)a0 + 0x1c0) & 1)) {
            v22 = sub_11d5f(a0);
            v23 = *(int *)((long)a0 + 0x48);
          }
          v14 |= 8;
          ...
          if ((v17 != v23) || (v17 == -1)) {
            ...
            for (v24 = v16; v24 <= v22; v24 = v24 + 1) {
              if ((*(char *)((long)a0 + 0x1cd)) && (*(unsigned short *)((long)v24 * 2 + *(long *)__ctype_b_loc()) & 0x400))
                sub_11c6d(v24,v10);
              else {
                sub_11834(v24,v10);
              }
      ...
      v14 |= v3;
      if (*(char *)((long)a0 + 0x418) != '\x01') { // branch-flip
        if ((*(char *)((long)a0 + 0x1cd)) && (*(unsigned short *)((long)v16 * 2 + *(long *)__ctype_b_loc()) & 0x400))
          sub_11c6d(v16,v10);
        else {
          sub_11834(v16,v10);
        }
        ...
        v5 = (*(char *)((long)a0 + 0x1cd)) ? sub_1c01a(v17,v12) + 1 : 1; // branch-flip
        v26 = v17;
        for (v25 = 0; v25 < v5; v25 = v25 + 1) {
          v1 = *(unsigned int *)&v12[(long)v25 * 4 + -4];
          if (sub_11c28(v1,v10) != '\x01') {
            v7 = *(long *)((long)a0 + 0x68);
            v2 = *(void **)((long)a0 + 0x60);
            *(unsigned long *)((long)a0 + 0x60) = sub_11a1e(v2,v7,(long *)((long)a0 + 0x70),-1,4);
            v7 = *(long *)((long)a0 + 0x68);
            *(long *)((long)a0 + 0x68) = v7 + 1;
            *(unsigned int *)(*(long *)((long)a0 + 0x60) + v7 * 4) = *(unsigned int *)&v12[(long)v25 * 4 + -4];
          }
        }
      }
      else {
      ...
      v18 = sub_11d5f(a0);
      v19 = *(int *)((long)a0 + 0x48);
      if ((((v18 != 0x3a) || (!(*(unsigned long *)((long)a0 + 0x1c0) & 4))) && (v18 != 0x2e)) && (v18 != 0x3d)) goto label_1217c;
      v20 = 0;
      while ((v4 = sub_11d5f(a0), *(long *)((long)a0 + 0x28) && ((v4 != v18 || (**(char **)((long)a0 + 0x20) != ']'))))) {
      ...
      if (v18 != 0x3a) // branch-flip
        ...
        if ((*(char *)((long)a0 + 0x1cd)) && ((sub_11536(v11,"upper") || (sub_11536(v11,"lower")))))
          v6 = "alpha";
        else {
          v6 = v11;
        }
        ...
        if ((*(char *)((long)a0 + 0x418)) && (*(char *)(v7 + 0x10) != '\x01'))
          v15 = '\0';
        else {
...
label_125c8:
    ...
    if (v18 == 0x5d) {
      if (v14 == 7) {
        v9 = (*(unsigned int *)((long)a0 + 0x1c8) & 4) ? sub_513f : sub_5174; // branch-flip
        (*v9)(gettext("character class syntax is [[:space:]], not [:space:]"));
      }
      if (v15 != '\x01')
        return 0x112;
      if ((*(char *)((long)a0 + 0x418)) && ((v13 || (*(long *)((long)a0 + 0x68))))) {
        *(bool *)((long)a0 + 0x58) = v13;
        if (sub_119db(v10)) // branch-flip
          v8 = 0xffffffffffffffff;
        else {
          v8 = sub_11a76(a0,v10);
        }
        *(unsigned long *)((long)a0 + 0x50) = v8;
        return 0x113;
      }
      if ((v13) && (sub_11934(v10), *(unsigned long *)((long)a0 + 0x1c0) & 0x100))
        sub_11882(10,v10);
...
void sub_1274c(void *a0,struct_3 *a1,char *a2)
{
...
void sub_127a9(void *a0,struct_3 *a1)
{
  *(unsigned long *)((long)a0 + 0x20) = a1->field_0x0;
  *(unsigned long *)((long)a0 + 0x28) = a1->field_0x8;
}

// Function: sub_127db @ 0x127db
unsigned long sub_127db(void *a0) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_127db
{
  char *v1;
  char v10 [16];
  char v11 [104];
...
label_13bcb:
  ...
  if (!*(long *)((long)a0 + 0x28)) {
    *(unsigned long *)((long)a0 + 0x30) = 0xffffffffffffffff;
    return *(unsigned long *)((long)a0 + 0x30);
  }
  v17 = sub_11cc7(a0);
  switch(v17) {
    case 10:
      if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x800)) goto label_1395f;
      if (!v12) {
        *(char *)((long)a0 + 0x78) = 1;
    ...
    default:
      goto label_1395f;
    case 0x24:
      if ((!v12) && (((((*(unsigned long *)((long)a0 + 0x1c0) & 8 || (!*(long *)((long)a0 + 0x28))) || (((long)(unsigned long)((*(unsigned long *)((long)a0 + 0x1c0) & 0x2000) == 0) < *(long *)((long)a0 + 0x28) && (*(char *)((unsigned long)(**(char **)((long)a0 + 0x20) == '\\' && !(*(unsigned long *)((long)a0 + 0x1c0) & 0x2000)) + *(long *)((long)a0 + 0x20)) == ')')))) || (((long)(unsigned long)((*(unsigned long *)((long)a0 + 0x1c0) & 0x8000) == 0) < *(long *)((long)a0 + 0x28) && (*(char *)((unsigned long)(**(char **)((long)a0 + 0x20) == '\\' && !(*(unsigned long *)((long)a0 + 0x1c0) & 0x8000)) + *(long *)((long)a0 + 0x20)) == '|')))) || ((*(unsigned long *)((long)a0 + 0x1c0) & 0x800 && ((1 <= *(long *)((long)a0 + 0x28) && (**(char **)((long)a0 + 0x20) == '\n')))))))) {
    ...
    case 0x27:
      ...
      if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x80000)) {
        *(unsigned long *)((long)a0 + 0x30) = 0x10d;
        return *(unsigned long *)((long)a0 + 0x30);
      }
      goto label_1398c;
    case 0x28:
      if (v12 == ((*(unsigned long *)((long)a0 + 0x1c0) & 0x2000) == 0)) {
      ...
      goto label_13ace;
    case 0x29:
      if ((v12 == ((*(unsigned long *)((long)a0 + 0x1c0) & 0x2000) == 0)) && ((*(long *)((long)a0 + 0x38) || (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x20000))))) {
        *(long *)((long)a0 + 0x38) = *(long *)((long)a0 + 0x38) + -1;
        *(char *)((long)a0 + 0x78) = 0;
    ...
    case 0x2a:
      ...
      if (*(char *)((long)a0 + 0x78)) {
        if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x10)) goto label_1395f;
        if (*(unsigned int *)((long)a0 + 0x1c8) & 0x10)
          sub_5174(gettext("* at start of expression"));
      }
      *(unsigned long *)((long)a0 + 0x30) = 0x102;
      return *(unsigned long *)((long)a0 + 0x30);
    case 0x2b:
      if (*(unsigned long *)((long)a0 + 0x1c0) & 0x400) goto label_1395f;
      if (v12 != ((*(unsigned long *)((long)a0 + 0x1c0) & 2) != 0)) goto label_13ace;
      if (*(char *)((long)a0 + 0x78)) {
        if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x10)) goto label_1395f;
        if (*(unsigned int *)((long)a0 + 0x1c8) & 0x20)
          sub_5174(gettext("+ at start of expression"));
      }
    ...
    case 0x2e:
      if (!v12) {
        if (*(long *)((long)a0 + 0x18) <= -1) {
          sub_118fc(v9);
          if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x40))
            sub_11882(10,v9);
          if (*(unsigned long *)((long)a0 + 0x1c0) & 0x80)
            sub_11882(0,v9);
          if (*(char *)((long)a0 + 0x418)) {
            for (v14 = 0; v14 <= 0xff; v14 = v14 + 1) {
              if (*(int *)((long)a0 + ((long)v14 + 0x144) * 4 + 0xc) == -1)
                sub_11882(v14,v9);
            }
          }
          *(unsigned long *)((long)a0 + 0x18) = sub_11a76(a0,v9);
        }
        *(char *)((long)a0 + 0x78) = 0;
        if (*(char *)((long)a0 + 0x418)) // branch-flip
          v8 = 0x10a;
        else {
          v8 = *(long *)((long)a0 + 0x18) + 0x114;
        }
        *(long *)((long)a0 + 0x30) = v8;
        return *(unsigned long *)((long)a0 + 0x30);
      }
      goto label_13ace;
    case 0x31:
    ...
    case 0x39:
      if (v12 != 1) goto label_13ace;
      if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x4000)) {
        *(char *)((long)a0 + 0x78) = 0;
    ...
    case 0x73:
      if (v12 != 1) goto label_13ace;
      if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x80000)) {
        if (*(char *)((long)a0 + 0x418) == '\x01') {
          sub_1274c(a0,v10,&"^[:space:]]"[(int)(unsigned int)(v17 == 0x73)]);
          *(unsigned long *)((long)a0 + 0x30) = sub_11e3e(a0);
          sub_127a9(a0,v10);
          *(char *)((long)a0 + 0x78) = 0;
          return *(unsigned long *)((long)a0 + 0x30);
        }
        ...
        if (v17 == 0x53)
          sub_11934(v9);
        *(char *)((long)a0 + 0x78) = 0;
        *(long *)((long)a0 + 0x30) = sub_11a76(a0,v9) + 0x114;
        return *(unsigned long *)((long)a0 + 0x30);
      }
      goto label_1398c;
    case 0x57:
    case 0x77:
      ...
      if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x80000)) {
        ...
        for (v16 = 0; v16 <= 0xff; v16 = v16 + 1) {
          if (*(char *)((long)a0 + (long)v16 + 0x1cf) == '\x02')
            sub_11834(v16,v9);
        }
        if (v17 == 0x57)
          sub_11934(v9);
    ...
    case 0x7d:
      goto label_13ace;
    case 0x5e:
      if ((!v12) && ((((*(unsigned long *)((long)a0 + 0x1c0) & 8 || (*(long *)((long)a0 + 0x30) == -1)) || (*(long *)((long)a0 + 0x30) == 0x107)) || (*(long *)((long)a0 + 0x30) == 0x106)))) {
    ...
    case 0x7c:
      if (*(unsigned long *)((long)a0 + 0x1c0) & 0x400) goto label_1395f;
      if (v12 == ((*(unsigned long *)((long)a0 + 0x1c0) & 0x8000) == 0)) {
        *(char *)((long)a0 + 0x78) = 1;
        *(unsigned long *)((long)a0 + 0x30) = 0x106;
        return *(unsigned long *)((long)a0 + 0x30);
      }
...
label_12eeb:
  if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x200)) goto label_1395f;
  if (v12 != ((*(unsigned long *)((long)a0 + 0x1c0) & 0x1000) == 0)) goto label_13ace;
  v18 = *(char **)((long)a0 + 0x20);
  v6 = &v18[*(long *)((long)a0 + 0x28)];
  *(unsigned int *)((long)a0 + 0x44) = 0xffffffff;
  *(unsigned int *)((long)a0 + 0x40) = *(unsigned int *)((long)a0 + 0x44);
  while ((v18 != v6 && (v2 = *v18, sub_11564((int)v2)))) {
    if (0 <= *(int *)((long)a0 + 0x40)) { // branch-flip
      v4 = (int)*v18 + *(int *)((long)a0 + 0x40) * 10;
      if (0x8031 <= v4)
        v4 = 0x8030;
    }
    else {
    ...
    *(int *)((long)a0 + 0x40) = v4 + -0x30;
    v18 = &v18[1];
  }
  if (v18 != v6) {
    if (*v18 != ',') // branch-flip
      *(unsigned int *)((long)a0 + 0x44) = *(unsigned int *)((long)a0 + 0x40);
    else {
      if (*(int *)((long)a0 + 0x40) <= -1)
        *(unsigned int *)((long)a0 + 0x40) = 0;
      while ((v18 = &v18[1], v18 != v6 && (v2 = *v18, sub_11564((int)v2)))) {
        if (0 <= *(int *)((long)a0 + 0x44)) { // branch-flip
          v4 = (int)*v18 + *(int *)((long)a0 + 0x44) * 10;
          if (0x8031 <= v4)
            v4 = 0x8030;
        }
        else {
        ...
        *(int *)((long)a0 + 0x44) = v4 + -0x30;
      }
    }
  }
  v3 = ((((v12) && ((v18 == v6 || (v1 = &v18[1], v2 = *v18, v18 = v1, v2 != '\\')))) || (v18 == v6)) || (((v1 = &v18[1], v2 = *v18, v18 = v1, v2 != '}' || (*(int *)((long)a0 + 0x40) <= -1)) || ((0 <= *(int *)((long)a0 + 0x44) && (*(int *)((long)a0 + 0x44) < *(int *)((long)a0 + 0x40)))))));
  if ((!v3) || (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x200000))) {
    if (*(char *)((long)a0 + 0x78)) {
      if (!(*(unsigned long *)((long)a0 + 0x1c0) & 0x10)) {
label_1395f:
        if (v12 != 1) goto label_13ace;
label_1398c:
        if (*(unsigned int *)((long)a0 + 0x1c8) & 8) {
          v5 = *(unsigned int *)((long)a0 + 0x48);
    ...
    if (0x8000 <= *(int *)((long)a0 + 0x44))
      sub_513f(gettext("regular expression too big")); // no-return
    *(char **)((long)a0 + 0x20) = v18;
    *(long *)((long)a0 + 0x28) = (long)v6 - (long)v18;
    *(char *)((long)a0 + 0x78) = 0;
    *(unsigned long *)((long)a0 + 0x30) = 0x104;
    v7 = *(unsigned long *)((long)a0 + 0x30);
  }
  else {
label_13ace:
    *(char *)((long)a0 + 0x78) = 0;
    ...
    else if ((*(char *)((long)a0 + 0x1cd)) && (*(unsigned short *)((long)v17 * 2 + *(long *)__ctype_b_loc()) & 0x400)) {
      sub_118d3(v9);
      sub_11c6d(v17,v9);
      *(long *)((long)a0 + 0x30) = sub_11a76(a0,v9) + 0x114;
      v7 = *(unsigned long *)((long)a0 + 0x30);
...
void sub_13bf7(void *a0,unsigned long a1,char a2) // return-dupe x3
{
  void *v1;
  unsigned long v2;
  long v3;
  
  if (*(long *)((long)a0 + 0xa0) == *(long *)((long)a0 + 0x98)) {
    v1 = *(void **)((long)a0 + 0x90);
    *(unsigned long *)((long)a0 + 0x90) = sub_26dc6(v1,(long *)((long)a0 + 0xa0),1,-1,8);
    if (*(char *)((long)a0 + 0x418)) {
      v2 = *(unsigned long *)((long)a0 + 0xa0);
      v1 = *(void **)((long)a0 + 0x118);
      *(unsigned long *)((long)a0 + 0x118) = sub_26bd0(v1,v2,1);
    }
  }
  if (*(char *)((long)a0 + 0x418))
    *(char *)(*(long *)((long)a0 + 0x118) + *(long *)((long)a0 + 0x98)) = a2;
  v3 = *(long *)((long)a0 + 0x98);
  *(long *)((long)a0 + 0x98) = v3 + 1;
  *(unsigned long *)(*(long *)((long)a0 + 0x90) + v3 * 8) = a1;
  switch(a1) {
    case 0x100:
      *(char *)((long)a0 + 0xc1) = 1;
      goto label_13d9a;
...
label_13d9a:
  *(long *)((long)a0 + 0x88) = *(long *)((long)a0 + 0x88) + 1;
  if (*(long *)((long)a0 + 0xa8) < *(long *)((long)a0 + 0x88)) {
    *(unsigned long *)((long)a0 + 0xa8) = *(unsigned long *)((long)a0 + 0x88);
    return;
  }
}

// Function: sub_13dee @ 0x13dee
void sub_13dee(void *a0,long a1)
{
  bool v1;
  long v2; // stack - 0x10
  ...
  if ((*(char *)((long)a0 + 0x418)) && (a1 == 0x113)) {
    v1 = 0;
    for (v2 = 0; v2 < *(long *)((long)a0 + 0x68); v2 = v2 + 1) {
      sub_13ef3(a0,*(unsigned int *)(v2 * 4 + *(long *)((long)a0 + 0x60)));
      if (v1)
        sub_13dee(a0,0x106);
      v1 = 1;
    }
    *(unsigned long *)((long)a0 + 0x68) = 0;
    if (*(long *)((long)a0 + 0x50) != -1) {
      sub_13dee(a0,*(long *)((long)a0 + 0x50) + 0x114);
      if (v1)
        sub_13dee(a0,0x106);
    }
  }
...
void sub_13ef3(void *a0,int a1) // ternary x2
{
  unsigned long v1; // rax
...
void sub_13fe9(void *a0)
{
  ...
  if (!*(long *)((long)a0 + 200)) {
    ...
    if (*(unsigned long *)((long)a0 + 0x1c0) & 0x80)
      sub_11882(0,&v1);
    *(long *)((long)a0 + 200) = sub_11a76(a0,&v1) + 0x114;
    for (v2 = 1; v2 <= 8; v2 = v2 + 1) {
      *(long *)((long)a0 + ((long)(int)v2 + 0x18) * 8 + 8) = sub_11a76(a0,(unsigned long *)((long)(int)v2 * 0x20 + 0x2b020)) + 0x114;
    }
  }
  sub_13dee(a0,*(long *)((long)a0 + 200));
  sub_13dee(a0,*(long *)((long)a0 + 0xd0));
  sub_13dee(a0,0xe0);
  sub_13dee(a0,*(long *)((long)a0 + 0xe0));
  sub_13dee(a0,0x105);
  sub_13dee(a0,0x106);
  sub_13dee(a0,0xed);
  sub_13dee(a0,*(long *)((long)a0 + 0xf0));
  sub_13dee(a0,0x105);
  sub_13dee(a0,0x106);
  sub_13dee(a0,*(long *)((long)a0 + 0xe8));
  sub_13dee(a0,0xf0);
  sub_13dee(a0,*(long *)((long)a0 + 0xf8));
  sub_13dee(a0,0x105);
  sub_13dee(a0,0x106);
  sub_13dee(a0,0xf4);
  sub_13dee(a0,*(long *)((long)a0 + 0x108));
  sub_13dee(a0,0x105);
  sub_13dee(a0,0x106);
  sub_13dee(a0,*(long *)((long)a0 + 0x100));
  for (v3 = 0; v3 <= 2; v3 = v3 + 1) {
    sub_13dee(a0,*(long *)((long)a0 + 0xd8));
    sub_13dee(a0,0x105);
    sub_13dee(a0,0x106);
  }
}
...
void sub_1430d(void *a0) // return-dupe x3
{
  int v1; // eax
  unsigned int v2 [34];
  int v3; // stack - 0xa0
  
  if ((((((0 <= *(long *)((long)a0 + 0x80)) && (*(long *)((long)a0 + 0x80) <= 0xff)) || (0x113 < *(long *)((long)a0 + 0x80))) || (((*(long *)((long)a0 + 0x80) == 0x10b || (*(long *)((long)a0 + 0x80) == 0x112)) || ((*(long *)((long)a0 + 0x80) == 0x10c || ((*(long *)((long)a0 + 0x80) == 0x10d || (*(long *)((long)a0 + 0x80) == 0x10e)))))))) || (*(long *)((long)a0 + 0x80) == 0x10f)) || ((((*(long *)((long)a0 + 0x80) == 0x110 || (*(long *)((long)a0 + 0x80) == 0x111)) || (*(long *)((long)a0 + 0x80) == 0x10a)) || (*(long *)((long)a0 + 0x80) == 0x113)))) {
    if ((*(long *)((long)a0 + 0x80) != 0x10a) || (!*(char *)((long)a0 + 0x41a)))
      sub_13dee(a0,*(long *)((long)a0 + 0x80));
    else {
      sub_13fe9(a0);
    }
    *(unsigned long *)((long)a0 + 0x80) = sub_127db(a0);
    return;
  }
  if (*(long *)((long)a0 + 0x80) == 0x109) {
    if (*(int *)((long)a0 + 0x48) != -1) { // branch-flip
      sub_13ef3(a0,*(unsigned int *)((long)a0 + 0x48));
      if (*(char *)((long)a0 + 0x1cd)) {
        v1 = sub_1c01a(*(unsigned int *)((long)a0 + 0x48),v2);
...
long sub_146a2(struct_39 *a0,long a1) // early-return, return-dupe
{
  long v1;
  
  v1 = *(long *)(a1 * 8 + -8 + a0->field_0x90);
  if (0x103 < v1) {
...
void sub_14760(void *a0,long a1,long a2) // return-dupe
{
  long v1; // stack - 0x18
  long v2; // stack - 0x10
  ...
  if (*(char *)((long)a0 + 0x418)) {
    for (v1 = 0; v1 < a2; v1 = v1 + 1) {
      sub_13bf7(a0,*(unsigned long *)((v1 + a1) * 8 + *(long *)((long)a0 + 0x90)),(int)*(char *)(v1 + a1 + *(long *)((long)a0 + 0x118)));
    }
    return;
  }
  for (v2 = 0; v2 < a2; v2 = v2 + 1) {
    sub_13bf7(a0,*(unsigned long *)((v2 + a1) * 8 + *(long *)((long)a0 + 0x90)),3);
  }
}
...
void sub_14840(void *a0)
{
  ...
  sub_1430d(a0);
  while (((*(long *)((long)a0 + 0x80) == 0x101 || (*(long *)((long)a0 + 0x80) == 0x102)) || ((*(long *)((long)a0 + 0x80) == 0x103 || (*(long *)((long)a0 + 0x80) == 0x104))))) {
    if ((*(long *)((long)a0 + 0x80) != 0x104) || ((!*(int *)((long)a0 + 0x40) && (!*(int *)((long)a0 + 0x44))))) {
      if (*(long *)((long)a0 + 0x80) != 0x104) { // branch-flip
        sub_13dee(a0,*(long *)((long)a0 + 0x80));
        *(unsigned long *)((long)a0 + 0x80) = sub_127db(a0);
      }
      else {
        ...
        *(long *)((long)a0 + 0x98) = v1 - sub_146a2(a0,v2);
        *(unsigned long *)((long)a0 + 0x80) = sub_127db(a0);
        sub_14840(a0);
      }
    }
    else {
      v1 = sub_146a2(a0,*(long *)((long)a0 + 0x98));
      v2 = *(long *)((long)a0 + 0x98) - v1;
      if (*(int *)((long)a0 + 0x44) <= -1)
        sub_13dee(a0,0x103);
      if (!*(int *)((long)a0 + 0x40))
        sub_13dee(a0,0x101);
      for (v3 = 1; v3 < *(int *)((long)a0 + 0x40); v3 = v3 + 1) {
        sub_14760(a0,v2,v1);
        sub_13dee(a0,0x105);
      }
      for (; v3 < *(int *)((long)a0 + 0x44); v3 = v3 + 1) {
        sub_14760(a0,v2,v1);
        sub_13dee(a0,0x101);
        sub_13dee(a0,0x105);
      }
...
void sub_14aa7(struct_40 *a0)
{
  sub_14840(a0);
  while (((a0->field_0x80 != 0x108 && (a0->field_0x80 != 0x106)) && (0 <= a0->field_0x80))) {
    sub_14840(a0);
    sub_13dee(a0,0x105);
  }
}
...
void sub_14b1b(struct_40 *a0)
{
  sub_14aa7(a0);
  while (a0->field_0x80 == 0x106) {
    a0->field_0x80 = sub_127db(a0);
    sub_14aa7(a0);
    sub_13dee(a0,0x106);
  }
}
...
void sub_14ce2(struct_41 *a0,unsigned long *a1) // return-dupe
{
  long v1;
  long v2;
...
void sub_14de8(long a0,long a1,struct_38 *a2)
{
  long *v1;
  long v10; // stack - 0x30
  void *v2;
...
void sub_14f8b(unsigned long a0,unsigned long a1,struct_38 *a2)
{
  unsigned long *v1;
  long v2;
  void *v3;
...
void sub_15021(struct_6 *a0,struct_6 *a1,unsigned int a2,long *a3)
{
  unsigned int v1;
  long v2;
  long v3;
...
void sub_152c9(struct_6 *a0,struct_6 *a1,long *a2)
{
  sub_15021(a0,a1,0xffffffff,a2);
}

// Function: sub_15300 @ 0x15300
void sub_15300(struct_38 *a0,struct_6 *a1,struct_41 *a2) // return-dupe
{
  long *v1; // rax
  long v2; // stack - 0x10
...
unsigned int sub_1539a(long a0,struct_6 *a1)
{
  unsigned int v1;
  long v2;
  unsigned long v3;
...
void sub_154bd(struct_41 *a0,long a1,struct_6 *a2,unsigned int a3,struct_6 *a4) // return-dupe
{
...
long sub_15528(void *a0,struct_41 *a1,unsigned int a2)
{
  unsigned int v1;
  long v2;
  void *v3;
  ...
  v6 = 0;
  do {
    if (*(long *)((long)a0 + 0x130) <= v6) {
      for (v8 = 0; v8 < (long)a1->field_0x8; v8 = v8 + 1) {
        v1 = *(unsigned int *)(*(long *)(v8 * 0x10 + (long)a1->field_0x0) * 4 + *(long *)((long)a0 + 0x150));
        if (v1) { // branch-flip
          if (sub_115e0(v1,a2,7))
            v4 |= v1;
        }
        else if (*(long *)(*(long *)(v8 * 0x10 + (long)a1->field_0x0) * 8 + *(long *)((long)a0 + 0x90)) == 0x112)
          v4 = 0x1ff;
      }
      v2 = *(long *)((long)a0 + 0x130);
      v3 = *(void **)((long)a0 + 0x128);
      *(unsigned long *)((long)a0 + 0x128) = sub_11a1e(v3,v2,(long *)((long)a0 + 0x138),-1,0x48);
      *(unsigned long *)(*(long *)((long)a0 + 0x128) + v6 * 0x48) = v5;
      sub_14d9e((unsigned long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 8),a1->field_0x8);
      sub_14ce2(a1,(unsigned long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 8));
      *(char *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x20) = (char)a2;
      *(short *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x22) = (short)v4;
      *(unsigned long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x30) = 0;
      *(unsigned long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x28) = 0;
      *(unsigned long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) = 0xffffffffffffffff;
      *(long *)((long)a0 + 0x130) = *(long *)((long)a0 + 0x130) + 1;
      return v6;
    }
    if (((v5 == *(unsigned long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128))) && (a1->field_0x8 == *(long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x10))) && (a2 == *(unsigned char *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 0x20))) {
      for (v7 = 0; ((v7 < (long)a1->field_0x8 && (*(int *)((long)a1->field_0x0 + v7 * 0x10 + 8) == *(int *)(v7 * 0x10 + *(long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 8) + 8))) && (*(long *)(v7 * 0x10 + (long)a1->field_0x0) == *(long *)(v7 * 0x10 + *(long *)(v6 * 0x48 + *(long *)((long)a0 + 0x128) + 8)))); v7 = v7 + 1) {
      }
      if (v7 == a1->field_0x8)
        return v6;
    }
...
void sub_15999(void *a0,long a1)
{
  ...
  sub_14d9e(v1,*(unsigned long *)((long)a0 + 0xb0));
  v3 = 0;
  do {
    if (*(long *)((long)a0 + 0x98) <= v3) {
      free(v1[0]);
      return;
    }
    if (1 <= *(long *)(v3 * 0x18 + *(long *)((long)a0 + 0x140) + 8)) {
      switch(*(unsigned long *)(v3 * 8 + *(long *)((long)a0 + 0x90))) {
        case 0x100:
          v2 = 0x1ff;
          break;
        default:
      ...
      sub_1539a(v3,*(long *)((long)a0 + 0x140) + v3 * 0x18);
      for (v4 = 0; v4 < *(long *)(a1 + v3 * 0x18 + 8); v4 = v4 + 1) {
        sub_154bd(*(long *)((long)a0 + 0x140) + *(long *)(v4 * 0x10 + *(long *)(a1 + v3 * 0x18)) * 0x18,v3,*(long *)((long)a0 + 0x140) + v3 * 0x18,v2,v1);
      }
      for (v5 = 0; v5 < *(long *)(v3 * 0x18 + *(long *)((long)a0 + 0x140) + 8); v5 = v5 + 1) {
        sub_154bd(*(long *)(v5 * 0x10 + *(long *)(v3 * 0x18 + *(long *)((long)a0 + 0x140))) * 0x18 + a1,v3,v3 * 0x18 + a1,0x1ff,v1);
      }
    }
label_15c47:
    v3 += 1;
...
unsigned int sub_15d56(struct_42 *a0,struct_6 *a1)
{
  ...
  v1 = 0;
  for (v2 = 0; v2 < a1->field_0x8; v2 = v2 + 1) {
    v1 |= *(unsigned int *)(*(long *)(v2 * 0x10 + a1->field_0x0) * 4 + a0->field_0x158);
  }
  return v1;
}

// Function: sub_15dbb @ 0x15dbb
void sub_15dbb(void *a0,long a1,long a2,struct_41 *a3)
{
  long v1;
  long v10; // stack - 0x28
  unsigned long *v2;
  ...
  do {
    ...
    if (v3) {
      if (0 <= *(long *)(*(long *)(v9 * 0x10 + *(long *)(v4 + a1 * 0x18)) * 8 + *(long *)((long)a0 + 0x90))) { // branch-flip
        if ((v5 != a1) && (!(*(unsigned char *)(a2 + v5) & 6))) {
          for (v10 = 0; v10 < v8; v10 = v10 + 1) {
            v1 = *(long *)(v10 * 0x10 + *(long *)(v4 + a1 * 0x18));
            if ((((v1 != a1) && (v3 == *(int *)(v10 * 0x10 + *(long *)(v4 + a1 * 0x18) + 8))) && (!(*(unsigned char *)(a2 + v1) & 6))) && ((*(long *)(v5 * 8 + *(long *)((long)a0 + 0x90)) == *(long *)(v1 * 8 + *(long *)((long)a0 + 0x90)) && (!((*(unsigned char *)(a2 + v1) ^ *(unsigned char *)(a2 + v5)) & 1))))) {
              if (*(unsigned char *)(a2 + v5) & 1)
                sub_1539a(v5,(struct_6 *)(v5 * 0x18 + v4));
              sub_15300((struct_38 *)(v1 * 0x18 + v4),(struct_6 *)(v5 * 0x18 + v4),a3);
              break;
            }
          }
        ...
        *(unsigned int *)(a1 * 4 + *(long *)((long)a0 + 0x150)) = *(unsigned int *)(a1 * 4 + *(long *)((long)a0 + 0x150)) | *(unsigned int *)(v9 * 0x10 + *(long *)(v4 + a1 * 0x18) + 8);
      }
    }
label_16184:
    v9 += 1;
...
void sub_1622c(void *a0) // ternary
{
  long v1;
  long v10; // stack - 0x58
  long v11; // stack - 0x50
  ...
  v4 = (unsigned long *)sub_26c63(*(unsigned long *)((long)a0 + 0x98),8);
  v10 = 1;
  *v4 = 0;
  for (v11 = 1; v11 < *(long *)((long)a0 + 0x98); v11 = v11 + 1) {
    v4[v11] = 0xffffffffffffffff;
  }
  v5 = (void *)sub_26c63(*(unsigned long *)((long)a0 + 0xb0),8);
  v6 = (void *)sub_26c63(*(unsigned long *)((long)a0 + 0xb0),0x18);
  v7 = (void *)sub_26c63(*(unsigned long *)((long)a0 + 0xb0),4);
  v8 = (*(char *)((long)a0 + 0x418)) ? (void *)sub_26c63(*(unsigned long *)((long)a0 + 0xb0),1) : NULL; // branch-flip
  for (v12 = 0; v12 < *(long *)((long)a0 + 0x98); v12 = v12 + 1) {
    if (0 <= (long)v4[v12]) { // branch-flip
      *(unsigned long *)((long)v5 + v4[v12] * 8) = *(unsigned long *)(v12 * 8 + *(long *)((long)a0 + 0x90));
      v2 = (unsigned long *)(*(long *)((long)a0 + 0x140) + v12 * 0x18);
      v9 = (unsigned long *)(v4[v12] * 0x18 + (long)v6);
      v3 = v2[1];
      *v9 = *v2;
      v9[1] = v3;
      v9[2] = v2[2];
      *(unsigned int *)((long)v7 + v4[v12] * 4) = *(unsigned int *)(v12 * 4 + *(long *)((long)a0 + 0x150));
      if (v8)
        *(char *)((long)v8 + v4[v12]) = *(char *)(v12 + *(long *)((long)a0 + 0x118));
      for (v13 = 0; v13 < *(long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140) + 8); v13 = v13 + 1) {
        if (v4[*(long *)(v13 * 0x10 + *(long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140)))] == -1) {
          v1 = v10 + 1;
          v4[*(long *)(v13 * 0x10 + *(long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140)))] = v10;
          v10 = v1;
        }
        *(unsigned long *)(*(long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140)) + v13 * 0x10) = v4[*(long *)(v13 * 0x10 + *(long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140)))];
      }
      qsort(*(unsigned long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140)),*(unsigned long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140) + 8),0x10,sub_161d8);
    }
    else {
      free(*(void **)(v12 * 0x18 + *(long *)((long)a0 + 0x140)));
      *(unsigned long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140)) = 0;
      *(unsigned long *)(v12 * 0x18 + *(long *)((long)a0 + 0x140) + 8) = 0;
    }
  }
  for (v14 = 0; v14 < v10; v14 = v14 + 1) {
    *(unsigned long *)(*(long *)((long)a0 + 0x90) + v14 * 8) = *(unsigned long *)(v14 * 8 + (long)v5);
    v2 = (unsigned long *)(v14 * 0x18 + (long)v6);
    v9 = (unsigned long *)(*(long *)((long)a0 + 0x140) + v14 * 0x18);
    v3 = v2[1];
    *v9 = *v2;
    v9[1] = v3;
    v9[2] = v2[2];
    *(unsigned int *)(*(long *)((long)a0 + 0x150) + v14 * 4) = *(unsigned int *)(v14 * 4 + (long)v7);
    if (v8)
      *(char *)(*(long *)((long)a0 + 0x118) + v14) = *(char *)(v14 + (long)v8);
  }
  *(long *)((long)a0 + 0xb0) = v10;
  *(unsigned long *)((long)a0 + 0x98) = *(unsigned long *)((long)a0 + 0xb0);
  free(v5);
  free(v6);
  free(v7);
  free(v8);
...
void sub_1681a(void *a0)
{
  ...
  v3 = (unsigned char *)sub_26fa5(*(unsigned long *)((long)a0 + 0x98));
  for (v5 = 0; v5 < *(long *)((long)a0 + 0x98); v5 = v5 + 1) {
    for (v6 = 0; v6 < *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140) + 8); v6 = v6 + 1) {
      if (v5 != *(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))) { // branch-flip
        if (v5 <= *(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))) { // branch-flip
          v1 = *(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)));
          v3[v1] = v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] & 8;
          if (v3[v1]) // branch-flip
            v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] = v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] | 4;
          else {
            v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] = v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] | 8;
          }
        }
        else {
          v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] = v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] | 2;
        }
      }
      else {
        v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] = v3[*(long *)(v6 * 0x10 + *(long *)(v5 * 0x18 + *(long *)((long)a0 + 0x140)))] | 1;
      }
    }
  }
  *v3 = *v3 | 0x10;
  sub_14d9e(v4,*(unsigned long *)((long)a0 + 0xb0));
  v2 = *(unsigned long *)((long)a0 + 0x98);
  *(unsigned long *)((long)a0 + 0x150) = sub_26ff9(v2,4);
  for (v7 = 0; v7 < *(long *)((long)a0 + 0x98); v7 = v7 + 1) {
    if (v3[v7] & 0x10)
...
void sub_16c9f(void *a0,char a1) // ternary
{
  unsigned int v1;
  ...
  v7 = (long *)sub_26c63(*(unsigned long *)((long)a0 + 0xb0),0x20);
  v12 = v7;
  v13 = &v7[*(long *)((long)a0 + 0xb0) * 2];
  v8 = (char *)sub_26c63(*(unsigned long *)((long)a0 + 0xa8),0x18);
  v14 = v8;
  sub_13dee(a0,0x105);
  v2 = *(unsigned long *)((long)a0 + 0x98);
  *(char *)((long)a0 + 0x148) = a1;
  sub_14d9e(v10,*(unsigned long *)((long)a0 + 0xb0));
  *(unsigned long *)((long)a0 + 0x140) = sub_26ff9(v2,0x18);
  v9 = (*(char *)((long)a0 + 0xc1)) ? (void *)sub_26ff9(v2,0x18) : NULL; // branch-flip
  for (v15 = 0; v15 < v2; v15 = v15 + 1) {
    switch(*(unsigned long *)(v15 * 8 + *(long *)((long)a0 + 0x90))) {
      case 0x100:
        *v14 = 1;
      ...
      case 0x101:
label_17012:
        if (*(long *)(v15 * 8 + *(long *)((long)a0 + 0x90)) != 0x103)
          v14[-0x18] = 1;
        break;
      case 0x102:
      case 0x103:
        if (*(char *)((long)a0 + 0xc1)) {
          v11 = &v13[*(long *)&v14[-8] * -2];
          v25 = *(unsigned long *)&v14[-8];
          for (v16 = &v12[*(long *)&v14[-0x10] * -2]; v16 < v12; v16 = &v16[2]) {
            sub_15300((struct_38 *)(*v16 * 0x18 + (long)v9),&v11,v10);
          }
        }
        v11 = &v12[*(long *)&v14[-0x10] * -2];
        v25 = *(unsigned long *)&v14[-0x10];
        for (v17 = &v13[*(long *)&v14[-8] * -2]; v17 < v13; v17 = &v17[2]) {
          sub_15300((struct_38 *)(*(long *)((long)a0 + 0x140) + *v17 * 0x18),&v11,v10);
        }
        goto label_17012;
      default:
        *v14 = *(long *)(v15 * 8 + *(long *)((long)a0 + 0x90)) == 0x112;
      ...
      case 0x105:
        if (v9) {
          ...
          for (v18 = &v12[*(long *)&v14[-0x10] * -2]; v18 < v12; v18 = &v18[2]) {
            sub_15300((struct_38 *)(*v18 * 0x18 + (long)v9),&v11,v10);
          }
        }
        v25 = *(unsigned long *)&v14[-0x10];
        v11 = &v12[*(long *)&v14[-0x10] * -2];
        ...
        for (v19 = &(&v13[v3 * -2])[*(long *)&v14[-0x20] * -2]; v19 < &v13[v3 * -2]; v19 = &v19[2]) {
          sub_15300((struct_38 *)(*(long *)((long)a0 + 0x140) + *v19 * 0x18),&v11,v10);
        }
  ...
  *(unsigned long *)((long)a0 + 0x158) = sub_26ff9(v2,4);
  for (v22 = 0; v22 < v2; v22 = v22 + 1) {
    v1 = *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x150));
    if (sub_1165b(v1))
      *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x158)) = *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x158)) | 4;
    v1 = *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x150));
    if (sub_11679(v1))
      *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x158)) = *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x158)) | 2;
    for (v23 = 0; v23 < *(long *)(v22 * 0x18 + *(long *)((long)a0 + 0x140) + 8); v23 = v23 + 1) {
      v1 = *(unsigned int *)(v23 * 0x10 + *(long *)(v22 * 0x18 + *(long *)((long)a0 + 0x140)) + 8);
      if (sub_1165b(v1))
        *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x158)) = *(unsigned int *)(v22 * 4 + *(long *)((long)a0 + 0x158)) | 4;
      v1 = *(unsigned int *)(v23 * 0x10 + *(long *)(v22 * 0x18 + *(long *)((long)a0 + 0x140)) + 8);
      if (sub_11679(v1))
  ...
  if (v6 & 4)
    sub_15528(a0,&v11,4);
  *(unsigned int *)((long)a0 + 0x16c) = sub_15528(a0,&v11,v6 ^ 7);
  *(long *)((long)a0 + 400) = (long)*(int *)((long)a0 + 0x16c);
  if (v6 & 2)
    *(unsigned int *)((long)a0 + 0x16c) = sub_15528(a0,&v11,2);
  *(int *)((long)a0 + 0x16c) = *(int *)((long)a0 + 0x16c) + 1;
...
void sub_179b7(void *a0) // return-dupe, ternary x3
{
  void *v1;
  unsigned long *v2; // rax
  long v3; // stack - 0x30
  ...
  v4 = *(long *)((long)a0 + 0x160);
  if (*(long *)((long)a0 + 0x130) <= v4)
    return;
  v5 = (*(long *)((long)a0 + 0x170)) ? (void *)(*(long *)((long)a0 + 0x170) + -0x10) : NULL; // branch-flip
  v3 = (v5) ? *(long *)((long)a0 + 0x160) + 2 : 0; // branch-flip
  v5 = (unsigned long *)sub_26dc6(v5,&v3,*(long *)((long)a0 + 0x130) - v4,-1,8);
  v5[1] = 0;
  *v5 = v5[1];
  *(unsigned long **)((long)a0 + 0x170) = &v5[2];
  *(long *)((long)a0 + 0x160) = v3 + -2;
  v6 = *(unsigned long *)((long)a0 + 0x160);
  v1 = *(void **)((long)a0 + 0x178);
  *(unsigned long *)((long)a0 + 0x178) = sub_26bd0(v1,v6,8);
  v1 = *(void **)((long)a0 + 0x180);
  *(unsigned long *)((long)a0 + 0x180) = sub_26bd0(v1,v6,1);
  v1 = *(void **)((long)a0 + 0x188);
  *(unsigned long *)((long)a0 + 0x188) = sub_26bd0(v1,v6,8);
  if (*(char *)((long)a0 + 0x418)) {
    v5 = (*(long *)((long)a0 + 0x1b0)) ? (void *)(*(long *)((long)a0 + 0x1b0) + -0x10) : NULL; // branch-flip
    v2 = (unsigned long *)sub_26bd0(v5,v3,8);
    if (!v4) {
      v2[1] = 0;
      *v2 = v2[1];
    }
    *(unsigned long **)((long)a0 + 0x1b0) = &v2[2];
  }
  for (; v4 < (long)v6; v4 = v4 + 1) {
    *(unsigned long *)(v4 * 8 + *(long *)((long)a0 + 0x170)) = 0;
    *(unsigned long *)(v4 * 8 + *(long *)((long)a0 + 0x178)) = 0;
    if (*(char *)((long)a0 + 0x418))
      *(unsigned long *)(v4 * 8 + *(long *)((long)a0 + 0x1b0)) = 0;
  }
}
    ...
    if (v33 <= v31) {
      ...
      if (1 <= v34) { // branch-flip
        if ((char)a1[0x29]) {
          ...
          if (v16)
            sub_15300(&v10,(struct_6 *)(a1[0x25] + 8),&v13);
        }
        v4 = sub_15c84(a1,v11);
        v5 = sub_15d56(a1,&v10);
...
label_184ca:
      ...
      if (*(long *)((long)v13 * 8 + a1[0x12]) == 0x10a) {
        ...
        if (sub_115e0(v14,(unsigned char)v2,1)) {
          ...
          sub_14de8(v13,v35,(struct_38 *)(a0 * 0x48 + a1[0x25] + 0x28));
        }
        goto label_184ca;
      }
    }
...
long sub_18e06(void *a0,long a1,long *a2,long a3)
{
  long v1;
  long v10; // stack - 0x40
  long v11; // stack - 0x38
  ...
  *(unsigned long *)((long)a0 + 0x1a0) = 0;
  v6 = 0;
  v12 = a1;
  for (v5 = a1; (v6 < v8 && ((!v6 || (*(int *)((long)a0 + 0x16c) <= v5)))); v5 = sub_18c54(a0,v5,a2)) {
    v6 += 1;
  }
  *a2 = *a2 + (long)(v8 - v6);
  if (v4 != -1) {
    if (*(long *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) <= -1) {
      if (0x400 <= *(long *)((long)a0 + 0x1b8)) {
        for (v10 = -1; v10 < *(long *)((long)a0 + 0x160); v10 = v10 + 1) {
          free(*(void **)(v10 * 8 + *(long *)((long)a0 + 0x1b0)));
          *(unsigned long *)(v10 * 8 + *(long *)((long)a0 + 0x1b0)) = 0;
        }
        for (v11 = 0; v11 < *(long *)((long)a0 + 0x130); v11 = v11 + 1) {
          *(unsigned long *)(v11 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) = 0xffffffffffffffff;
        }
        *(unsigned long *)((long)a0 + 0x1b8) = 0;
      }
      v1 = *(long *)((long)a0 + 0x1b8);
      *(long *)((long)a0 + 0x1b8) = v1 + 1;
      *(long *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) = v1;
    }
    if (*(long *)(v5 * 8 + *(long *)((long)a0 + 0x1b0))) { // branch-flip
      if (0 <= *(long *)(*(long *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) * 8 + *(long *)(v5 * 8 + *(long *)((long)a0 + 0x1b0))))
        return *(long *)(*(long *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) * 8 + *(long *)(v5 * 8 + *(long *)((long)a0 + 0x1b0)));
    }
    else {
      v1 = *(long *)((long)a0 + 0x1b0);
      *(unsigned long *)(v1 + v5 * 8) = sub_26aea(0x2000);
      for (v7 = 0; v7 <= 0x3ff; v7 = v7 + 1) {
        *(unsigned long *)((long)v7 * 8 + *(long *)(v5 * 8 + *(long *)((long)a0 + 0x1b0))) = 0xffffffffffffffff;
      }
    }
    if (v5 != -1) // branch-flip
      sub_152c9((struct_6 *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x28),(struct_6 *)(v5 * 0x48 + *(long *)((long)a0 + 0x128) + 8),(long *)((long)a0 + 0x198));
    else {
      sub_14ce2((struct_41 *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x28),(unsigned long *)((long)a0 + 0x198));
    }
    v3 = sub_15d56(a0,(struct_6 *)((long)a0 + 0x198));
    v9 = v3;
    v13 = sub_15528(a0,(struct_41 *)((long)a0 + 0x198),v3 ^ 7);
    sub_179b7(a0);
    *(long *)(*(long *)(v5 * 8 + *(long *)((long)a0 + 0x1b0)) + *(long *)(v12 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) * 8) = v13;
    v5 = v13;
  }
  return v5;
}
...
unsigned char * sub_19334(void *a0,unsigned char *a1,unsigned char *a2,bool a3,long *a4,char a5)
{
  unsigned char *v1;
  long v10; // stack - 0x68
  long v11; // stack - 0x60
  ...
  if (0x400 <= *(long *)((long)a0 + 0x130)) {
    for (v10 = (long)*(int *)((long)a0 + 0x16c); v10 < *(long *)((long)a0 + 0x130); v10 = v10 + 1) {
      free(*(void **)(v10 * 0x48 + *(long *)((long)a0 + 0x128) + 8));
      free(*(void **)(v10 * 0x48 + *(long *)((long)a0 + 0x128) + 0x28));
    }
    *(long *)((long)a0 + 0x130) = (long)*(int *)((long)a0 + 0x16c);
    if (*(long *)((long)a0 + 0x170)) {
      for (v11 = 0; v11 < *(long *)((long)a0 + 0x160); v11 = v11 + 1) {
        free(*(void **)(v11 * 8 + *(long *)((long)a0 + 0x170)));
        free(*(void **)(v11 * 8 + *(long *)((long)a0 + 0x178)));
        v8 = (unsigned long *)(v11 * 8 + *(long *)((long)a0 + 0x178));
        *v8 = 0;
        *(unsigned long *)(v11 * 8 + *(long *)((long)a0 + 0x170)) = *v8;
      }
      *(unsigned int *)((long)a0 + 0x168) = 0;
    }
    if ((*(char *)((long)a0 + 0x418)) && (*(long *)((long)a0 + 0x1b0))) {
      for (v12 = -1; v12 < *(long *)((long)a0 + 0x160); v12 = v12 + 1) {
        free(*(void **)(v12 * 8 + *(long *)((long)a0 + 0x1b0)));
        *(unsigned long *)(v12 * 8 + *(long *)((long)a0 + 0x1b0)) = 0;
      }
      for (v13 = 0; v13 < *(int *)((long)a0 + 0x16c); v13 = v13 + 1) {
        *(unsigned long *)(v13 * 0x48 + *(long *)((long)a0 + 0x128) + 0x40) = 0xffffffffffffffff;
      }
      *(unsigned long *)((long)a0 + 0x1b8) = 0;
    }
  }
  if (!*(long *)((long)a0 + 0x160))
    sub_179b7(a0);
  v14 = 0;
  v15 = 0;
  v17 = *(long *)((long)a0 + 0x170);
  v2 = *(unsigned char *)((long)a0 + 0x1ce);
  v3 = *a2;
  *a2 = v2;
  v9 = a1;
  v16 = a1;
  if ((a5) && (memset((void *)((long)a0 + 0x110),0,8), !*(long *)((long)a0 + 0x1a8)))
    sub_14d9e((unsigned long *)((long)a0 + 0x198),*(unsigned long *)((long)a0 + 0xb0));
  v18 = 0;
label_198ee:
  do {
    while (v19 = *(long *)(v17 + v14 * 8), v19) {
      if (v14 < *(int *)((long)a0 + 0x16c)) {
        if ((a5 != '\x01') || (!*(long *)(v14 * 0x48 + *(long *)((long)a0 + 0x128) + 0x30))) {
      ...
      if (a5) { // branch-flip
        v15 = v14;
        if (((*(long *)(v14 * 0x48 + *(long *)((long)a0 + 0x128) + 0x30)) && (*(int *)((long)a0 + ((long)(int)(unsigned int)*v9 + 0x144) * 4 + 0xc) == -1)) && (v9 < a2)) {
    ...
    if (0 <= v14) {
      if (*(long *)(v14 * 8 + *(long *)((long)a0 + 0x178))) { // branch-flip
        if ((*(unsigned char *)((long)a0 + (long)(int)(unsigned int)*v9 + 0x1cf) & *(unsigned char *)(v14 + *(long *)((long)a0 + 0x180))) || ((a2 == v9 && (v7 = sub_116d2((unsigned char)*(char *)(v14 * 0x48 + *(long *)((long)a0 + 0x128) + 0x20),4,v14,a0), v7)))) goto label_19c3b;
        if ((a5) && (v14 < *(int *)((long)a0 + 0x16c))) {
          v16 = (unsigned char *)sub_1929e(a0,v9,v16,a2);
          v9 = v16;
        }
        v15 = v14;
        if ((((a5 != '\x01') || (!*(long *)(v14 * 0x48 + *(long *)((long)a0 + 0x128) + 0x30))) || (*(int *)((long)a0 + ((long)(int)(unsigned int)*v9 + 0x144) * 4 + 0xc) != -1)) || (a2 <= v9)) {
          v1 = &v9[1];
          v14 = *(long *)((unsigned long)*v9 * 8 + *(long *)(v14 * 8 + *(long *)((long)a0 + 0x178)));
          v9 = v1;
        }
        else {
          v14 = sub_18e06(a0,v14,&v9,a2);
    ...
    if (v14 != -2) { // branch-flip
      if (((a2 < v9) || (v2 != v9[-1])) || (*(long *)(v15 * 8 + *(long *)((long)a0 + 0x188)) < 0)) {
        v9 = NULL;
label_19c3b:
        if (a4)
          *a4 = *a4 + v18;
      ...
      v16 = v9;
      if (a3) // branch-flip
        v14 = *(long *)(v15 * 8 + *(long *)((long)a0 + 0x188));
      else if (*(char *)((long)a0 + (long)(int)(unsigned int)v2 + 0x1cf) != '\x04') { // branch-flip
        if (*(char *)((long)a0 + (long)(int)(unsigned int)v2 + 0x1cf) != '\x02') // branch-flip
          v14 = *(long *)((long)a0 + 400);
        else {
          v14 = (long)(*(int *)((long)a0 + 0x16c) + -1);
        }
      }
      else {
        v14 = 0;
...
void sub_19c87(void *a0,unsigned char *a1,unsigned char *a2,char a3,long *a4,unsigned long a5)
{
  sub_19334(a0,a1,a2,(unsigned char)a3,a4,1,a5);
}

// Function: sub_19cd3 @ 0x19cd3
void sub_19cd3(void *a0,unsigned char *a1,unsigned char *a2,char a3,long *a4,unsigned long a5)
{
...
void sub_19d4d(struct_46 *a0,char *a1,char *a2,char a3,unsigned long a4,unsigned long a5)
{
  (*a0->field_0x410)(a0,a1,a2,(unsigned char)a3,a4,a5);
}

// Function: sub_19da3 @ 0x19da3
unsigned long sub_19da3(struct_47 *a0)
{
  return a0->field_0x120;
}

// Function: sub_19dbc @ 0x19dbc
char sub_19dbc(void *a0)
{
  return *(char *)((long)a0 + 0xc0);
}

// Function: sub_19dd5 @ 0x19dd5
void sub_19dd5(void *a0) // return-dupe
{
  long v1; // stack - 0x10
  ...
  if (!*(long *)((long)a0 + 0x1b0))
    return;
  for (v1 = -1; v1 < *(long *)((long)a0 + 0x160); v1 = v1 + 1) {
    free(*(void **)(v1 * 8 + *(long *)((long)a0 + 0x1b0)));
  }
  free((void *)(*(long *)((long)a0 + 0x1b0) + -0x10));
}

// Function: sub_19e86 @ 0x19e86
unsigned long sub_19e86(void *a0) // return-dupe
{
  long v1;
  long v2; // stack - 0x10
  ...
  v2 = 0;
  do {
    if (*(long *)((long)a0 + 0x98) <= v2)
      return 1;
    v1 = *(long *)(v2 * 8 + *(long *)((long)a0 + 0x90));
    if (0x112 <= v1) { // branch-flip
      if ((unsigned long)(v1 - 0x112U) <= 1)
        return 0;
    }
    else if ((0x10e <= v1) && (*(char *)((long)a0 + 0x418) == '\x01'))
      return 0;
    v2 += 1;
  } while( true );
}
...
void sub_19f0c(void *a0) // return-dupe x2
{
  long v1;
  bool v2;
  long v3; // stack - 0x10
  
  if (*(char *)((long)a0 + 0x41a) != '\x01')
    return;
  v2 = 0;
  v3 = 0;
  while( true ) {
    if (*(long *)((long)a0 + 0x98) <= v3) {
      if ((!v2) && (*(long *)((long)a0 + 0x120))) {
        sub_1a550(*(struct_44 **)((long)a0 + 0x120));
        free(*(void **)((long)a0 + 0x120));
        *(unsigned long *)((long)a0 + 0x120) = 0;
      }
      sub_19dd5(a0);
      *(char *)((long)a0 + 0x418) = 0;
      *(void **)((long)a0 + 0x410) = sub_19cd3;
      *(char *)((long)a0 + 0xc0) = 1;
      return;
    }
    v1 = *(long *)(v3 * 8 + *(long *)((long)a0 + 0x90));
    if (v1 == 0x113) break;
    if (v1 <= 0x113) {
      if (v1 == 0x10a)
        abort(); // no-return
...
void sub_1a490(long a0,unsigned long a1,unsigned long *a2,char a3) // return-dupe
{
  if (a0)
    sub_14b84(a0,a1,a2);
  sub_1a02d(a2);
  ...
  if (!a2[0x24])
    return;
  *(char *)&a2[0x18] = 1;
  sub_16c9f((void *)a2[0x24],(unsigned char)a3);
}

// Function: sub_1a550 @ 0x1a550
void sub_1a550(struct_44 *a0) // return-dupe
{
  long v1; // stack - 0x20
  long v2; // stack - 0x18
  long v3; // stack - 0x10
...
struct_34 * sub_1acc0(unsigned long a0,unsigned long a1)
{
  struct_34 *v1; // rax
  
  v1 = (struct_34 *)sub_26aea(0x30);
...
char * sub_1ae2f(struct_35 *a0) // ternary x2
{
  char *v1;
  bool v10;
  int v11;
...
void sub_1bd5a(void *a0,void *a1)
{
  unsigned long *v1;
  unsigned long *v2;
  long v3; // rcx
  ...
  memset(a0,0,0x1c0);
  *(unsigned long *)((long)a0 + 0x18) = 0xffffffffffffffff;
  *(char *)((long)a0 + 0xc0) = *(char *)((long)a1 + 0xc0);
  v3 = 0x4a;
  v4 = (unsigned long *)((long)a1 + 0x1c0);
  ...
  *(unsigned long *)((long)a0 + 0x410) = *(unsigned long *)((long)a1 + 0x410);
  v3 = 0xa0;
  v4 = (unsigned long *)((long)a1 + 0x418);
...
void sub_1c191(struct_50 *a0,unsigned long a1)
{
  struct_3 *v1; // rax
  
  v1 = (struct_3 *)sub_26aea(0x10);
  v1->field_0x8 = a1;
...
unsigned long sub_1c9e9(struct_11 *a0,char *a1)
{
  unsigned int v1;
  unsigned long v2;
  unsigned long v3;
...
unsigned long sub_1ca61(void *a0,char *a1)
{
  long v1;
  long v2;
  long v3; // stack - 0x20
  ...
  while( true ) {
    if (v1 <= v3)
      return 0;
    if (sub_1c9e9((struct_11 *)(v3 * 0x48 + v2),a1)) break;
    v3 += 1;
  }
  return 1;
}
...
unsigned long sub_1cae3(void *a0,char *a1,char *a2) // return-dupe
{
  unsigned int v1;
  struct_4 *v2;
  char *v3; // rax
...
unsigned long sub_1cfe2(void *a0,struct_50 *a1,FILE *a2,unsigned int a3,unsigned char a4,unsigned long a5) // return-dupe, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_1cfe2
{
  long v1;
...
FILE * sub_1d272(unsigned long a0,struct_50 *a1,char *a2,unsigned int a3,char a4) // early-return x2
{
  unsigned int v1; // eax
  FILE *v2; // rax
  unsigned long v3; // stack - 0x20
...
unsigned int sub_1d366(struct_6 *a0,struct_6 *a1) // return-dupe
{
...
unsigned long sub_1d3bf(void *a0,unsigned long a1)
{
  return *(unsigned long *)((long)a0 + 8) % a1;
}

// Function: sub_1d3ed @ 0x1d3ed
unsigned long sub_1d3ed(void *a0) // return-dupe x2, return-dupe
{
  if (!(*(unsigned int *)((long)a0 + 0x48) & 0x102)) {
    *(void **)((long)a0 + 0x58) = malloc(0x20);
    if (*(long *)((long)a0 + 0x58)) {
      sub_27aa3(*(void **)((long)a0 + 0x58));
      return 1;
    }
    return 0;
  }
  *(unsigned long *)((long)a0 + 0x58) = sub_208d6(0x1f,NULL,sub_1d3bf,sub_1d366,dat_32fc8);
  if (*(long *)((long)a0 + 0x58))
    return 1;
  return 0;
}
...
unsigned long sub_1d499(void *a0,struct_18 *a1) // return-dupe x3
{
  struct_17 *v1;
  struct_19 *v2; // rax
  struct_19 *v3; // rax
  ...
  *(unsigned long *)((long)v2->field_0x0 + 8) = a1->field_0x78;
  v2->field_0x10 = a1;
  v3 = (struct_19 *)sub_21617(*(void **)((long)a0 + 0x58),v2);
  if (v3 == v2)
    return 1;
  free(v2);
  if (v3) {
...
void sub_1d5ab(void *a0,void *a1)
{
  long v1;
  void *v2; // rax
  long v3; // stack - 0x28
  ...
  if (*(unsigned int *)((long)a0 + 0x48) & 0x102) { // branch-flip
    ...
    v2 = (void *)sub_21687(*(void **)((long)a0 + 0x58),&v3);
    if (!v2)
      abort(); // no-return
    free(v2);
  }
...
void sub_1d6dd(void *a0) // return-dupe
{
  if (!(*(unsigned int *)((long)a0 + 0x48) & 0x102)) {
  ...
  if (*(long *)((long)a0 + 0x58)) {
    sub_20b56(*(struct_15 **)((long)a0 + 0x58));
    return;
  }
}

// Function: sub_1d72f @ 0x1d72f
void sub_1d72f(void *a0)
{
  int v1; // eax
...
void sub_1d777(void *a0,bool a1) // ternary
{
...
void sub_1d7bf(void *a0,int a1,bool a2)
{
  int v1;
  ...
  if ((v1 == a1) && (v1 != -100))
    abort(); // no-return
  if (a2) { // branch-flip
    v1 = sub_21a29((void *)((long)a0 + 0x60),v1);
    if (0 <= v1)
      close(v1);
  }
...
unsigned int sub_1d84f(void *a0)
{
  unsigned int v1;
  int v2;
  ...
  if (!(*(unsigned int *)((long)a0 + 0x48) & 4)) {
    if (*(unsigned int *)((long)a0 + 0x48) & 0x200) { // branch-flip
      ...
      if (fchdir(v2)) {
        v1 = 1;
        sub_1d72f((void *)((long)a0 + 0x60)); // return-dupe
        return v1;
      }
    }
  }
  v1 = 0;
  sub_1d72f((void *)((long)a0 + 0x60));
  return v1;
}

// Function: sub_1d8fd @ 0x1d8fd
unsigned int sub_1d8fd(void *a0,char *a1)
{
  unsigned int v1; // eax
  unsigned int v2; // eax
  ...
  if (*(unsigned int *)((long)a0 + 0x48) & 0x200) // branch-flip
    v2 = sub_22af5(*(unsigned int *)((long)a0 + 0x2c),a1,v1);
  else {
    v2 = sub_28056(a1,v1);
  }
  return v2;
...
label_1dad4:
    ...
    for (v6 = a0; *v6; v6 = &v6[1]) {
      ...
      v4 = (void *)sub_1f908(v2,(void *)*v6,v9);
      ...
      *(long *)((long)v4 + 0x30) = (long)v4 + 0x100;
      if ((v1) && (v5)) {
        ...
        *(unsigned short *)((long)v4 + 0x68) = sub_1f5cd(v2,v4,0);
      }
      if (a2) { // branch-flip
...
void sub_1dd40(struct_24 *a0,void *a1)
{
  char *v1; // rax
  unsigned long v2; // rax
...
unsigned long sub_1ddff(struct_16 *a0) // return-dupe, ternary
{
  int v1;
  void *v2;
  void *v3;
  ...
  if (a0->field_0x50)
    sub_20b56((struct_15 *)a0->field_0x50);
  sub_1d6dd(a0);
  free(a0);
  if (v4) {
    *__errno_location() = v4;
...
unsigned long sub_1dff7(void *a0,int a1) // early-return x2
{
  long v1;
  struct_3 *v2; // rax
  struct_3 *v3; // rax
  ...
  if (!(*(unsigned int *)(v1 + 0x48) & 0x200))
    return 0;
  if (!v6) {
    *(unsigned long *)(v1 + 0x50) = sub_208d6(0xd,NULL,sub_1df8c,sub_1dfc1,dat_32fc8);
    v6 = *(struct_4 **)(v1 + 0x50);
  }
  if (v6) {
...
unsigned long sub_1e1f0(void *a0,unsigned int a1) // early-return
{
  long v1; // rax
...
unsigned long sub_1e246(void *a0,unsigned int a1) // early-return
{
  long v1; // rax
...
void * sub_1e2b9(struct_24 *a0) // early-return x7, ternary
{
  char *v1;
  short v2;
  int v3;
            ...
            if (*(short *)((long)v6 + 0x68) != 0xb) {
              *(char *)(*(long *)((long)v6 + 0x48) + a0->field_0x20) = 0;
              if (*(long *)((long)v6 + 0x58)) { // branch-flip
                ...
                else if ((!(*(unsigned short *)((long)v6 + 0x6a) & 1)) && (v8 = *(void **)((long)v6 + 8), sub_1fc3d(a0,v8,0xffffffff,".."))) {
                  *(int *)((long)v6 + 0x40) = *__errno_location();
                  a0->field_0x48 = a0->field_0x48 | 0x2000;
                }
              }
...
unsigned long sub_1e92f(unsigned long a0,void *a1,int a2) // return-dupe
{
...
int * sub_1e98a(struct_24 *a0,int a1) // early-return x4
{
  int v1;
  long v2;
  int v3;
...
void sub_1eb7d(struct_21 *a0,unsigned int a1)
{
...
void * sub_1ec09(struct_23 *a0,int a1) // early-return, return-dupe x2, ternary, warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_1ec09
{
  bool v1;
  void *v10; // rax
  int v11; // stack - 0x98
  ...
  if (v15) {
    ...
    v12 = sub_22c33(v6,*(char **)((long)v21 + 0x30),v12,&v11);
  ...
  if (v15)
    ...
    v3 = ((a1 != 2) && ((((!(a0->field_0x48 & 8) || (!(a0->field_0x48 & 0x10))) || (a0->field_0x48 & 0x20)) || ((*(long *)((long)v21 + 0x80) != 2 || (v7 = sub_1e246(v21,v11), !v7))))));
    if ((v3) || (v1 = 0, a1 == 3)) {
    ...
    *(unsigned long *)((long)v10 + 0x78) = *(unsigned long *)v26;
    ...
    if ((a0->field_0x40) && (!(a0->field_0x48 & 0x400)))
      ...
      *(unsigned short *)((long)v10 + 0x68) = 0xb;
      sub_1eb7d((struct_21 *)((long)v10 + 0x70),(unsigned char)v26->field_0x12);
      sub_1d777(v10,!v4);
    }
...
label_1f448:
  ...
  if (((!v15) && (v1)) && ((a1 == 1 || (!v14)))) {
    if (*(long *)((long)v21 + 0x58)) // branch-flip
      v7 = sub_1fc3d(a0,*(void **)((long)v21 + 8),0xffffffff,"..");
    else {
      v7 = sub_1d84f(a0);
    }
    if (v7) {
...
unsigned long sub_1f5cd(void *a0,void *a1,bool a2) // early-return x7, ternary
{
  stat *v1;
  int v2;
  char *v3;
...
void * sub_1f79a(void *a0,void *a1,unsigned long a2)
{
  unsigned long *v1;
  unsigned long v2;
  void *v3;
...
void * sub_1f908(struct_14 *a0,void *a1,unsigned long a2) // early-return
{
  void *v1; // rax
...
unsigned long sub_1f9ff(void *a0,long a1) // return-dupe x2
{
  unsigned long v1; // rax
  void *v2; // rax
...
void sub_1fad0(void *a0,void *a1) // ternary
{
  long v1;
  void *v2; // stack - 0x18
...
int sub_1fc3d(struct_22 *a0,void *a1,int a2,char *a3) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_1fc3d
{
  bool v1; // al
  int v2;
  stat v3; // stack - 0xa8
  ...
  v4 = a3;
  v5 = a2;
  if ((((a2 <= -1) && (v1)) && (a0->field_0x48 & 0x200)) && ((sub_21a13(&a0[1].field_0x0[0x14]) != '\x01' && (v2 = sub_21ab5(&a0[1].field_0x0[0x14]), 0 <= v2)))) {
    v5 = v2;
    v4 = NULL;
  }
  v7 = v5;
...
unsigned long sub_1ff1d(struct_19 *a0)
{
  return a0->field_0x10;
}

// Function: sub_1ff33 @ 0x1ff33
unsigned long sub_1ff33(struct_53 *a0)
{
  return a0->field_0x18;
}

// Function: sub_1ff49 @ 0x1ff49
unsigned long sub_1ff49(struct_14 *a0)
{
  return a0->field_0x20;
}

// Function: sub_1ff5f @ 0x1ff5f
unsigned long sub_1ff5f(struct_54 *a0)
{
  long *v1; // stack - 0x28
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
unsigned long sub_1ffe1(struct_54 *a0) // return-dupe
{
  long *v1; // stack - 0x28
  long v2; // stack - 0x20
  long v3; // stack - 0x18
...
void sub_2007f(struct_14 *a0,FILE *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
long sub_201c6(struct_2 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
long sub_20221(struct_4 *a0,long a1) // return-dupe
{
  void *v1;
  long v2;
  long *v3; // stack - 0x18
...
long sub_202b8(struct_54 *a0) // early-return
{
  long *v1; // stack - 0x10
...
long sub_20318(void *a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_203b6(struct_54 *a0,long a1,unsigned long a2)
{
  unsigned long v1;
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
long sub_20456(struct_54 *a0,void *a1,unsigned long a2)
{
  long v1;
  long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
unsigned long sub_206b0(struct_0 *a0) // return-dupe x2
{
  float *v1;
  ...
  if ((((dat_2b2ac < v1[2]) && (v1[2] < dat_2b2a0 - dat_2b2ac)) && (dat_2b2ac + dat_2b2a0 < v1[3])) && (((0.0 <= *v1 && (*v1 + dat_2b2ac < v1[1])) && ((v1[1] <= dat_2b2a0 && (*v1 + dat_2b2ac < v1[2]))))))
    return 1;
  a0->field_0x28 = (float *)0x2b210;
  return 0;
}

// Function: sub_207bd @ 0x207bd
unsigned long sub_207bd(unsigned long a0,void *a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
  unsigned long v3; // stack - 0x20
...
long * sub_208d6(unsigned long a0,void *a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
void sub_20cd4(struct_1 *a0,struct_3 *a1)
{
  a1->field_0x0 = 0;
...
long sub_20d0e(struct_4 *a0,long a1,unsigned long *a2,bool a3) // early-return
{
  void *v1;
  long v2;
  struct_3 *v3;
...
unsigned long sub_20ea7(struct_7 *a0,struct_54 *a1,bool a2)
{
  long *v1;
  long v2;
  struct_6 *v3; // rax
...
unsigned long sub_2107b(struct_8 *a0,unsigned long a1) // return-dupe x4
{
  void *v1; // stack - 0x68
...
unsigned long sub_212a6(void *a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
  ...
  if (((float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18)) && (sub_206b0(a0), (float)*(unsigned long *)((long)a0 + 0x10) * *(float *)(*(long *)((long)a0 + 0x28) + 8) < (float)*(unsigned long *)((long)a0 + 0x18))) {
...
unsigned long sub_21617(void *a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_21687(void *a0,long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
  ...
  if (!v5)
    return 0;
  *(long *)((long)a0 + 0x20) = *(long *)((long)a0 + 0x20) + -1;
  if (((!*v2) && (*(long *)((long)a0 + 0x18) = *(long *)((long)a0 + 0x18) + -1, (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) && (sub_206b0(a0), (float)*(unsigned long *)((long)a0 + 0x18) < (float)*(unsigned long *)((long)a0 + 0x10) * **(float **)((long)a0 + 0x28))) {
    v6 = *(long *)((long)a0 + 0x28);
...
void sub_2198d(void *a0,long a1)
{
  sub_21687(a0,a1);
}

// Function: sub_219b6 @ 0x219b6
void sub_219b6(void *a0,unsigned int a1)
{
  int v1; // stack - 0xc
...
char sub_21a13(void *a0)
{
  return *(char *)((long)a0 + 0x1c);
}

// Function: sub_21a29 @ 0x21a29
unsigned int sub_21a29(void *a0,unsigned int a1)
{
  unsigned int v1;
  unsigned int v2; // eax
...
unsigned int sub_21ab5(void *a0)
{
  unsigned int v1;
...
void sub_22228(void *a0,long a1)
{
  *(long *)((long)a0 + 0x10) = *(long *)((long)a0 + 0x10) + a1;
}

// Function: sub_22252 @ 0x22252
void sub_22252(struct_59 *a0,struct_59 *a1)
{
  ...
  sub_283a6((struct_57 *)&a0[1].field_0x1[2],(struct_58 *)&a1[1].field_0x1[2]);
}
...
void sub_224b1(void *a0,unsigned long a1) // return-dupe
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
    (**(void **)((long)a0 + 0x38))(*(unsigned long *)((long)a0 + 0x48),a1);
    return;
  }
  (**(void **)((long)a0 + 0x38))(a1);
}

// Function: sub_22505 @ 0x22505
void sub_22505(void *a0,unsigned long a1) // return-dupe
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
    (**(void **)((long)a0 + 0x40))(*(unsigned long *)((long)a0 + 0x48),a1);
    return;
  }
  (**(void **)((long)a0 + 0x40))(a1);
}

// Function: sub_2255a @ 0x2255a
unsigned long sub_2255a(struct_30 *a0,long a1,long a2)
{
  long v1;
  long *v2;
  long v3; // stack - 0x30
...
bool _obstack_allocated_p(void *a0,unsigned long *a1)
{
  unsigned long *v1; // stack - 0x18
  
  for (v1 = *(unsigned long **)((long)a0 + 8); (v1 && ((a1 <= v1 || ((unsigned long *)*v1 < a1)))); v1 = (unsigned long *)v1[1]) {
  }
  return v1 != NULL;
}
...
unsigned int sub_22df3(void *a0,unsigned int a1)
{
  unsigned int v1;
  void *v2; // stack - 0x20
...
void * sub_243a3(int a0,char *a1,unsigned long a2,struct_9 *a3)
{
  int v1;
  unsigned int v2; // eax
  unsigned long *v3;
...
{
  sub_243a3(a0,a1,0xffffffffffffffff,(struct_9 *)0x43b20);
}

// Function: sub_24686 @ 0x24686
void sub_24686(unsigned int a0,char *a1,unsigned long a2)
{
  sub_243a3(a0,a1,a2,(struct_9 *)0x43b20);
}
...
{
  sub_243a3(a0,a1,a2,(struct_9 *)0x330c0);
}
...
void sub_24d19(unsigned long a0,void *a1,void *a2) // return-dupe x2, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_24d19
{
  unsigned long v1;
  unsigned long v2;
  int v3;
  ...
  if ((dat_43c80) && (v3 = (*dat_43c80)(v1,0), v3))
    return;
  if ((dat_43c68) && (v2 = *(unsigned long *)((long)a2 + 0xa0), dat_43c60)) {
    v3 = *__errno_location();
...
bool sub_25339(long a0,struct_25 *a1)
{
  return (unsigned long)(a1->field_0x0 - a0) <= (unsigned long)(a1->field_0x0 - a1->field_0x18) >> 1;
}

// Function: sub_2537a @ 0x2537a
unsigned long sub_2537a(struct_26 *a0,char *a1) // return-dupe x3, return-dupe
{
  void *v1;
  long v2;
  long v3;
...
unsigned long sub_256b7(struct_27 *a0) // early-return
{
...
unsigned long sub_2573f(struct_27 *a0,long *a1) // return-dupe
{
  int v1; // eax
  int v2; // stack - 0x18
  long v3; // stack - 0x10
...
void sub_2581b(void *a0) // return-dupe
{
...
unsigned long sub_25856(struct_28 *a0) // return-dupe
{
  bool v1;
  int v2; // eax
  char v3 [48];
...
unsigned long sub_259f7(struct_28 *a0) // return-dupe
{
  if (!sub_25856(a0))
    return 0;
  return 0xffffffff;
...
unsigned long sub_25fdb(struct_28 *a0,unsigned long a1,unsigned long a2) // return-dupe
{
...
void sub_26804(FILE *a0,char *a1,char *a2,char *a3,struct_29 *a4)
{
  long *v1;
  long v2 [11];
...
unsigned long sub_27ac9(struct_17 *a0,struct_6 *a1) // return-dupe
{
  unsigned long v1;
...
void sub_283a6(struct_57 *a0,struct_58 *a1) // return-dupe
{
  if ((struct_58 *)a1->field_0x0 != &a1[1]) // branch-flip
    a0->field_0x0 = a1->field_0x0;
  else {
