...
char * sub_40e0(unsigned long a0,void *a1)
{
  unsigned long v1;
  char *v2;
  char *v3; // r8
...
unsigned long sub_4220(char *a0,char *a1)
{
  char v1;
  char v10; // stack - 0xac
  char *v11; // stack - 0xa8
...
unsigned long sub_48e0(void)
{
  return sub_4830(); // tail-call
}
...
void sub_4950(unsigned long a0,void *a1,void *a2)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
...
void sub_4e60(struct_1 *a0) // return-dupe
{
  int v1; // eax
...
unsigned long sub_4ee0(struct_2 *a0,unsigned long a1,unsigned long a2)
{
  unsigned long *v1;
  unsigned long v2;
...
void * sub_51b0(long a0) // return-dupe
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
unsigned long sub_5320(struct_3 *a0) // return-dupe x2
{
  int v1; // eax
  int v2; // eax
  void *v3;
  ...
  do {
    if (0x104a <= v7) { // branch-flip
      ...
      if (0 <= v2) {
        if (!v2) goto label_54ec;
        if (v7 < (unsigned long)(long)(v2 + 0x1049)) goto label_53bf;
        v5 = (long)v2;
        while( true ) {
          a0->field_0x8 = v5;
          ...
          v2 = (int)v4;
          if (v2 <= -1) break;
          if (v7 - a0->field_0x8 < (unsigned long)(long)(v2 + 0x1049)) goto label_53bf;
          if (!v2) {
            close(v1);
...
unsigned long sub_5560(struct_2 *a0) // return-dupe
{
  unsigned long v1;
...
label_55b0:
  do {
    ...
    if (v3 <= v7) { // branch-flip
      v1 = v5 - 1;
      if (v1 < v11 - 1) goto label_5650;
      v6 = v5;
      if ((v3 < v7) && (v2 = sub_4ee0(a0,v3,v7), v2)) {
        sub_4f40(v4);
        return 0;
      }
      if (v1 <= v11 - 1) goto label_55b0;
...
unsigned long sub_5690(struct_2 *a0)
{
  return sub_5560(a0); // tail-call
}

// Function: sub_56a0 @ 0x56a0
unsigned long sub_56a0(unsigned long a0,unsigned long *a1)
{
  unsigned long v1; // stack - 0x48
...
label_590f:
          ...
          if (v15) {
            if (iswspace(v16)) goto label_590f;
            if (v15) {
              v8 = 1;
              iswspace(v16);
              goto label_57d5;
...
long sub_5a50(FILE *a0,char *a1,char *a2,char *a3,unsigned long *a4,unsigned long a5)
{
  long v1;
  unsigned long v10; // stack - 0x48
  char *v2; // rax
...
void sub_5ef0(FILE *a0,char *a1,char *a2,char *a3,struct_8 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
{
  sub_61b0(NULL,a0,a1); // tail-call
}

// Function: sub_6200 @ 0x6200
void sub_6200(void *a0,unsigned long a1,unsigned long a2)
{
  sub_61b0(a0,a1,a2); // tail-call
}
...
void sub_6230(void *a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  unsigned long v2; // rax
  unsigned long v3;
...
void sub_62a0(void *a0,unsigned long *a1)
{
  sub_6230(a0,a1,1); // tail-call
}

// Function: sub_62b0 @ 0x62b0
void sub_62b0(void *a0,long *a1,long a2,long a3,long a4)
{
  long v1;
  long v2;
  long v3;
...
void sub_63f0(char *a0,unsigned long a1)
{
...
int sub_6530(unsigned long a0,long a1,unsigned long a2,long *a3,unsigned long *a4)
{
  int v1; // eax
  
  v1 = sub_7ce0(a0,a1,a2,a3,a4);
  if (v1 < 0) {
...
long sub_6590(char *a0,char *a1,char *a2)
{
  long v1; // rax
  
  v1 = sub_81b0(a0,a1,a2);
  if (!v1) {
    if (*__errno_location() == 0xc)
      sub_64b0(); // no-return
  }
...
unsigned int sub_6610(long *a0,unsigned int a1,int a2)
{
  unsigned int v1; // eax
...
int sub_6b30(char *a0,char *a1) // early-return
{
  ...
  if (a0 == a1)
    return 0;
  do {
    v2 = sub_8710((unsigned char)*a0);
    v1 = sub_8710((unsigned char)*a1);
...
void sub_6c40(struct_4 *a0)
{
  ...
  v3 = sub_84f0(&a0->field_0x2c,v2,a0->field_0x0 - (long)v2,(mbstate_t *)&a0->field_0x9[3]);
  a0->field_0x20 = v3;
  if (v3 == -1) {
    a0->field_0x20 = 1;
    a0->field_0x28 = 0;
...
void sub_6db0(struct_0 *a0,long a1)
{
...
void sub_6dc0(struct_9 *a0,struct_9 *a1)
{
  char v1;
  ...
  sub_8800((struct_6 *)&a0[1],(struct_7 *)&a1[1]); // tail-call
}
...
char sub_6fb0(void *a0,void *a1,long *a2)
{
  ...
  if ((0 <= SUB168(ZEXT816(0x38) * ZEXT816(v22),0)) && (!SUB168(ZEXT816(0x38) * ZEXT816(v22),8))) {
    ...
    if (v19) {
      ...
      while( true ) {
        v32 = 0;
        *(unsigned long *)((long)v15 + -8) = 0x712f;
        sub_7a60(v24);
        v21 = v34;
        if ((v34) && (!v35)) break;
        v7 = &v5[6];
        *(unsigned long *)((long)v15 + -8) = 0x7117;
        sub_8800(v5,&v9);
        v9 = (void *)((long)v9 + v33);
        v5 = v7;
      }
...
label_71c5:
            ...
            if (v16 == v4[1]) {
              v18 = (void *)*v4;
              v6 = (void *)*v7;
              *(unsigned long *)((long)v15 + -8) = 0x71c1;
              if (!memcmp(v6,v18,v16)) goto label_71c5;
            }
          }
          if (!v17) goto label_73a0;
...
label_71fa:
      ...
      *v20 = 0;
      ...
      do {
        while( true ) {
          *(unsigned long *)((long)v15 + -8) = 0x725c;
          sub_7a60(v24);
          v16 = v33;
          if (!v34) break;
          if (!v35) goto label_7097;
          v5 = &v19[(long)v18 * 6];
          if (!*(char *)&v5[2]) goto label_72cb;
...
label_734b:
          if (v18) { // branch-flip
            ...
            for (; v17; v17 = v17 + -1) {
              *(unsigned long *)((long)v15 + -8) = 0x7387;
              sub_7a60(v11);
              if ((v29) && (!v30)) goto label_739a;
              v26 = 0;
              v27 = (void *)((long)v27 + v28);
            }
          }
          else {
            *(unsigned long *)((long)v15 + -8) = 0x72e2;
            sub_7a60(v11);
            if ((v29) && (!v30)) {
label_739a:
              *(unsigned long *)((long)v15 + -8) = 0x739f; // no-return
              abort();
            }
            v26 = 0;
            v27 = (void *)((long)v27 + v28);
        ...
        v5 = &v19[(long)v18 * 6];
label_72cb:
        if (v5[1] != v33) goto label_734b;
        v6 = (void *)*v5;
        v23 = v9;
        *(unsigned long *)((long)v15 + -8) = 0x7339;
        v3 = memcmp(v6,v9,v33);
        v6 = v23;
        if (v3) goto label_734b;
label_7287:
        v9 = (void *)((long)v6 + v16);
        v32 = 0;
        v18 = (void *)((long)v18 + 1);
      ...
      *v20 = (long)v27;
label_7097:
      *(unsigned long *)((long)v15 + -8) = 0x72b8;
      sub_87a0(v19);
      return v21;
    }
  }
...
label_7940:
              v16 = v8 - v20;
              while ((v16 && ((sub_7a60(v15), !v31 || (v32))))) {
                v28 = 0;
                v29 = &v29[v30];
                v16 -= 1;
              }
          ...
          v9 = v8 + 1;
          if (!v25) goto label_7716;
          if (v39 == v26) goto label_7756;
label_76a8:
          v6 = v36;
          v17 = v37;
        }
...
label_7756:
              ...
              do {
                ...
                if ((char)v47) { // branch-flip
                  if (!v47._4_4_)
                    return NULL;
                  if (!v55) goto label_78c3;
                  if (v47._4_4_ != v56) goto label_76a8;
                }
                else {
label_78c3:
                  if ((v46 != v54) || (memcmp(v45,v53,v46))) goto label_76a8;
                }
                v45 = &v6[v8];
        ...
        if (v4) {
          if (v17 * 5 <= v9) { // branch-flip
            if (v6) {
              ...
              v8 = v9;
              if (*v6) goto label_74ed;
            }
            v5 = sub_6e10(v1,a1,strlen(a1),&v10);
            if ((char)v5)
              return v10;
            v6 = NULL;
          }
...
void sub_7a60(struct_5 *a0)
{
  ...
  v2 = a0->field_0x10;
  v4 = sub_84f0(&a0->field_0x24,v2,sub_8270(v2,v3),(mbstate_t *)&a0->field_0x1[3]);
  a0->field_0x18 = v4;
  if (v4 == -1) {
    a0->field_0x18 = 1;
    a0->field_0x20 = '\0';
...
void sub_7be0(void *a0,long a1)
{
  *(long *)((long)a0 + 0x10) = *(long *)((long)a0 + 0x10) + a1;
}

// Function: sub_7bf0 @ 0x7bf0
void sub_7bf0(struct_10 *a0,struct_10 *a1)
{
  char v1;
  ...
  sub_8800((struct_6 *)&a0[1].field_0x1[2],(struct_7 *)&a1[1].field_0x1[2]); // tail-call
}
...
char * sub_81b0(char *a0,char *a1,char *a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
...
unsigned long sub_84f0(unsigned int *a0,char *a1,unsigned long a2,mbstate_t *a3)
{
  unsigned long v1; // rax
  long v2;
...
void sub_8800(struct_6 *a0,struct_7 *a1) // return-dupe
{
  char v1;
  long v2;
  struct_7 *v3;
