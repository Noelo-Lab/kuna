...
char * sub_4ad0(unsigned long a0,void *a1)
{
  bool v1;
  char *v2;
...
unsigned int sub_6d70(void *a0,unsigned int a1)
{
  unsigned int v1;
...
unsigned long sub_7580(FILE *a0,void *a1)
{
  int v1; // eax
  char *v2;
  long v3; // rax
...
label_75ae:
  do {
    ...
    if (*(char **)((long)a1 + 0x38) != v2) goto label_75a0;
    _obstack_newchunk((obstack *)((long)a1 + 0x18),1);
    v2 = *(char **)((long)a1 + 0x30);
    *(char **)((long)a1 + 0x30) = &v2[1];
    *v2 = (char)v1;
...
void sub_8670(void *a0,unsigned long a1)
{
...
void sub_8690(void *a0,unsigned long a1)
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
