...
char * sub_7de0(unsigned long a0,void *a1)
{
...
void sub_8240(unsigned long a0,unsigned char a1,struct_8 *a2,unsigned long a3,unsigned int a4)
{
  if (dat_263c8) {
    sub_13030(a0,0x3e9,((long)a2->field_0x10 + (unsigned long)a1 * 0xc) * 0x80 + 0x263e0,a2,a3,a4); // tail-call
    return;
  }
...
void sub_9a80(void *a0,unsigned long a1) // return-dupe
{
  char *v1;
  int v2;
  char v3 [664];
  ...
  if (dat_2732c) {
    v1 = "?";
    if (*(char *)((long)a0 + 0xb8))
      v1 = (char *)sub_ffa0(*(unsigned long *)((long)a0 + 0x58),v3,dat_27328,0x200,dat_27320);
    v2 = 0;
    if (dat_27338 != 4)
      v2 = dat_2735c;
    __printf_chk(1,"%*s ",v2,v1);
  ...
  if (dat_27365) {
    ...
    if (dat_27338 != 4)
      v2 = dat_27354;
    __printf_chk(1,"%*s ",v2,*(char **)((long)a0 + 0xb0));
  }
  sub_9160(a0,0,NULL,a1);
  if (!dat_27314)
    return;
  sub_9280((unsigned char)*(char *)((long)a0 + 0xb8),*(unsigned int *)((long)a0 + 0x30),*(unsigned int *)((long)a0 + 0xa8));
}
...
void sub_a340(void *a0,struct_16 *a1)
{
  unsigned int v1;
  unsigned int v2;
  unsigned long v3;
  ...
  v3 = gnu_dev_makedev(*(unsigned int *)((long)a0 + 0x88),*(unsigned int *)((long)a0 + 0x8c));
  v1 = *(unsigned int *)((long)a0 + 0x84);
  v2 = *(unsigned int *)((long)a0 + 0x80);
  a1->field_0x0 = v3;
  a1->field_0x8 = *(unsigned long *)((long)a0 + 0x20);
  a1->field_0x18 = (unsigned int)*(unsigned short *)((long)a0 + 0x1c);
  a1->field_0x10 = (unsigned long)*(unsigned int *)((long)a0 + 0x10);
  a1->field_0x1c = *(unsigned int *)((long)a0 + 0x14);
  a1->field_0x20 = *(unsigned int *)((long)a0 + 0x18);
  v4 = gnu_dev_makedev(v2,v1);
  v1 = *(unsigned int *)((long)a0 + 0x48);
  v3 = *(unsigned long *)((long)a0 + 0x40);
  a1->field_0x28 = v4;
  a1->field_0x30 = *(unsigned long *)((long)a0 + 0x28);
  a1->field_0x38 = (unsigned long)*(unsigned int *)((long)a0 + 4);
  a1->field_0x40 = *(unsigned long *)((long)a0 + 0x30);
  v5 = sub_a330(v3,v1);
  v1 = *(unsigned int *)((long)a0 + 0x78);
  v3 = *(unsigned long *)((long)a0 + 0x70);
  a1->field_0x48 = SUB168(v5,0);
  a1->field_0x50 = SUB168(v5,8);
  v5 = sub_a330(v3,v1);
  v1 = *(unsigned int *)((long)a0 + 0x68);
  v3 = *(unsigned long *)((long)a0 + 0x60);
...
label_aa99:
    *(unsigned long *)((long)v25 + -8) = 0xaaa1;
    v6 = sub_a4c0(v10,(struct_16 *)&v1[3]);
    v16 = 1;
    v23 = v25;
    v13 = v19;
label_aaa8:
...
unsigned int sub_d6d0(long *a0,char *a1,struct_19 *a2)
{
  unsigned int v1; // eax
  struct_22 *v2;
  ...
  v2 = (struct_22 *)*a0;
  if (!v2) {
    v2 = (struct_22 *)sub_f380(7,NULL,sub_fba0,sub_fbd0,sub_fc10);
    *a0 = (long)v2;
    if (!v2)
...
void sub_e070(void *a0,char *a1,struct_19 *a2)
{
  unsigned long *v1; // rax
  unsigned long *v2; // rax
...
unsigned long sub_e100(struct_22 *a0,unsigned long a1,struct_19 *a2) // early-return
{
  unsigned long v1; // rax
...
void sub_e2f0(struct_14 *a0)
{
  sub_e1d0(a0->field_0x18); // tail-call
}
...
void sub_f240(struct_30 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_fb90(void *a0)
{
  return sub_fa00(a0); // tail-call
}

// Function: sub_fba0 @ 0xfba0
unsigned long sub_fba0(struct_26 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
char * sub_10b80(unsigned long a0,void *a1)
{
  unsigned long v1;
  char *v2;
  char *v3; // r8
...
char * sub_10c20(unsigned long a0,void *a1)
{
  bool v1;
  char *v2;
...
label_11798:
  ...
  if (v9 != '%') {
    ...
    if (v21)
      v12 = v21;
    if ((unsigned long)(a1 - v37) <= v12) goto label_11820;
    if (a0) {
      v40 = a0;
      if (1 < (int)v39) {
        v40 = &a0[v21 - 1];
    ...
    case 0x25:
      ...
      if (v40 == a2) {
        if ((v35 != 0x2d) && (0 <= v38)) {
          ...
          if (v21)
            v39 = v21;
          if ((unsigned long)(a1 - v37) <= v39) goto label_11820;
          if (a0) {
            if (2 <= v38) {
              v21 -= 1;
              v40 = &a0[v21];
...
label_12c97:
          ...
          if ((unsigned long)(a1 - v37) <= 1) goto label_11820;
          v39 = 1;
...
label_11ca5:
    ...
    case 0x46:
      ...
      v39 = sub_11700(0,0xffffffffffffffff,"%Y-%m-%d",a3,(unsigned char)v9,0x2b,4,v8,v31,(long)*(int *)((v21 & 0xff) * 4 + 0x1d3c0) + 0x1d3c0);
      v40 = "%Y-%m-%d";
      v21 = 0;
      v35 = 0x2b;
      v43 = v39;
    ...
    case 0x67:
      if (v15 != 0x45) {
        ...
        v31 = v15;
        v33 = sub_11620(v28,*(unsigned int *)&a3->field_0x18);
...
label_12ed6:
    ...
    case 0x54:
      ...
      v40 = "%H:%M:%S";
label_11d8d:
      v39 = sub_11700(0,0xffffffffffffffff,v40,a3,(unsigned char)v9,v35,v15,v8,v31);
      if ((v35 != 0x2d) && (0 <= v38)) {
        v21 = (unsigned long)v38;
        v43 = v21;
        if (v21 <= v39)
...
label_11e0b:
      if ((unsigned long)(a1 - v37) <= v43) goto label_11820;
      if (a0) {
        if (v39 < v21) {
          v21 -= v39;
          v30 = &a0[v21];
        ...
        a0 = &v30[v39];
        sub_11700(v30,a1 - v37,v40,a3,(unsigned char)v9,v35,v15,v8,a8);
      }
      v37 += v43;
      goto label_117e8;
    case 0x55:
...
label_12007:
    ...
    case 99:
    case 0x78:
      if (v15 != 0x4f) goto label_11a1c;
      break;
    case 0x59:
      if (v15 == 0x45) goto label_11cc2;
      if (v15 == 0x4f) break;
      v44._0_1_ = *(int *)&a3->field_0x14 < -0x76c;
      v10 = *(int *)&a3->field_0x14 + 0x76c;
      if (v35) goto label_12cb6;
    ...
    case 0x5a:
      ...
      if ((unsigned long)(a1 - v37) <= v44) goto label_11820;
      if (a0) {
        v40 = a0;
        if (v39 < v21) {
          v21 -= v39;
...
label_11a1e:
      if (v15) goto label_11cd1;
      v13 = (unsigned char *)((long)&v23 + 5);
      goto label_11a3e;
    case 0x71:
      if (v15 == 0x4f) goto label_11cc2;
      v34 = 0;
      v19 = 0;
      v45 = 1;
      v44._0_1_ = 0;
...
label_11a3e:
      ...
      *v13 = v32;
      ...
      if (v39) {
        ...
        if ((char *)(a1 - v37) <= v29) goto label_11820;
        if (a0) {
          if (v16 < v40) {
...
label_12310:
      ...
      if (v39 != 2) { // branch-flip
        if (3 <= v39) { // branch-flip
          v40 = v16;
          if (v39 != 3) break;
          if (v33 % 0x3c) goto label_12de3;
          if (v31) goto label_123ab;
          v34 = 1;
          v45 = 3;
          v27 = (bool)(v44._0_1_ ^ 1);
          v19 = 0;
...
label_129cb:
        ...
        if (((v33 >= v38) || (v35 == 0x2d)) && (v10 == 0x2d)) goto label_129fe;
label_12266:
        v30 = (char *)(long)v38;
        v29 = (char *)(long)v33;
...
label_125d5:
  ...
  if ((unsigned long)(a1 - v37) > v21) {
    ...
    else if (a1 == v37) goto label_11820;
label_117e8:
    v9 = v22[1];
    a2 = &v22[1];
...
void sub_13050(void *a0,unsigned long a1)
{
...
void sub_13070(void *a0,unsigned long a1)
{
  if (*(unsigned char *)((long)a0 + 0x50) & 1) {
...
unsigned long sub_13090(struct_28 *a0,long a1,long a2)
{
  long *v1; // rax
...
struct_15 * sub_13430(struct_15 *a0,int a1)
{
  if (a1 != 10) {
    a0->field_0x0 = a1;
    a0->field_0x4 = 0;
...
unsigned int sub_15260(void *a0,unsigned int a1)
{
  unsigned int v1;
...
struct_17 * sub_158d0(struct_17 *a0,unsigned long a1) // early-return
{
  struct_17 *v1;
  struct_17 *v2;
  void *v3; // rax
  
  v1 = (struct_17 *)a0->field_0x0;
  if (v1 != &a0[1]) {
    v2 = realloc(v1,a1);
    if (!v2)
      v2 = v1;
...
void sub_15940(struct_17 *a0)
{
  if ((struct_17 *)a0->field_0x0 != &a0[1]) {
    free((struct_17 *)a0->field_0x0); // tail-call
    return;
  }
}

// Function: sub_15960 @ 0x15960
unsigned long sub_15960(struct_17 *a0)
{
  unsigned long v1;
  long *v2; // rax
...
unsigned long sub_159e0(struct_17 *a0) // return-dupe
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // rax
...
void sub_167d0(FILE *a0,char *a1,char *a2,char *a3,struct_33 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
