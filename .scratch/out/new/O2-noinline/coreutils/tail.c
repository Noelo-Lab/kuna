...
void sub_8710(struct_21 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_9060(void *a0)
{
  return sub_8ed0(a0); // tail-call
}

// Function: sub_9070 @ 0x9070
char * sub_9070(unsigned long a0,void *a1)
{
  unsigned long v1;
  char *v2;
  char *v3; // r8
...
unsigned int sub_b070(void *a0,unsigned int a1)
{
  unsigned int v1;
...
void sub_bd90(FILE *a0,char *a1,char *a2,char *a3,struct_17 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
unsigned long sub_d200(struct_15 *a0,timespec *a1) // early-return
{
  int v1; // eax
  long v2;
