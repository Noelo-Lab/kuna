...
int sub_7080(void *a0,char *a1,int a2,char *a3,int a4,unsigned int a5,unsigned int a6,unsigned int a7,char a8,void *a9) // return-dupe
{
  int v1;
  int *v2; // rax
  char *v3; // rax
  ...
  if (!a8) {
    if (*(unsigned long *)((long)a0 + 0x18) & 0xff0000000000ff) // branch-flip
      v5 = *(unsigned int *)((long)a9 + 0x18);
    else {
      if (!*(char *)((long)a0 + 0x39)) goto label_70f0;
      a5 = *(unsigned int *)((long)a0 + 0x10);
      v5 = *(unsigned int *)((long)a9 + 0x18);
    }
    if (((unsigned short)(~(unsigned short)a5 | 0xe00) & v5 & 0xfff) && (sub_127a0(a1,a4,a5 & v5 & 0x1c0))) {
      v2 = __errno_location();
      if (((*v2 != 1) && (*v2 != 0x16)) || (*(char *)((long)a0 + 0x1b))) {
        v3 = (char *)sub_14440(4,a1);
        v4 = dcgettext(NULL,"clearing permissions for %s",5);
        error(0,*v2,v4,v3);
      }
      return -(unsigned int)*(unsigned char *)((long)a0 + 0x32); // return-dupe
    }
  }
label_70f0:
  if (a4 != -1) { // branch-flip
...
label_e0d7:
          ...
          if (!stat(v20,&v16)) {
            ...
            if (!v26) {
              v26 = (struct_7 *)sub_11bb0(7,NULL,sub_12460,sub_12490,sub_124d0);
              if (!v26) {
                sub_17150();
              }
            }
...
void sub_e790(void *a0,char *a1,struct_5 *a2)
{
  unsigned long *v1; // rax
  unsigned long *v2; // rax
...
unsigned long sub_e820(struct_6 *a0,unsigned long a1,struct_5 *a2) // early-return
{
  unsigned long v1; // rax
  unsigned long v2; // stack - 0x28
  unsigned long v3; // stack - 0x20
...
void sub_e880(unsigned int a0,struct_26 *a1) // ternary x2
{
  unsigned char v1;
  char v2; // cl
  char v3; // cl
...
void sub_ea00(void *a0,struct_26 *a1)
{
  sub_e880(*(unsigned int *)((long)a0 + 0x18),a1); // tail-call
}
...
long sub_eb30(struct_31 *a0) // early-return
{
  long v1; // rax
...
unsigned long sub_ebe0(struct_12 *a0,struct_12 *a1)
{
...
unsigned long sub_ec10(void *a0,unsigned long a1)
{
...
int sub_ec70(void *a0,void *a1,bool a2) // early-return x3
{
  stat *v1;
  unsigned long *v2;
  char *v3;
...
void * sub_ee20(void *a0,void *a1,unsigned long a2)
{
  unsigned long v1;
  long *v2;
  unsigned long v3;
...
void * sub_ef30(struct_16 *a0,void *a1,unsigned long a2)
{
  unsigned long v1;
  void *v2; // rax
...
unsigned long sub_efd0(void *a0,int a1)
{
  long v1;
  struct_6 *v2;
  struct_5 *v3; // rax
  ...
  if (!(*(unsigned char *)(v1 + 0x49) & 2))
    return 0;
  if (!v2) {
    v2 = (struct_6 *)sub_11bb0(0xd,NULL,sub_ec30,sub_ec40,dat_22fc0);
    *(struct_6 **)(v1 + 0x50) = v2;
...
void sub_f100(void *a0,int a1,bool a2)
{
  int v1;
  ...
  if ((v1 == a1) && (v1 != -100))
    abort(); // no-return
  if (a2) { // branch-flip
    v1 = sub_12520((void *)((long)a0 + 0x60));
    if (0 <= v1) {
      close(v1);
      goto label_f144;
    }
...
unsigned long sub_f160(void *a0,long a1)
{
  void *v1; // rax
...
unsigned long sub_f1d0(void *a0)
{
  unsigned long v1; // rax
  void *v2; // rax
  
  if (*(unsigned int *)((long)a0 + 0x48) & 0x102) {
    v1 = sub_11bb0(0x1f,NULL,sub_ec10,sub_ebe0,dat_22fc0);
...
unsigned long sub_f240(void *a0,struct_14 *a1) // return-dupe x2
{
  void *v1;
  struct_15 *v2; // rax
  struct_15 *v3; // rax
  ...
  if (!(*(unsigned int *)((long)a0 + 0x48) & 0x102)) {
    v4 = sub_17670(*(struct_13 **)((long)a0 + 0x58),&a1->field_0x70);
    if (!(char)v4)
      return 1;
    a1->field_0x0 = a1;
    a1->field_0x68 = 2;
...
void sub_f2f0(void *a0,void *a1)
{
  ...
  if (*(unsigned int *)((long)a0 + 0x48) & 0x102) { // branch-flip
    ...
    v4 = (void *)sub_12270(*(void **)((long)a0 + 0x58),&v5);
    if (!v4)
...
bool sub_f3b0(void *a0)
{
  ...
  while( true ) {
    if (sub_12510((void *)((long)a0 + 0x60))) break;
    v1 = sub_12560((void *)((long)a0 + 0x60));
    if (0 <= v1)
      close(v1);
  }
  return v2;
...
unsigned int sub_f440(void *a0,void *a1,int a2,char *a3) // return-dupe
{
  unsigned int v1;
...
label_f5f0:
    ...
    if (0 <= a2) { // branch-flip
      ...
      v4 = sub_12510((void *)((long)a0 + 0x60));
      if (v4) {
      ...
      v5 = sub_12560((void *)((long)a0 + 0x60));
      v7 = *(unsigned int *)((long)a0 + 0x48);
      if (v5 < 0) {
        v10 = 1;
        v5 = v7;
...
void * sub_f740(unsigned long *a0,int a1)
{
  unsigned char v1;
  unsigned long v10; // rax
  void *v11;
...
label_f7a2:
    ...
    v14 = sub_12620(v6,*(char **)((long)v15 + 0x30),v7,&v18);
    *(long *)((long)v15 + 0x18) = v14;
    ...
    if (*(short *)((long)v15 + 0x68) != 0xb) { // branch-flip
      ...
      *(unsigned short *)((long)v15 + 0x68) = sub_ec70(a0,v15,0);
    }
...
label_fc75:
      ...
      v14 = sub_efd0(v15,v18);
      v7 = v18;
      if (v14 == 0x9fa0) goto label_fc75;
      if (v14 <= 0x9fa0) {
        if ((v14) && (v14 != 0x6969)) goto label_fe11;
        goto label_fc75;
      }
      if ((v14 == 0x5346414f) || (v14 == 0xff534d42)) goto label_fc75;
label_fe11:
    ...
    if ((0 <= v7) && (!sub_f440(a0,v15,v7,NULL))) goto label_f7a2;
    if ((v23) && (v3))
      *(int *)((long)v15 + 0x40) = *__errno_location();
...
label_f874:
      ...
      v11 = (void *)sub_ef30(a0,&v9->field_0x13,v10);
      if (!v11) {
label_fd18:
        v7 = *v8;
        free(v11);
...
label_fe9b:
    ...
    v26 = NULL;
    if (!(bool)(v23 & v2 == NULL)) goto label_ff45;
    v3 = 0;
    v21 = 0;
label_ff20:
    if (*(long *)((long)v15 + 0x58)) // branch-flip
      v7 = sub_f440(a0,*(void **)((long)v15 + 8),0xffffffff,"..");
    else {
      v7 = sub_f3b0(a0);
    }
    if (v7) {
...
label_1054f:
          ...
          sub_124f0((struct_18 *)&v4[0xc],0xffffffff);
          return v4;
        }
      }
label_1047d:
...
unsigned int sub_10650(struct_11 *a0) // return-dupe
{
  long v1;
  void *v2;
  struct_7 *v3;
          ...
          if (*(short *)((long)v12 + 0x68) != 0xb) {
            *(char *)(a0->field_0x20 + *(long *)((long)v12 + 0x48)) = 0;
            if (*(long *)((long)v12 + 0x58)) { // branch-flip
              ...
              v8 = sub_f440(a0,*(void **)((long)v12 + 8),0xffffffff,"..");
            }
            else {
              v8 = sub_f3b0(a0);
            }
...
unsigned long sub_10f90(unsigned long a0,void *a1,unsigned int a2)
{
  if (a2 <= 4) {
...
int * sub_10fc0(struct_32 *a0,unsigned int a1) // early-return x2
{
  unsigned int v1;
  long v2;
  void *v3;
...
void sub_11a70(struct_33 *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
long sub_12400(void *a0)
{
  return sub_12270(a0); // tail-call
}

// Function: sub_12410 @ 0x12410
unsigned long sub_12410(void *a0,unsigned long a1)
{
  return *(unsigned long *)((long)a0 + 8) % a1;
}
...
unsigned long sub_12460(struct_8 *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
void sub_124f0(struct_18 *a0,unsigned int a1)
{
...
char sub_12510(void *a0)
{
  return *(char *)((long)a0 + 0x1c);
}

// Function: sub_12520 @ 0x12520
unsigned int sub_12520(void *a0,unsigned int a1)
{
  unsigned int v1;
  unsigned int v2; // eax
  unsigned int v3; // edx
...
unsigned int sub_12560(void *a0)
{
  unsigned int v1;
  unsigned int v2;
...
char * sub_13d70(unsigned int a0,char *a1,unsigned long a2,struct_10 *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
...
unsigned int sub_14020(void *a0,unsigned int a1)
{
  unsigned int v1;
...
{
  return sub_13d70(a0,a1,0xffffffffffffffff,(struct_10 *)0x236c0); // tail-call
}
...
{
  return sub_13d70(0,a0,0xffffffffffffffff,(struct_10 *)0x236c0); // tail-call
}

// Function: sub_142f0 @ 0x142f0
char * sub_142f0(char *a0,unsigned long a1)
{
  return sub_13d70(0,a0,a1,(struct_10 *)0x236c0); // tail-call
}
...
{
  return sub_13d70(0,a0,a1,(struct_10 *)0x23040); // tail-call
}

// Function: sub_14b10 @ 0x14b10
char * sub_14b10(unsigned int a0,char *a1)
{
  return sub_13d70(a0,a1,0xffffffffffffffff,(struct_10 *)0x23040); // tail-call
}

// Function: sub_14b30 @ 0x14b30
char * sub_14b30(char *a0)
{
  return sub_13d70(0,a0,0xffffffffffffffff,(struct_10 *)0x23040); // tail-call
}
...
unsigned long sub_15450(struct_9 *a0) // return-dupe
{
  unsigned long v1;
  void *v2; // rax
  struct_9 *v3;
...
unsigned int sub_15b50(int a0,char *a1,struct_29 *a2,void *a3,unsigned int a4)
{
  long v1;
  int v10;
  int v11; // edx
  ...
  v1 = a2->field_0x58;
  v20 = *(unsigned long *)((long)a3 + 0x58);
  v18 = (int)*(unsigned long *)((long)a3 + 0x60);
  v21 = v1 == v20;
  a4 &= 1;
...
label_161a0:
    ...
    v7 = sub_11bb0(0x10,NULL,sub_15b30,sub_15b40,dat_22fc0);
    dat_23700 = v7;
...
unsigned int sub_16390(char *a0,struct_29 *a1,void *a2,unsigned int a3)
{
...
void sub_16980(FILE *a0,char *a1,char *a2,char *a3,struct_37 *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
bool sub_171e0(void *a0,void *a1)
{
  unsigned int v1; // eax
  bool v2; // r8b
...
unsigned long sub_174e0(unsigned long *a0,int *a1,struct_21 *a2) // early-return x2
{
  void *v1; // rax
  unsigned long v2; // stack - 0x18
...
unsigned long sub_17670(struct_13 *a0,struct_12 *a1)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
...
int * sub_17bd0(int *a0,unsigned long *a1,int *a2,struct_21 *a3)
{
  unsigned long v1;
  unsigned long v10;
  unsigned long v11;
...
unsigned long sub_18e20(struct_21 *a0,struct_22 *a1) // return-dupe x2
{
  unsigned int v1;
  long v2;
  unsigned int *v3;
...
unsigned long sub_19050(char *a0,unsigned long *a1,struct_23 *a2) // return-dupe
{
  unsigned char v1;
  struct_23 *v10;
  char *v11;
