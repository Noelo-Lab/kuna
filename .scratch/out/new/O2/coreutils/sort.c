...
char * sub_7ca0(char *a0,long a1,void *a2)
{
  char *v1;
  long v2;
  char *v3;
  ...
  v1 = &a0[a1 + -1];
  v2 = *(long *)((long)a2 + 0x18);
  v5 = *(long *)((long)a2 + 0x10) + (unsigned long)(v2 == 0);
...
char * sub_e120(unsigned int a0,void *a1)
{
  int v1;
  char *v2;
  char *v3; // r8
...
char * sub_e1b0(unsigned long a0,void *a1)
{
  unsigned int v1; // edi
  char *v2;
...
char * sub_e200(unsigned long a0,void *a1)
{
  bool v1;
  char *v2;
...
unsigned int sub_104c0(void *a0,unsigned int a1)
{
  unsigned int v1;
...
void sub_11200(void *a0,unsigned long a1)
{
  *(unsigned long *)((long)a0 + 8) = a1;
}

// Function: sub_11210 @ 0x11210
void sub_11210(void *a0,unsigned long a1)
{
...
unsigned long sub_11aa0(FILE *a0,void *a1)
{
  int v1; // eax
  char *v2;
  long v3; // rax
...
label_11ace:
  do {
    ...
    if (*(char **)((long)a1 + 0x38) != v2) goto label_11ac0;
    _obstack_newchunk((obstack *)((long)a1 + 0x18),1);
    v2 = *(char **)((long)a1 + 0x30);
    *(char **)((long)a1 + 0x30) = &v2[1];
    *v2 = (char)v1;
