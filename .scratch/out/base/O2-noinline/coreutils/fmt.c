...
// Function: sub_26e0 @ 0x26e0
unsigned long sub_26e0(int a0,char **a1)
{
  char *v1;
  unsigned long v10;
  ...
  dat_18118 = 0;
  dat_18114 = 0;
  if (((2 <= a0) && (v1 = a1[1], *v1 == '-')) && ((unsigned int)((int)v1[1] - 0x30U) <= 9)) {
    v6 = &v1[1];
    v1 = *a1;
    a0 -= 1;
    a1 = &a1[1];
  ...
  v13 = NULL;
  while (v3 = getopt_long(a0,a1,"0123456789cstuw:p:g:",(void *)0xca80,NULL), v3 != -1) {
    if (0x77 < v3) {
label_2a9d:
  ...
  if (v6) { // branch-flip
    v3 = sub_7450(v6,0,0x9c4,"",dcgettext(NULL,"invalid width",5),0);
    dat_18120 = v3;
    if (v13) { // branch-flip
      dat_18110 = sub_7450(v13,0,(long)v3,"",dcgettext(NULL,"invalid width",5),0);
      v10 = v9;
    }
    else {
label_29f3:
      dat_18110 = (dat_18120 * 0xbb) / 200;
      v10 = (long)(dat_18120 * 0xbb) % 200 & 0xffffffff;
    }
  }
  else {
    if (!v13) goto label_29f3;
    dat_18110 = sub_7450(v13,0,0x4b,"",dcgettext(NULL,"invalid width",5),0);
...
void sub_2b90(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_cfc0)(sub_26e0,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_2c80(char a0) // return-dupe x2
{
  if (dat_18131) {
    dat_d0ec = dat_d0f0;
    return;
...
void sub_30b0(void *a0) // return-dupe
{
  unsigned char v1;
  unsigned int v2;
  unsigned char *v3;
...
void sub_3150(int a0) // return-dupe
{
  ...
  do {
    ...
    dat_18108 += 1;
  } while (dat_18108 < (int)v1);
}

// Function: sub_31f0 @ 0x31f0
void sub_31f0(unsigned long *a0)
{
  char v1;
  char *v2;
  int v3;
...
void sub_3460(unsigned long *a0)
{
  unsigned char *v1;
  char *v2; // rax
  long *v3; // rax
  ...
  v1 = (unsigned char *)*a0;
  v4 = &v1[(long)*(int *)&a0[1] + -1];
  v2 = strchr("([\'`\"",(int)(char)*v1);
  v3 = __ctype_b_loc();
  *(unsigned char *)&a0[2] = *(unsigned char *)(*v3 + (unsigned long)*v4 * 2) & 4 | v2 != NULL | *(unsigned char *)&a0[2] & 0xfa;
  ...
  *(unsigned char *)&a0[2] = *(unsigned char *)&a0[2] & 0xfd | (strchr(".?!",v5) != NULL) * '\x02';
}
...
unsigned long sub_3850(unsigned long a0)
{
  char v1; // al
  int v2;
  unsigned int v3; // eax
...
unsigned int sub_3a30(void *a0,unsigned long a1)
{
  int v1;
  unsigned int v2; // eax
...
void sub_41b0(void *a0,unsigned int a1)
{
  if (a0) {
...
unsigned long sub_41e0(void *a0) // early-return
{
  int v1;
  int *v2; // rax
...
unsigned long sub_42d0(unsigned int *a0,unsigned long a1,unsigned int a2) // return-dupe
{
  long v1; // rax
...
{
  return sub_78c0(a0 + 9,a1 + 9) == 0;
}

// Function: sub_4460 @ 0x4460
unsigned long sub_4460(long a0,unsigned long a1,unsigned char a2)
{
  unsigned char v1;
...
unsigned long sub_44c0(long a0,unsigned long a1,unsigned char a2,char a3)
{
  unsigned char v1;
...
unsigned long sub_4540(long a0,unsigned long a1,unsigned char a2,char a3,char a4)
{
  unsigned char v1;
...
unsigned long sub_45b0(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5)
{
  unsigned char v1;
...
unsigned long sub_4650(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6)
{
  unsigned int v1;
  unsigned char v2;
...
unsigned long sub_46f0(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,unsigned int a7)
{
  unsigned int v1;
  unsigned int v2;
  unsigned char v3;
...
unsigned long sub_47b0(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,unsigned int a8)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_4870(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,int a8,unsigned int a9)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_4950(unsigned char *a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6,unsigned int a7,unsigned int a8) // early-return
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
    ...
    if (v25) {
      ...
      if (v25) {
        if (v30) {
          ...
          if ((a3 < v23 + v30) || (v8 = memcmp(v11,v31,v30), v8)) goto label_5600;
          if (!v24) {
            v7 = *v11;
...
label_56a4:
              ...
              if (((bool)(v2 & v24)) && (v30)) goto label_56ca;
              v16 = 0x5c;
              goto label_50f2;
            }
          }
...
label_4dc8:
    v16 = (unsigned char)v21;
    v12 = v13;
    if (!v29) goto label_4f73;
    if (!(*(unsigned int *)(v29 + (v21 >> 5) * 4) >> (v16 & 0x1f) & 1)) goto label_4f73;
  }
  else {
label_4f70:
    v7 = 0;
...
label_5103:
  if (v24) {
    v24 = v2;
label_511f:
    if ((bool)(v24 & a4 == 2)) goto label_512b;
label_4ebc:
    v34 &= 0xfffffffd;
    v29 = 0;
    goto label_4bb0;
...
void * sub_5f70(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_d058 <= (int)a0) {
      v10 = (long)dat_d058;
      v9 = (long)(int)((a0 - dat_d058) + 1);
      if (dat_d060 != (unsigned long *)0xd070) // branch-flip
        v6 = (unsigned long *)sub_7100(dat_d060,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_7100(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_d070;
        v6[1] = dat_d078;
      }
      dat_d060 = v6;
      memset(&v6[(long)dat_d058 * 2],0,(v10 - dat_d058) * 0x10);
      dat_d058 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_4b40(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x18160)
      ...
      sub_4b40(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
void sub_6280(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_4b40(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_6300 @ 0x6300
unsigned long sub_6300(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_4b40(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_6f80(v3 + 1);
  sub_4b40(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_63f0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_6300(a0,a1,0,a2); // tail-call
}
...
void sub_64a0(unsigned long a0,unsigned long a1)
{
  sub_5f70(a0,a1,0xffffffffffffffff,0x18260); // tail-call
}
...
void sub_64d0(unsigned long a0)
{
  sub_64a0(0,a0); // tail-call
}

// Function: sub_64e0 @ 0x64e0
void sub_64e0(unsigned long a0,unsigned long a1)
{
  sub_64c0(0,a0,a1); // tail-call
}

// Function: sub_64f0 @ 0x64f0
void sub_64f0(unsigned int a0,unsigned long a1,unsigned long a2)
{
  char v1 [56];
...
void sub_6550(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_65c0(unsigned int a0,unsigned long a1)
{
  sub_64f0(0,a0,a1); // tail-call
}

// Function: sub_65d0 @ 0x65d0
void sub_65d0(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_6550(0,a0,a1,a2); // tail-call
}

// Function: sub_65f0 @ 0x65f0
void sub_65f0(unsigned long a0,unsigned long a1,char a2,unsigned long a3)
{
...
void sub_6680(unsigned long a0,char a1)
{
  sub_65f0(a0,0xffffffffffffffff,(int)a1); // tail-call
}

// Function: sub_66a0 @ 0x66a0
void sub_66a0(unsigned long a0)
{
  sub_6680(a0,0x3a); // tail-call
}

// Function: sub_66b0 @ 0x66b0
void sub_66b0(unsigned long a0,unsigned long a1)
{
  sub_65f0(a0,a1,0x3a); // tail-call
}

// Function: sub_66c0 @ 0x66c0
void sub_66c0(unsigned int a0,unsigned long a1,unsigned long a2)
{
...
void sub_6760(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
...
void sub_6830(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
...
void sub_6860(unsigned long a0,unsigned long a1)
{
  sub_6850(0,a0,a1); // tail-call
}

// Function: sub_6870 @ 0x6870
void sub_6870(unsigned long a0,unsigned long a1)
{
  sub_6850(a0,a1,0xffffffffffffffff); // tail-call
}

// Function: sub_6880 @ 0x6880
void sub_6880(unsigned long a0)
{
  sub_6870(0,a0); // tail-call
}

// Function: sub_6890 @ 0x6890
long sub_6890(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
...
void sub_6d30(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_7080(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  unsigned long v2; // rax
  unsigned long v3;
...
void sub_70f0(unsigned long a0,unsigned long a1)
{
  sub_7080(a0,a1,1); // tail-call
}

// Function: sub_7100 @ 0x7100
void sub_7100(long a0,long *a1,long a2,long a3,long a4)
{
  long v1;
  long v2;
  long v3;
...
unsigned long sub_7340(unsigned long a0,unsigned int a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,int a6)
{
  int v1;
  int *v2; // rax
  unsigned long v3; // stack - 0x48
  
  v1 = sub_74e0(a0,0,a1,&v3);
  if (v1) { // branch-flip
    v2 = __errno_location();
    if (v1 != 1) {
      if (v1 == 3)
...
void sub_7450(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
...
label_75a9:
  ...
  switch((unsigned int)v5 - 0x42 & 0xff) {
    case 0:
      v10 |= sub_7480(&v7,0x400);
      break;
    default:
      goto label_75a9;
    case 3:
      v10 |= sub_74b0(&v7,v9,6);
      break;
    case 5:
    case 0x25:
      v10 |= sub_74b0(&v7,v9,3);
      break;
    case 9:
    case 0x29:
      v10 |= sub_74b0(&v7,v9,1);
      break;
    case 0xb:
    case 0x2b:
      v10 |= sub_74b0(&v7,v9,2);
      break;
    case 0xe:
      v10 |= sub_74b0(&v7,v9,5);
      break;
    case 0x12:
    case 0x32:
      v10 |= sub_74b0(&v7,v9,4);
      break;
    case 0x17:
      v10 |= sub_74b0(&v7,v9,8);
      break;
    case 0x18:
      v10 |= sub_74b0(&v7,v9,7);
      break;
    case 0x20:
      v10 |= sub_7480(&v7,0x200);
      break;
    case 0x21:
      break;
    case 0x35:
...
unsigned long sub_7920(void *a0) // early-return x2, return-dupe
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_7a40(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
