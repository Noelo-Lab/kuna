...
void * localtime_r(void *a0,void *a1)
{
  ...
  v1 = (void *)(*dat_1cfc8)(); // jump-as-call
  return v1;
}
...
void * readdir(void *a0)
{
  ...
  v1 = (void *)(*dat_1ce50)(); // jump-as-call
  return v1;
}
...
void getmntent(void)
{
  (*dat_1ce78)(); // jump-as-call
}

// Function: setmntent @ 0x3a50
void setmntent(void)
{
  (*dat_1ce80)(); // jump-as-call
}
...
void * fopen(char *a0,char *a1)
{
  ...
  v1 = (void *)(*dat_1cef0)(); // jump-as-call
  return v1;
}
...
void sub_4950(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_1cfb8)(sub_3cd0,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
unsigned int sub_5540(unsigned int a0)
{
  ...
  if (dat_1d110) {
    ...
    v3 = __errno_location();
    if (*v3) {
      v5 = sub_10680(0,3,*(unsigned long *)(v1 + 0x20));
      v4 = dcgettext(NULL,"fts_read failed: %s",5);
      v6 = 0;
      error(0,*v3,v4,v5);
    }
    dat_1d188 = 0;
...
void sub_5c30(unsigned long a0,unsigned long a1,long a2)
{
  char *v1; // rax
  unsigned long v2; // rax
...
void sub_5cc0(long *a0,void *a1,unsigned long a2)
{
  long v1;
  void *v2;
  long v3;
  ...
  while (v1) {
    if ((v3) && (!memcmp(v4,a1,a2)))
      __fprintf_chk(stderr,1,", %s",sub_10840(v1));
    else {
...
long sub_5dc0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,void *a5,char a6) // early-return
{
  long v1; // rax
...
void sub_5eb0(unsigned long a0) // return-dupe
{
  unsigned long *v1; // rax
...
long sub_5f20(long *a0,int *a1) // early-return x2
{
  long *v1;
  long v2;
  void *v3;
...
{
  sub_be30(*(unsigned long *)((long)a0 + 8));
  free(a0); // tail-call
}

// Function: sub_6120 @ 0x6120
long sub_6120(unsigned long *a0,long a1) // early-return
{
  long *v1; // rax
  long *v2;
  long v3;
  ...
  *v2 = a1;
  v1 = (long *)sub_c290(*a0,v2);
  if (!v1)
    return 0;
  if (v2 == v1) {
    a0[2] = 0;
    v3 = sub_bc70(0x3fd,0,sub_60f0,0,0);
    v2[1] = v3;
    return v3;
  }
  v3 = v1[1];
...
long sub_61d0(long a0,long a1)
{
  ...
  v1 = *(long *)(a0 + 8);
  if (!v1) {
    v1 = sub_d190(0x7fffffffffffffff);
    *(long *)(a0 + 8) = v1;
    if (!v1)
      return -1;
  }
...
unsigned long sub_62e0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  long v1; // rax
  long v2; // rax
  ...
  if (v1) {
    v2 = sub_61d0(a0,a2);
    if (v2 != -1)
      return sub_c0a0(v1,v2,0); // tail-call
  }
  return 0xffffffff;
}

// Function: sub_6330 @ 0x6330
unsigned long sub_6330(unsigned long a0,unsigned long a1,unsigned long a2)
{
  long v1; // rax
  long v2; // rax
...
unsigned long sub_64c0(char *a0,char *a1,unsigned int a2) // early-return
{
  int v1; // eax
  unsigned int v2; // eax
...
void sub_65b0(unsigned long *a0,int a1,unsigned int a2)
{
  ...
  v2 = (unsigned long *)sub_11940(0x28);
  *(int *)&v2[1] = a1;
  *(unsigned int *)((long)v2 + 0xc) = a2;
  if (!a1) {
    ...
    if (v5)
      v4 = sub_6630;
    v2[2] = sub_bc70(0,0,v4,v3,sub_63e0);
  }
  v1 = *a0;
  *a0 = v2;
  *v2 = v1;
...
char * sub_6710(unsigned int a0,unsigned long a1,char *a2,char *a3)
{
  char *v1; // rax
...
void sub_67c0(long a0,unsigned long a1)
{
  ...
  v2 = (unsigned long *)sub_11680(0x10);
...
void sub_68d0(unsigned long *a0)
{
  unsigned long *v1;
  unsigned long *v2;
...
unsigned int sub_69f0(unsigned int *a0,unsigned long a1)
{
  unsigned long v1;
  int v2; // eax
...
unsigned long sub_6a30(long a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long v2; // r13
...
void sub_6b50(long *a0,char *a1,unsigned int a2) // return-dupe x2
{
  ...
  v6 = *(long *)(v9 + 0x10);
  if (v11 == *(long *)(v9 + 0x18)) {
    v6 = sub_11840(v6,v9 + 0x18,1,0xffffffffffffffff,0x48);
    v11 = *(long *)(v9 + 0x20);
    *(long *)(v9 + 0x10) = v6;
  }
  *(long *)(v9 + 0x20) = v11 + 1;
  ...
  *v1 = a2;
  ...
  if (a2 & 8) { // branch-flip
    ...
    if (0 < (long)v4) {
      do {
        v8 = v4;
        if (a1[v4 - 1] != '/') goto label_6c31;
        v4 -= 1;
      } while (v4);
      goto label_6c91;
    }
    v8 = v4;
    if (!v4) goto label_6c91;
label_6c31:
    v5 = (void *)sub_116a0(v8 + 7);
    memcpy(v5,a1,v4);
...
int sub_6df0(void *a0,unsigned long a1,void *a2,unsigned int a3,unsigned char a4,unsigned long a5)
{
  int v1; // eax
  int *v10; // stack - 0x58
  int v11; // stack - 0x50
  ...
  while( true ) {
    ...
    if (v1 == -1) break;
    if (v4 == v7)
      v2 = sub_11840(v2,&v4,1,0xffffffffffffffff,1);
    *(char *)(v2 + v7) = (char)v1;
    v7 += 1;
  }
  v9 = ferror(a2);
      ...
      do {
        ...
        if (*v8 == a4) {
          ...
          if (*(unsigned short *)(v2 + (unsigned long)a4 * 2) & 0x2000) { // branch-flip
            for (; v3 != v8; v8 = &v8[-1]) {
              if (!(*(unsigned char *)(v2 + 1 + (unsigned long)v8[-1] * 2) & 0x20)) goto label_6f8d;
            }
          }
          else {
label_6f8d:
...
unsigned int sub_6fe0(unsigned long a0,unsigned long a1,char *a2,unsigned int a3,char a4) // return-dupe
{
  int v1;
  unsigned int v2; // eax
  void *v3; // rax
...
unsigned long sub_70c0(void *a0) // early-return
{
  int v1;
  int *v2; // rax
...
void sub_71f0(void *a0,unsigned char *a1,long a2)
{
  unsigned char v1;
  long *v2; // rax
...
void sub_7250(void *a0,unsigned char *a1,long a2)
{
  unsigned char v1;
  long *v2; // rax
  unsigned char *v3; // r12
...
unsigned long sub_72b0(void *a0,char *a1,unsigned int *a2,char a3,unsigned int a4,int a5,unsigned long a6,int a7)
{
  int v1;
  unsigned long v10;
  char *v11;
  ...
  char *v20;
  unsigned long v21;
  char v22; // stack - 0x44b
  unsigned short v23; // stack - 0x44d
  char v24 [23];
  long v25;
  ...
  bool v37;
  int *v38; // stack - 0x4f0
  unsigned int v39; // stack - 0x4e8
  int *v4;
  unsigned long v40; // stack - 0x4c0
  unsigned long v41; // stack - 0x4b8
  char *v42; // stack - 0x4a8
  unsigned long v43; // stack - 0x480
  unsigned long v44; // stack - 0x478
  long v45; // stack - 0x470
  unsigned long v46; // stack - 0x468
...
label_7342:
  ...
  if (v29 - 0x30 <= 9) {
    ...
    do {
      v35 = (long)(int)v34 * 10;
      v33 = (int)v35;
      if ((v33 != v35) || (v34 = (unsigned long)(unsigned int)(v33 + *v32 + -0x30), SCARRY4(v33,*v32 + -0x30)))
        v34 = 0x7fffffff;
      v11 = &v32[1];
      v21 = (unsigned long)(unsigned int)(int)*v11;
      v32 = &v32[1];
      v10 = v21;
  ...
  if (((char)v21 != 'E') && ((char)v21 != 'O'))
    ...
    v21 = (unsigned long)(unsigned char)v32[1];
    v32 = &v32[1];
  }
  v31 = (char)v21;
  v33 = (int)v34;
  ...
  switch(v21 & 0xff) {
    ...
    case 0x25:
      if (&v32[-1] == a1) {
        if ((v30 != 0x2d) && (0 <= v33)) {
          v21 = (unsigned long)v33;
          v34 = 1;
          if (v21)
            v34 = v21;
          if (~v36 <= v34) goto label_73c0;
          if (a0) {
            if (2 <= v33) {
              if ((v30 != 0x30) && (v35 = 0, v30 != 0x2b)) {
                do {
                  v35 += 1;
                  fputc(0x20,a0);
                } while (v21 - 1 != v35);
...
label_881f:
          ...
          if (0xfffffffffffffffe <= v36) goto label_73c0;
          v34 = 1;
    ...
    case 0x43:
      if (v17 != 0x45) {
        v29 = a2[5];
        v37 = (int)v29 < -0x76c;
        v16 = (int)((-(unsigned int)(v29 + 0x76c < 0x76c) & 0xffffff9d) + v29) / 100 + 0x13;
        v8 = -0x76c <= (int)v29;
        if (!v30)
          v30 = a4;
        if (v30 != 0x2b) { // branch-flip
          v2 = 0;
          v17 = 2;
        }
        else {
...
label_8899:
    ...
    case 0x46:
      ...
      v17 = 4;
      v11 = "%Y-%m-%d";
      v34 = sub_72b0(0,"%Y-%m-%d",a2,v7,0x2b,4,v6,v28);
      v30 = 0x2b;
      v40 = v34;
      goto label_7e11;
    case 0x47:
    ...
    case 0x67:
      if (v17 != 0x45) {
        v15 = a2[5];
        v14 = (v15 - 100) + ((int)v15 >> 0x1f & 400U);
        v16 = a2[7];
        v28 = sub_71b0(v16,a2[6]);
        if (0 <= v28) { // branch-flip
          v17 = 0x16d;
          if ((!(v14 & 3)) && (v17 = 0x16e, (v14 * -0x3d70a3d7 + 0x51eb850 >> 2 | v15 * 0x40000000) <= 0x28f5c28))
            v17 = 0x16e - (unsigned int)((int)v14 % 400 != 0);
          v17 = sub_71b0(v16 - v17);
          if (0 <= v17)
            v28 = v17;
          v19 = (v17 >> 0x1f) + 1;
        }
          ...
          v14 -= 1;
          v28 = 0x16d;
          if ((!(v14 & 3)) && (v28 = 0x16e, (v14 * -0x3d70a3d7 + 0x51eb850 >> 2 | v14 * 0x40000000) <= 0x28f5c28))
            v28 = 0x16e - (unsigned int)((int)v14 % 400 != 0);
          v28 = sub_71b0(v16 + v28);
          v19 = -1;
        }
        if (v31 == 'G') {
          v16 = v15 + 0x76c + v19;
          v37 = (int)v15 < 0xfffff894U - v19;
          if (v30) { // branch-flip
label_8884:
            v17 = 4;
            v29 = 9999;
            if (v30 == 0x2b) goto label_8899;
            v2 = 0;
            v8 = (bool)(v37 ^ 1);
          }
          else {
...
label_8aa6:
        ...
        v16 = ((int)v15 % 100 + v19) % 100;
        if (0 <= (int)v16) goto label_7830;
        if ((int)v15 < 0xfffff894U - v19) {
          v16 = -v16;
          if (!v30) goto label_7842;
label_884b:
          v29 = v30;
          goto label_7842;
        }
        v16 += 100;
        if (v30) goto label_884b;
    ...
    case 0x54:
      ...
      v11 = "%H:%M:%S";
label_7db9:
      v34 = sub_72b0(0,v11,a2,v7,v30,v17,v6,v28);
      if ((v30 != 0x2d) && (0 <= v33)) {
        v21 = (unsigned long)v33;
        v40 = v21;
        if (v21 <= v34)
...
label_7e11:
      ...
      if (a0) {
        ...
        sub_72b0(a0,v11,a2,v7,v30,v17,v6,a7);
      }
      v36 += v40;
      goto label_738d;
    case 0x55:
...
label_7b23:
    ...
    case 0x57:
      if (v17 != 0x45) {
        v19 = (((int)(a2[6] + 6) / 7) * 7 - (a2[6] + 6)) + 7 + a2[7];
        goto label_7b23;
      }
      break;
    case 0x58:
    case 99:
    case 0x78:
      if (v17 != 0x4f) goto label_7634;
      break;
    case 0x59:
      if (v17 == 0x45) goto label_7872;
      if (v17 == 0x4f) break;
      v37 = (int)a2[5] < -0x76c;
      v16 = a2[5] + 0x76c;
      if (v30) goto label_8884;
    ...
    case 0x5a:
      ...
      if (~v36 <= v41) goto label_73c0;
      if (a0) {
        if (v34 < v21) {
          if ((v30 != 0x30) && (v30 != 0x2b)) {
            v35 = 0;
            if (v21 != v34) {
              do {
                v35 += 1;
...
label_8474:
      ...
      if (v18)
        v7 = '\0';
label_7639:
      if (v17) goto label_7884;
      v11 = &v22;
      goto label_7657;
    case 0x71:
      if (v17 == 0x4f) goto label_7872;
      v2 = 0;
      v37 = 0;
      v29 = 0;
      v17 = 1;
      v16 = ((int)(a2[4] * 0xb) >> 5) + 1;
      goto label_7ff0;
    case 0x72:
label_7634:
      v42._0_1_ = '\0';
      goto label_7639;
    case 0x73:
      v46 = *(unsigned long *)&a2[8];
      v47 = *(unsigned long *)&a2[10];
      v26 = *(unsigned long *)a2;
      v43 = *(unsigned long *)&a2[2];
      v44 = *(unsigned long *)&a2[4];
      v48 = *(unsigned long *)&a2[0xc];
      v45._0_4_ = (unsigned int)*(unsigned long *)&a2[6];
      v45 = CONCAT44(0xffffffff,(unsigned int)v45);
      v35 = sub_10d80(v6,&v26);
      if (v45 <= -1) {
        *v38 = 0x4b;
        return 0;
      }
      v37 = SUB81((unsigned long)v35 >> 0x3f,0);
      v11 = &v27[1];
      v13 = v35;
      do {
        v3 = v13 / 10;
        v31 = (char)v13 + (char)v3 * '\xf6';
        if (v35 <= -1)
          v31 = -v31;
        v11 = &v11[-1];
        *v11 = v31 + '0';
...
label_7a78:
      v2 = 0;
      v29 = 0;
      v12 = (unsigned char)(v16 >> 0x18);
      v37 = (bool)(v12 >> 7);
      v8 = (bool)((unsigned char)~v12 >> 7);
      goto label_7860;
    case 0x77:
      if (v17 != 0x45) {
        v17 = 1;
...
label_82c7:
      v32 = v11;
      if ((int)a2[8] < 0) goto label_738d;
      v37 = 1;
      v28 = (int)*(unsigned long *)&a2[10];
      if ((0 <= v28) && (v37 = 0, !v28))
        v37 = *v9 == '-';
      v16 = v28 / 0xe10;
      v19 = (v28 / 0x3c) % 0x3c;
      if (v34 != 2) { // branch-flip
        if (3 <= v34) { // branch-flip
          if (v34 != 3) break;
          if (v28 % 0x3c) goto label_89cb;
          if (v19) goto label_8367;
          v2 = 1;
          v17 = 3;
          v8 = (bool)(v37 ^ 1);
          v29 = 0;
        }
        else if (v34) { // branch-flip
label_8367:
          v2 = 1;
          v17 = 6;
          v8 = (bool)(v37 ^ 1);
...
label_89cb:
        ...
        v17 = 9;
        v29 = 0x14;
        v16 = v28 % 0x3c + v16 * 10000 + v19 * 100;
        v8 = (bool)(v37 ^ 1);
      }
label_7860:
...
label_7ff0:
        ...
        while( true ) {
          ...
          v29 = (int)v29 >> 1;
          v11 = &v20[-1];
          v20[-1] = (char)v16 + (char)(v16 / 10) * '\xf6' + '0';
          if ((v16 <= 9) && (!v29)) break;
          v16 /= 10;
          v20 = v11;
        }
...
label_84e5:
          ...
          if (0xfffffffffffffffe <= v36) goto label_73c0;
          if (a0)
            fputc((int)(char)v41,a0);
          v41 = (unsigned long)v28;
          v36 += 1;
          v34 = 0;
          if ((v16 != 0x2d) && (v33 = v33 + -1, 0 <= v33)) {
label_7c77:
            v34 = (unsigned long)v33;
            v41 = (long)v28;
            if ((unsigned long)(long)v28 <= v34)
              v41 = v34;
          }
        }
        else {
          ...
          v41 = (unsigned long)v28;
          if (((v28 < v33) && (v30 != 0x2d)) || (v16 != 0x2d)) goto label_7c77;
          v34 = 0;
        }
...
label_7740:
        v36 += v41; // crossjump-dupe
      }
      else {
        if (!v8) goto label_8160;
label_7872:
        v42._0_1_ = '\0';
label_7884:
        v22 = (char)v10;
...
label_7657:
        ...
        *v11 = v31;
        v11[1] = '\0';
        v34 = strftime(&v24[1],0x400,(char *)&v23,a2);
        if (v34) {
          v34 -= 1;
          if ((v30 != 0x2d) && (0 <= v33)) {
            v21 = (unsigned long)v33;
          ...
          if (a0) {
            ...
            if ((char)v42) // branch-flip
              sub_71f0(a0,&v24[2],v34);
            else if (v7) // branch-flip
              sub_7250(a0,&v24[2],v34);
            else {
              fwrite(&v24[2],v34,1,a0);
            }
          }
          v36 += v41;
        }
  ...
  if ((char *)~v36 <= v42) goto label_73c0;
  if (a0) {
    if (v11 < v20) {
      if ((v30 != 0x30) && (v30 != 0x2b)) {
        v35 = 0;
...
label_7963:
    ...
    do {
      v11 = &v11[-1];
      *v11 = (char)v17 + (char)(v17 / 10) * '\xf6' + '0';
      v17 /= 10;
    } while (&v24[v34 - (unsigned int)(v19 - 1)] != v11);
  }
  else {
    v21 = 0;
  }
...
label_73c0:
  ...
  if (a0) {
    if (v7) // branch-flip
      sub_7250(a0,&v24[1],v21);
    else {
      fwrite(&v24[1],v21,1,a0);
    }
  }
  v36 += v21;
  if ((v30 != 0x2d) && (0 <= v33 - v19)) {
    v34 = (unsigned long)(v33 - v19);
    if (~v36 <= v34) goto label_73c0;
    if (a0) {
      if (!v34) goto label_738d;
      if ((v30 != 0x30) && (v21 = 0, v30 != 0x2b)) {
        do {
          v21 += 1;
          fputc(0x20,a0);
        } while (v34 != v21);
  ...
  else if (v36 == 0xffffffffffffffff) goto label_73c0;
label_738d:
  v7 = v32[1];
  a1 = &v32[1];
...
long sub_8c10(unsigned long a0,unsigned long a1,void *a2)
{
  char v1; // al
  int v2;
  int *v3;
...
unsigned long sub_8e00(unsigned int *a0,unsigned long a1,unsigned int a2) // return-dupe
{
  long v1; // rax
...
unsigned long sub_8e80(long *a0,long *a1)
{
  if (a0[1] != a1[1])
    return 0;
  return CONCAT71((undefined7)((unsigned long)*a1 >> 8),*a0 == *a1);
...
int sub_9010(long a0,long a1,char a2) // early-return x3
{
  void *v1;
  unsigned long *v2;
  char *v3;
...
void sub_9430(unsigned long a0)
{
  int v1; // eax
  ...
  if ((0 <= a1) && (!fstatfs(a1,v6))) {
    if ((v2) && (v3 = malloc(0x10), v3)) {
      *v3 = *(unsigned long *)(a0 + 0x70);
      v3[1] = v6[0];
      v4 = (unsigned long *)sub_c290(v2,v3);
      if (v4) { // branch-flip
        if (v3 != v4)
          abort(); // no-return
      }
...
unsigned long sub_96c0(long a0,unsigned long *a1) // return-dupe x2
{
  unsigned long v1;
  unsigned long *v2; // rax
  unsigned long *v3; // rax
  ...
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    v4 = sub_130e0(*(unsigned long *)(a0 + 0x58),&a1[0xe]);
    if (!(char)v4)
      return 1;
    *a1 = a1;
  ...
  *v2 = v4;
  v2[1] = a1[0xf];
  v3 = (unsigned long *)sub_c290(v1,v2);
  if (v2 == v3)
    return 1;
  free(v2);
  if (v3) {
...
void sub_9770(long a0,int a1,char a2)
{
  int v1;
...
void sub_9840(long a0,long a1)
{
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x102) { // branch-flip
    ...
    v4 = (void *)sub_c2f0(*(unsigned long *)(a0 + 0x58),&v5);
    if (!v4)
...
void sub_9980(unsigned long a0,unsigned int a1,unsigned long a2)
{
  if (a1 & 0x200) {
...
void * sub_9c70(long *a0,int a1) // return-dupe
{
  long v1;
  unsigned long v10;
  void *v11; // rax
...
label_9cd2:
    ...
    v12 = sub_e2b0(v16,*(unsigned long *)(v1 + 0x30),v7,&v14);
    *(long *)(v1 + 0x18) = v12;
    if (!v12) {
      if (a1 == 3) {
        *(unsigned short *)(v1 + 0x68) = 4;
...
label_a0b7:
    ...
    if ((0 <= v7) && (!sub_99c0(a0,v1,v7,0))) goto label_9cd2;
    if ((v20) && (v4))
      *(int *)(v1 + 0x40) = *__errno_location();
...
label_9da3:
      ...
      v11 = (void *)sub_92d0(a0,(char *)((long)v9 + 0x13),v10);
      if (!v11) {
label_a130:
        v7 = *v8;
        free(v11);
      ...
      *(unsigned long *)((long)v11 + 0x78) = *v9;
      ...
      if ((a0[8]) && (!(v13 & 0x400)))
        *(unsigned short *)((long)v11 + 0x68) = sub_9010(a0,v11,0);
      else {
        v10 = 1;
        ...
        *(unsigned short *)((long)v11 + 0x68) = 0xb;
        sub_8f10((long)v11 + 0x70);
        sub_8ff0(v11,v10 & 0xffffffff);
      }
...
label_a234:
    if (v27)
      sub_9900(a0[1],a0[4],v23);
    if (*(unsigned char *)&a0[9] & 4) {
      if ((a0[6] == v21) || (!v18)) goto label_a264;
label_a26a:
      *v24 = 0;
    }
    if ((v2) || (!v20)) {
...
label_a2f0:
      if (*(long *)(v1 + 0x58)) // branch-flip
        v7 = sub_99c0(a0,*(unsigned long *)(v1 + 8),0xffffffff,"..");
      else {
        v7 = sub_97d0(a0);
      }
      if (v7) {
...
void sub_a5c0(unsigned int a0,void *a1)
{
  if (!(a0 & 0x102)) {
    free(a1); // tail-call
    return;
...
unsigned int sub_a960(long *a0) // return-dupe
{
  long *v1;
  void *v2;
  int *v3; // rax
  ...
  if (*(unsigned int *)&a0[9] & 0x200) { // branch-flip
    v6 = *(int *)((long)a0 + 0x2c);
    if ((v6 <= -1) || (!close(v6))) goto label_a9f7;
    v6 = *__errno_location();
label_aaad:
    sub_9430(v1);
    v5 = a0[10];
    if (v5) goto label_aa0c;
  }
  else {
    if (!(*(unsigned int *)&a0[9] & 4)) {
      ...
      if (fchdir((int)v5)) {
        ...
        v5 = a0[5];
        v6 = *v3;
        if (!close((int)v5)) goto label_aaad;
        if (!v6) goto label_aa68;
        sub_9430(v1);
        v5 = a0[10];
        if (!v5) {
          sub_a5c0((int)a0[9],a0[0xb]);
          free(a0);
          goto label_aa31;
        }
        goto label_aa0c;
          ...
          if (*(short *)((long)v8 + 0x68) != 0xb) {
            *(char *)(a0[4] + *(long *)((long)v8 + 0x48)) = 0;
            if (*(long *)((long)v8 + 0x58)) { // branch-flip
              ...
              v6 = sub_99c0(a0,*(unsigned long *)((long)v8 + 8),0xffffffff,"..");
            }
            else {
              v6 = sub_97d0(a0);
            }
      ...
      if (*(short *)((long)v8 + 0x6c) == 2) {
        ...
        *(short *)((long)v8 + 0x68) = v5;
        if ((v5 == 1) && (!(*(unsigned int *)&a0[9] & 4))) {
          v6 = sub_9980(*(unsigned int *)((long)a0 + 0x2c),*(unsigned int *)&a0[9],".");
          *(int *)((long)v8 + 0x44) = v6;
          if (0 <= v6) // branch-flip
...
int * sub_b1c0(long *a0,unsigned int a1) // early-return x2
{
  long v1;
  int v2;
  int *v3;
  ...
  *v5 = 0;
  ...
  if (((*(long *)(v1 + 0x58)) || (**(char **)(v1 + 0x30) == '/')) || (*(unsigned int *)&a0[9] & 4)) {
    v5 = (long)sub_9c70(a0,v6);
    a0[1] = (long)v5;
  }
  else {
    v4 = sub_9980(*(unsigned int *)((long)a0 + 0x2c),*(unsigned int *)&a0[9],".");
    v2 = v4;
    if (v4 < 0) {
      a0[1] = 0;
      v5 = NULL;
...
unsigned long sub_b760(float a0,unsigned long a1,char a2) // early-return, ternary
{
  unsigned long v1; // rax
...
bool sub_b880(unsigned long *a0)
{
  long v1;
  long *v2;
  long v3;
...
long sub_ba70(unsigned long *a0)
{
  long *v1;
...
void sub_bb30(unsigned long *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
void sub_bc40(unsigned long *a0)
{
  *(char *)&a0[2] = 0;
...
unsigned long sub_c690(char *a0,unsigned long *a1,unsigned int *a2)
{
  char *v1;
  char v2;
  int v3; // eax
  ...
  if (((a0) || (a0 = getenv("BLOCK_SIZE"), a0)) || (a0 = getenv("BLOCKSIZE"), a0)) {
    ...
    v3 = sub_5ac0(a0,0x1ca20,0x15ab0,4);
    if (0 <= v3) { // branch-flip
      *a1 = 1;
...
label_cb6f:
        ...
        if (5 < (int)((((unsigned int)v15 & 1) + v23 != 0) + v12)) goto label_cb8f;
        goto label_cbb0;
      }
    }
label_c8da:
...
label_c923:
      ...
      v28 = v28 / ((long double)(long)a4 + (long double)dat_15a64);
...
label_ca48:
    ...
    if ((!a3) || (v16 = a4 / a3, a4 % a3)) goto label_c8da;
    v15 = a0 / v16;
    v17 = (a0 % v16) * 10;
    v9 = v17 / v16;
    v26 = (v17 % v16) * 2;
...
label_cb60:
    ...
    while( true ) {
      ...
      if (v15 < v26) break;
      v16 = v15;
      if (v24 == 8) goto label_cb6f;
    }
    if (10 <= v15) goto label_cb6f;
    v16 = v15;
    if (v11 != 1) { // branch-flip
      if ((!(a2 & 3)) && (v23)) goto label_ce72;
label_ceea:
      if (!v12) goto label_cef3;
      v10 = (char)v17 + '0';
    }
    else {
      if (3 > (v12 & 1) + v23) goto label_ceea;
label_ce72:
      v10 = (char)v17 + '1';
      if (v12 == 9) {
        v16 = v15 + 1;
        if (v15 == 9) goto label_cebc;
        v23 = 0;
        v15 = v16;
label_cef3:
...
label_cbb0:
      ...
      if (1 > (int)(v23 + v12)) goto label_cbb0;
label_cb8f:
      v15 += 1;
      if (((!(a2 & 0x10)) || (v20 != v15)) || (v24 == 8)) goto label_cbb0;
      v24 += 1;
      if (!(a2 & 8)) {
        v25[-1] = '0';
        v25 = &v25[~v14];
  ...
  if (a2 & 4)
    v21 = (char *)sub_c560(v21,(long)v25 - (long)v21,v2,v27);
  if (!(a2 & 0x80)) goto label_cade;
  if (v24 != -1) { // branch-flip
label_cacb:
    if (!(a2 & 0x100) && !v24) goto label_cade;
    if (a2 & 0x40) {
label_cd41:
      v30 = &a1[0x288];
      a1[0x287] = ' ';
    }
    if (v24) goto label_cd5f;
    v27 = v30;
...
unsigned long sub_d070(unsigned long a0,unsigned long a1,long *a2)
{
  unsigned long v1; // rax
...
void sub_d0a0(unsigned int *a0,unsigned int a1)
{
...
void sub_d200(unsigned long *a0)
{
  sub_be30(*a0);
  free((void *)a0[2]);
  free(a0); // tail-call
...
long sub_d230(unsigned long *a0,long a1)
{
  long v1;
  long *v2; // rax
  long *v3;
...
void sub_d5c0(char *a0)
{
  ...
  v5 = sub_135b0(&a0[0x24],v3,sub_108f0(v3,v4),&a0[4]);
  *(long *)&a0[0x18] = v5;
  if (v5 == -1) {
    a0[0x18] = '\x01';
    a0[0x19] = '\0';
...
void sub_d750(char *a0,char *a1)
{
  ...
  *a0 = v1;
  ...
  a0[0xc] = a1[0xc];
  sub_13530(&a0[0x10],&a1[0x10]); // tail-call
}
...
void sub_d860(unsigned long *a0)
{
  free((void *)*a0);
  free((void *)a0[1]);
  free((void *)a0[2]);
...
label_dcb6:
                    ...
                    if (strcmp(v17,"smbfs")) {
                      ...
                      if (strcmp(v17,"smb3")) {
                        v18 = 1;
                        if (strcmp(v17,"cifs")) goto label_dcb6;
                      }
                    }
                  }
                }
    ...
    if (sub_70c0(v2) != -1) goto label_dafb;
  }
  else {
    ...
    while (v6 = (unsigned long *)getmntent(v3), v6) {
      ...
      v9 = (unsigned long *)sub_11680(0x38);
      v10 = sub_11a20(*v6);
      v7 = v6[1];
      *v9 = v10;
      v10 = sub_11a20(v7);
...
void * sub_e2b0(unsigned long a0,unsigned long a1,unsigned int a2,int *a3)
{
  int v1;
  int v2; // eax
  void *v3; // rax
...
{
  return sub_12fe0(a0 + 9,a1 + 9) == 0;
}

// Function: sub_e420 @ 0xe420
unsigned long sub_e420(long a0,unsigned long a1,unsigned char a2)
{
  unsigned char v1;
...
unsigned long sub_e480(long a0,unsigned long a1,unsigned char a2,char a3)
{
  unsigned char v1;
...
unsigned long sub_e500(long a0,unsigned long a1,unsigned char a2,char a3,char a4)
{
  unsigned char v1;
...
unsigned long sub_e570(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5)
{
  unsigned char v1;
...
unsigned long sub_e610(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6)
{
  unsigned int v1;
  unsigned char v2;
...
unsigned long sub_e6b0(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,unsigned int a7)
{
  unsigned int v1;
  unsigned int v2;
  unsigned char v3;
...
unsigned long sub_e770(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,unsigned int a8)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_e830(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,int a8,unsigned int a9)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_e910(unsigned char *a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6,unsigned int a7,unsigned int a8) // early-return
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
    ...
    if (v25) {
      ...
      if (v25) {
        if (v30) {
          ...
          if ((a3 < v23 + v30) || (v8 = memcmp(v11,v31,v30), v8)) goto label_f5c0;
          if (!v24) {
            v7 = *v11;
...
label_f664:
              ...
              if (((bool)(v2 & v24)) && (v30)) goto label_f68a;
              v16 = 0x5c;
              goto label_f0b2;
            }
          }
...
label_ed88:
    v16 = (unsigned char)v21;
    v12 = v13;
    if (!v29) goto label_ef33;
    if (!(*(unsigned int *)(v29 + (v21 >> 5) * 4) >> (v16 & 0x1f) & 1)) goto label_ef33;
  }
  else {
label_ef30:
    v7 = 0;
...
label_f0c3:
  if (v24) {
    v24 = v2;
label_f0df:
    if ((bool)(v24 & a4 == 2)) goto label_f0eb;
label_ee7c:
    v34 &= 0xfffffffd;
    v29 = 0;
    goto label_eb70;
...
void * sub_ff30(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_1d078 <= (int)a0) {
      v10 = (long)dat_1d078;
      v9 = (long)(int)((a0 - dat_1d078) + 1);
      if (dat_1d080 != (unsigned long *)0x1d090) // branch-flip
        v6 = (unsigned long *)sub_11840(dat_1d080,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_11840(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_1d090;
        v6[1] = dat_1d098;
      }
      dat_1d080 = v6;
      memset(&v6[(long)dat_1d078 * 2],0,(v10 - dat_1d078) * 0x10);
      dat_1d078 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_eb00(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x1d1c0)
        free(v8);
      v8 = (void *)sub_116c0(v7);
      v4 = *a3;
      v1[1] = (unsigned long)v8;
      sub_eb00(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
void sub_10240(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_eb00(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_102c0 @ 0x102c0
unsigned long sub_102c0(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_eb00(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_116c0(v3 + 1);
  sub_eb00(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_103b0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_102c0(a0,a1,0,a2); // tail-call
}
...
void sub_10460(unsigned long a0,unsigned long a1)
{
  sub_ff30(a0,a1,0xffffffffffffffff,0x1d2c0); // tail-call
}
...
void sub_10490(unsigned long a0)
{
  sub_10460(0,a0); // tail-call
}

// Function: sub_104a0 @ 0x104a0
void sub_104a0(unsigned long a0,unsigned long a1)
{
  sub_10480(0,a0,a1); // tail-call
}

// Function: sub_104b0 @ 0x104b0
void sub_104b0(unsigned int a0,unsigned long a1,unsigned long a2)
{
  char v1 [56];
...
void sub_10510(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_10580(unsigned int a0,unsigned long a1)
{
  sub_104b0(0,a0,a1); // tail-call
}

// Function: sub_10590 @ 0x10590
void sub_10590(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_10510(0,a0,a1,a2); // tail-call
}

// Function: sub_105b0 @ 0x105b0
void sub_105b0(unsigned long a0,unsigned long a1,char a2,unsigned long a3)
{
...
void sub_10720(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
...
void sub_107f0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
...
void sub_10820(unsigned long a0,unsigned long a1)
{
  sub_10810(0,a0,a1); // tail-call
}

// Function: sub_10830 @ 0x10830
void sub_10830(unsigned long a0,unsigned long a1)
{
  sub_10810(a0,a1,0xffffffffffffffff); // tail-call
}

// Function: sub_10840 @ 0x10840
void sub_10840(unsigned long a0)
{
  sub_10830(0,a0); // tail-call
}
...
unsigned long sub_10a60(long *a0,char *a1) // return-dupe x2
{
  char *v1;
  long *v2;
  int v3; // eax
...
void * sub_10ce0(long a0,void *a1,void *a2) // return-dupe
{
  long v1; // rax
  ...
  if (!v1)
    return NULL;
  if ((localtime_r(a1,a2)) && (sub_10a60(a0,a2))) {
    if (!sub_10c80(v1))
      return NULL;
    return a2;
  }
...
void sub_10eb0(long a0)
{
  *(unsigned int *)(a0 + 0x20) = 0;
  sub_128b0(a0,dat_1cfd0,0x1d2f8); // tail-call
}
...
long sub_10fd0(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
  unsigned long v10; // stack - 0x48
  char *v2; // rax
...
void sub_11470(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_117c0(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  unsigned long v2; // rax
  unsigned long v3;
...
void sub_11830(unsigned long a0,unsigned long a1)
{
  sub_117c0(a0,a1,1); // tail-call
}

// Function: sub_11840 @ 0x11840
void sub_11840(long a0,long *a1,long a2,long a3,long a4)
{
  long v1;
  long v2;
  long v3;
...
void sub_11a80(unsigned long a0,unsigned int a1)
{
  if (sub_a5f0(a0,a1 | 0x200))
    return;
...
unsigned int sub_11b50(unsigned long a0,unsigned long a1,int a2)
{
  unsigned int v1; // eax
  unsigned int v2; // r8d
...
void sub_12020(unsigned long a0,unsigned long a1,char a2,unsigned long a3,unsigned long a4)
{
...
label_12169:
  ...
  switch((unsigned int)v5 - 0x42 & 0xff) {
    case 0:
      v10 |= sub_12040(&v7,0x400);
      break;
    default:
      goto label_12169;
    case 3:
      v10 |= sub_12070(&v7,v9,6);
      break;
    case 5:
    case 0x25:
      v10 |= sub_12070(&v7,v9,3);
      break;
    case 9:
    case 0x29:
      v10 |= sub_12070(&v7,v9,1);
      break;
    case 0xb:
    case 0x2b:
      v10 |= sub_12070(&v7,v9,2);
      break;
    case 0xe:
      v10 |= sub_12070(&v7,v9,5);
      break;
    case 0x12:
    case 0x32:
      v10 |= sub_12070(&v7,v9,4);
      break;
    case 0x17:
      v10 |= sub_12070(&v7,v9,8);
      break;
    case 0x18:
      v10 |= sub_12070(&v7,v9,7);
      break;
    case 0x20:
      v10 |= sub_12040(&v7,0x200);
      break;
    case 0x21:
      break;
    case 0x35:
...
long sub_12660(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  long v1; // rax
  long v2; // rdx
  long v3;
...
int * sub_12710(unsigned long a0,long *a1,int *a2)
{
  int *v1; // rax
  int v10; // stack - 0x6c
  int v11; // stack - 0x68
...
long sub_128b0(int *a0,unsigned long a1,long *a2)
{
  long v1;
  long v10; // rax
  long v11;
  ...
  v21 = a2;
  v8 = v2;
  v1 = (long)(int)((unsigned int)*(unsigned short *)(((long)(int)((v19 >> 0x1f & 0xcU) + v19) + (unsigned long)(unsigned char)sub_12490(v11) * 0xd) * 2 + 0x166a0) - 1) + (long)v20[3];
  v19 = 0x3b;
  if (v8 <= 0x3b)
    v19 = v8;
  if (v19 <= -1)
  ...
  v26._0_4_ = (int)*v21;
  v8 = -(int)v26;
  v9 = sub_12530(v11,v1,v22 & 0xffffffff,v3,v19,0x46,0,0,0,v8);
  v15 = v9;
  v26 = v9;
  v27 = 6;
  v25 = 0;
  ...
  while( true ) {
    v18 = v12;
    if (!sub_12710(a1,&v15,&v14))
      return -1;
    v10 = sub_12690(v11,v1,v4,v3,v19,&v14);
    v6 = v32;
    v12 = v15;
    if (!v10) break;
    if ((v18 != v15) && (v26 == v15)) {
      if (v32 < 0) goto label_12aa0;
      if (0 <= v5) { // branch-flip
        if ((v5 != 0) != (v32 != 0)) goto label_12aa0;
      }
      else if (v25 <= (v32 != 0)) goto label_12aa0;
    }
    v27 -= 1;
    if (!v27) goto label_12ba0;
    v10 += v15;
    v25 = v32 != 0;
    v26 = v18;
    v15 = v10;
    ...
    do {
      ...
      while( true ) {
        ...
        if (!SCARRY8((long)v13,v12)) {
          if (!sub_12710(a1,&v17,v16))
            return -1;
          v7 = sub_12510(v5,v36);
          if (!v7) {
            v10 = sub_12690(v11,v1,v4,v3,v19,v16) + v17;
            if (sub_126c0(a1,v10,&v14)) {
              v12 = v10;
              goto label_12aa0;
            }
...
void sub_12d40(unsigned long a0)
{
  sub_128a0();
  sub_128b0(a0,dat_1cfc8,0x1d300); // tail-call
}
...
unsigned long sub_13040(void *a0) // early-return x2, return-dupe
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_130e0(long *a0,long *a1) // return-dupe x3
{
  char v1; // al
  long v2;
  long *v3; // rdx
...
void sub_13530(long *a0,long *a1) // return-dupe
{
  long v1;
  long *v2;
...
unsigned long sub_135b0(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
