...
void * localtime(void *a0)
{
  ...
  v1 = (void *)(*dat_18da0)(); // jump-as-call
  return v1;
}
...
void * opendir(char *a0)
{
  ...
  v1 = (void *)(*dat_18e20)(); // jump-as-call
  return v1;
}
...
void * readdir(void *a0)
{
  ...
  v1 = (void *)(*dat_18f00)(); // jump-as-call
  return v1;
}
...
void * fdopendir(int a0)
{
  ...
  v1 = (void *)(*dat_18f68)(); // jump-as-call
  return v1;
}
...
void sub_39c0(int a0,char **a1)
{
  ...
  if (v10) { // branch-flip
    v4 = v10[optind];
    if ((!v4) || (strcmp(v4,"--"))) {
      v1 = getopt_long(v8,v10,"ab:cdfhH?klLmMnNqrS:tvVZ123456789",(void *)0x187c0,&v9);
      v2 = v1 + 0x83;
      if (v1 < 0) {
        if (optind != v8) {
...
label_3b75:
    v2 = getopt_long(a0,a1,"ab:cdfhH?klLmMnNqrS:tvVZ123456789",(void *)0x187c0,&v9);
    v1 = optind;
    if (v2 < 0) {
      if (dat_19028 <= -1)
        dat_19028 = dat_dd9f8;
...
label_4085:
      ...
      sub_5570();
      if (a0 != v1) { // branch-flip
        while (v6 = (long)optind, optind < a0) {
          optind += 1;
          sub_7b60(a1[v6]);
        }
      }
...
label_3b5c:
    if (v3 <= 0xd3) {
      (*(void *)((long)*(int *)((unsigned long)v3 * 4 + 0x12f80) + 0x12f80))(); // jump-as-call
      return;
    }
    if ((v2 <= 0x82) || (v2 == 0xc2)) {
...
void sub_4170(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_18fc0)(sub_39c0,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
label_4770:
      ...
      if ((int)v10 <= (int)v14) goto label_4698;
      if (dat_1a080 <= (int)v10) {
        dat_1a068 = a0;
        return v10;
      }
      v2 = *(unsigned short *)((unsigned long)(a0 & 0x7fff) * 2 + 0x1b880);
      v9 = *(char *)(v5 + 0x3bfff + (long)(int)v10);
      v4 = 1;
      v3 = 1;
      v15 = v1[(int)v10];
      v14 = v10;
...
label_4c1a:
    v11 = 0;
    if (0 <= (long)dat_1a078)
      v11 = (dat_1a078 & 0xffffffff) + 0x3c000;
...
label_4b3a:
      v5 = sub_b290(0,*(char *)(v10 + 0x3c000));
      v9 = dat_1b000;
      v12 = dat_1a06c;
      if (dat_1b000)
...
label_509d:
    v13 = 0;
    if (0 <= (long)dat_1a078)
      v13 = (dat_1a078 & 0xffffffff) + 0x3c000;
    ...
    *v2 = (unsigned short)dat_1a06c;
    ...
    if ((3 <= v8) && (v12 <= v8)) {
      ...
      *v3 = (short)v12 + -2 + (short)v8;
      ...
      v14 = sub_b290(0,*(char *)((unsigned long)(v11 - 1) + 0x3c000));
      if (dat_1b000) { // branch-flip
        v9 = (unsigned long)dat_1a06c;
    ...
    while (v11 <= 0x105) {
      if (dat_1a0a0) {
        ...
        if (!dat_1a09c) {
          v14 -= 1;
          if (v15)
            sub_b290(0,*(char *)((unsigned long)(dat_1a06c - 1) + 0x3c000));
          goto label_509d;
        }
        break;
      }
...
void sub_5570(void)
{
  ...
  v4 = 2;
  v1 = (int *)0x13350;
  sigemptyset((void *)0xdd940);
  while( true ) {
    sigaction(v4,NULL,&v3);
    if (v3 != (void *)0x1)
      sigaddset((void *)0xdd940,v4);
    v1 = &v1[1];
  ...
  v20 = dat_dd9b8;
  while( true ) {
    if (sigismember(0xdd940,v4)) {
      if (!v2)
        dat_dd9e0 = 1;
      sigaction(v4,&v3,NULL);
    }
    v2 += 1;
    if (v2 == 6) break;
    v4 = *(int *)(v2 * 4 + 0x13350);
...
void sub_56e0(char a0) // return-dupe x3
{
  int v1;
  char v2 [128];
  char v3 [1032];
...
unsigned int sub_5b50(unsigned int a0) // early-return x9, return-dupe x2
{
  ...
  if ((dat_dd9f4) && (dat_1b860)) {
    ...
    v13 = (char)v16;
    if (v11 <= v7) { // branch-flip
      v16 = sub_d830(1);
      v7 = (unsigned int)v16;
    }
    else {
      dat_1b008 = v7 + 1;
      v16 = (unsigned long)*(unsigned char *)((unsigned long)v7 + 0x9d000);
    ...
    if (v13) { // branch-flip
      ...
      if (v8 <= v7) { // branch-flip
        ...
        dat_1b008 = v7 + 1;
        v1 = *(unsigned char *)((unsigned long)v7 + 0x9d000);
        v16 = (unsigned long)v1;
        v7 = (unsigned int)v1;
      }
      v8 = 0;
  ...
  dat_dd9dc = 0;
  dat_dd9d8 = v12;
  if ((memcmp(&v13,(void *)0x12cb4,2)) && (memcmp(&v13,(void *)0x12cb7,2))) {
    if (((memcmp(&v13,(void *)0x12cd7,2)) || (dat_1b008 != 2)) || (memcmp((void *)0x9d000,(void *)0x12cd7,4))) {
      if (!memcmp(&v13,(void *)0x12cdc,2)) {
        dat_190d0 = sub_c9f0;
        dat_19020 = 2;
        return 2;
      }
      if (!memcmp(&v13,(void *)0x12cdf,2)) {
        dat_190d0 = sub_c040;
        dat_19020 = 1;
        dat_dd9dc = 1;
        return 1;
      }
      if (!memcmp(&v13,(void *)0x12ce2,2)) {
        dat_190d0 = sub_bfd0;
        dat_19020 = 3;
        dat_dd9dc = 1;
        return 3;
...
label_6060:
      if (!v13) {
        while (!v7) {
          ...
          if (dat_1b00c <= dat_1b008) // branch-flip
            ...
            dat_1b008 += 1;
            v7 = (unsigned int)*(unsigned char *)(v16 + 0x9d000);
          }
        }
        if (v7 == 0xffffffff) {
          if (!dat_dd9e4)
    ...
    if (dat_1b00c <= dat_1b008) // branch-flip
      ...
      dat_1b008 += 1;
      dat_19020 = (unsigned int)*(unsigned char *)(v16 + 0x9d000);
    }
    if (dat_19020 != 8) {
    ...
    if (dat_1b00c <= dat_1b008) // branch-flip
      ...
      dat_1b008 += 1;
      v8 = (unsigned int)*(unsigned char *)(v16 + 0x9d000);
    }
    if (v8 & 0x20) {
      v15 = "%s: %s is encrypted -- not supported\n";
      sub_f630(stderr,v15,dat_1b850,0x1b420); // return-dupe
      dat_1b84c = 1;
      return 0xffffffff;
    }
    if (v8 & 0xc0) { // branch-flip
      sub_f630(stderr,"%s: %s has flags 0x%x -- not supported\n",dat_1b850,0x1b420,v8 & 0xff);
      dat_1b84c = 1;
      if (dat_dd9f4 <= 1) {
        dat_1b84c = 1;
        return 0xffffffff;
...
label_5e0f:
      v16 = (unsigned long)dat_1b008;
      dat_1b008 += 1;
      v16 = (unsigned long)*(unsigned char *)(v16 + 0x9d000);
      if (dat_1b008 < v11) goto label_5e2c;
label_6180:
      v16 |= (long)(int)sub_d830(0) << 8;
      v11 = dat_1b00c;
      if (dat_1b00c <= dat_1b008) goto label_61a4;
label_5e4f:
      v10 = (unsigned long)dat_1b008;
      dat_1b008 += 1;
      v16 |= (unsigned long)*(unsigned char *)(v10 + 0x9d000) << 0x10;
      if (dat_1b008 < v11) goto label_5e73;
label_61c9:
      v10 = (unsigned long)(int)sub_d830(0);
    }
    else {
      v11 = dat_1b00c;
      if (dat_1b008 < dat_1b00c) goto label_5e0f;
label_6162:
      v16 = (unsigned long)(int)sub_d830(0);
      v11 = dat_1b00c;
      if (dat_1b00c <= dat_1b008) goto label_6180;
label_5e2c:
      v10 = (unsigned long)dat_1b008;
      dat_1b008 += 1;
      v16 |= (unsigned long)*(unsigned char *)(v10 + 0x9d000) << 8;
      if (dat_1b008 < v11) goto label_5e4f;
label_61a4:
      v16 |= (long)(int)sub_d830(0) << 0x10;
      if (dat_1b00c <= dat_1b008) goto label_61c9;
label_5e73:
      v10 = (unsigned long)dat_1b008;
      dat_1b008 += 1;
      v10 = (unsigned long)*(unsigned char *)(v10 + 0x9d000);
    }
    v16 |= v10 << 0x18;
    if ((v16) && (!dat_19028)) {
      if (0 <= (long)v16) { // branch-flip
        dat_1b838 = 0;
        dat_1b830 = v16;
      }
      else {
        if (!dat_1b85c)
          sub_f630(stderr,"%s: %s: MTIME %lu out of range for this platform\n",dat_1b850,0x1b420,v16);
        if (!dat_1b84c)
          dat_1b84c = 2;
        dat_1b838 = 999999999;
    ...
    if (v6 <= v11) // branch-flip
      ...
      dat_1b008 = v11 + 1;
      v23 = *(char *)((unsigned long)v11 + 0x9d000);
    }
    if (v8 & 2) {
      v19 = 8;
    ...
    if (v8 & 4) {
      ...
      if (v6 <= v11)
        ...
        dat_1b008 = v11 + 1;
        v17 = *(char *)((unsigned long)v11 + 0x9d000);
      }
      v2 = CONCAT11(v17,v4);
      if (dat_dd9e4)
        sub_f630(stderr,"%s: %s: extra field of %u bytes ignored\n",dat_1b850,0x1b420,v2);
      if (v8 & 2)
        sub_d1f0(&v14,2);
      sub_5a90(v2,v8 & 0xff);
    }
    if (v8 & 8) {
      if ((dat_1902c) || (((dat_1b860 && (!dat_dd9e8)) || (2 <= dat_dd9d8))))
        sub_5a90(0xffffffffffffffff,v8 & 0xff);
      else {
        v9 = (char *)sub_d3b0(0x1b020);
        v15 = v9;
        while( true ) {
          v16 = (unsigned long)dat_1b008;
          if (dat_1b00c <= dat_1b008) // branch-flip
        ...
        if (v8 & 2)
          sub_d1f0(v9,(int)v15 - (int)v9);
        v15 = (char *)sub_d3b0(v9);
        memmove(v9,v15,strlen(v15) + 1);
      }
    }
    if (v8 & 0x10)
      sub_5a90(0xffffffffffffffff,v8 & 0xff);
    if (v8 & 2) {
      ...
      if (dat_1b00c <= dat_1b008) { // branch-flip
        ...
        dat_1b008 += 1;
        v6 = (unsigned int)*(unsigned char *)(v16 + 0x9d000);
        v8 = dat_1b008;
        v11 = dat_1b00c;
      }
      if (v11 <= v8) // branch-flip
        v8 = sub_d830(0);
      else {
        dat_1b008 = v8 + 1;
        v8 = (unsigned int)*(unsigned char *)((unsigned long)v8 + 0x9d000);
      }
      v6 = v8 << 8 | v6;
      if (v5 != v6) {
        sub_f630(stderr,"%s: %s: header checksum 0x%04x != computed checksum 0x%04x\n",dat_1b850,0x1b420,v6,(unsigned int)v5);
        dat_1b84c = 1;
        if (dat_dd9f4 <= 1) {
          dat_1b84c = 1;
          return 0xffffffff;
  ...
  sub_f630(stderr,v15,dat_1b850,0x1b420);
  dat_1b84c = 1;
  return 0xffffffff;
}
...
label_6d88:
  ...
  if (dat_dd9e4) {
    ...
    if (v1) // branch-flip
      sub_f7b0("%s%3d %02d:%02d ",&"Jan"[(long)*(int *)((long)v1 + 0x10) * 4],*(unsigned int *)((long)v1 + 0xc),*(unsigned int *)((long)v1 + 8),*(unsigned int *)((long)v1 + 4));
    else {
      sub_f7b0("??? ?? ??:?? ");
    }
  }
...
int sub_72b0(void)
{
  ...
  if (!dat_dd9f0) {
    v7 = sub_e060(0x1b420);
    v5 = sub_5a00(0x1b420,v7 + -0x1b420);
...
unsigned long sub_7380(char *a0) // early-return
{
  ...
  if (strlen(a0) <= 0x3fe) {
    ...
    if (0 <= (int)v4)
      return v4;
    if (((dat_dd9f8) && (v5 = __errno_location(), *v5 == 2)) && (!sub_67e0(0x1b420))) {
      v6 = strlen((char *)0x1b420);
      v2 = strcmp(dat_dd9c8,".gz");
      v7 = (unsigned long *)0x190a0;
      if (!v2)
        v7 = (unsigned long *)0x190a8;
      v2 = 0;
      v8 = (char *)*v7;
      do {
        __strcpy_chk((char *)0x1b420,a0,0x400);
        if (0x400 <= strlen(v8) + (long)(int)v6) {
          sub_f630(stderr,"%s: %s: file name too long\n",dat_1b850,a0); // return-dupe
          dat_1b84c = 1;
          return 0xffffffff;
        }
        __strcat_chk((char *)0x1b420,v8,0x400);
        v4 = sub_72b0();
        v1 = dat_dd9c8;
        if (0 <= (int)v4)
          return v4;
        if (*v5 != 2) {
          sub_5820(0x1b420); // return-dupe
          return 0xffffffff;
        }
        v3 = strcmp(v8,dat_dd9c8);
        if (!v3)
          v2 = 2;
        v8 = (char *)v7[1];
        v7 = &v7[1];
...
unsigned int sub_76e0(void)
{
  ...
  if (!dat_dd9f0) {
    v6 = sub_e060(0x1b020);
    v3 = sub_5a00(0x1b020,v6 + -0x1b020);
...
label_7726:
  ...
  do {
    while( true ) {
      sub_5470(0xdd520,0x1b020);
      sigprocmask(0,(void *)0xdd940,v5);
...
void sub_78e0(void)
{
  ...
  if (((dat_dd9f8) && (0 <= dat_1b838)) && ((v8 != dat_1b830 || (dat_1b838 != v9)))) {
    v8 = dat_1b830;
    v9 = dat_1b838;
    v2 = sub_eb50(dat_1b010,0x1b020,&v5);
    if (v2) { // branch-flip
label_7a68:
      v4 = __errno_location();
      v2 = *v4;
...
label_7dd9:
      ...
      sub_78e0();
      if (((dat_dda00) && ((((0 <= dat_19014 && (fdatasync())) && (*__errno_location() != 0x16)) || ((v3 = fsync(dat_1b010), v3 && (*__errno_location() != 0x16)))))) || (v3 = close(dat_1b010), v3))
        sub_d670(); // no-return
      if (!dat_dd9f0) {
        v5 = (char *)sub_e060(0x1b420);
        v1 = sub_59a0(0x1b420,&v5[-0x1b420]);
        v3 = dat_19014;
        if (v1) { // branch-flip
          sigprocmask(0,(void *)0xdd940,v6);
          dat_19018 = 0xffffffff;
...
void sub_a0c0(long *a0) // return-dupe
{
  unsigned short *v1;
  unsigned int v10;
  unsigned int v11;
  ...
  v5 = *a0;
  v4 = *(int *)((long)a0 + 0x24);
  v20 = *(unsigned int *)&a0[4];
  v16 = a0[1];
  v14 = a0[3];
  v12 = (unsigned short *)0xdf9c0;
  do {
    v13 = &v12[1];
    *v12 = 0;
    v12 = v13;
  } while (v13 != (unsigned short *)0xdf9e0);
  v15 = (long)dat_df0a0;
  *(unsigned short *)(v5 + 2 + (long)*(int *)(v15 * 4 + 0xdf0c0) * 4) = 0;
  if (0x23c <= dat_df0a0)
    return;
  v8 = 0;
  v22 = 0;
  ...
  do {
    v18 = *(int *)(v21 + 4);
    v1 = (unsigned short *)(v5 + (long)v18 * 4);
    v10 = *(unsigned short *)(v5 + 2 + (unsigned long)v1[1] * 4) + 1;
    if ((int)v20 < (int)v10) {
      v22 += 1;
      v10 = v20;
    }
    v1[1] = (unsigned short)v10;
    if (v18 <= v4) {
      v19 = (long)(int)v10;
      v17 = 0;
      ...
      *v2 = *v2 + 1;
      if ((int)v14 <= v18) {
        v17 = *(int *)(v24 + (long)(v18 - (int)v14) * 4);
        v19 = (long)(int)(v10 + v17);
      }
      v25 += v19 * (unsigned long)*v1;
      v8 = 1;
      if (v16) {
        v7 = 1;
        v26 += (long)(int)((unsigned int)*(unsigned short *)(v16 + 2 + (long)v18 * 4) + v17) * (unsigned long)*v1;
      }
    }
    v21 += 4;
  ...
  v3 = *(short *)((long)(int)v10 * 2 + 0xdf9c0);
  v24 = (long)(int)v20;
  ...
  do {
    ...
    while( true ) {
      *(short *)((long)(int)v11 * 2 + 0xdf9c0) = v3 + -1;
      v2 = (short *)((long)(int)v6 * 2 + 0xdf9c0);
      *v2 = *v2 + 2;
      v9 = *(short *)(v24 * 2 + 0xdf9c0) - 1;
      *(unsigned short *)(v24 * 2 + 0xdf9c0) = v9;
      if (v18 == v22) {
        if (!v20)
          return;
        v7 = 0;
        ...
        while( true ) {
          ...
          if (v23) {
            ...
            do {
              ...
              if (v9 != v20) {
                ...
                v7 = 1;
                v16 += (unsigned long)*v1 * (v24 - (unsigned long)v9);
              }
              v14 -= 1;
              v23 -= 1;
            } while (v23);
          ...
          v24 -= 1;
          if (!v10) break;
          v9 = *(unsigned short *)(v24 * 2 + 0xdf9c0);
          v20 = v10;
          v10 -= 1;
        }
        if (!v7)
...
void sub_a370(long a0,int a1) // return-dupe
{
  short *v1;
  int v10; // r9d
  unsigned short *v2;
  ...
  *(unsigned short *)(a0 + 6 + (long)a1 * 4) = 0xffff;
  ...
  do {
    while( true ) {
      ...
      if (v7 != v6) {
        if (v10 <= v4) break;
        v1 = (short *)((long)(int)v6 * 4 + 0xdf9e0);
        *v1 = *v1 + (short)v4;
...
void sub_a5a0(unsigned long *a0)
{
  unsigned char v1;
...
unsigned long sub_a8c0(void)
{
  ...
  sub_a370(0xe0080,dat_193e4);
  sub_a370(0xdff80,dat_193a4);
  sub_a5a0(0x19340);
  v2 = 0xf;
  v1 = 0x12;
  while( true ) {
...
void sub_a960(long a0,int a1) // return-dupe
{
  unsigned short v1;
  int v2; // ecx
  int v3;
...
label_aa30:
      if (v4) { // branch-flip
        if (v7 != v4) {
          sub_4290(*(unsigned short *)((long)(int)v4 * 4 + 0xdf9e0),*(unsigned short *)((long)(int)v4 * 4 + 0xdf9e2));
          v9 = v3;
        }
...
void sub_ab20(int a0,int a1,int a2)
{
  ...
  sub_a960(0xe0080,a0 + -1);
  sub_a960(0xdff80,a1 + -1); // tail-call
}

// Function: sub_abd0 @ 0xabd0
void sub_abd0(long a0,long a1) // ternary
{
  unsigned short *v1;
  unsigned long v10;
  unsigned long v11;
  ...
  sub_4290(*(unsigned short *)(a0 + 0x400),*(unsigned short *)(a0 + 0x402)); // tail-call
}
...
long sub_b070(long a0,unsigned long a1,int a2,int a3)
{
  int v1; // eax
  unsigned long v2;
...
int sub_b5a0(unsigned int a0)
{
  unsigned int v1; // eax
  
  v1 = (unsigned int)dat_e0994;
  sub_b450(a0);
  return (int)v1 >> (0x10U - (char)a0 & 0x1fU);
}
  ...
  if (0 < v4) {
    do {
      while( true ) {
        ...
        v5 = (unsigned int)v9;
        sub_b450(*(char *)((long)(int)v5 + 0xe0bc0));
        if (v5 <= 2) break;
        v11 = (long)v10;
        v10 += 1;
...
label_ba89:
    if (0x1fd < v10) {
      sub_b670(0x1fe,0x5c000,0xc,0x4c000); // return-dupe, tail-call
      return;
    }
  }
  v11 = (long)v10;
  ...
  sub_b670(0x1fe,0x5c000,0xc,0x4c000);
  return;
}
  ...
  do {
    ...
    do {
      if (v2 <= v13) {
        ...
        sub_b670(a0,0xe0bc0,8,0xe09a0); // tail-call
        return;
      }
      v9 = 3;
  ...
  if (0x1fe <= v1) {
    ...
    do {
      while (v2 & dat_e0994) {
        ...
        v3 = (unsigned long)v1;
        if (v1 <= 0x1fd) {
          sub_b450(*(char *)(v3 + 0x5c000)); // return-dupe
          return v3;
        }
      }
...
unsigned long sub_c040(unsigned int a0,unsigned int a1) // return-dupe x2
{
  ...
  long v19; // stack - 0xa0
  unsigned char v2;
  unsigned short v20; // stack - 0x98
  unsigned int v21; // stack - 0x8c
  long v22; // stack - 0x88
  long v23; // stack - 0x70
  unsigned int v24; // stack - 0x48
  unsigned int v25; // stack - 0x44
  unsigned int v26; // stack - 0x40
  long v3; // rax
  char *v4;
  unsigned long v5;
  int v6;
  ...
  dat_1b978 = 0;
  v14 = (unsigned long)(dat_1b008 * 8);
  v19 = 0x101 - (unsigned long)(dat_193e8 == 0);
  v25 = dat_1b00c;
  v7 = 0x1f;
  v11 = (unsigned long *)0x1b888;
  while (v7) {
    v1 = &v11[1];
    *v11 = 0;
    v7 -= 1;
...
label_c19c:
  v13 = (unsigned int)((long)v14 >> 3);
  v10 = (unsigned int)v5;
  v17 = v16;
  if (v13 <= v10) goto label_c408;
label_c1a9:
  dat_1b00c = 0;
  v7 = 0x9d000;
label_c1ba:
  v25 = sub_d2b0(a0,v7,0x40000);
  if (v25 == 0xffffffff)
    sub_d600(); // no-return
  dat_1b828 += (int)v25;
  dat_1b00c += v25;
...
label_c1f9:
  ...
  if (v25) { // branch-flip
    v14 = 0;
    v23 = (v5 - v5 % (unsigned long)v24) * 8;
    if (v23 <= 0) goto label_c19c;
  }
  else {
    v23 = v5 * 8 - (long)(int)(v24 - 1);
    if (v23 <= 0) {
label_c5a5:
      if (v15 > 0) {
        sub_d6c0(a1,0x5c000,v15);
        return 0;
      }
      return 0;
    }
...
label_c258:
  v7 = (long)v14 >> 3;
  v2 = (unsigned char)v14;
  v14 += (long)(int)v24;
  v17 = (long)((unsigned long)*(unsigned char *)(v7 + 0x9d001) << 8 | (unsigned long)*(unsigned char *)(v7 + 0x9d002) << 0x10 | (unsigned long)*(unsigned char *)(v7 + 0x9d000)) >> (v2 & 7) & (unsigned long)v26;
  if (v16 != 0xffffffffffffffff) { // branch-flip
    if (v17 != 0x100) { // branch-flip
      if (v19 <= (long)v17) {
        if (v19 < (long)v17) {
          if (1 <= v15)
            sub_d6c0(a1,0x5c000,v15);
          v12 = "corrupt input.";
          if (!dat_1b860)
            v12 = "corrupt input. Use zcat to recover some data.";
          sub_d510(v12); // no-return
        }
        goto label_c2c8;
      }
      v9 = (char *)0x5bffe;
      ...
      if (dat_193e8) {
        ...
        v22 = 0x1ff;
        v7 = (long)(int)(v13 << 3);
        v14 = (v14 - 1) + (v7 - (long)((v14 - 1) + v7) % v7);
        goto label_c19c;
      }
      v5 = 0x100;
      v9 = (char *)0x5bffe;
      if (v19 != 0x100) goto label_c2e8;
label_c2c8:
      v9 = (char *)0x5bffd;
      dat_5bffd = (char)v21;
      v5 = v16;
...
label_c2e8:
    ...
    if (0x40000 <= v6) { // branch-flip
      ...
      memcpy((void *)((long)v15 + 0x5c000),v4,(long)(int)v7);
      v15 = v6;
    }
    v10 = dat_1b00c;
    if (v19 < v3) {
      v20 = (unsigned short)v16;
      *(unsigned short *)(v19 * 2 + 0x1b880) = v20;
      *(unsigned char *)(v19 + 0x3c000) = v2;
      v19 += 1;
    }
  }
  else {
    ...
    v15 += 1;
    *(char *)(v7 + 0x5c000) = (char)v17;
    v10 = dat_1b00c;
  }
  v16 = v17;
  dat_1b00c = v10;
  if (v23 <= (long)v14) {
    if (!v25) goto label_c5a5;
    v5 = (unsigned long)v10;
    goto label_c19c;
  }
  if (v22 < v19) goto label_c395;
  goto label_c258;
label_c395:
  v7 = v14 - 1;
label_c39f:
  ...
  v22 = v3;
  if (dat_19024 != v24)
    v22 = (1L << ((unsigned char)v24 & 0x3f)) + -1;
  v26 = (1 << ((unsigned char)v24 & 0x1f)) - 1;
  v13 = (unsigned int)(v7 + (v8 - (v8 + v7) % v8) >> 3);
  if (v10 < v13) goto label_c1a9;
label_c408:
  dat_1b00c = v10 - v13;
  v5 = (unsigned long)dat_1b00c;
  if (1 <= (int)dat_1b00c) {
...
unsigned long sub_c9f0(unsigned int a0,unsigned int a1)
{
  ...
  do {
    if ((int)dat_e0bf0 <= v7) { // branch-flip
      ...
      dat_1b004 += 1;
      *(char *)(v8 + 0x3c000) = *(char *)((unsigned long)(v6 + *(int *)((long)(int)v9 * 4 + 0xe0d00)) + 0xe0d80);
      if (dat_1b004 == 0x8000)
        sub_d7e0();
      dat_e0be0 -= v9;
      v8 = dat_e0be8;
...
char * sub_d3d0(unsigned int *a0,unsigned long *a1,char *a2)
{
  ...
  if (v2) {
    ...
    if (*v2) { // branch-flip
      ...
      *a0 = v6 + 1U;
      v4 = (unsigned long *)sub_f4d0((long)(v6 + 2),8);
      v7 = (unsigned long *)*a1;
      *a1 = v4;
      *v4 = *v7;
      v5 = v2;
...
void sub_d580(unsigned long a0) // return-dupe
{
  if (!dat_1b85c) {
...
void sub_d6c0(unsigned int a0,long a1,unsigned long a2)
{
  int v1; // eax
  unsigned long v2; // rax
...
unsigned long sub_d720(unsigned int a0,unsigned int a1) // return-dupe
{
  ...
  *__errno_location() = 0;
  ...
  if (dat_1b00c <= dat_1b008)
    return 0;
  do {
    sub_d6c0(a1,v2 + 0x9d000,dat_1b00c - (int)v2);
    v1 = sub_d2b0(a0,0x9d000,0x40000);
    if (v1 == 0xffffffff)
      sub_d600(); // no-return
    v2 = 0;
    dat_1b828 += (int)v1;
...
unsigned long sub_d830(int a0)
{
  ...
  dat_1b00c = 0;
  do {
    v1 = sub_d2b0(dat_1b014,v2 + 0x9d000,0x40000 - (int)v2);
    if (!v1) {
...
void sub_d930(void *a0,unsigned long a1,int a2) // return-dupe
{
  char *v1;
  char v2;
  char *v3;
...
unsigned long sub_e010(unsigned long a0,unsigned int a1)
{
  unsigned int v1; // eax
...
unsigned long sub_e0f0(void *a0) // early-return
{
  int v1;
  int *v2; // rax
...
unsigned long sub_e4a0(unsigned int *a0,unsigned long a1,unsigned int a2) // return-dupe
{
  long v1; // rax
...
char * sub_e5b0(void *a0,unsigned int a1)
{
  unsigned long v1;
  long v10;
  char *v11;
  ...
  if (a0) { // branch-flip
    ...
    while( true ) {
      *v4 = 0;
      v5 = readdir(a0);
      if (!v5) break;
      v3 = *(char *)((long)v5 + 0x13);
      v11 = (char *)((long)v5 + 0x13);
      if ((v3 == '.') && (v3 = *(char *)((long)v5 + 0x14), v3 == '.'))
        v3 = *(char *)((long)v5 + 0x15);
      if (v3) {
        v1 = strlen(v11) + 1;
        if (v14) { // branch-flip
          if (v12 == v15)
            v8 = (void *)sub_f3f0(v8,&v12,1,0xffffffffffffffff,8);
          v2 = v15 * 8;
          v15 += 1;
          *(unsigned long *)((long)v8 + v2) = sub_f5d0(v11);
        }
        else {
          if (v13 - v10 <= (long)v1)
            v9 = (char *)sub_f3f0(v9,&v13,v1 - (v13 - v10),0x7ffffffffffffffe,1);
          memcpy(&v9[v10],v11,v1);
        }
        v10 += v1;
      }
    }
...
unsigned long sub_ea90(unsigned long a0,long *a1) // return-dupe x3
{
  unsigned long *v1;
  long v2;
  char v3 [16];
...
int sub_eb50(int a0,char *a1,long *a2)
{
  ...
  if (0 <= dat_e0eb8) {
    ...
    if (0 <= a0) // branch-flip
      ...
      v4 = utimensat(0xffffff9c,a1,v5,0);
    }
    if (1 <= v4) // branch-flip
  ...
  if (a0 < 0)
    return futimesat(0xffffff9c,a1,v5);
  if (futimesat(a0,0,v5)) {
    if (!a1)
      return -1;
    return utimes(a1,v5);
  }
  ...
  v21 = v5[3];
  v11 = v23 - v5[2] != 1;
  if (((v22 - *v5 != 1) || (v1 <= 499999)) || (sub_e8e0(v7))) {
    if (v2 <= 499999 || v11)
      return 0;
    if (sub_e900(v7))
      return 0;
    ...
    if ((v2 <= 499999 || v11) || (sub_e900(v7))) {
      futimesat(a0,0,&v10); // return-dupe
      return 0;
    }
  }
  v21 = 0;
...
void sub_ef70(unsigned long a0,unsigned long a1)
{
  sub_eb50(0xffffffff,a0,a1); // tail-call
}
...
label_f050:
      v2 = utimensat(0xffffff9c,a0,v3,0x100);
      if (1 <= v2) // branch-flip
        *__errno_location() = 0x26;
...
void sub_f370(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  unsigned long v2; // rax
  unsigned long v3;
...
void sub_f3e0(unsigned long a0,unsigned long a1)
{
  sub_f370(a0,a1,1); // tail-call
}

// Function: sub_f3f0 @ 0xf3f0
void sub_f3f0(long a0,long *a1,long a2,long a3,long a4)
{
  long v1;
  long v2;
  long v3;
...
void sub_f530(void *a0,unsigned long a1)
{
...
unsigned long sub_f5f0(void)
{
  ...
  return CONCAT71((undefined7)((unsigned long)v3 >> 8),(v1 & 0xffffffdf) == 0x59) & 0xffffffff;
}

// Function: sub_f630 @ 0xf630
unsigned long sub_f630(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,void *a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  unsigned long v1;
  char *v10; // stack - 0x8c8
  char *v11; // stack - 0x8c0
  unsigned long v12; // stack - 0xc8
  unsigned long v13; // stack - 0xc0
  unsigned long v14; // stack - 0xb8
  unsigned long v15; // stack - 0xb0
  unsigned long v16; // stack - 0xa8
  unsigned long v17; // stack - 0x98
  ...
  unsigned long v4; // rax
  char v5 [2008];
  unsigned int v6; // stack - 0x8d0
  unsigned long v7; // stack - 0x8d8
  char v8 [16];
  unsigned int v9; // stack - 0x8cc
  ...
  v14 = a12;
  v15 = a13;
  v3 = (char *)sub_f880(v5,&v7,a9,&v6);
  v1 = v7;
  if (v3) {
    v4 = fwrite(v3,1,v7,a8);
    if (v4 < v1) {
      if (v3 == v5)
        return 0xffffffff;
      free(v3);
...
void sub_f7b0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void * sub_f880(void *a0,unsigned long *a1,int *a2,unsigned long a3)
{
  undefined10 v1;
  unsigned long v10;
  void *v11;
  ...
  v36 = a1;
  v43 = a0;
  if ((int)sub_10dd0(a2,&v19,v17) <= -1)
    return (void *)0;
  if ((int)sub_10ba0(a3,v17) < 0) {
    if (v45 != v20)
      free(v45);
    if (v44 != v21)
      free(v44);
...
label_f941:
    ...
    while( true ) {
      ...
      *(unsigned long *)&v24[-8] = 0xf9a4;
      v10 = sub_10b30(v28,(long)v12 - (long)a2);
      v12 = v41;
      v14 = v42;
      v11 = v16;
...
label_f9cc:
      ...
      if ((!v16) || (v16 == v43)) {
        ...
        *(unsigned long *)&v24[-8] = 0x1038c;
        v11 = malloc(v9,v24[-8]);
        if (v11) {
          if ((v28) && ((char)v41)) {
            v41 = v40;
            *(unsigned long *)&v24[-8] = 0x103da;
      ...
      *(unsigned long *)&v24[-8] = 0xfa11;
      v11 = realloc(v16,v9,v24[-8]);
      if (!v11) {
label_1044e:
        *(unsigned long *)&v24[-8] = 0x10453;
        v6 = v24[-8];
...
label_fa3a:
      do {
        if (v19 == v38) {
          *(unsigned long *)&v24[-8] = 0x10765;
          ...
          if (v9 < v14) {
            ...
            v32 = v16 == v43;
            if ((!v16) || (v32)) {
              *(unsigned long *)&v24[-8] = 0x10845;
              v11 = malloc(v9,v24[-8]);
              if (!v11) goto label_fb98;
              if ((v28) && (v32)) {
                *(unsigned long *)&v24[-8] = 0x10869;
                v11 = memcpy(v11,v16,v28,v24[-8]);
              }
            }
            else {
              *(unsigned long *)&v24[-8] = 0x107b9;
              v11 = realloc(v16,v9,v24[-8]);
          ...
          *(char *)((long)v11 + v28) = 0;
          ...
          if (v35) {
            *(unsigned long *)&v24[-8] = 0x107f4;
            free(v35,v24[-8]);
          }
          if (v45 != v20) {
            *(unsigned long *)&v24[-8] = 0x1080c;
            free(v45,v24[-8]);
          }
          if (v44 != v21) {
            *(unsigned long *)&v24[-8] = 0x10824;
            free(v44,v24[-8]);
          }
          *v36 = v28;
          return v11;
        ...
        if (*(char *)&v31[9] != '%') { // branch-flip
          if (v4 == -1) {
label_10885:
            *(unsigned long *)&v24[-8] = 0x1088a; // no-return
            abort(v24[-8]);
          }
          v8 = v44[v4 * 8];
          ...
          if (*(char *)&v31[9] != 'n') { // branch-flip
            ...
            *v30 = v2;
            if (v31[5] != -1) { // branch-flip
              if (v12[v31[5] * 8] != 5) goto label_10885;
            ...
            *(unsigned long *)&v24[-8] = 0xfd2a;
            ...
            if (v9 < v14) {
              ...
              if ((!v16) || (v16 == v43)) {
                v41 = (int *)CONCAT71(v41._1_7_,v16 == v43);
                *(unsigned long *)&v24[-8] = 0x105ae;
                v11 = malloc(v9,v24[-8]);
                if (!v11) goto label_fb98;
                if ((v28) && ((char)v41)) {
                  *(unsigned long *)&v24[-8] = 0x105e0;
                  v11 = memcpy(v11,v16,v28,v24[-8]);
                }
              }
              else {
                *(unsigned long *)&v24[-8] = 0xfd74;
                v11 = realloc(v16,v9,v24[-8]);
                if (!v11) goto label_fb98;
              }
            }
            *(char *)((long)v11 + v28) = 0;
            *(unsigned long *)&v24[-8] = 0xfd8a;
...
label_fe2b:
              ...
              case 0xb:
                ...
                v33 = v14;
                *(unsigned long *)&v24[-0x18] = 0x10102;
              ...
              case 0xc:
                ...
                if ((int)v40 != 1) {
                  ...
                  *(unsigned long *)&v24[-0x38] = 0x10503;
...
label_ffa3:
              if (!v37[1]) {
                if (v8 <= -1) {
                  ...
                  if ((v16 != v43) && (v16)) {
                    *(unsigned long *)&v24[-8] = 0xffff;
                    free(v16,v24[-8]);
                  }
                  if (v35) {
                    *(unsigned long *)&v24[-8] = 0x10013;
                    free(v35,v24[-8]);
                  }
                  if (v45 != v20) {
                    *(unsigned long *)&v24[-8] = 0x1002b;
                    free(v45,v24[-8]);
                  }
                  if (v44 != v21) {
                    *(unsigned long *)&v24[-8] = 0x10047;
                    free(v44,v24[-8]);
                    return (void *)0;
                  }
                  return (void *)0;
...
label_101a5:
            v33 = v14;
            *(unsigned long *)&v24[-0x28] = 0x101cd;
            v8 = __snprintf_chk((char *)((long)v16 + v28),v14,1,0xffffffffffffffff,v39,(unsigned long)v22[0]);
            v14 = v33;
label_fe55:
            if (v23 <= -1) goto label_ffa3;
label_fe63:
            if (((unsigned long)(long)v23 < v14) && (*(char *)((long)v16 + v28 + (long)v23))) goto label_10885;
            v7 = v23;
            if (v23 < v8) {
label_fe7d:
              v23 = v8;
            ...
            if (v14 <= v7 + 1) {
              if (0x7fffffff <= v10) {
                if ((v16 != v43) && (v16)) {
                  *(unsigned long *)&v24[-8] = 0x106ce;
                  free(v16,v24[-8]);
                }
                if (v35) {
                  *(unsigned long *)&v24[-8] = 0x106e2;
                  free(v35,v24[-8]);
                }
                if (v45 != v20) {
                  *(unsigned long *)&v24[-8] = 0x106fa;
                  free(v45,v24[-8]);
                }
                if (v44 != v21) {
                  *(unsigned long *)&v24[-8] = 0x10712;
                  free(v44,v24[-8]);
                }
                *v41 = 0x4b;
                return NULL;
              ...
              *(unsigned long *)&v24[-8] = 0xfebb;
              v15 = sub_10b30(v28,v7 + 2);
              *(unsigned long *)&v24[-8] = 0xfec6;
              v10 = sub_10b90(v15,v14);
              if (v9 < v10) {
                if (!v9)
                  v14 = 0xc;
                v9 = v10;
                ...
                v32 = v16 == v43;
                if ((!v16) || (v32)) {
                  *(unsigned long *)&v24[-8] = 0x10248;
                  v11 = malloc(v9,v24[-8]);
                  if (!v11) goto label_fba4;
                  if ((!v28) || (!v32))
                    v16 = v11;
                  else {
                    *(unsigned long *)&v24[-8] = 0x10274;
                    v16 = memcpy(v11,v16,v28,v24[-8]);
                  }
                }
                else {
                  *(unsigned long *)&v24[-8] = 0xff17;
                  v11 = realloc(v16,v9,v24[-8]);
                  if (!v11) goto label_fba4;
                  v16 = v11;
                }
          ...
          if (v4 != -1) goto label_10885;
          *(unsigned long *)&v24[-8] = 0x102d7;
          v14 = sub_10b30(v28,1);
          if (v9 < v14) {
            if (v9) { // branch-flip
              if ((long)v9 < 0) goto label_fb98;
            ...
            if ((!v16) || (v16 == v43)) {
              ...
              *(unsigned long *)&v24[-8] = 0x105fe;
              v11 = malloc(v9,v24[-8]);
              if (!v11) goto label_fb98;
              if ((v28) && ((char)v42)) {
                *(unsigned long *)&v24[-8] = 0x10630;
                v16 = memcpy(v11,v16,v28,v24[-8]);
              }
              else {
                v16 = v11;
...
label_fb98:
    *(unsigned long *)&v24[-8] = 0xfb9d;
    v6 = v24[-8];
    v41 = __errno_location(v6);
label_fba4:
    if ((v16 != v43) && (v16)) {
label_10460:
      *(unsigned long *)&v24[-8] = 0x10468;
      free(v16,v24[-8]);
    }
    if (v35) {
      *(unsigned long *)&v24[-8] = 0xfbca;
      free(v35,v24[-8]);
    }
  }
  if (v45 != v20) {
    *(unsigned long *)&v24[-8] = 0xfbe2;
    free(v45,v24[-8]);
  }
  if (v44 != v21) {
    *(unsigned long *)&v24[-8] = 0xfbfa;
    free(v44,v24[-8]);
  }
  *v41 = 0xc;
  return NULL;
...
unsigned long sub_108a0(void *a0,unsigned long a1,unsigned long a2)
{
  unsigned long v1;
  char *v2; // rax
  unsigned long v3; // rax
  char v4 [2008];
  unsigned long v5; // stack - 0x810
  
  v5 = 2000;
  v2 = (char *)sub_f880(v4,&v5,a1,a2);
  v1 = v5;
  if (v2) {
    v3 = fwrite(v2,1,v5,a0);
    if (v3 < v1) {
      if (v2 == v4)
        return 0xffffffff;
      free(v2);
...
unsigned long sub_10ba0(unsigned int *a0,long *a1) // return-dupe x2
{
  unsigned int v1;
  long v2;
  unsigned int *v3;
...
unsigned long sub_10dd0(unsigned char *a0,unsigned long *a1,unsigned long *a2) // return-dupe x2
{
  unsigned long *v1;
  unsigned long v10;
  int v11;
...
label_10fe1:
    ...
    v24 = 0xffffffffffffffff;
    if (*v15 != 0x24) goto label_10efe;
    v24 = 0;
    while( true ) {
      v20 = -1;
      if (v24 <= 0x1999999999999999)
        v20 = v24 * 10;
      v24 = sub_10b30(v20,(long)(char)(v19 - 0x30),v19 - 0x30);
...
label_1116d:
      v4[5] = v27;
      v14 = v27 + 1;
      if (v27 == 0xffffffffffffffff) goto label_113e0;
      v10 = v27;
      v27 = v14;
    }
    else {
      ...
      if (*v15 != 0x24) goto label_1116d;
      v10 = 0;
      while( true ) {
        v20 = -1;
        if (v10 <= 0x1999999999999999)
          v20 = v10 * 10;
        v10 = sub_10b30(v20,(long)(char)(v17 - 0x30));
        v17 = v9[1];
        v16 = &v9[1];
    ...
    if (v21 <= v10) { // branch-flip
      ...
      if (0x800000000000000 <= v21) goto label_116ed;
      if (v2 != v7) // branch-flip
        v8 = realloc(v7,v21 << 5);
      else {
        v8 = malloc(v21 << 5);
