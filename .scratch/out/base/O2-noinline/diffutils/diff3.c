...
void sub_4020(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_12fd8)(sub_3ac0,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
unsigned long sub_6380(char *a0,unsigned long a1)
{
  char v1;
  char v10; // stack - 0xac
  char *v11; // stack - 0xa8
...
void sub_69d0(unsigned long a0,long a1,long a2)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
...
void sub_6ee0(long *a0) // return-dupe
{
  if ((int)sub_6ec0() <= -1)
    return;
  *a0 = *a0 + 1;
...
unsigned long sub_6f60(unsigned long *a0,unsigned long a1,unsigned long a2)
{
  unsigned long *v1;
  unsigned long v2;
...
unsigned int sub_6fe0(unsigned long a0)
{
  unsigned int v1; // eax
  long v2;
...
unsigned long sub_7150(unsigned long a0)
{
  unsigned long v1;
  unsigned long v2;
  char v3 [1032];
...
long sub_7230(long a0) // return-dupe
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
label_743f:
      if (v6) { // branch-flip
        ...
        for (v7 = v6; v7 <= "waitpid"; v7 = (char *)((long)v7 * 2)) {
        }
      }
...
unsigned long sub_75e0(unsigned long a0) // return-dupe
{
  unsigned long v1;
...
label_7630:
  do {
    ...
    if (v3 <= v7) { // branch-flip
      v1 = v5 - 1;
      if (v1 < (unsigned long)(v11 - 1U)) goto label_76d0;
      v6 = v5;
      if ((v3 < v7) && (v2 = sub_6f60(a0,v3,v7), v2)) {
        sub_6fc0(v4);
        return 0;
      }
      if (v1 <= (unsigned long)(v11 - 1U)) goto label_7630;
...
unsigned long sub_7720(unsigned long a0,long a1)
{
  unsigned long v1; // stack - 0x48
  long v2; // stack - 0x40
  unsigned long v3; // stack - 0x38
...
long sub_7ad0(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
  unsigned long v10; // stack - 0x48
  char *v2; // rax
...
void sub_7f70(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_82b0(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  unsigned long v2; // rax
  unsigned long v3;
...
void sub_8320(unsigned long a0,unsigned long a1)
{
  sub_82b0(a0,a1,1); // tail-call
}

// Function: sub_8330 @ 0x8330
void sub_8330(long a0,long *a1,long a2,long a3,long a4)
{
  long v1;
  long v2;
  long v3;
...
void sub_8570(char *a0,unsigned long a1,long a2)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  char *v3; // rax
...
void sub_89a0(long *a0)
{
  ...
  v3 = sub_c6f0((long)a0 + 0x2c,v2,*a0 - (long)v2,(void *)((long)a0 + 0xc));
  a0[4] = v3;
  if (v3 == -1) {
    a0[4] = 1;
    *(char *)&a0[5] = 0;
...
void sub_8b20(unsigned long *a0,unsigned long *a1)
{
  char v1;
...
char sub_8d10(void *a0,void *a1,long *a2)
{
  ...
  if ((0 <= SUB168(ZEXT816(0x38) * v2._0_16_,0)) && (!SUB168(ZEXT816(0x38) * v2._0_16_,8))) {
    ...
    if (v21) {
      ...
      while( true ) {
        v34 = 0;
        *(unsigned long *)((long)v17 + -8) = 0x8e8f;
        sub_97c0(v26);
        v23 = v36;
        if ((v36) && (!v37)) break;
        v9 = &v7[6];
        *(unsigned long *)((long)v17 + -8) = 0x8e77;
        sub_ca90(v7,&v11);
...
label_8f25:
            ...
            if (v18 == v6[1]) {
              v20 = (void *)*v6;
              v8 = (void *)*v9;
              *(unsigned long *)((long)v17 + -8) = 0x8f21;
              v3 = *(char *)((long)v17 + -8);
              if (!memcmp(v8,v20,v18,v3)) goto label_8f25;
            }
          }
          if (!v19) goto label_9100;
...
label_8f5a:
      ...
      *v22 = 0;
      ...
      do {
        while( true ) {
          *(unsigned long *)((long)v17 + -8) = 0x8fbc;
          sub_97c0(v26);
          v18 = v35;
          if (!v36) break;
          if (!v37) goto label_8df7;
          v7 = &v21[(long)v20 * 6];
          if (!*(char *)&v7[2]) goto label_902b;
...
label_90ab:
          if (v20) { // branch-flip
            ...
            for (; v19; v19 = v19 + -1) {
              *(unsigned long *)((long)v17 + -8) = 0x90e7;
              sub_97c0(v13);
              if ((v31) && (!v32)) goto label_90fa;
              v28 = 0;
              v29 = (void *)((long)v29 + v30);
            }
          }
          else {
            *(unsigned long *)((long)v17 + -8) = 0x9042;
            sub_97c0(v13);
            if ((v31) && (!v32)) {
label_90fa:
              *(unsigned long *)((long)v17 + -8) = 0x90ff; // no-return
        ...
        v7 = &v21[(long)v20 * 6];
label_902b:
        if (v7[1] != v35) goto label_90ab;
        v8 = (void *)*v7;
        v25 = v11;
        *(unsigned long *)((long)v17 + -8) = 0x9099;
        v5 = memcmp(v8,v11,v35,*(char *)((long)v17 + -8));
        v8 = v25;
        if (v5) goto label_90ab;
label_8fe7:
      ...
      *v22 = (long)v29;
label_8df7:
      *(unsigned long *)((long)v17 + -8) = 0x9018;
      sub_ca30(v21);
      return v23;
    }
  }
...
label_96a0:
              v17 = v9 - v21;
              while ((v17 && ((sub_97c0(v16), !v32 || (v33))))) {
                v29 = 0;
                v30 = &v30[v31];
                v17 -= 1;
              }
          ...
          v10 = v9 + 1;
          if (!v26) goto label_9476;
          if (v40 == v27) goto label_94b6;
label_9408:
          v7 = v37;
          v18 = v38;
        }
...
label_94b6:
              ...
              do {
                ...
                if ((char)v48) { // branch-flip
                  if (!v48._4_4_)
                    return NULL;
                  if (!v56) goto label_9623;
                  if (v48._4_4_ != v57) goto label_9408;
                }
                else {
label_9623:
                  if ((v47 != v55) || (v6 = memcmp(v46,v54,v47), v6)) goto label_9408;
                }
                v46 = &v7[v9];
        ...
        if (v4) {
          if (v18 * 5 <= v10) { // branch-flip
            if (v7) {
              ...
              v9 = v10;
              if (*v7) goto label_924d;
            }
            v5 = sub_8b70(v1,a1,strlen(a1),&v11);
            if ((char)v5)
              return v11;
            v7 = NULL;
          }
...
void sub_97c0(char *a0)
{
  ...
  v5 = sub_c6f0(&a0[0x24],v3,sub_c470(v3,v4),&a0[4]);
  *(long *)&a0[0x18] = v5;
  if (v5 == -1) {
    a0[0x18] = '\x01';
    a0[0x19] = '\0';
...
void sub_9940(long a0,long a1)
{
  *(long *)(a0 + 0x10) = *(long *)(a0 + 0x10) + a1;
}

// Function: sub_9950 @ 0x9950
void sub_9950(char *a0,char *a1)
{
  char v1;
  ...
  *a0 = v1;
  ...
  a0[0xc] = a1[0xc];
  sub_ca90(&a0[0x10],&a1[0x10]); // tail-call
}

// Function: sub_9990 @ 0x9990
int * sub_9990(int *a0,int a1)
{
  if (a1 != 10) {
    *a0 = a1;
    a0[1] = 0;
...
{
  return sub_8890(a0 + 9,a1 + 9) == 0;
}

// Function: sub_9a00 @ 0x9a00
unsigned long sub_9a00(long a0,unsigned long a1,unsigned char a2)
{
  unsigned char v1;
...
unsigned long sub_9a60(long a0,unsigned long a1,unsigned char a2,char a3)
{
  unsigned char v1;
...
unsigned long sub_9ae0(long a0,unsigned long a1,unsigned char a2,char a3,char a4)
{
  unsigned char v1;
...
unsigned long sub_9b50(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5)
{
  unsigned char v1;
...
unsigned long sub_9bf0(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6)
{
  unsigned int v1;
  unsigned char v2;
...
unsigned long sub_9c90(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,unsigned int a7)
{
  unsigned int v1;
  unsigned int v2;
  unsigned char v3;
...
unsigned long sub_9d50(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,unsigned int a8)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_9e10(long a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,int a6,int a7,int a8,unsigned int a9)
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
...
unsigned long sub_9ef0(unsigned char *a0,unsigned long a1,unsigned char a2,char a3,char a4,char a5,unsigned int a6,unsigned int a7,unsigned int a8) // early-return
{
  unsigned int v1;
  unsigned int v2;
  unsigned int v3;
    ...
    if (v25) {
      ...
      if (v25) {
        if (v30) {
          ...
          if ((a3 < v23 + v30) || (v8 = memcmp(v11,v31,v30), v8)) goto label_aba0;
          if (!v24) {
            v7 = *v11;
...
label_ac44:
              ...
              if (((bool)(v2 & v24)) && (v30)) goto label_ac6a;
              v16 = 0x5c;
              goto label_a692;
            }
          }
...
label_a368:
    v16 = (unsigned char)v21;
    v12 = v13;
    if (!v29) goto label_a513;
    if (!(*(unsigned int *)(v29 + (v21 >> 5) * 4) >> (v16 & 0x1f) & 1)) goto label_a513;
  }
  else {
label_a510:
    v7 = 0;
...
label_a6a3:
  if (v24) {
    v24 = v2;
label_a6bf:
    if ((bool)(v24 & a4 == 2)) goto label_a6cb;
label_a45c:
    v34 &= 0xfffffffd;
    v29 = 0;
    goto label_a150;
...
void * sub_b510(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_13078 <= (int)a0) {
      v10 = (long)dat_13078;
      v9 = (long)(int)((a0 - dat_13078) + 1);
      if (dat_13080 != (unsigned long *)0x13090) // branch-flip
        v6 = (unsigned long *)sub_8330(dat_13080,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_8330(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_13090;
        v6[1] = dat_13098;
      }
      dat_13080 = v6;
      memset(&v6[(long)dat_13078 * 2],0,(v10 - dat_13078) * 0x10);
      dat_13078 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_a0e0(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x23180)
      ...
      sub_a0e0(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
unsigned int sub_b7c0(long a0,unsigned int a1)
{
  unsigned int v1;
...
void sub_b820(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_a0e0(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_b8a0 @ 0xb8a0
unsigned long sub_b8a0(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_a0e0(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_81a0(v3 + 1);
  sub_a0e0(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_b990(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_b8a0(a0,a1,0,a2); // tail-call
}
...
void sub_ba40(unsigned long a0,unsigned long a1)
{
  sub_b510(a0,a1,0xffffffffffffffff,0x23280); // tail-call
}
...
void sub_ba70(unsigned long a0)
{
  sub_ba40(0,a0); // tail-call
}

// Function: sub_ba80 @ 0xba80
void sub_ba80(unsigned long a0,unsigned long a1)
{
  sub_ba60(0,a0,a1); // tail-call
}

// Function: sub_ba90 @ 0xba90
void sub_ba90(unsigned int a0,unsigned long a1,unsigned long a2)
{
  char v1 [56];
...
void sub_baf0(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_bb60(unsigned int a0,unsigned long a1)
{
  sub_ba90(0,a0,a1); // tail-call
}

// Function: sub_bb70 @ 0xbb70
void sub_bb70(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_baf0(0,a0,a1,a2); // tail-call
}

// Function: sub_bb90 @ 0xbb90
void sub_bb90(unsigned long a0,unsigned long a1,char a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
...
void sub_bc20(unsigned long a0,char a1)
{
...
void sub_bc50(unsigned long a0,unsigned long a1)
{
  sub_bb90(a0,a1,0x3a); // tail-call
}

// Function: sub_bc60 @ 0xbc60
void sub_bc60(unsigned int a0,unsigned long a1,unsigned long a2)
{
...
void sub_bd00(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
...
void sub_bdd0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
...
void sub_be00(unsigned long a0,unsigned long a1)
{
  sub_bdf0(0,a0,a1); // tail-call
}

// Function: sub_be10 @ 0xbe10
void sub_be10(unsigned long a0,unsigned long a1)
{
  sub_bdf0(a0,a1,0xffffffffffffffff); // tail-call
}

// Function: sub_be20 @ 0xbe20
void sub_be20(unsigned long a0)
{
  sub_be10(0,a0); // tail-call
}
...
char * sub_c3b0(char *a0,unsigned long a1,unsigned long a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
...
unsigned long sub_c6f0(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
...
void sub_ca30(unsigned long a0)
{
  if (a0 & 0xf)
    abort(); // no-return
  if (!(a0 & 0x10))
...
void sub_ca90(long *a0,long *a1) // return-dupe
{
  long v1;
  long *v2;
