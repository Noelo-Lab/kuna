...
void sub_2880(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_efd0)(sub_4670,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
unsigned long * sub_5165(unsigned long a0) // early-return
{
  unsigned long *v1; // rax
...
long sub_5227(long *a0,unsigned int *a1) // early-return x2, ternary
{
  void *v1;
  long *v2;
  long v3; // rax
...
void sub_54ec(void *a0,unsigned int a1) // return-dupe
{
  if (!a0)
    return;
...
unsigned long sub_552b(void *a0)
{
  int v1; // eax
  int v2; // stack - 0x14
...
void sub_55e4(unsigned int *a0) // return-dupe
{
  if (!(*a0 & 0x100))
    return;
  sub_566b(a0,0,1);
...
unsigned long sub_566b(unsigned int *a0,unsigned long a1,unsigned int a2) // early-return x2
{
  long v1; // rax
...
void sub_57ed(long *a0,long *a1) // return-dupe
{
...
unsigned long sub_58d8(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3) // early-return
{
  long v1;
...
unsigned long sub_5d06(long a0)
{
  int v1;
...
label_6afc:
    if ((v29 <= 1) && ((!v1 || (v16)))) goto label_6d5f;
    v32 = v29 + v24;
    while( true ) {
      if ((!v1) || (v16)) {
        if (v3) {
...
label_6d5f:
    if (((((v1) && (v19 != 2)) || (v14)) && ((v7 && (*(unsigned int *)(v7 + (unsigned long)(v22 >> 5) * 4) >> (v22 & 0x1f) & 1)))) || (v3)) goto label_6dca;
  }
label_6e85:
  if ((v2) && (!v4)) {
    if (v25 < v21)
...
label_7096:
  ...
  if (((v19 == 2) && (!v14)) && (v5)) {
    if (v6)
      return sub_605a(a0,v26,a2,v20,5,a5,v7,v18,v17);
    if ((!v21) && (v26)) {
      v21 = v26;
      v25 = 0;
      goto label_6114;
...
unsigned long sub_711b(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  unsigned long v2; // rax
  ...
  v1 = *__errno_location();
  v2 = sub_605a(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *__errno_location() = v1;
  return v2;
}

// Function: sub_71c3 @ 0x71c3
void sub_71c3(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_71f9(a0,a1,0,a2);
}

// Function: sub_71f9 @ 0x71f9
unsigned long sub_71f9(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  unsigned int v2; // eax
  long v3; // rax
  ...
  v3 = sub_605a(0,0,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_8e27(v3 + 1);
  sub_605a(v4,v3 + 1,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *__errno_location() = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void * sub_73e4(int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  int v1;
  unsigned int v2;
  unsigned long *v3;
  ...
  if ((0 <= a0) && (a0 <= 0x7ffffffe)) {
    ...
    v2 = a3[1];
    v9 = sub_605a(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v8 <= v9) {
      v8 = v9 + 1;
      v6[(long)a0 * 2] = v8;
      if (v7 != (void *)0xf1c0)
      ...
      v7 = (void *)sub_8e27(v8);
      v6[(long)a0 * 2 + 1] = v7;
      sub_605a(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *__errno_location() = v1;
    return v7;
  }
...
void sub_7693(unsigned int a0,unsigned long a1)
{
  sub_73e4(a0,a1,0xffffffffffffffff,0xf180);
}

// Function: sub_76c7 @ 0x76c7
void sub_76c7(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_73e4(a0,a1,a2,0xf180);
}

// Function: sub_76f9 @ 0x76f9
void sub_76f9(unsigned long a0)
{
  sub_7693(0,a0);
}

// Function: sub_771c @ 0x771c
void sub_771c(unsigned long a0,unsigned long a1)
{
  sub_76c7(0,a0,a1);
}

// Function: sub_7747 @ 0x7747
void sub_7747(unsigned int a0,unsigned int a1,unsigned long a2)
{
  char v1 [56];
...
void sub_77af(unsigned int a0,unsigned int a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_7815(unsigned int a0,unsigned long a1)
{
  sub_7747(0,a0,a1);
}

// Function: sub_783d @ 0x783d
void sub_783d(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_77af(0,a0,a1,a2);
}

// Function: sub_786d @ 0x786d
void sub_786d(unsigned long a0,unsigned long a1,char a2)
{
...
void sub_7928(unsigned long a0,char a1)
{
  sub_786d(a0,0xffffffffffffffff,(int)a1);
}

// Function: sub_7956 @ 0x7956
void sub_7956(unsigned long a0)
{
  sub_7928(a0,0x3a);
}

// Function: sub_7979 @ 0x7979
void sub_7979(unsigned long a0,unsigned long a1)
{
  sub_786d(a0,a1,0x3a);
}

// Function: sub_79a7 @ 0x79a7
void sub_79a7(unsigned int a0,unsigned int a1,unsigned long a2)
{
...
void sub_7a69(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_7aa3(a0,a1,a2,a3,0xffffffffffffffff);
}

// Function: sub_7aa3 @ 0x7aa3
void sub_7aa3(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned long v3; // stack - 0x38
...
void sub_7b61(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_7a69(0,a0,a1,a2);
}

// Function: sub_7b94 @ 0x7b94
void sub_7b94(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_7aa3(0,a0,a1,a2,a3);
}

// Function: sub_7bd2 @ 0x7bd2
void sub_7bd2(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_73e4(a0,a1,a2,0xf060);
}

// Function: sub_7c04 @ 0x7c04
void sub_7c04(unsigned long a0,unsigned long a1)
{
  sub_7bd2(0,a0,a1);
}

// Function: sub_7c2f @ 0x7c2f
void sub_7c2f(unsigned int a0,unsigned long a1)
{
  sub_7bd2(a0,a1,0xffffffffffffffff);
}

// Function: sub_7c5c @ 0x7c5c
void sub_7c5c(unsigned long a0)
{
  sub_7c2f(0,a0);
}
...
void sub_7c7f(unsigned long *a0)
{
  *a0 = 0;
  a0[1] = 0;
  a0[2] = 0;
  _obstack_begin(&a0[3],0,0,dat_efe8,dat_efc8);
  _obstack_begin(&a0[0xe],0,0,dat_efe8,dat_efc8);
  _obstack_begin(&a0[0x19],0,0,dat_efe8,dat_efc8);
}
...
unsigned long sub_809e(void *a0,long a1)
{
  char *v1;
  long v2;
  int v3; // eax
...
void sub_8486(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5) // return-dupe x10
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
void sub_8a82(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,long a4)
{
  long v1; // stack - 0x10
...
void sub_8af5(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  long *v1;
  long v2 [11];
...
void sub_8bfb(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_8d88(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_8ec1(a0,a1,a2);
}
...
void sub_8e90(unsigned long a0,unsigned long a1)
{
...
void sub_8f1b(unsigned long a0,unsigned long a1,unsigned long a2)
{
...
void sub_8faa(unsigned long a0,unsigned long a1)
{
  sub_8fd8(a0,a1,1);
}

// Function: sub_8fd8 @ 0x8fd8
unsigned long sub_8fd8(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_90b7(long a0,long *a1,long a2,long a3,long a4) // ternary
{
  long v1;
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_953d(void *a0)
{
  int v1; // eax
  unsigned long v2; // rax
  bool v3; // zf
...
unsigned long sub_984e(long *a0,long a1,long a2)
{
  long v1;
  long *v2;
  long v3; // stack - 0x30
...
void _obstack_newchunk(unsigned long *a0,long a1)
{
  ...
  if (v7 < *a0)
    v7 = *a0;
  if ((v2 <= v3) && (v3 <= v4))
    v6 = (unsigned long *)sub_97a5(a0,v7);
  if (!v6)
    (*obstack_alloc_failed_handler)();
...
void sub_9ec9(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_9e11(a0,a1,a2);
}
