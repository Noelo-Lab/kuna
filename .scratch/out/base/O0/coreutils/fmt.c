...
void sub_26c0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_cfc0)(sub_2bde,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
// Function: sub_2bde @ 0x2bde
unsigned long sub_2bde(int a0,char **a1)
{
  bool v1;
  ...
  v12 = a1;
  v13 = a0;
  if (((2 <= a0) && (v2 = dat_d100, v3 = dat_d101, v4 = dat_d102, *a1[1] == '-')) && ((unsigned int)((int)a1[1][1] - 0x30U) <= 9)) {
    v15 = &a1[1][1];
    a1[1] = *a1;
    v12 = &a1[1];
    v13 = a0 + -1;
  ...
  while( true ) {
    ...
    dat_d101 = v3;
    dat_d100 = v2;
    v6 = getopt_long(v13,v12,"0123456789cstuw:p:g:",(void *)0xca80,NULL);
    if (v6 == 0xffffffff) {
      if (v15)
        dat_d110 = sub_7afa(v15,0,0x9c4,0x91c3,gettext("invalid width"),0);
      if (v16) { // branch-flip
        v8 = gettext("invalid width");
        dat_d120 = sub_7afa(v16,0,(long)dat_d110,0x91c3,v8,0);
        if (!v15)
      ...
      v1 = 0;
      if (v13 != optind) { // branch-flip
        for (; optind < v13; optind = optind + 1) {
          v8 = v12[optind];
          if (strcmp(v8,"-")) { // branch-flip
            v9 = fopen(v8,"r");
            if (v9) // branch-flip
              v14 = (sub_31d1(v9,v8) & v14) != 0;
            else {
              v10 = sub_6589(4,v8);
...
unsigned int sub_31d1(void *a0,unsigned long a1) // ternary
{
  unsigned long v1; // rax
  char *v2; // rax
...
void sub_32fb(char a0) // return-dupe x4, return-dupe x2
{
  if (dat_d102) {
    dat_18134 = dat_18130;
    return;
...
unsigned long sub_33b7(unsigned long a0) // return-dupe
{
  int v1; // stack - 0xc
...
void sub_3793(void *a0,int a1) // ternary, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_3793
{
  char *v1;
  int v2;
  char v3; // al
...
void sub_3aba(unsigned long *a0)
{
  unsigned char v1;
  unsigned char v2;
  unsigned char *v3;
  ...
  v3 = (unsigned char *)*a0;
  v4 = &v3[(long)*(int *)&a0[1] + -1];
  v1 = *v4;
  v2 = *v3;
  *(unsigned char *)&a0[2] = *(unsigned char *)&a0[2] & 0xfe | strchr("([\'`\"",(int)(char)v2) != NULL;
  *(unsigned char *)&a0[2] = *(unsigned char *)&a0[2] & 0xfb | ((*(unsigned short *)((unsigned long)v1 * 2 + *(long *)__ctype_b_loc()) & 4) != 0) * '\x04';
  for (; v3 < v4; v4 = &v4[-1]) {
    v1 = *v4;
    if (!strchr(")]\'\"",(int)(char)v1)) break;
  }
  v1 = *v4;
  *(unsigned char *)&a0[2] = *(unsigned char *)&a0[2] & 0xfd | (strchr(".?!",(int)(char)v1) != NULL) * '\x02';
}
...
long sub_406b(long a0,int a1) // early-return
{
  long v1; // stack - 0x10
...
void sub_417f(long a0,int a1)
{
  ...
  v1 = *(long *)(a0 + 0x20);
  for (v2 = a0; v2 != v1 + -0x28; v2 = v2 + 0x28) {
    sub_4248(v2);
    sub_42aa(*(unsigned int *)(v2 + 0xc));
  }
  sub_4248(v2);
  dat_18140 = dat_d128;
  putchar_unlocked(10);
...
void sub_4248(unsigned long *a0)
{
  char *v1;
  int v2; // stack - 0x14
  char *v3; // stack - 0x10
...
void sub_4752(void *a0,unsigned int a1) // return-dupe
{
  if (!a0)
    return;
...
unsigned long sub_4791(void *a0)
{
  int v1; // eax
  int v2; // stack - 0x14
...
void sub_484a(unsigned int *a0) // return-dupe
{
  if (!(*a0 & 0x100))
    return;
  sub_48d1(a0,0,1);
...
unsigned long sub_48d1(unsigned int *a0,unsigned long a1,unsigned int a2) // early-return x2
{
  long v1; // rax
...
unsigned long sub_4a7a(long a0)
{
  int v1;
...
unsigned int sub_4ba8(long a0,unsigned int a1)
{
  unsigned int v1;
  long v2; // stack - 0x20
...
label_5870:
    if ((v29 <= 1) && ((!v1 || (v16)))) goto label_5ad3;
    v32 = v29 + v24;
    while( true ) {
      if ((!v1) || (v16)) {
        if (v3) {
...
label_5ad3:
    if (((((v1) && (v19 != 2)) || (v14)) && ((v7 && (*(unsigned int *)(v7 + (unsigned long)(v22 >> 5) * 4) >> (v22 & 0x1f) & 1)))) || (v3)) goto label_5b3e;
  }
label_5bf9:
  if ((v2) && (!v4)) {
    if (v25 < v21)
...
label_5e0a:
  ...
  if (((v19 == 2) && (!v14)) && (v5)) {
    if (v6)
      return sub_4dce(a0,v26,a2,v20,5,a5,v7,v18,v17);
    if ((!v21) && (v26)) {
      v21 = v26;
      v25 = 0;
      goto label_4e88;
...
unsigned long sub_5e8f(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  unsigned long v2; // rax
  ...
  v1 = *__errno_location();
  v2 = sub_4dce(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *__errno_location() = v1;
  return v2;
}

// Function: sub_5f37 @ 0x5f37
void sub_5f37(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_5f6d(a0,a1,0,a2);
}

// Function: sub_5f6d @ 0x5f6d
unsigned long sub_5f6d(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  unsigned int v2; // eax
  long v3; // rax
  ...
  v3 = sub_4dce(0,0,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_7394(v3 + 1);
  sub_4dce(v4,v3 + 1,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *__errno_location() = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void * sub_6158(int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  int v1;
  unsigned int v2;
  unsigned long *v3;
  ...
  if ((0 <= a0) && (a0 <= 0x7ffffffe)) {
    ...
    v2 = a3[1];
    v9 = sub_4dce(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v8 <= v9) {
      v8 = v9 + 1;
      v6[(long)a0 * 2] = v8;
      if (v7 != (void *)0x181a0)
      ...
      v7 = (void *)sub_7394(v8);
      v6[(long)a0 * 2 + 1] = v7;
      sub_4dce(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *__errno_location() = v1;
    return v7;
  }
...
void sub_6407(unsigned int a0,unsigned long a1)
{
  sub_6158(a0,a1,0xffffffffffffffff,0x18160);
}

// Function: sub_643b @ 0x643b
void sub_643b(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_6158(a0,a1,a2,0x18160);
}

// Function: sub_646d @ 0x646d
void sub_646d(unsigned long a0)
{
  sub_6407(0,a0);
}

// Function: sub_6490 @ 0x6490
void sub_6490(unsigned long a0,unsigned long a1)
{
  sub_643b(0,a0,a1);
}

// Function: sub_64bb @ 0x64bb
void sub_64bb(unsigned int a0,unsigned int a1,unsigned long a2)
{
  char v1 [56];
...
void sub_6523(unsigned int a0,unsigned int a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_6589(unsigned int a0,unsigned long a1)
{
  sub_64bb(0,a0,a1);
}

// Function: sub_65b1 @ 0x65b1
void sub_65b1(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_6523(0,a0,a1,a2);
}

// Function: sub_65e1 @ 0x65e1
void sub_65e1(unsigned long a0,unsigned long a1,char a2)
{
...
void sub_669c(unsigned long a0,char a1)
{
  sub_65e1(a0,0xffffffffffffffff,(int)a1);
}

// Function: sub_66ca @ 0x66ca
void sub_66ca(unsigned long a0)
{
  sub_669c(a0,0x3a);
}

// Function: sub_66ed @ 0x66ed
void sub_66ed(unsigned long a0,unsigned long a1)
{
  sub_65e1(a0,a1,0x3a);
}

// Function: sub_671b @ 0x671b
void sub_671b(unsigned int a0,unsigned int a1,unsigned long a2)
{
...
void sub_67dd(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_6817(a0,a1,a2,a3,0xffffffffffffffff);
}

// Function: sub_6817 @ 0x6817
void sub_6817(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned long v3; // stack - 0x38
...
void sub_68d5(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_67dd(0,a0,a1,a2);
}

// Function: sub_6908 @ 0x6908
void sub_6908(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_6817(0,a0,a1,a2,a3);
}

// Function: sub_6946 @ 0x6946
void sub_6946(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_6158(a0,a1,a2,0xd040);
}

// Function: sub_6978 @ 0x6978
void sub_6978(unsigned long a0,unsigned long a1)
{
  sub_6946(0,a0,a1);
}

// Function: sub_69a3 @ 0x69a3
void sub_69a3(unsigned int a0,unsigned long a1)
{
  sub_6946(a0,a1,0xffffffffffffffff);
}

// Function: sub_69d0 @ 0x69d0
void sub_69d0(unsigned long a0)
{
  sub_69a3(0,a0);
}

// Function: sub_69f3 @ 0x69f3
void sub_69f3(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5) // return-dupe x10
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
void sub_6fef(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,long a4)
{
  long v1; // stack - 0x10
...
void sub_7062(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  long *v1;
  long v2 [11];
...
void sub_7168(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_72f5(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_742e(a0,a1,a2);
}
...
void sub_73fd(unsigned long a0,unsigned long a1)
{
...
void sub_7488(unsigned long a0,unsigned long a1,unsigned long a2)
{
...
void sub_7517(unsigned long a0,unsigned long a1)
{
  sub_7545(a0,a1,1);
}

// Function: sub_7545 @ 0x7545
unsigned long sub_7545(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_7624(long a0,long *a1,long a2,long a3,long a4) // ternary
{
  long v1;
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_79c0(unsigned long a0,unsigned int a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,int a6)
{
  int v1;
  unsigned long v2; // rax
...
void sub_7afa(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned int a5)
{
...
unsigned long sub_8102(void *a0)
{
  int v1; // eax
  unsigned long v2; // rax
  bool v3; // zf
...
unsigned long sub_82c0(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3) // early-return
{
  long v1;
...
void sub_84f4(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_843c(a0,a1,a2);
}
