...
void ctime(void)
{
  (*dat_48b08)(); // jump-as-call
}

// Function: setmntent @ 0x69a0
void setmntent(void)
{
  (*dat_48b10)(); // jump-as-call
}
...
void * getgrnam(char *a0)
{
  ...
  v1 = (void *)(*dat_48b58)(); // jump-as-call
  return v1;
}
...
void * fopen(char *a0,char *a1)
{
  ...
  v1 = (void *)(*dat_48c30)(); // jump-as-call
  return v1;
}
...
void * getpwuid(unsigned int a0)
{
  ...
  v1 = (void *)(*dat_48c78)(); // jump-as-call
  return v1;
}
...
void * opendir(char *a0)
{
  ...
  v1 = (void *)(*dat_48cc8)(); // jump-as-call
  return v1;
}
...
void * readdir(void *a0)
{
  ...
  v1 = (void *)(*dat_48ce8)(); // jump-as-call
  return v1;
}
...
void * fdopen(int a0,char *a1)
{
  ...
  v1 = (void *)(*dat_48d00)(); // jump-as-call
  return v1;
}
...
void * getgrgid(unsigned int a0)
{
  ...
  v1 = (void *)(*dat_48e20)(); // jump-as-call
  return v1;
}
...
void * localtime_r(void *a0,void *a1)
{
  ...
  v1 = (void *)(*dat_48ea0)(); // jump-as-call
  return v1;
}
...
void * localtime(void *a0)
{
  ...
  v1 = (void *)(*dat_48f20)(); // jump-as-call
  return v1;
}
...
void * getpwnam(char *a0)
{
  ...
  v1 = (void *)(*dat_48f70)(); // jump-as-call
  return v1;
}
...
{
  (*dat_48f78)(); // jump-as-call
}

// Function: re_match @ 0x7280
void re_match(void)
{
  (*dat_48f80)(); // jump-as-call
}
...
void * fdopendir(int a0)
{
  ...
  v1 = (void *)(*dat_48fa0)(); // jump-as-call
  return v1;
}
...
void sub_72d0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_48fe0)(sub_88ed,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_19aae(unsigned long a0,unsigned long a1)
{
  sub_1a1b8(a0,a1,dat_49720,0,0,0,0);
}

// Function: sub_19af7 @ 0x19af7
void sub_19af7(long a0,unsigned long a1,char *a2,unsigned long a3,char *a4,long a5,char *a6,long a7,unsigned int a8)
{
  long v1; // rax
  ...
  v5 = *(long *)(a0 + 0x18) - 1;
  if (!dat_4a1e0)
    dat_4a1e0 = (char *)sub_31bc2(*(long *)(a0 + 0x18) + 1);
  v4 = dat_4a1e0;
  v2 = a3;
  v3 = a2;
  do {
    v1 = sub_24cc3(v3,*(unsigned long *)(a0 + 0x30));
    if (v1) // branch-flip
      v6 = v1 - (long)v3;
    else {
      v6 = v2;
  ...
  if (!*v3) {
    *v4 = '\0';
    sub_1a1b8(a0,a1,dat_4a1e0,&v4[1 - (long)dat_4a1e0],0,0,a8);
    return;
  }
...
unsigned long sub_19cee(long a0,long a1,char a2,unsigned long a3) // ternary x2
{
  unsigned long v1; // stack - 0x38
  
  if (a2) { // branch-flip
    if (*(unsigned long *)(a1 + 0x40) < a3)
      *(unsigned long *)(a1 + 0x40) = a3;
  }
  else if ((a3 < *(unsigned long *)(a1 + 0x48)) || (!*(long *)(a1 + 0x48)))
    *(unsigned long *)(a1 + 0x48) = a3;
  if ((*(long *)(a1 + 0x40)) && (*(unsigned long *)(a1 + 0x40) < *(unsigned long *)(a1 + 0x48))) {
    v1 = (unsigned long)(*(long *)(a1 + 0x48) - *(long *)(a1 + 0x40)) >> 1;
    if (a2) { // branch-flip
  ...
  if ((*(long *)(a0 + 0x38)) && (v1 <= *(long *)(a0 + 0x38) + 1U))
    v1 = *(long *)(a0 + 0x38) + 1;
  if (!v1)
    v1 = 1;
  return v1;
...
unsigned long sub_19e2b(long a0,unsigned long *a1,long a2,unsigned long a3,long a4)
{
  unsigned long v1;
  unsigned long v2;
  ...
  v3 = 0;
  v4 = 0;
  while (v4 < *(unsigned long *)(a0 + 0x38)) {
    v1 = v4 + 1;
    v2 = v3 + 1;
    *(unsigned long *)(v3 * 8 + a2) = *(unsigned long *)(a1[1] + v4 * 8);
    v3 = v2;
    v4 = v1;
  }
  v4 += a4;
...
void sub_19f5a(long a0,unsigned long *a1)
{
  void *v1;
  unsigned long v2;
  void *v3; // rax
  ...
  do {
    ...
    if ((*v1)(a0,v2,v4 & 0xffffffff,v3)) { // branch-flip
      ...
      if (v5 <= *(long *)(a0 + 0x38) + 1U) {
        error(1,0,gettext("can\'t call exec() due to argument size restrictions"));
        return;
      }
      v5 = sub_19cee(a0,a1,0,v5);
    }
  } while (v6 + 1U < *a1 - *(long *)(a0 + 0x38));
  free(v3);
  sub_1a840(a0,a1);
}

// Function: sub_1a152 @ 0x1a152
bool sub_1a152(int a0,long a1,long *a2) // early-return
{
  if (((!a0) && (*(long *)(a1 + 0x50))) && (*a2 - *(long *)(a1 + 0x38) == *(long *)(a1 + 0x50)))
    return 1;
  return *a2 == *(long *)(a1 + 0x20);
}

// Function: sub_1a1b8 @ 0x1a1b8
void sub_1a1b8(int *a0,unsigned long *a1,char *a2,long a3,char *a4,long a5,int a6) // return-dupe
{
  unsigned long v1;
  unsigned long v2;
  int v3; // eax
  ...
  if (v4) {
    if (*(unsigned long *)&a0[6] < a1[4] + a3 + a5) {
  ...
  if (v4) {
    v1 = *a1;
    *a1 = v1 + 1;
    *(unsigned long *)(v1 * 8 + a1[1]) = a1[3] + a1[4];
    if (a4) {
      strcpy((char *)(a1[3] + a1[4]),a4);
      a1[4] = a1[4] + a5;
    }
    strcpy((char *)(a1[3] + a1[4]),a2);
    a1[4] = a1[4] + a3;
    v3 = sub_1a152(a6,a0,a1);
    if (v3)
      sub_19f5a(a0,a1);
...
unsigned long sub_1a58c(unsigned int *a0,long a1) // return-dupe x2
{
  unsigned long v1; // rax
  
  v1 = sub_1a53a();
  *(unsigned long *)&a0[4] = 0x1000;
  *(unsigned long *)&a0[2] = sub_1a4e9();
  *a0 = 0;
  if (*(unsigned long *)&a0[2] < v1)
    return 1;
  if (*(unsigned long *)&a0[2] <= a1 + v1)
    return 2;
  *(unsigned long *)&a0[2] = *(long *)&a0[2] - v1;
  *(long *)&a0[2] = *(long *)&a0[2] - a1;
  *(unsigned long *)&a0[8] = (*(unsigned long *)&a0[2] >> 3) - 2;
  if (*(long *)&a0[8]) {
    *(unsigned long *)&a0[10] = 0;
    *(unsigned long *)&a0[0xc] = 0;
    *(unsigned long *)&a0[0xe] = 0;
    *(void **)&a0[0x10] = sub_1a51c;
    *(unsigned long *)&a0[0x12] = 0;
    *(unsigned long *)&a0[0x14] = 0;
    *(unsigned long *)&a0[6] = *(unsigned long *)&a0[2];
    return 0;
  }
...
void sub_1a6e3(long a0) // return-dupe x2
{
  if (*(unsigned long *)(a0 + 8) <= 0x1ffff) {
    *(unsigned long *)(a0 + 0x18) = *(unsigned long *)(a0 + 8);
    return;
  }
  if (0x20001 <= *(unsigned long *)(a0 + 0x10)) {
    *(unsigned long *)(a0 + 0x18) = *(unsigned long *)(a0 + 0x10);
    return;
  }
  *(unsigned long *)(a0 + 0x18) = 0x20000;
}

// Function: sub_1a742 @ 0x1a742
void sub_1a742(long a0,unsigned long *a1,unsigned long a2)
{
  long v1;
  ...
  *a1 = 0;
  ...
  a1[8] = 0;
  a1[9] = 0;
  if (0x7ffffffffffff800 <= *(unsigned long *)(a0 + 0x18))
  ...
  a1[4] = a1[5];
  *(unsigned int *)&a1[7] = 0;
  *(unsigned int *)((long)a1 + 0x3c) = 0xffffffff;
  a1[6] = a2;
}

// Function: sub_1a840 @ 0x1a840
void sub_1a840(long a0,unsigned long *a1)
{
...
int * sub_1a888(char *a0,unsigned long a1) // return-dupe
{
  char *v1;
  int v2; // eax
  int *v3; // rax
...
int sub_1a9dd(unsigned long a0,void *a1,unsigned long a2)
{
  int v1; // eax
  int v2;
  char v3 [24];
...
void * sub_1ac29(void *a0,long a1,unsigned long *a2)
{
  unsigned long v1; // rax
  int v2; // stack - 0x1c
  void *v3; // stack - 0x18
...
int sub_1ad9e(void) // return-dupe
{
  ...
  v6 = -1;
  v3 = (void *)sub_1d78f("/proc/self/fd");
  if (!v3)
    return -1;
  v1 = 0;
  while( true ) {
    *__errno_location() = 0;
    v4 = readdir(v3);
    if (!v4) break;
    if ((*(char *)((long)v4 + 0x13) != '.') || ((*(char *)((long)v4 + 0x14) && ((*(char *)((long)v4 + 0x14) != '.' || (*(char *)((long)v4 + 0x15))))))) {
      v2 = sub_1cd12((long)v4 + 0x13,0);
      if (v6 < v2)
        v6 = v2;
      v1 = 1;
    }
...
unsigned long sub_1b156(unsigned int a0,long *a1) // return-dupe x2
{
  long v1; // rax
  
  if (sub_1b128(a0))
    return 0;
  v1 = sub_1ac29(*a1,(a1[1] + 1) * 4,&a1[2]);
  if (v1) {
    *a1 = v1;
    *(unsigned int *)(*a1 + a1[1] * 4) = a0;
    a1[1] = a1[1] + 1;
    return 0;
  }
  return 0xffffffff;
...
unsigned long sub_1b29c(int a0,long *a1) // return-dupe x2
{
  if (sub_1b128(a0))
    return 0;
  do {
    if ((unsigned long)a1[1] <= (unsigned long)a1[2]) {
label_1b33a:
      *(int *)&a1[3] = a0;
      return 0xffffffff;
    }
...
int sub_1b433(unsigned long a0,unsigned int a1)
{
  int v1; // eax
...
void sub_1b61e(void)
{
  ...
  if ((int)v1 <= -1)
    return;
  error(0,0,gettext("File descriptor %d will leak; please report this as a bug, remembering to include a detailed description of the simplest way to reproduce this problem."),(unsigned long)v1);
  __assert_fail("no_leaks","fdleak.c",0x18c,"complain_about_leaky_fds"); // no-return
}

// Function: sub_1b6b6 @ 0x1b6b6
void sub_1b6b6(unsigned long a0)
{
  char *v1; // rax
  char *v2; // rax
...
unsigned long sub_1b74e(void *a0,unsigned long a1,unsigned int *a2) // return-dupe
{
  unsigned int v1; // eax
  
  v1 = fprintf(a0,"%*lu",(unsigned long)*a2,a1);
  if ((int)v1 <= -1)
    return 0;
  if ((int)v1 <= (int)*a2)
    return 1;
...
void sub_1b7b3(unsigned long a0,unsigned int a1,unsigned long a2,long a3,long a4,int a5,unsigned int a6,void *a7)
{
  char v1;
  char v10 [12];
  char v11 [664];
  ...
  long v17; // stack - 0x448
  unsigned long v18; // stack - 0x440
  int v19; // stack - 0x438
  long v2;
  unsigned int v20; // stack - 0x434
  unsigned long v21; // stack - 0x430
  bool v22; // stack - 0x425
  unsigned int v23; // stack - 0x424
  unsigned int v24; // stack - 0x420
  unsigned int v25; // stack - 0x41c
  unsigned int v26; // stack - 0x418
  int v27; // stack - 0x414
  unsigned int v28; // stack - 0x410
  unsigned int v29; // stack - 0x40c
  unsigned int v3;
  char *v30; // stack - 0x408
  unsigned long v31; // stack - 0x400
  long v32; // stack - 0x3f8
  long v33; // stack - 0x3f0
  void *v34; // stack - 0x3e8
  char *v35; // stack - 0x3e0
  char *v36; // stack - 0x3d8
  void *v37; // stack - 0x3d0
  char v4; // al
  int v5;
  unsigned long v6;
  unsigned long v7; // rax
  ...
  v20 = a1;
  v21 = a0;
  sub_1e2a6(*(unsigned int *)(a3 + 0x18),v10);
  v6 = sub_22eb1(*(unsigned long *)(v17 + 8),v11,0,1,1);
  v24 = fprintf(v9,"%*s",(unsigned long)dat_49730,v6);
  if (0 <= (int)v24) { // branch-flip
    if ((int)dat_49730 < (int)v24)
      dat_49730 = v24;
  }
  else {
    v22 = '\0';
  ...
  if (v22) {
    ...
    v6 = sub_22eb1(*(unsigned long *)(v17 + 0x40),v11,0,0x200,(long)v19);
    v24 = fprintf(v9,"%*s",(unsigned long)dat_49734,v6);
    if (0 <= (int)v24) { // branch-flip
      if ((int)dat_49734 < (int)v24)
        dat_49734 = v24;
    }
    else {
      v22 = '\0';
  ...
  if ((v22) && (v5 = putc(0x20,v9), v5 == -1)) {
    v22 = '\0';
    v23 = 0xfa;
  }
  if ((v22) && (v5 = fputs(v10,v9), v5 <= -1)) {
    v22 = '\0';
    v23 = 0x113;
  }
  if (v22) {
    v24 = fprintf(v9,"%*lu",(unsigned long)dat_49738,*(unsigned long *)(v17 + 0x10));
    if (0 <= (int)v24) { // branch-flip
      if ((int)dat_49738 < (int)v24)
        dat_49738 = v24;
    }
    else {
      v22 = '\0';
  ...
  if (v22) {
    ...
    v32 = sub_23cf8(*(unsigned int *)(v17 + 0x1c));
    if (v32) { // branch-flip
      v25 = sub_25431(v32,0);
      if ((int)dat_4973c < (int)v25)
        dat_4973c = v25;
      v5 = fprintf(v9,"%-*s ",(unsigned long)dat_4973c,v32);
      v22 = -((char)~(unsigned char)((unsigned int)v5 >> 0x18) >> 7);
      if (v22 != '\x01')
        v23 = 400;
    }
    else {
      v24 = fprintf(v9,"%-8lu ",(unsigned long)*(unsigned int *)(v17 + 0x1c));
      if ((int)dat_4973c < (int)v24)
        dat_4973c = v24;
      v22 = 0 < (int)v24;
      if (0 >= (int)v24)
        v23 = 0x1c2;
  ...
  if (v22) {
    v33 = sub_23f4a(*(unsigned int *)(v17 + 0x20));
    if (v33) { // branch-flip
      v26 = sub_25431(v33,0);
      if ((int)dat_49740 < (int)v26)
        dat_49740 = v26;
      v5 = fprintf(v9,"%-*s ",(unsigned long)dat_49740,v33);
      v22 = -((char)~(unsigned char)((unsigned int)v5 >> 0x18) >> 7);
      if (v22 != '\x01')
        v23 = 500;
    }
    else {
      v24 = fprintf(v9,"%-*lu",(unsigned long)dat_49740,(unsigned long)*(unsigned int *)(v17 + 0x20));
      if ((int)dat_49740 < (int)v24)
        dat_49740 = v24;
      v22 = -((char)~(unsigned char)(v24 >> 0x18) >> 7);
      if (v22) { // branch-flip
        v5 = putc(0x20,v9);
        if (v5 == -1) {
          v22 = '\0';
  ...
  if (v22) {
    if (((*(unsigned int *)(v17 + 0x18) & 0xf000) != 0x2000) && ((*(unsigned int *)(v17 + 0x18) & 0xf000) != 0x6000)) {
      if (0 <= v19) // branch-flip
        v27 = 1;
      else {
        v27 = v19;
      }
      v6 = sub_22eb1(*(unsigned long *)(v17 + 0x30),v11,0,1,(long)v27);
      v24 = fprintf(v9,"%*s",(unsigned long)dat_4974c,v6);
      if (0 <= (int)v24) { // branch-flip
        if ((int)dat_4974c < (int)v24)
          dat_4974c = v24;
      }
      else {
        v22 = '\0';
      ...
      v6 = *(unsigned long *)(v17 + 0x28);
      v4 = sub_1b74e(v9,gnu_dev_major(v6),0x49744);
      if (v4 != '\x01') {
        v22 = '\0';
        v23 = 600;
      }
      if ((v22) && (v5 = fprintf(v9,", "), v5 <= -1)) {
        v22 = '\0';
        v23 = 0x271;
      }
      if (v22) {
        v6 = *(unsigned long *)(v17 + 0x28);
        v4 = sub_1b74e(v9,gnu_dev_minor(v6),0x49748);
        if (v4 != '\x01') {
          v22 = '\0';
          v23 = 0x28a;
        }
  ...
  v15 = &v9;
  if (v22) {
    v34 = localtime((void *)(v17 + 0x58));
    if (v34) { // branch-flip
      v30 = v12;
      v31 = 0x100;
      if ((v16 + -0xed4e00 <= *(long *)(v17 + 0x58)) && (*(long *)(v17 + 0x58) <= v16 + 0xe10))
        v36 = "%b %e %H:%M";
      else {
        v36 = "%b %e  %Y";
      }
      while( true ) {
        *(unsigned long *)((long)v14 + -8) = 0x1c077;
        v7 = strftime(v30,v31,v36,v34,*(char *)((long)v14 + -8));
        if (v7) break;
        v31 *= 2;
        v7 = ((v31 + 0x17) / 0x10) * 0x10;
        for (v13 = (char *)v14; v13 != (char *)((long)v14 + -(v7 & 0xfffffffffffff000)); v13 = &v13[-0x1000]) {
          *(unsigned long *)&v13[-8] = *(unsigned long *)&v13[-8];
        }
        v2 = -(unsigned long)((unsigned int)v7 & 0xfff);
        v14 = (char *)&v13[v2];
        if (v7 & 0xfff)
          *(unsigned long *)&v13[((unsigned long)((unsigned int)v7 & 0xfff) - 8) + v2] = *(unsigned long *)&v13[((unsigned long)((unsigned int)v7 & 0xfff) - 8) + v2];
      ...
      *(unsigned long *)((long)v14 + -8) = 0x1c0a5;
      ...
      v28 = 0xc;
      if (0 <= *(long *)(v17 + 0x58)) { // branch-flip
        v6 = sub_22eb1(*(unsigned long *)(v17 + 0x58),v11,0,1,1);
        v5 = fprintf(v9,"%*s ",(unsigned long)v28,v6);
        v15 = &v9;
        if (v5 <= -1) {
          v22 = '\0';
          v23 = 0x44c;
        ...
        v8 = (char *)sub_22eb1(-*(long *)(v17 + 0x58),v11,0,1,1);
        v3 = v28;
        v35 = v8;
        v29 = v3 - (int)strlen(v8);
        v7 = 0;
        if (0 <= (int)v29)
          v7 = (unsigned long)v29;
        v5 = fprintf(v9,"%*s%s ",v7,"-",v35);
        v15 = &v9;
        if (v5 <= -1) {
          v22 = '\0';
          v23 = 1000;
  ...
  if (v22) {
    if ((*(unsigned int *)(v17 + 0x18) & 0xf000) == 0xa000) {
      *(unsigned long *)((long)v15 + -8) = 0x1c273;
      v37 = (void *)sub_1d06d(v20,v18);
      if (v37) { // branch-flip
        *(unsigned long *)((long)v15 + -8) = 0x1c29d;
        v5 = fputs(" -> ",v9,*(char *)((long)v15 + -8));
        if (v5 <= -1) {
          v22 = '\0';
          v23 = 0x514;
        }
      ...
      *(unsigned long *)((long)v15 + -8) = 0x1c32f;
      free(v37,*(char *)((long)v15 + -8));
    }
    if (v22) {
      *(unsigned long *)((long)v15 + -8) = 0x1c34c;
      v5 = putc(10,v9,*(char *)((long)v15 + -8));
      if (v5 == -1) {
        v22 = '\0';
        v23 = 0x578;
      }
  ...
  *(unsigned long *)((long)v15 + -8) = 0x1c38d;
  v8 = gettext("Failed to write output (at stage %d)",*(char *)((long)v15 + -8));
  *(unsigned long *)((long)v15 + -8) = 0x1c395;
  v1 = *(char *)((long)v15 + -8);
  v5 = *__errno_location(v1);
  *(unsigned long *)((long)v15 + -8) = 0x1c3b3;
  error(1,v5,v8,(unsigned long)v23);
}

// Function: sub_1c3ce @ 0x1c3ce
unsigned int sub_1c3ce(unsigned long a0,void *a1)
{
  return (unsigned int)~fprintf(a1,"%s",a0) >> 0x1f;
}

// Function: sub_1c408 @ 0x1c408
unsigned long sub_1c408(unsigned char *a0,void *a1) // return-dupe x2
{
  unsigned char *v1;
  unsigned char v2;
  unsigned int v3; // eax
...
label_1c585:
      if ((0x21 <= v2) && (v2 <= 0x7e)) {
        ...
        v4 = fprintf(a1,"\\%03o",(unsigned long)v3);
      }
    }
    else {
...
void sub_1c605(unsigned long a0,unsigned long a1,int a2) // return-dupe
{
  if (a2) {
    sub_1c3ce(a0,a1);
    return;
...
int sub_1c643(void *a0,unsigned long a1,char a2,char *a3,unsigned long a4)
{
  unsigned long v1; // rax
  char v2 [8200];
  int v3; // stack - 0x202c
  ...
  while( true ) {
    if (0xd <= v4) {
      ...
      for (v4 = 0; v4 <= 0xc; v4 = v4 + 1) {
        ...
        v2 = sub_2fd76(*(unsigned long *)((unsigned long)v4 * 0x10 + 0x49760));
    ...
    v1 = (char *)sub_2fd76(*(unsigned long *)((unsigned long)v4 * 0x10 + 0x49760));
    v5 += strlen(v1) + 2;
    v4 += 1;
  }
...
unsigned long sub_1cf56(long a0,unsigned long a1,char a2,long *a3,long *a4)
{
  long v1;
  ...
  v1 = *a3;
  *a4 = sub_1cf01(v1 + a0,a1);
  return 1;
}

// Function: sub_1d008 @ 0x1d008
void sub_1d008(void *a0,unsigned long a1)
{
...
{
  sub_1d51d(a0,a1,0,0,0,dat_48fd8);
}

// Function: sub_1d0aa @ 0x1d0aa
unsigned long * sub_1d0aa(unsigned long a0) // early-return
{
  unsigned long *v1; // rax
...
long sub_1d16c(long *a0,unsigned int *a1) // early-return x2, ternary
{
  void *v1;
  long *v2;
  long v3; // rax
...
void sub_1d51d(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  char v1 [1032];
...
unsigned long sub_1d5ba(unsigned int a0,char a1) // return-dupe, ternary
{
  unsigned int v1; // eax
  unsigned int v2; // eax
...
char * sub_1d9d4(void *a0) // early-return
{
  char *v1; // rax
  unsigned long v2; // stack - 0x18
...
unsigned long sub_1dad5(void *a0)
{
  int v1; // eax
  int v2; // stack - 0x14
...
void sub_1e170(unsigned int *a0) // return-dupe
{
  if (!(*a0 & 0x100))
    return;
  sub_1e588(a0,0,1);
...
void sub_1e472(long a0,unsigned long a1)
{
  sub_1e2a6(*(unsigned int *)(a0 + 0x18),a1);
}

// Function: sub_1e49e @ 0x1e49e
void * sub_1e49e(char *a0,char *a1)
{
  int v1;
  int v2;
  void *v3; // rax
...
unsigned long sub_1e588(unsigned int *a0,unsigned long a1,unsigned int a2) // early-return x2
{
  long v1; // rax
...
unsigned int sub_1e646(long *a0,long *a1) // return-dupe
{
  if ((a0[1] == a1[1]) && (*a0 == *a1))
    return 1;
  return 0;
...
unsigned long sub_1e69f(long a0,unsigned long a1)
{
  return *(unsigned long *)(a0 + 8) % a1;
}

// Function: sub_1e6cd @ 0x1e6cd
unsigned long sub_1e6cd(long a0) // return-dupe x2, return-dupe
{
  unsigned long v1; // rax
  ...
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    *(void **)(a0 + 0x58) = malloc(0x20);
    if (*(long *)(a0 + 0x58)) {
      sub_33f75(*(unsigned long *)(a0 + 0x58));
      return 1;
    }
    return 0;
  }
  v1 = sub_21bb1(0x1f,0,sub_1e69f,sub_1e646,dat_48fc0);
...
unsigned long sub_1e779(long a0,unsigned long *a1) // return-dupe x3
{
  unsigned long v1;
  unsigned long *v2; // rax
  unsigned long *v3; // rax
  ...
  *v2 = a1[0xe];
  v2[1] = a1[0xf];
  v2[2] = a1;
  v3 = (unsigned long *)sub_228f2(*(unsigned long *)(a0 + 0x58),v2);
  if (v3 == v2)
    return 1;
  free(v2);
  if (v3) {
...
void sub_1e88b(long a0,long a1)
{
  long v1;
  void *v2; // rax
  long v3; // stack - 0x28
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x102) { // branch-flip
    ...
    v2 = (void *)sub_22962(*(unsigned long *)(a0 + 0x58),&v3);
    if (!v2)
      abort(); // no-return
    free(v2);
  }
...
void sub_1e9bd(long a0) // return-dupe
{
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    free(*(void **)(a0 + 0x58));
    return;
  ...
  if (*(long *)(a0 + 0x58)) {
    sub_21e31(*(unsigned long *)(a0 + 0x58));
    return;
  }
}

// Function: sub_1ea0f @ 0x1ea0f
void sub_1ea0f(unsigned long a0)
{
  int v1; // eax
...
void sub_1ea57(long a0,char a1) // ternary
{
...
void sub_1ea9f(long a0,int a1,char a2)
{
  int v1;
...
unsigned int sub_1eb2f(long a0)
{
  unsigned int v1;
  int v2;
...
unsigned int sub_1ebdd(long a0,unsigned long a1)
{
  unsigned int v1; // eax
  unsigned int v2; // eax
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x200) // branch-flip
    v2 = sub_2704e(*(unsigned int *)(a0 + 0x2c),a1,v1);
  else {
    v2 = sub_1e034(a1,v1);
  }
  return v2;
...
long * sub_1ec55(long *a0,unsigned int a1,long a2) // early-return x5
{
  ...
  *(unsigned int *)((long)v2 + 0x2c) = 0xffffff9c;
  ...
  if (*a0) { // branch-flip
    v7 = (void *)sub_20bf4(v2,0x3c7d4,0);
    if (v7) {
...
label_1edb4:
    ...
    for (v6 = a0; *v6; v6 = &v6[1]) {
      ...
      *(long *)(v4 + 0x30) = v4 + 0x100;
      if ((v1) && (v5)) {
        ...
        *(unsigned short *)(v4 + 0x68) = sub_208ad(v2,v4,0);
      }
      if (a2) { // branch-flip
        *(long *)(v4 + 0x10) = v5;
        v5 = v4;
    ...
    if ((a2) && (2 <= v3))
      v5 = sub_20a86(v2,v5,v3);
    *v2 = sub_20bf4(v2,0x3c7d4,0);
    if (*v2) {
      *(long *)(*v2 + 0x10) = v5;
...
void sub_1f020(long a0,long a1)
{
  char *v1; // rax
  unsigned long v2; // rax
...
unsigned long sub_1f0df(long *a0) // return-dupe, ternary
{
  int v1;
  long v2;
  void *v3;
...
unsigned long sub_1f2d7(long a0,int a1) // early-return x2
{
  unsigned long v1; // rax
  long v2;
  unsigned long *v3; // rax
  ...
  if (!(*(unsigned int *)(v2 + 0x48) & 0x200))
    return 0;
  if (!v7) {
    v1 = sub_21bb1(0xd,0,sub_1f26c,sub_1f2a1,dat_48fc0);
  ...
  if ((0 <= a1) && (!fstatfs(a1,v6))) {
    if ((v7) && (v3 = malloc(0x10), v3)) {
      *v3 = *(unsigned long *)(a0 + 0x70);
      v3[1] = v6[0];
      v4 = (unsigned long *)sub_228f2(v7,v3);
      if (v4) { // branch-flip
        if (v4 != v3)
          abort(); // no-return
      }
...
unsigned long sub_1f4d0(unsigned long a0,unsigned int a1) // early-return
{
  long v1; // rax
...
unsigned long sub_1f526(unsigned long a0,unsigned int a1) // early-return
{
  long v1; // rax
...
void * sub_1f599(long *a0) // early-return x7, ternary
{
  short v1;
  int v2;
  unsigned long v3;
  ...
  *(unsigned short *)((long)v5 + 0x6c) = 3;
  if (v1 == 1) {
    *(unsigned short *)((long)v5 + 0x68) = sub_208ad(a0,v5,0);
    return v5;
  }
...
label_1fa69:
              ...
              if (*(long *)((long)v5 + 0x58)) { // branch-flip
                if (*(unsigned short *)((long)v5 + 0x6a) & 2) { // branch-flip
                  if (!(*(unsigned int *)&a0[9] & 4)) {
                    if (*(unsigned int *)&a0[9] & 0x200) { // branch-flip
                      sub_1ea9f(a0,*(unsigned int *)((long)v5 + 0x44),1);
                      v9 = 0;
                    }
                    else {
                      v2 = *(int *)((long)v5 + 0x44);
                ...
                else if ((!(*(unsigned short *)((long)v5 + 0x6a) & 1)) && (v3 = *(unsigned long *)((long)v5 + 8), sub_20f29(a0,v3,0xffffffff,".."))) {
                  *(int *)((long)v5 + 0x40) = *__errno_location();
                  *(unsigned int *)&a0[9] = *(unsigned int *)&a0[9] | 0x2000;
                }
              }
      ...
      if (*(short *)((long)v5 + 0x6c) == 2) {
        *(unsigned short *)((long)v5 + 0x68) = sub_208ad(a0,v5,1);
        if ((*(short *)((long)v5 + 0x68) == 1) && (!(*(unsigned int *)&a0[9] & 4))) {
          *(unsigned int *)((long)v5 + 0x44) = sub_1ebdd(a0,".");
      ...
      if (a0[1]) { // branch-flip
        ...
        if (sub_20f29(a0,v5,0xffffffff,v3)) {
          *(int *)((long)v5 + 0x40) = *__errno_location();
...
unsigned long sub_1fc0f(unsigned long a0,long a1,int a2) // return-dupe
{
...
int * sub_1fc6a(long *a0,int a1) // early-return x4
{
  int v1;
  long v2;
  int v3;
...
void sub_1fe5d(long a0,unsigned int a1)
{
...
void * sub_1fee9(long *a0,int a1) // early-return, return-dupe x2, ternary, warn: iteboolean: re-rolled 2 0/1 select diamond(s) to a boolean assignment in sub_1fee9
{
  bool v1;
  int v10; // stack - 0x98
  unsigned long v11; // rax
  ...
  if (v14) {
    ...
    v11 = sub_2718c(v6,*(unsigned long *)(v20 + 0x30),v11,&v10);
  ...
  if (v14)
    ...
    v3 = ((a1 != 2) && ((((!(*(unsigned int *)&a0[9] & 8) || (!(*(unsigned int *)&a0[9] & 0x10))) || (*(unsigned int *)&a0[9] & 0x20)) || ((*(long *)(v20 + 0x80) != 2 || (v7 = sub_1f526(v20,v10), !v7))))));
    if ((v3) || (v1 = 0, a1 == 3)) {
      if (*(unsigned int *)&a0[9] & 0x200)
        v10 = sub_1db8e(v10,0x406,3);
      if ((0 <= v10) && (v7 = sub_20f29(a0,v20,v10,0), !v7))
        v1 = 1;
      else {
        if ((v3) && (a1 == 3))
          *(int *)(v20 + 0x40) = *__errno_location();
...
label_206f9:
    ...
    v9 = (void *)sub_20bf4(a0,(long)v25 + 0x13,v26);
    if (!v9) {
label_2044a:
    ...
    *(unsigned long *)((long)v9 + 0x78) = *v25;
    ...
    if ((a0[8]) && (!(*(unsigned int *)&a0[9] & 0x400)))
      *(unsigned short *)((long)v9 + 0x68) = sub_208ad(a0,v9,0);
    else {
      ...
      *(unsigned short *)((long)v9 + 0x68) = 0xb;
      sub_1fe5d((long)v9 + 0x70,*(char *)((long)v25 + 0x12));
      sub_1ea57(v9,!v4);
    }
...
label_20728:
  ...
  if (((!v14) && (v1)) && ((a1 == 1 || (!v13)))) {
    if (*(long *)(v20 + 0x58)) // branch-flip
      v7 = sub_20f29(a0,*(unsigned long *)(v20 + 8),0xffffffff,"..");
    else {
      v7 = sub_1eb2f(a0);
    }
    if (v7) {
...
unsigned long sub_208ad(long a0,long a1,char a2)
{
  void *v1;
  int v2;
  char *v3;
  ...
  v1 = (void *)(a1 + 0x70);
  v4 = a2;
  if ((!*(long *)(a1 + 0x58)) && (*(unsigned int *)(a0 + 0x48) & 1))
    v4 = '\x01';
  if ((*(unsigned int *)(a0 + 0x48) & 2) || (v4)) {
    v3 = *(char **)(a1 + 0x30);
    if (!stat(v3,v1)) goto label_209a5;
    if ((*__errno_location() == 2) && (v3 = *(char **)(a1 + 0x30), !lstat(v3,v1))) {
      *__errno_location() = 0;
      return 0xd;
    }
...
long sub_20a86(long a0,long a1,unsigned long a2)
{
  long *v1;
  unsigned long v2;
  long v3;
...
void * sub_20bf4(long a0,void *a1,unsigned long a2) // early-return
{
  void *v1; // rax
...
unsigned long sub_20ceb(long a0,long a1) // return-dupe x2
{
  unsigned long v1; // rax
  void *v2; // rax
...
void sub_20dbc(long a0,long a1) // ternary
{
  long v1;
  long v2; // stack - 0x18
...
int sub_20f29(long a0,long a1,int a2,char *a3) // warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_20f29
{
  bool v1; // al
  int v2;
  long v3; // stack - 0xa8
  ...
  v4 = a3;
  v5 = a2;
  if ((((a2 <= -1) && (v1)) && (*(unsigned int *)(a0 + 0x48) & 0x200)) && ((sub_23bd0(a0 + 0x60) != '\x01' && (v2 = sub_23c72(a0 + 0x60), 0 <= v2)))) {
    v5 = v2;
    v4 = NULL;
  }
  v7 = v5;
...
unsigned long sub_212bc(unsigned long *a0) // return-dupe
{
  long *v1; // stack - 0x28
  long v2; // stack - 0x20
  long v3; // stack - 0x18
...
void sub_2135a(unsigned long a0,void *a1)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  unsigned long v3; // rax
...
long sub_214fc(long a0,long a1) // return-dupe
{
  void *v1;
  long v2;
  long *v3; // stack - 0x18
...
long sub_21593(unsigned long *a0) // early-return
{
  long *v1; // stack - 0x10
...
long sub_215f3(long a0,long a1) // early-return
{
  long *v1; // stack - 0x18
  long *v2; // stack - 0x10
...
unsigned long sub_21691(unsigned long *a0,long a1,unsigned long a2)
{
  unsigned long v1;
  unsigned long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
long sub_21731(unsigned long *a0,void *a1,unsigned long a2)
{
  long v1;
  long v2; // stack - 0x20
  long *v3; // stack - 0x18
...
void sub_218dd(unsigned int *a0)
{
  *a0 = 0;
  a0[1] = dat_3c8a0;
  a0[2] = dat_3c8a4;
...
unsigned long sub_2198b(long a0) // return-dupe x2
{
  float *v1;
  ...
  if ((((dat_3c8ac < v1[2]) && (v1[2] < dat_3c8a0 - dat_3c8ac)) && (dat_3c8ac + dat_3c8a0 < v1[3])) && (((0.0 <= *v1 && (*v1 + dat_3c8ac < v1[1])) && ((v1[1] <= dat_3c8a0 && (*v1 + dat_3c8ac < v1[2]))))))
    return 1;
  *(unsigned long *)(a0 + 0x28) = 0x3c810;
  return 0;
}

// Function: sub_21a98 @ 0x21a98
unsigned long sub_21a98(unsigned long a0,long a1) // early-return x2
{
  unsigned long v1; // rax
  float v2; // xmm0_da
  unsigned long v3; // stack - 0x20
...
long * sub_21bb1(unsigned long a0,long a1,void *a2,void *a3,long a4) // early-return x2
{
  unsigned long v1;
  long *v2; // rax
  void *v3; // stack - 0x38
...
void sub_21d26(unsigned long *a0)
{
  unsigned long *v1;
  long *v2; // stack - 0x20
  unsigned long *v3; // stack - 0x18
...
void sub_21e31(unsigned long *a0)
{
  void *v1;
  long *v2; // stack - 0x20
  long *v3; // stack - 0x18
...
void sub_21faf(long a0,unsigned long *a1)
{
  *a1 = 0;
...
long sub_21fe9(long a0,long a1,unsigned long *a2,char a3) // early-return
{
  void *v1;
  long v2;
  long *v3;
...
unsigned long sub_22182(long a0,unsigned long *a1,char a2)
{
  long v1;
  long *v2;
  long *v3; // rax
  ...
  do {
    ...
    if (*v4) {
      ...
      v4[1] = 0;
      if (!a2) {
        v2 = (long *)sub_214a1(a0,v1);
        if (*v2) { // branch-flip
          v3 = (long *)sub_21f60(a0);
          if (!v3)
            return 0;
          *v3 = v1;
          v3[1] = v2[1];
...
unsigned long sub_22356(unsigned long *a0,unsigned long a1) // return-dupe x4
{
  void *v1; // stack - 0x68
  unsigned long v10; // stack - 0x20
  void *v2; // stack - 0x60
...
unsigned long sub_22581(long a0,long a1,long *a2) // return-dupe x2, return-dupe, ternary x2
{
  unsigned long v1; // rax
  long *v2; // rax
  long *v3; // stack - 0x30
  ...
  if (((float)*(unsigned long *)(a0 + 0x10) * *(float *)(*(long *)(a0 + 0x28) + 8) < (float)*(unsigned long *)(a0 + 0x18)) && (sub_2198b(a0), (float)*(unsigned long *)(a0 + 0x10) * *(float *)(*(long *)(a0 + 0x28) + 8) < (float)*(unsigned long *)(a0 + 0x18))) {
    v6 = *(long *)(a0 + 0x28);
...
unsigned long sub_228f2(unsigned long a0,unsigned long a1) // early-return
{
  int v1; // eax
  unsigned long v2; // rax
  unsigned long v3; // stack - 0x18
...
long sub_22962(long a0,unsigned long a1) // early-return, ternary x2
{
  char v1; // al
  long *v2; // stack - 0x40
  float v3; // xmm0_da
  ...
  if (!v5)
    return 0;
  *(long *)(a0 + 0x20) = *(long *)(a0 + 0x20) + -1;
  if (((!*v2) && (*(long *)(a0 + 0x18) = *(long *)(a0 + 0x18) + -1, (float)*(unsigned long *)(a0 + 0x18) < (float)*(unsigned long *)(a0 + 0x10) * **(float **)(a0 + 0x28))) && (sub_2198b(a0), (float)*(unsigned long *)(a0 + 0x18) < (float)*(unsigned long *)(a0 + 0x10) * **(float **)(a0 + 0x28))) {
    v6 = *(long *)(a0 + 0x28);
...
void sub_22c68(unsigned long a0,unsigned long a1)
{
  sub_22962(a0,a1);
}
...
int sub_23975(char *a0,unsigned long *a1,unsigned int *a2)
{
  unsigned int v1;
  int v2; // eax
  char *v3; // stack - 0x18
...
unsigned int sub_23b1d(unsigned long a0,unsigned long a1,long *a2)
{
  unsigned int v1; // stack - 0xc
...
void sub_23b73(long a0,unsigned int a1)
{
  int v1; // stack - 0xc
...
char sub_23bd0(long a0)
{
  return *(char *)(a0 + 0x1c);
}

// Function: sub_23be6 @ 0x23be6
unsigned int sub_23be6(long a0,unsigned int a1)
{
  unsigned int v1;
  unsigned int v2; // eax
...
unsigned int sub_23c72(long a0)
{
  unsigned int v1;
...
unsigned long sub_2419c(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3) // early-return
{
  long v1;
...
unsigned long sub_2452d(void *a0,void *a1,long *a2)
{
  ...
  v10 = v18;
  v11[0] = 0;
  *(unsigned long *)&v15[-8] = 0x24725;
  memset(v9,0,8,v15[-8]);
  v36 = 0;
  while( true ) {
    v36 = 0;
    *(unsigned long *)&v15[-8] = 0x24786;
    sub_256ef(v11);
    if ((v38 != '\x01') || (v39))
      v16 = 1;
    else {
    ...
    if (!v16) break;
    *(unsigned long *)&v15[-8] = 0x2475f;
    sub_34467(v27 + v20 * 0x30,&v10);
...
label_248fa:
  ...
  *v17 = 0;
  ...
  v32 = v19;
  v13[0] = 0;
  *(unsigned long *)&v15[-8] = 0x249ed;
  memset(v12,0,8,v15[-8]);
  v31 = 0;
  v10 = v19;
  v11[0] = 0;
  *(unsigned long *)&v15[-8] = 0x24a1d;
  memset(v9,0,8,v15[-8]);
  v36 = 0;
  do {
    *(unsigned long *)&v15[-8] = 0x24c73;
    sub_256ef(v11);
    if ((v38 != '\x01') || (v39))
      v16 = 1;
    else {
...
label_24c99:
      ...
      for (v24 = *(long *)(v29 + v23 * 8); v24; v24 = v24 + -1) {
        *(unsigned long *)&v15[-8] = 0x24bb7;
        ...
        if (!v16) {
          *(unsigned long *)&v15[-8] = 0x24bde; // no-return
          abort(v15[-8]);
        }
      ...
      *(unsigned long *)&v15[-8] = 0x24c17;
      ...
      if (!v16) {
        *(unsigned long *)&v15[-8] = 0x24c3e; // no-return
        abort(v15[-8]);
      }
      v32 = (void *)(v33 + (long)v32);
      v31 = 0;
...
int sub_25467(unsigned char *a0,long a1,unsigned int a2)
{
  unsigned char *v1;
...
void sub_256ef(char *a0)
{
  ...
  v5 = sub_30ad4(*(unsigned long *)&a0[0x10],v4);
  v2 = *(unsigned long *)&a0[0x10];
  *(unsigned long *)&a0[0x18] = sub_2419c(&a0[0x24],v2,v5,&a0[4]);
...
void sub_25906(long a0,long a1)
{
  *(long *)(a0 + 0x10) = *(long *)(a0 + 0x10) + a1;
}

// Function: sub_25930 @ 0x25930
void sub_25930(char *a0,char *a1)
{
  *a0 = *a1;
  if (*a0) // branch-flip
    memcpy(&a0[4],&a1[4],8);
...
char * sub_259d5(unsigned int a0,unsigned int a1)
{
  char *v1; // rax
  
  v1 = (char *)sub_31bc2(0x20);
  *v1 = 0x3d;
  v1[1] = 1;
  *(unsigned int *)&v1[4] = 0xfff;
  *(unsigned int *)&v1[8] = a0;
  *(unsigned int *)&v1[0xc] = a1;
  v1[0x11] = 0;
  return v1;
}
...
unsigned long sub_25ebd(char *a0) // early-return
{
  ...
  if (stat(a0,v1))
    return 0;
  return sub_259d5(v2,0xfff);
}

// Function: sub_25f2e @ 0x25f2e
unsigned int sub_25f2e(unsigned int a0,char a1,unsigned int a2,char *a3,unsigned int *a4) // ternary x5
{
  char v1;
...
void sub_26f67(unsigned long *a0)
{
  free((void *)*a0);
  free((void *)a0[1]);
  free((void *)a0[2]);
...
void * sub_2718c(unsigned int a0,unsigned long a1,unsigned int a2,int *a3) // early-return
{
  int v1;
  int v2; // eax
  void *v3; // rax
...
void sub_27244(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_27346(long a0) // return-dupe x2
{
  unsigned long v1; // stack + 0x8
  long v2; // stack + 0x10
  long v3; // stack + 0x18
  
  if ((((*(long *)(a0 + 0xa8)) && (!*(long *)(a0 + 0x30))) && (*(char *)(a0 + 0xa1) != '\x01')) && ((*(long *)(a0 + 200) || (3 <= v3)))) {
    *(char *)(a0 + 0xd8) = 1;
  ...
  if (5 <= v3) {
    ...
    *(long *)(a0 + 0x40) = v2 % 100;
    *(long *)(a0 + 0x38) = (v2 / 100) % 100;
    *(long *)(a0 + 0x28) = v2 / 10000;
    *(long *)(a0 + 0x30) = v3 + -4;
    return;
  }
...
void sub_278cd(long a0,unsigned long a1,unsigned long a2,unsigned long a3,int a4)
{
  *(unsigned long *)(a0 + 0x48) = a1;
...
char * sub_2791e(long a0,char *a1,int a2)
{
  int v1; // stack - 0xc
  
  if (*(char *)(a0 + 0xdf)) { // branch-flip
    if ((-1 <= *(long *)(a0 + 8)) && (*(long *)(a0 + 8) <= 0xc))
      v1 = snprintf(a1,(long)a2,"%s",&"last"[(*(long *)(a0 + 8) + 1) * 0xb]);
    else {
      v1 = snprintf(a1,(long)a2,"%ld",*(unsigned long *)(a0 + 8));
    }
  }
  else {
    *a1 = '\0';
  ...
  if ((((0 <= *(int *)(a0 + 0x10)) && (*(int *)(a0 + 0x10) <= 6)) && (0 <= v1)) && (v1 < a2))
    snprintf(&a1[v1],(long)(a2 - v1),&" %s"[(int)(unsigned int)(v1 == 0)],&"Sun"[(long)*(int *)(a0 + 0x10) * 4]);
  return a1;
}
...
char * sub_27a68(int a0,char *a1) // ternary
{
  ...
  v3 = (0 <= a0) ? '+' : '-'; // branch-flip
  v4 = abs(a0 / 0xe10);
  v1 = &a1[sprintf(a1,"%c%02d",(unsigned long)(unsigned int)(int)v3,(unsigned long)v4)];
  v5 = abs(a0 % 0xe10);
  if (v5) {
    v2 = v5 / 0x3c;
    v5 %= 0x3c;
...
void sub_27c77(unsigned long a0,long a1) // return-dupe, ternary
{
  unsigned int v1;
  unsigned int v2;
  unsigned long v3;
  ...
  char *v5; // rax
  char v6 [104];
  unsigned char v7; // stack - 0xad
  
  v7 = 0;
  if (sub_27333(a1) != '\x01')
    return;
  sub_27244(gettext("parsed %s part: "),a0);
  if ((*(long *)(a1 + 0xa8)) && (*(char *)(a1 + 0xd9) != '\x01')) {
    fprintf(stderr,"(Y-M-D) %04ld-%02ld-%02ld",*(unsigned long *)(a1 + 0x28),*(unsigned long *)(a1 + 0x38),*(unsigned long *)(a1 + 0x40));
    *(char *)(a1 + 0xd9) = 1;
    v7 = 1;
  }
  if (*(char *)(a1 + 0xd8) != *(char *)(a1 + 0xde)) {
    if (v7)
      fputc(0x20,stderr);
    v3 = *(unsigned long *)(a1 + 0x28);
    fprintf(stderr,gettext("year: %04ld"),v3);
    *(char *)(a1 + 0xde) = *(char *)(a1 + 0xd8);
    v7 = 1;
  }
  if ((*(long *)(a1 + 200)) && (*(char *)(a1 + 0xdc) != '\x01')) {
    fprintf(stderr,&" %02ld:%02ld:%02ld"[(int)(unsigned int)(v7 ^ 1)],*(unsigned long *)(a1 + 0x48),*(unsigned long *)(a1 + 0x50),*(unsigned long *)(a1 + 0x58));
    if (*(long *)(a1 + 0x60))
      fprintf(stderr,".%09d",*(unsigned long *)(a1 + 0x60) & 0xffffffff);
    if (*(int *)(a1 + 0x1c) == 1)
      fputs("pm",stderr);
    *(char *)(a1 + 0xdc) = 1;
    v7 = 1;
  }
  if ((*(long *)(a1 + 0xb0)) && (*(char *)(a1 + 0xda) != '\x01')) {
    if (v7)
      fputc(0x20,stderr);
    v1 = *(unsigned int *)(a1 + 0x10);
    v3 = *(unsigned long *)(a1 + 8);
    v4 = sub_2791e(a1,v6,100);
    fprintf(stderr,gettext("%s (day ordinal=%ld number=%d)"),v4,v3,(unsigned long)v1);
    *(char *)(a1 + 0xda) = 1;
    v7 = 1;
  }
  if ((*(long *)(a1 + 0xb8)) && (*(char *)(a1 + 0xdb) != '\x01')) {
    v5 = (*(long *)(a1 + 0xc0)) ? " DST" : ""; // branch-flip
    fprintf(stderr,&" isdst=%d%s"[(int)(unsigned int)(v7 ^ 1)],(unsigned long)*(unsigned int *)(a1 + 0x14),v5);
    *(char *)(a1 + 0xdb) = 1;
    v7 = 1;
  }
  if ((*(long *)(a1 + 0xd0)) && (*(char *)(a1 + 0xdd) != '\x01')) {
    v2 = *(unsigned int *)(a1 + 0x18);
    fprintf(stderr,&" UTC%s"[(int)(unsigned int)(v7 ^ 1)],sub_27a68(v2,v6));
    *(char *)(a1 + 0xdd) = 1;
    v7 = 1;
  }
  if (*(char *)(a1 + 0xa0)) {
...
unsigned char sub_281ae(unsigned char a0,long a1,unsigned long a2) // early-return
{
  if (!a1)
    return a0;
...
void sub_2820e(unsigned long a0,long a1) // return-dupe x2
{
  void *v1;
  char v2; // al
  ...
  v2 = sub_281ae(0,*(unsigned long *)(a1 + 0x68),"year(s)");
  v2 = sub_281ae(v2,*(unsigned long *)(a1 + 0x70),"month(s)");
  v2 = sub_281ae(v2,*(unsigned long *)(a1 + 0x78),"day(s)");
  v2 = sub_281ae(v2,*(unsigned long *)(a1 + 0x80),"hour(s)");
  v2 = sub_281ae(v2,*(unsigned long *)(a1 + 0x88),"minutes");
  v2 = sub_281ae(v2,*(unsigned long *)(a1 + 0x90),"seconds");
  sub_281ae(v2,(long)*(int *)(a1 + 0x98),"nanoseconds");
  fputc(10,stderr);
}
...
unsigned int sub_28423(long a0) // return-dupe
{
  unsigned long v1;
  char v10 [24];
  unsigned long v11 [140];
  unsigned long v12; // stack - 0x518
  int v13; // stack - 0x598
  int v14; // stack - 0x590
  int v15; // stack - 0x58c
  int v16; // stack - 0x588
  unsigned int v17; // stack - 0x584
  int v18; // stack - 0x580
  int v19; // stack - 0x57c
  char *v2;
  long v20; // stack - 0x570
  char *v21; // stack - 0x568
  char *v22; // stack - 0x560
  unsigned long *v23; // stack - 0x558
  unsigned long *v24; // stack - 0x550
  unsigned long v25; // stack - 0x510
  unsigned long v26; // stack - 0x508
  unsigned long v27; // stack - 0x500
  unsigned long v28; // stack - 0x4f8
  unsigned long v29; // stack - 0x4f0
  char v3;
  unsigned long v30; // stack - 0x4e8
  unsigned long v31; // stack - 0x4d8
  unsigned long v32; // stack - 0x4d0
  unsigned long v33; // stack - 0x4c8
  unsigned long v34; // stack - 0x4c0
  unsigned long v35; // stack - 0x4b8
  unsigned long v36; // stack - 0x4b0
  ...
  do {
    ...
    *v22 = (char)v14;
    if (&v21[v20 + -1] <= v22) {
      v6 = (long)v22 - (long)v21;
      v7 = v6 + 1;
      if (v20 <= 0x13) {
        v20 <<= 1;
        if (0x15 <= v20)
          v20 = 0x14;
        v8 = malloc(v20 * 0x39 + 0x37);
        if (v8) {
          memcpy(v8,v21,v7);
          v21 = v8;
          v9 = (unsigned long *)&v8[((v20 + 0x37) / 0x38) * 0x38];
          memcpy(v9,v23,v7 * 0x38);
          if (v2 != v10)
            free(v2);
          v22 = &v8[v6];
          v24 = &v9[v7 * 7 + -7];
          v23 = v9;
          if (v22 < &v8[v20 + -1]) goto label_28738;
label_2a80b:
          v17 = 1;
label_2a83f:
          if (v13 != -2) {
            if ((0 <= v13) && (v13 <= 0x115))
              v4 = (int)*(char *)((long)v13 + 0x3cce0);
            else {
              v4 = 2;
            }
            sub_283f7("Cleanup: discarding lookahead",v4,&v12,a0);
          }
          v24 = &v24[(long)v19 * -7];
          for (v22 = &v22[-(long)v19]; v22 != v21; v22 = &v22[-1]) {
            sub_283f7("Cleanup: popping",(int)*(char *)((long)(int)*v22 + 0x3d040),v24,a0);
            v24 = &v24[-7];
          }
          if (v21 != v10) {
            free(v21);
...
label_28738:
    ...
    v3 = *(char *)((long)v14 + 0x3ce00);
    if (v3 != -0x5d) {
      if (v13 == -2)
        v13 = sub_2b1ac(&v12,a0);
      if (0 < v13) {
        if (v13 != 0x100) {
          if ((0 <= v13) && (v13 <= 0x115))
            v18 = (int)*(char *)((long)v13 + 0x3cce0);
          else {
            v18 = 2;
          }
          goto label_28813;
...
label_28813:
      v4 = v3 + v18;
      if (((v4 < 0) || (0x70 < v4)) || (v18 != *(char *)((long)v4 + 0x3cfc0))) goto label_28915;
      v14 = (int)*(char *)((long)v4 + 0x3cf40);
      if (v14 <= 0) {
        v16 = -v14;
        goto label_2893f;
      }
    ...
    if (!v16) {
      ...
      if (v15 == 3) {
        if (1 <= v13) { // branch-flip
          sub_283f7("Error: discarding",v4,&v12,a0);
          v13 = -2;
        }
        else if (!v13) goto label_2a80b;
      }
label_2a67d:
      v15 = 3;
      while( true ) {
        v19 = 0;
        if (((*(char *)((long)v14 + 0x3ce00) != -0x5d) && (v4 = *(char *)((long)v14 + 0x3ce00) + 1, 0 <= v4)) && ((v4 <= 0x70 && ((*(char *)((long)v4 + 0x3cfc0) == '\x01' && (v3 = *(char *)((long)v4 + 0x3cf40), 1 <= v3)))))) break;
        if (v22 == v21) goto label_2a80b;
        sub_283f7("Error: popping",(int)*(char *)((long)v14 + 0x3d040),v24,a0);
        v24 = &v24[-7];
        v22 = &v22[-1];
        v14 = (int)*v22;
      }
...
label_2893f:
    ...
    switch(v16) {
      case 4:
        v7 = v24[1];
        *(unsigned long *)(a0 + 0x58) = *v24;
        *(unsigned long *)(a0 + 0x60) = v7;
        *(char *)(a0 + 0xa0) = 1;
      ...
      case 0xf:
        ...
        break;
      case 0x12:
        sub_278cd(a0,v24[-6],0,0,0);
        *(int *)(a0 + 0x1c) = (int)*v24;
        break;
      case 0x13:
        sub_278cd(a0,v24[-0x14],v24[-6],0,0);
        *(int *)(a0 + 0x1c) = (int)*v24;
        break;
      case 0x14:
        sub_278cd(a0,v24[-0x22],v24[-0x14],v24[-7],v24[-6] & 0xffffffff);
        *(int *)(a0 + 0x1c) = (int)*v24;
        break;
      case 0x16:
        sub_278cd(a0,v24[-6],0,0,0);
      ...
      case 0x22:
        v7 = *v24;
        if ((sub_2a972(a0,v7) != '\x01') || (v4 = *(int *)(a0 + 0x18), v7 = v24[-0xe], v6 = (long)v4 + v7, v5 = (int)v6, *(int *)(a0 + 0x18) = v5, v6 != v5 || SCARRY8((long)v4,v7))) goto label_2a80b;
        break;
      case 0x23:
        *(int *)(a0 + 0x18) = (int)*v24 + 0xe10;
        break;
      case 0x24:
        *(int *)(a0 + 0x18) = (int)v24[-7] + 0xe10;
        break;
      case 0x25:
      ...
      case 0x26:
        *(unsigned long *)(a0 + 8) = 0;
        *(int *)(a0 + 0x10) = (int)v24[-7];
        break;
      case 0x27:
        *(unsigned long *)(a0 + 8) = v24[-7];
        *(int *)(a0 + 0x10) = (int)*v24;
        *(char *)(a0 + 0xdf) = 1;
        break;
      case 0x28:
        *(unsigned long *)(a0 + 8) = v24[-6];
        *(int *)(a0 + 0x10) = (int)*v24;
        *(char *)(a0 + 0xdf) = 1;
        break;
      case 0x29:
        *(unsigned long *)(a0 + 0x38) = v24[-0xd];
        *(unsigned long *)(a0 + 0x40) = v24[1];
        break;
      case 0x2a:
        if (4 <= (long)v24[-0x1a]) { // branch-flip
          if (sub_27333(a0)) {
            v7 = v24[-0x1a];
            v1 = v24[-0x1b];
          ...
          v7 = v24[-0x1b];
          *(unsigned long *)(a0 + 0x20) = v24[-0x1c];
          *(unsigned long *)(a0 + 0x28) = v7;
          *(unsigned long *)(a0 + 0x30) = v24[-0x1a];
          *(unsigned long *)(a0 + 0x38) = v24[-0xd];
          *(unsigned long *)(a0 + 0x40) = v24[1];
        }
        else {
          ...
          *(unsigned long *)(a0 + 0x38) = v24[-0x1b];
          *(unsigned long *)(a0 + 0x40) = v24[-0xd];
          v7 = v24[1];
          *(unsigned long *)(a0 + 0x20) = *v24;
          *(unsigned long *)(a0 + 0x28) = v7;
          *(unsigned long *)(a0 + 0x30) = v24[2];
        }
        break;
      case 0x2b:
        *(unsigned long *)(a0 + 0x40) = v24[-0xd];
        *(unsigned long *)(a0 + 0x38) = v24[-7];
        v7 = v24[1];
        *(unsigned long *)(a0 + 0x28) = -v7;
        ...
        *(unsigned long *)(a0 + 0x30) = v24[2];
        break;
      case 0x2c:
        *(unsigned long *)(a0 + 0x38) = v24[-0xe];
        v7 = v24[-6];
        *(unsigned long *)(a0 + 0x40) = -v7;
        if ((SBORROW8(0,v7)) || (v7 = v24[1], *(unsigned long *)(a0 + 0x28) = -v7, SBORROW8(0,v7))) goto label_2a80b;
        *(unsigned long *)(a0 + 0x30) = v24[2];
        break;
      case 0x2d:
        *(unsigned long *)(a0 + 0x38) = v24[-7];
        *(unsigned long *)(a0 + 0x40) = v24[1];
        break;
      case 0x2e:
        *(unsigned long *)(a0 + 0x38) = v24[-0x15];
        *(unsigned long *)(a0 + 0x40) = v24[-0xd];
        v7 = v24[1];
        *(unsigned long *)(a0 + 0x20) = *v24;
        *(unsigned long *)(a0 + 0x28) = v7;
        *(unsigned long *)(a0 + 0x30) = v24[2];
        break;
      case 0x2f:
        *(unsigned long *)(a0 + 0x40) = v24[-6];
        *(unsigned long *)(a0 + 0x38) = *v24;
        break;
      case 0x30:
        *(unsigned long *)(a0 + 0x40) = v24[-0xd];
        *(unsigned long *)(a0 + 0x38) = v24[-7];
      ...
      case 0x32:
        v7 = v24[-0xd];
        *(unsigned long *)(a0 + 0x20) = v24[-0xe];
        *(unsigned long *)(a0 + 0x28) = v7;
        *(unsigned long *)(a0 + 0x30) = v24[-0xc];
        v7 = v24[-6];
        *(unsigned long *)(a0 + 0x38) = -v7;
        if ((SBORROW8(0,v7)) || (v7 = v24[1], *(unsigned long *)(a0 + 0x40) = -v7, SBORROW8(0,v7))) goto label_2a80b;
        break;
      case 0x33:
        v3 = sub_275d8(a0,*v24 & 0xffffffff);
        goto label_2a426;
      case 0x34:
        v3 = sub_275d8(a0,1);
        goto label_2a426;
      ...
      case 0x3c:
        ...
        v37 = 0;
        v33 = *v24 * v24[-7];
        if (SEXT816((long)v33) != SEXT816((long)*v24) * SEXT816((long)v24[-7])) goto label_2a80b;
        break;
      case 0x3d:
        v31 = 0;
        v32 = 0;
        ...
        v37 = 0;
        v33 = *v24 * v24[-6];
        if (SEXT816((long)v33) != SEXT816((long)*v24) * SEXT816((long)v24[-6])) goto label_2a80b;
        break;
      case 0x3e:
        v31 = 0;
        v32 = 0;
...
label_2a426:
    ...
    v9 = &v24[(long)v19 * -7 + 7];
    *v9 = v31;
    v24[(long)v19 * -7 + 8] = v32;
    v24[(long)v19 * -7 + 9] = v33;
    v24[(long)v19 * -7 + 10] = v34;
    v24[(long)v19 * -7 + 0xb] = v35;
    v24[(long)v19 * -7 + 0xc] = v36;
    v24[(long)v19 * -7 + 0xd] = v37;
    v4 = *(char *)((long)v16 + 0x3d0c0) + -0x1c;
    v5 = (int)*v22 + (int)*(char *)((long)v4 + 0x3cf00);
    if (((0 <= v5) && (v5 <= 0x70)) && (*(char *)((long)v5 + 0x3cfc0) == *v22))
...
unsigned long sub_2a972(long a0,long a1) // return-dupe
{
  long v1; // rax
  bool v2;
  char v3; // stack + 0x8
...
char * sub_2ac65(char a0,int *a1) // return-dupe, ternary
{
  bool v1;
  int v2; // eax
  char *v3; // rax
...
long * sub_2ad8a(long a0,char *a1)
{
  char *v1;
  long *v2; // stack - 0x10
  ...
  for (v2 = (long *)(a0 + 0xe0); *v2; v2 = &v2[2]) {
    v1 = (char *)*v2;
    if (!strcmp(a1,v1))
      return v2;
  }
...
long * sub_2ae65(unsigned long a0,char *a1) // early-return x2, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_2ae65
{
  char *v1;
  char v2; // al
  bool v3;
...
long sub_2b725(unsigned long a0,long a1,long a2,int a3)
{
  int v1; // eax
  char v2 [40];
  int v3; // stack - 0x40
  ...
  if (((a1) && (v1 < a3)) && (*(long *)(a1 + 0xd0))) {
    v3 = *(int *)(a1 + 0x18);
    if (((*(long *)(a1 + 0xb8)) && (!*(long *)(a1 + 0xd0))) && (1 <= *(int *)(a1 + 0x14)))
      v3 += 0xe10;
    snprintf((char *)(v1 + a2),(long)(a3 - v1)," TZ=%s",sub_27a68(v3,v2));
  }
  return a2;
}

// Function: sub_2b83c @ 0x2b83c
char * sub_2b83c(long a0,char *a1,int a2)
{
  unsigned int v1;
  int v2;
  unsigned int v3;
  ...
  v2 = *(int *)(a0 + 0x10);
  v3 = *(unsigned int *)(a0 + 0x14);
  snprintf(a1,(long)a2,"(Y-M-D) %s-%02d-%02d",sub_2abc6(v3,v4),(unsigned long)(v2 + 1),(unsigned long)v1);
  return a1;
}

// Function: sub_2b8d7 @ 0x2b8d7
char * sub_2b8d7(unsigned int *a0,char *a1,int a2)
{
  snprintf(a1,(long)a2,"%02d:%02d:%02d",(unsigned long)a0[2],(unsigned long)a0[1],(unsigned long)*a0);
  return a1;
}

// Function: sub_2b92e @ 0x2b92e
void sub_2b92e(int *a0,int *a1,unsigned long a2,char a3) // return-dupe, ternary x6, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_2b92e
{
  int v1;
  unsigned long v10; // rax
  char *v11; // rax
  ...
  v7 = a0[5];
  v8 = a1[5];
  v9 = !(((((v1 != v2) || (v3 != v4)) || (v5 == v6)) || ((v18 || (v19)))) || (v7 != v8));
  if (sub_27333(a2) != '\x01')
    return;
  sub_27244(gettext("error: invalid date/time value:\n"));
  v10 = sub_2b725(a0,a2,v14,100);
  sub_27244(gettext("    user provided time: \'%s\'\n"),v10);
  v10 = sub_2b725(a1,a2,v14,100);
  ...
  v16 = (v19) ? "--" : "";
  v11 = (v7 != v8) ? "----" : "";
  v20 = snprintf(v14,100,"                                 %4s %2s %2s %2s %2s %2s",v11,v16,v17,v13,v12,v15);
  if (0 <= (int)v20) {
    if (100 <= v20)
      v20 = 99;
    while ((1 <= (int)v20 && (v14[(int)(v20 - 1)] == ' '))) {
      v20 -= 1;
    }
    v14[(int)v20] = '\0';
  }
  ...
  if (a3) // branch-flip
    v15 = gettext("incorrect timezone");
  else {
    v15 = gettext("missing timezone");
  }
  sub_27244("       %s\n",v15);
}

// Function: sub_2bd5c @ 0x2bd5c
char sub_2bd5c(long *a0,char *a1,long *a2,unsigned long a3,long a4,char *a5) // ternary, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_2bd5c
{
  char v1;
  long v10;
  char v100; // stack - 0x1e0
  char v101; // stack - 0x1df
  char v102; // stack - 0x1de
  char v103; // stack - 0x1dd
  char v104; // stack - 0x1dc
  char v105; // stack - 0x1db
  char v106; // stack - 0x1da
  char v107; // stack - 0x1d9
  char *v108; // stack - 0x1d8
  unsigned int v109; // stack - 0x1d0
  long v11;
  int v110; // stack - 0x1cc
  char *v111; // stack - 0x1c8
  unsigned int v112; // stack - 0x1c0
  int v113; // stack - 0x1bc
  unsigned long v114; // stack - 0x1b8
  char v115; // stack - 0x97
  char v116; // stack - 0x96
  long v12;
  unsigned long v13; // rax
  long v14 [2];
  char v15 [112];
  int v16; // stack - 0x378
  unsigned long v17 [4]; // stack - 0x2f8
  long v18 [8]; // stack - 0x338
  char *v19; // stack - 0x2b8
  char v2; // al
  char v20 [32];
  int v21; // stack - 0x424
  char v22 [112];
  unsigned int v23; // stack - 0x438
  unsigned int v24; // stack - 0x3f8
  char v25 [101];
  char v26; // stack - 0x98
  char v27 [13];
  bool v28; // zf
  char *v29; // stack - 0x558
  int v3;
  long *v30; // stack - 0x540
  char *v31; // stack - 0x538
  char v32; // stack - 0x523
  char v33; // stack - 0x522
  int v34; // stack - 0x51c
  char *v35; // stack - 0x4e0
  unsigned long v36; // stack - 0x4d8
  long v37; // stack - 0x4d0
  unsigned long v38; // stack - 0x4c8
  char *v39; // stack - 0x4c0
  int v4;
  char *v40; // stack - 0x4b8
  char *v41; // stack - 0x4b0
  unsigned int v42; // stack - 0x434
  int v43; // stack - 0x430
  int v44; // stack - 0x42c
  int v45; // stack - 0x428
  int v46; // stack - 0x420
  int v47; // stack - 0x418
  long v48; // stack - 0x410
  unsigned int v49; // stack - 0x3f4
  int v5; // eax
  int v50; // stack - 0x3f0
  int v51; // stack - 0x3ec
  int v52; // stack - 0x3e8
  int v53; // stack - 0x3e4
  int v54; // stack - 0x3d8
  long v55; // stack - 0x3b8
  long v56; // stack - 0x3b0
  long v57; // stack - 0x3a8
  long v58; // stack - 0x3a0
  long v59; // stack - 0x398
  unsigned long v6;
  long v60; // stack - 0x390
  unsigned long v61; // stack - 0x388
  int v62; // stack - 0x374
  int v63; // stack - 0x370
  int v64; // stack - 0x36c
  int v65; // stack - 0x368
  int v66; // stack - 0x364
  int v67; // stack - 0x358
  char *v68; // stack - 0x348
  int v69; // stack - 0x2d8
  char *v7; // rax
  unsigned long v70; // stack - 0x2d0
  char *v71; // stack - 0x2c8
  long v72; // stack - 0x2b0
  int v73; // stack - 0x2a8
  int v74; // stack - 0x2a4
  int v75; // stack - 0x2a0
  int v76; // stack - 0x29c
  long v77; // stack - 0x290
  unsigned long v78; // stack - 0x288
  long v79; // stack - 0x280
  unsigned long v8; // rax
  long v80; // stack - 0x278
  long v81; // stack - 0x270
  long v82; // stack - 0x268
  long v83; // stack - 0x260
  long v84; // stack - 0x258
  long v85; // stack - 0x250
  long v86; // stack - 0x248
  long v87; // stack - 0x240
  long v88; // stack - 0x238
  long v89; // stack - 0x230
  char *v9;
  long v90; // stack - 0x228
  unsigned long v91; // stack - 0x220
  char v92; // stack - 0x218
  char v93; // stack - 0x217
  unsigned long v94; // stack - 0x210
  unsigned long v95; // stack - 0x208
  long v96; // stack - 0x200
  unsigned long v97; // stack - 0x1f8
  unsigned long v98; // stack - 0x1f0
  long v99; // stack - 0x1e8
...
label_2c0a2:
    if (*v39) {
      if (*v39 != '\\') {
        if (*v39 != '\"') goto label_2c092;
        v40 = v15;
        if (0x65 <= (long)v38) {
          v35 = malloc(v38);
          if (!v35) goto label_2dc5a;
          v40 = v35;
        }
        v41 = v40;
        v39 = &v31[4];
      ...
      v39 = &v39[1];
      if ((*v39 == '\\') || (*v39 == '\"')) goto label_2c092;
    }
    goto label_2c0b4;
  }
label_2c0b4:
  if (!sub_30fdc(v37,v30,&v16)) goto label_2dc5a;
  if (!*v31)
    v31 = "0";
  v19 = v31;
  v77 = (long)v66 + 0x76c;
  ...
  v34 = 1;
  while( true ) {
    if ((4 <= v34) || (v18[0] = v10 + v34 * 0x76a700, SCARRY8(v10,(long)(v34 * 0x76a700)))) goto label_2c3cc;
    if ((sub_30fdc(v37,v18,v17)) && ((v71 && (v69 != v110)))) break;
    v34 += 1;
  }
  v111 = v71;
  v112 = 0x10d;
  ...
  v114 = 0;
label_2c3cc:
  if (((v108) && (v111)) && (v3 = strcmp(v108,v111), !v3)) {
    v110 = -1;
    v111 = NULL;
  }
  if (sub_28423(&v19)) {
  ...
  if (sub_27333(&v19)) {
    ...
    else if (v99) // branch-flip
      fprintf(stderr,gettext("parsed date/time string"));
    else if (v29) { // branch-flip
      if (v37 != a4) // branch-flip
        fprintf(stderr,gettext("TZ=\"%s\" in date string"),v29);
      else if (strcmp(v29,"UTC0")) // branch-flip
        fprintf(stderr,gettext("TZ=\"%s\" environment value"),v29);
      else {
  ...
  if (v92) { // branch-flip
    *a0 = v83;
    ...
    if (2 <= (long)(v99 + v96 | v98 | v94 | v95 | v97)) {
      if (sub_27333(&v19)) {
        if (2 <= (long)v98)
    ...
    v2 = sub_27333(&v19);
    if (((sub_2ac65(v2,&v21) != '\x01') || (v45 = (int)(v79 + -1), v79 + -1 != (long)v45 || SCARRY8(v79,-1))) || (v44 = (int)v80, v80 != v44)) {
      if (sub_27333(&v19))
        sub_27244(gettext("error: year, month, or day overflow\n"));
      goto label_2dc5a;
    }
    if ((v98) || (((v93 && (!v94)) && (!v95)))) {
      v43 = sub_2ab3b(v81,v76);
      if (v43 <= -1) {
        if (v76) { // branch-flip
          v9 = (v76 != 1) ? "" : "pm"; // branch-flip
        }
        else {
          v9 = "am";
        }
    ...
    v54 = v47;
    v46 = -1;
    v36 = sub_3108c(v37,&v23);
    if (sub_2b692(&v24,&v23) != '\x01') {
      v33 = '\0';
      v28 = v99 != 0;
      if (v28) {
        v116 = 0x58;
        ...
        v47 = v54;
        v46 = -1;
        v36 = sub_3108c(v10,&v23);
        v33 = sub_2b692(&v24,&v23);
        sub_30db5(v10);
      }
      if (v33 != '\x01') {
        sub_2b92e(&v24,&v23,&v19,v28);
        goto label_2dc5a;
      }
    }
    if ((v95) && (!v94)) {
      v3 = ((1 <= v72) && (v46 != v73));
      v17[0] = (v72 - v3) * 7;
      if (((SEXT816((long)v17[0]) != SEXT816(v72 - v3) * SEXT816(7)) || (v10 = (long)(((v73 - v46) + 7) % 7), v28 = SCARRY8(v10,v17[0]), v17[0] = v10 + v17[0], v28)) || (v10 = (long)v44, v11 = v10 + v17[0], v44 = (int)v11, v11 != v44 || SCARRY8(v10,v17[0])))
      ...
      if (v36 == 0xffffffffffffffff) {
        if (sub_27333(&v19)) {
          v8 = sub_2b725(&v23,&v19,v22,100);
          v13 = sub_2791e(&v19,&v26,100);
    ...
    if (v87 || (v85 || v86)) {
      ...
      v10 = v21 + v85;
      v3 = (int)v10;
      if (v10 == v3 && !SCARRY8((long)v21,v85)) {
        v10 = v45 + v86;
        v4 = (int)v10;
        v18[0] = CONCAT44(v18[0]._4_4_,v4);
        if (v10 == v4 && !SCARRY8((long)v45,v86)) {
          v10 = v44 + v87;
          v5 = (int)v10;
          v17[0] = CONCAT44(v17[0]._4_4_,v5);
          if (v10 == v5 && !SCARRY8((long)v44,v87)) {
            v43 = v50;
            v42 = v49;
            v23 = v24;
            v47 = v54;
            ...
            if (v1) {
              ...
              if ((!v87) && ((v44 != (int)v17[0] || ((!v86 && (v45 != (int)v18[0])))))) {
...
label_2d50c:
    if (v99) {
      v18[0] = v75 - v48;
      v28 = SBORROW8(v36,v18[0]);
      v36 -= v18[0];
      v17[0] = v36;
      if (v28 || SBORROW8((long)v75,v48)) {
        if (sub_27333(&v19))
    ...
    v10 = (v84 + (int)v91) % 1000000000 + 1000000000;
    v3 = (int)v10 + (int)(v10 / 1000000000) * -1000000000;
    v10 = v88 * 0xe10;
    if (((((SEXT816(v10) != SEXT816(v88) * SEXT416(0xe10)) || (SCARRY8(v36,v10))) || (v11 = v89 * 0x3c, SEXT816(v11) != SEXT816(v89) * SEXT816(0x3c))) || ((v12 = v11 + v36 + v10, SCARRY8(v11,v36 + v10) || (v10 = v90 + v12, SCARRY8(v90,v12))))) || (v11 = (long)(int)(((v84 + (int)v91) - (long)v3) / 1000000000), v18[0] = v11 + v10, SCARRY8(v11,v10))) {
      if (sub_27333(&v19))
  ...
  if (sub_27333(&v19)) {
    ...
    if (gmtime_r(a0,v18)) {
      v8 = sub_2b725(v18,0,v22,100);
      sub_27244(gettext("final: %s (UTC)\n"),v8);
    }
    if (sub_30fdc(v37,a0,v17)) {
      v8 = sub_27a68(v70 & 0xffffffff,v20);
      v13 = sub_2b725(v17,0,v22,100);
...
char sub_2dcb0(unsigned long a0,unsigned long a1,unsigned long a2) // early-return
{
  char v1; // al
  char *v2; // rax
  long v3; // rax
...
unsigned long sub_2de20(long a0)
{
  int v1;
  unsigned long v2; // rax
...
unsigned int sub_2df4e(long a0,unsigned int a1)
{
  unsigned int v1;
  long v2; // stack - 0x20
...
label_2ec16:
    if ((v29 <= 1) && ((!v1 || (v16)))) goto label_2ee79;
    v32 = v29 + v24;
    while( true ) {
      if ((!v1) || (v16)) {
        if (v3) {
...
label_2e921:
  ...
  if (0x3f < v22) {
    ...
    v23 = v22;
    if (((!v1) || (!v14)) || (!v28)) goto label_2e8f7;
    goto label_2ef9f;
  }
  switch(v22) {
    case 0:
...
label_2ee79:
    if (((((v1) && (v19 != 2)) || (v14)) && ((v7 && (*(unsigned int *)(v7 + (unsigned long)(v22 >> 5) * 4) >> (v22 & 0x1f) & 1)))) || (v3)) goto label_2eee4;
  }
label_2ef9f:
  if ((v2) && (!v4)) {
    if (v25 < v21)
...
label_2f1b0:
  ...
  if (((v19 == 2) && (!v14)) && (v5)) {
    if (v6)
      return sub_2e174(a0,v26,a2,v20,5,a5,v7,v18,v17);
    if ((!v21) && (v26)) {
      v21 = v26;
      v25 = 0;
      goto label_2e22e;
...
unsigned long sub_2f235(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  unsigned long v2; // rax
  ...
  v1 = *__errno_location();
  v2 = sub_2e174(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *__errno_location() = v1;
  return v2;
}

// Function: sub_2f2dd @ 0x2f2dd
void sub_2f2dd(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_2f313(a0,a1,0,a2);
}

// Function: sub_2f313 @ 0x2f313
unsigned long sub_2f313(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  unsigned int v2; // eax
  long v3; // rax
  ...
  v3 = sub_2e174(0,0,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_31c0e(v3 + 1);
  sub_2e174(v4,v3 + 1,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *__errno_location() = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void * sub_2f4fe(int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  int v1;
  unsigned int v2;
  unsigned long *v3;
  ...
  if ((0 <= a0) && (a0 <= 0x7ffffffe)) {
    ...
    v2 = a3[1];
    v9 = sub_2e174(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v8 <= v9) {
      v8 = v9 + 1;
      v6[(long)a0 * 2] = v8;
      if (v7 != (void *)0x4a280)
      ...
      v6[(long)a0 * 2 + 1] = v7;
      sub_2e174(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *__errno_location() = v1;
    return v7;
  }
...
void sub_2f7ad(unsigned int a0,unsigned long a1)
{
  sub_2f4fe(a0,a1,0xffffffffffffffff,0x4a240);
}

// Function: sub_2f7e1 @ 0x2f7e1
void sub_2f7e1(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_2f4fe(a0,a1,a2,0x4a240);
}

// Function: sub_2f813 @ 0x2f813
void sub_2f813(unsigned long a0)
{
  sub_2f7ad(0,a0);
}

// Function: sub_2f836 @ 0x2f836
void sub_2f836(unsigned long a0,unsigned long a1)
{
  sub_2f7e1(0,a0,a1);
}

// Function: sub_2f861 @ 0x2f861
void sub_2f861(unsigned int a0,unsigned int a1,unsigned long a2)
{
  char v1 [56];
...
void sub_2f8c9(unsigned int a0,unsigned int a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_2f92f(unsigned int a0,unsigned long a1)
{
  sub_2f861(0,a0,a1);
}

// Function: sub_2f957 @ 0x2f957
void sub_2f957(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_2f8c9(0,a0,a1,a2);
}

// Function: sub_2f987 @ 0x2f987
void sub_2f987(unsigned long a0,unsigned long a1,char a2)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
...
void sub_2fa42(unsigned long a0,char a1)
{
  sub_2f987(a0,0xffffffffffffffff,(int)a1);
}

// Function: sub_2fa70 @ 0x2fa70
void sub_2fa70(unsigned long a0)
{
  sub_2fa42(a0,0x3a);
}

// Function: sub_2fa93 @ 0x2fa93
void sub_2fa93(unsigned long a0,unsigned long a1)
{
  sub_2f987(a0,a1,0x3a);
}

// Function: sub_2fac1 @ 0x2fac1
void sub_2fac1(unsigned int a0,unsigned int a1,unsigned long a2)
{
...
void sub_2fb83(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_2fbbd(a0,a1,a2,a3,0xffffffffffffffff);
}

// Function: sub_2fbbd @ 0x2fbbd
void sub_2fbbd(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned long v3; // stack - 0x38
...
void sub_2fc7b(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_2fb83(0,a0,a1,a2);
}

// Function: sub_2fcae @ 0x2fcae
void sub_2fcae(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_2fbbd(0,a0,a1,a2,a3);
}

// Function: sub_2fcec @ 0x2fcec
void sub_2fcec(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_2f4fe(a0,a1,a2,0x49860);
}

// Function: sub_2fd1e @ 0x2fd1e
void sub_2fd1e(unsigned long a0,unsigned long a1)
{
  sub_2fcec(0,a0,a1);
}

// Function: sub_2fd49 @ 0x2fd49
void sub_2fd49(unsigned int a0,unsigned long a1)
{
  sub_2fcec(a0,a1,0xffffffffffffffff);
}

// Function: sub_2fd76 @ 0x2fd76
void sub_2fd76(unsigned long a0)
{
  sub_2fd49(0,a0);
}

// Function: sub_2fd99 @ 0x2fd99
unsigned long sub_2fd99(int *a0) // return-dupe x2
{
  a0[2] = 0;
  a0[3] = 0;
  *a0 = sub_1e034(".",0x80000);
  if (0 <= *a0)
    return 0;
  *(char **)&a0[2] = getcwd(NULL,0);
  if (*(long *)&a0[2])
    return 0;
  return 0xffffffff;
}
...
void sub_2fe17(int *a0) // return-dupe
{
  if (0 <= *a0) {
    fchdir(*a0);
    return;
  }
  sub_33b60(*(unsigned long *)&a0[2]);
}

// Function: sub_2fe52 @ 0x2fe52
void sub_2fe52(int *a0)
{
  if (0 <= *a0)
    close(*a0);
  free(*(void **)&a0[2]);
...
unsigned long sub_2fe8c(int a0,char *a1,unsigned long a2) // early-return x2
{
  unsigned int v1; // eax
  int v2;
  char *v3; // rax
...
unsigned long sub_3011a(int a0,char *a1,unsigned long a2) // early-return x2
{
  unsigned int v1; // eax
  int v2;
  char *v3; // rax
...
unsigned long sub_303a8(int a0,char *a1,unsigned long a2) // early-return x2
{
  unsigned int v1; // eax
  int v2;
  char *v3; // rax
...
unsigned long sub_30636(int a0,char *a1,unsigned long a2) // early-return x2
{
  unsigned int v1; // eax
  int v2;
  char *v3; // rax
...
int sub_308c4(int a0,unsigned long *a1) // early-return x2
{
  char *v1;
  ...
  if ((a0 == 10) && (v1 = (char *)*a1, !strcmp(v1,"unlabeled"))) {
    freecon(*a1);
    *a1 = 0;
...
unsigned long * sub_30b5c(char *a0) // ternary
{
  ...
  if (v3) {
    ...
    *(char *)((long)v3 + 9) = 0;
    if (a0)
      sub_30b1c((long)v3 + 9,a0,v1);
  }
  return v3;
}

// Function: sub_30c11 @ 0x30c11
unsigned long sub_30c11(long *a0,char *a1) // return-dupe
{
  char *v1;
  long v2;
  long *v3; // stack - 0x30
...
bool sub_30e59(long a0) // ternary
{
  bool v1; // zf
...
long sub_30ea3(long a0) // early-return x2
{
  int v1;
  char *v2; // rax
  long v3; // rax
...
char sub_30f70(long a0) // early-return
{
  char v1; // al
  int v2; // stack - 0xc
...
void * sub_30fdc(long a0,void *a1,void *a2) // early-return, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_30fdc
{
  bool v1; // al
  long v2; // rax
  ...
  v2 = sub_30ea3(a0);
  if (v2) {
    v1 = ((localtime_r(a1,a2)) && (sub_30c11(a0,a2)));
    if ((sub_30f70(v2)) && (v1))
      return a2;
  }
  return NULL;
...
unsigned long sub_3108c(long a0,unsigned long *a1) // early-return, warn: iteboolean: re-rolled 1 0/1 select diamond(s) to a boolean assignment in sub_3108c
{
  bool v1; // al
...
void sub_3126d(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5) // return-dupe x10
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
void sub_31869(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,long a4)
{
  long v1; // stack - 0x10
...
void sub_318dc(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  long *v1;
  long v2 [11];
...
void sub_319e2(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_31b6f(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_31ca8(a0,a1,a2);
}
...
void sub_31c77(unsigned long a0,unsigned long a1)
{
...
void sub_31d02(unsigned long a0,unsigned long a1,unsigned long a2)
{
...
void sub_31d91(unsigned long a0,unsigned long a1)
{
  sub_31dbf(a0,a1,1);
}

// Function: sub_31dbf @ 0x31dbf
unsigned long sub_31dbf(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_31e9e(long a0,long *a1,long a2,long a3,long a4) // ternary
{
  long v1;
  long v2; // rax
  unsigned long v3; // rax
...
void sub_32ff2(unsigned long a0,unsigned long a1,long a2)
{
  char *v1; // rax
  unsigned long v2; // rax
...
long sub_331e2(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,void *a5,unsigned int a6) // early-return, ternary
{
  long v1; // stack - 0x10
...
char * sub_33321(char *a0,unsigned int a1,char *a2) // early-return, ternary
{
  unsigned int v1; // eax
  unsigned long v2; // rax
  char v3 [40];
  ...
  if (*a2) { // branch-flip
    if (!dat_4a380) {
      ...
      if (0 <= (int)v1) { // branch-flip
        sprintf(v3,"/proc/self/fd/%d/../fd",(unsigned long)v1);
    ...
    strcpy(&v4[sprintf(v4,"/proc/self/fd/%d/",(unsigned long)a1)],a2);
    a0 = v4;
  }
  else {
    *a0 = '\0';
...
int sub_33b60(char *a0)
{
  ...
  while (0xfff < (long)v9 - (long)v3) {
    v12 = (char *)memrchr(v3,0x2f,0x1000);
    if (!v12) {
      *__errno_location() = 0x24;
      return -1;
    }
...
unsigned long sub_33ec6(void *a0)
{
  int v1; // eax
  unsigned long v2; // rax
  bool v3; // zf
...
unsigned long sub_33f9b(long *a0,long *a1) // return-dupe
{
  long v1;
...
void sub_343d1(unsigned long a0) // return-dupe
{
  if (a0 & 0xf)
    abort(); // no-return
  if (!(a0 & 0x10))
...
void sub_34467(long *a0,long *a1) // return-dupe
{
...
void sub_34722(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned int a5)
{
  char v1; // stack - 0x11
...
long sub_347a5(char *a0,long a1,char *a2,unsigned int *a3,char a4,int a5,int a6,unsigned long a7,unsigned long a8,int a9) // early-return x13, ternary x6, warn: iteboolean: re-rolled 3 0/1 select diamond(s) to a boolean assignment in sub_347a5
{
  int v1;
  int v10; // eax
  ...
  bool v24; // stack - 0x6c4
  char v25; // stack - 0x6c1
  unsigned int v26; // stack - 0x6bc
  int v27; // stack - 0x6b8
  int v28; // stack - 0x6b0
  unsigned int v29; // stack - 0x6ac
  unsigned int v3;
  unsigned int v30; // stack - 0x6a8
  unsigned int v31; // stack - 0x6a4
  char v32; // stack - 0x6a0
  int v33; // stack - 0x69c
  int v34; // stack - 0x698
  int v35; // stack - 0x694
  int v36; // stack - 0x690
  int v37; // stack - 0x68c
  int v38; // stack - 0x688
  unsigned int v39; // stack - 0x684
  bool v4;
  char *v40; // stack - 0x648
  long v41; // stack - 0x640
  char *v42; // stack - 0x638
  char *v43; // stack - 0x630
  char *v44; // stack - 0x628
  char *v45; // stack - 0x620
  unsigned long v46; // stack - 0x618
  char *v47; // stack - 0x610
  long v48; // stack - 0x608
  unsigned long v49; // stack - 0x460
  unsigned long v5;
  unsigned long v50; // stack - 0x458
  long v51; // stack - 0x450
  unsigned long v52; // stack - 0x448
  unsigned long v53; // stack - 0x440
  unsigned long v54; // stack - 0x438
  unsigned long v6;
  char *v7;
  bool v8;
  char v9;
  ...
  do {
    ...
    if (*v43 != '%') {
      ...
      if (v13 <= 1)
        v14 = 1;
      if ((unsigned long)(a1 - v41) <= v14) {
        *__errno_location() = 0x22;
        return 0;
      }
      if (v42) {
        if (1 < v13) {
          memset(v42,0x20,v13 - 1);
          v42 = &v42[v13 - 1];
        }
        *v42 = *v43;
        v42 = &v42[1];
    ...
    if ((unsigned int)((int)*v43 - 0x30U) <= 9) {
      ...
      do {
        v10 = (int)((long)a6 * 10);
        if (((long)v10 != (long)a6 * 10) || (a6 = *v43 + -0x30 + v10, SCARRY4(*v43 + -0x30,v10)))
          a6 = 0x7fffffff;
        v43 = &v43[1];
...
label_36db3:
      ...
      case 0x42:
        ...
        break;
      case 0x43:
        if (v9 == 'E') goto label_3501f;
        v24 = (int)a3[5] < -0x76c;
        v30 = (int)((unsigned int)((a3[5] >> 0x1f & (unsigned int)!(bool)v24) != 0) * -99 + a3[5]) / 100 + 0x13;
        v28 = 2;
label_353d1:
        if (!v27)
          v27 = a5;
...
label_3541e:
          ...
          v11 = (v28 != 2) ? 9999 : 99; // branch-flip
          if ((v30 <= v11) && (a6 <= v28)) goto label_3541e;
          v8 = 1;
        }
        goto label_3546a;
      case 0x44:
      ...
      case 0x67:
        if (v9 != 'E') {
          ...
          v11 = v10 + a3[5];
          v37 = 0;
          v38 = sub_346d2(a3[7],a3[6]);
          if (0 <= v38) { // branch-flip
            v10 = !((v11 & 3) || ((!((int)v11 % 100) && ((int)v11 % 400))));
            v10 = sub_346d2(a3[7] - (v10 + 0x16d),a3[6]);
            if (0 <= v10) {
              v37 = 1;
              v38 = v10;
            }
          ...
          if (*v43 != 'G') { // branch-flip
            ...
            v30 = (v37 + (int)a3[5] % 100) % 100;
            v28 = 2;
            v24 = 0;
            if ((int)v30 <= -1) {
              v30 = (0xfffff894U - v37 <= (int)a3[5]) ? v30 + 100 : -v30; // branch-flip
            }
          }
          else {
            v28 = 4;
            v24 = (int)a3[5] < 0xfffff894U - v37;
            v30 = v37 + a3[5] + 0x76c;
          }
          goto label_353d1;
        }
      ...
      case 0x4e:
        ...
        if (a6 <= 0)
          a6 = 9;
        v35 = 9;
        for (; (a6 < v35 || ((2 <= v35 && (!(v34 % 10))))); v34 = v34 / 10) {
          v35 -= 1;
        }
        for (v36 = v35; 0 < v36; v36 = v36 + -1) {
          v21[v36 + -1] = (char)v34 + (char)(v34 / 10) * '\xf6' + '0';
          v34 /= 10;
        }
        if (!v27)
          v27 = 0x30;
        v13 = (unsigned long)v35;
        if ((unsigned long)(a1 - v41) <= v13) {
          *__errno_location() = 0x22;
          return 0;
        }
        if (v42) {
          if (v25) // branch-flip
            sub_3467a(v42,v21,v13);
          else {
            memcpy(v42,v21,v13);
          }
          v42 = &v42[v13];
        }
        if ((v27 != 0x2d) && (0 <= a6 - v35))
          v14 = (unsigned long)(a6 - v35);
        else {
          v14 = 0;
        }
        v15 = v14;
...
label_34e0b:
        v33 = -1;
label_34e15:
        v13 = sub_347a5(0,0xffffffffffffffff,v44,a3,v25,v27,v33,v5,v6,a9);
        if ((v27 != 0x2d) && (0 <= a6))
        ...
        if (v42) {
          ...
          sub_347a5(v42,a1 - v41,v44,a3,v25,v27,v33,v5,v6,a9);
          v42 = &v42[v13];
        }
        v41 += v15;
        goto label_36fb5;
      ...
      case 0x5a:
        ...
        if (v42) {
          ...
          if (v8)
            sub_34622(v42,v40,v13);
          else if (v25) // branch-flip
            sub_3467a(v42,v40,v13);
          else {
            memcpy(v42,v40,v13);
          }
          v42 = &v42[v13];
...
label_36055:
      ...
      case 0x71:
        v28 = 1;
        v24 = 0;
        v30 = ((int)(a3[4] * 0xb) >> 5) + 1;
        goto label_35463;
      case 0x72:
        goto label_3501f;
      case 0x73:
        v23 = *(unsigned long *)a3;
        v49 = *(unsigned long *)&a3[2];
        v50 = *(unsigned long *)&a3[4];
        v52 = *(unsigned long *)&a3[8];
        v53 = *(unsigned long *)&a3[10];
        v54 = *(unsigned long *)&a3[0xc];
        v51._0_4_ = (unsigned int)*(unsigned long *)&a3[6];
        v51 = CONCAT44(0xffffffff,(unsigned int)v51);
        v48 = sub_3108c(v6,&v23);
        if (v51 <= -1) {
...
label_3546a:
        v31 = 0;
label_35474:
        if ((v9 == 'O') && ((bool)v24 != 1)) goto label_3501f;
        v45 = &v22[1];
        if ((bool)v24)
          v30 = -v30;
        do {
          ...
          v31 = (int)v31 >> 1;
          v45 = &v45[-1];
          *v45 = (char)v30 + (char)(v30 / 10) * '\xf6' + '0';
          v30 /= 10;
        } while ((v30) || (v31));
label_3554d:
        if (!v27)
        ...
        if (v9) {
          if (v27 == 0x5f) {
            if (v42) {
              memset(v42,0x20,(long)v12);
              v42 = &v42[v12];
            }
            v41 += v12;
            a6 -= v12;
          }
          if ((unsigned long)(a1 - v41) <= 1) {
            *__errno_location() = 0x22;
            return 0;
          }
          if (v42) {
      ...
      case 0x78:
label_35345:
        if (v9 != 'O') goto label_3501f;
        break;
      case 0x79:
        if (v9 != 'E') {
          v39 = (int)a3[5] % 100;
          if ((int)v39 <= -1) {
            v39 = (-0x76c <= (int)a3[5]) ? v39 + 100 : -v39; // branch-flip
          }
          v28 = 2;
          v24 = 0;
          v30 = v39;
...
label_3501f:
        ...
        *v47 = v32;
        ...
        if (v13) {
          ...
          if (v42) {
            ...
            if (v4)
              sub_34622(v42,&v21[1],v13);
            else if (v25) // branch-flip
              sub_3467a(v42,&v21[1],v13);
            else {
              memcpy(v42,&v21[1],v13);
            }
            v42 = &v42[v13];
          }
          v41 += v15;
      ...
      case 0x7a:
        v46 = 0;
label_36b84:
        if ((int)a3[8] < 0) goto label_36fb5;
...
label_36d39:
          v28 = 9;
          v31 = 0x14;
          v30 = v10 % 0x3c + v30 * 10000 + v12 * 100;
        }
...
label_353c5:
    ...
    if (v42) {
      ...
      if (v25) // branch-flip
        sub_3467a(v42,v7,v16);
      else {
        memcpy(v42,v7,(unsigned long)v16);
      }
      v42 = &v42[(long)v16];
    }
    v41 += (long)v18;
...
void sub_37102(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_3704a(a0,a1,a2);
}
