...
void sub_2900(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_ffc0)(sub_2d6d,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_2a5f(int a0,unsigned long *a1,char a2) // return-dupe
{
  int v1; // eax
  long v2; // stack - 0x20
...
void sub_2c28(void)
{
  ...
  for (v5 = (long *)0xfb40; *v5; v5 = &v5[1]) {
    v3 = (char *)*v5;
    printf("  %s\n",gettext(v3));
  }
  v3 = gettext("Exit status is 0 if inputs are the same, 1 if different, 2 if trouble.");
  v4 = gettext("If a FILE is \'-\' or missing, read standard input.");
  printf("\n%s\n\n%s\n%s\n",gettext("SKIP values may be followed by the following multiplicative suffixes:\nkB 1000, K 1024, MB 1,000,000, M 1,048,576,\nGB 1,000,000,000, G 1,073,741,824, and so on for T, P, E, Z, Y."),v4,v3);
  sub_74c0();
}

// Function: sub_2d6d @ 0x2d6d
unsigned long sub_2d6d(int a0,char **a1)
{
  int v1;
  ...
  unsigned int v21; // stack - 0x130
  long v22; // stack - 0x120
  long v23; // stack - 0xb0
  unsigned int v24; // stack - 0xa0
  long v25; // stack - 0x90
  bool v3;
  long v4;
  int v5;
  ...
  sub_479f(0);
  sub_7c09();
  while (v5 = getopt_long(a0,a1,"bci:ln:sv",(void *)0xfa00,NULL), v5 != -1) {
    switch(v5) {
      case 0x62:
      case 99:
        dat_10214 = 1;
      ...
      case 0x6c:
        ...
        break;
      case 0x6e:
        v5 = sub_7e2e(optarg,0,0,&v11,"kKMGTPEZY0");
        if ((v5) || ((long)v11 <= -1))
      ...
      case 0x73:
        ...
        break;
      case 0x76:
        v6 = sub_500c("David MacKenzie");
        sub_73dc(stdout,"cmp","GNU diffutils",dat_10018,sub_50b2("Torbjorn Granlund",0xc60c),v6,0);
        sub_2b8a();
        return 0;
      case 0x80:
        sub_2c28();
  ...
  if (a0 == optind)
    sub_29e9("missing operand after \'%s\'",a1[(long)a0 + -1]); // no-return
  v5 = optind + 1;
  dat_100a0 = a1[optind];
  if (a0 <= v5) { // branch-flip
    dat_100a8 = "-";
    optind = v5;
  }
  else {
  ...
  if (optind < a0)
    sub_29e9("extra operand \'%s\'",a1[optind]); // no-return
  for (v15 = 0; v15 <= 1; v15 = v15 + 1) {
    if (((v15) && (dat_10200 == dat_10208)) && (v5 = strcmp(dat_100a0,dat_100a8), !v5))
      return 0;
    ...
    if ((*(int *)((long)v15 * 4 + 0x100b0) < 0) || (v5 = *(int *)((long)v15 * 4 + 0x100b0), fstat(v5,(void *)((long)v15 * 0x90 + 0x100c0)))) {
      if ((*(int *)((long)v15 * 4 + 0x100b0) <= -1) && (dat_10210 == 3))
        exit(2); // no-return
      v6 = *(unsigned long *)((long)v15 * 8 + 0x100a0);
      error(2,*__errno_location(),"%s",v6);
      return v7;
    }
  }
  ...
  if (((dat_10210 != 3) && (!fstat(1,&v12))) && (!stat("/dev/null",&v13))) {
    if (((v20 != v23) || (v12 != v13)) && (((((v21 & 0xf000) != 0x6000 || ((v24 & 0xf000) != 0x6000)) && (((v21 & 0xf000) != 0x2000 || ((v24 & 0xf000) != 0x2000)))) || (v22 != v25))))
      v3 = 0;
    else {
      v3 = 1;
    }
  ...
  if (((dat_10210 == 3) && ((dat_100d8 & 0xf000) == 0x8000)) && ((dat_10168 & 0xf000) == 0x8000)) {
    ...
    if (v17 != v18) {
      if (0 <= (long)dat_10010) {
        ...
        if (v18 < v17)
          v8 = v18;
        if ((long)dat_10010 <= v8) goto label_368d;
      }
      exit(1); // no-return
    }
  }
label_368d:
  dat_101f0 = sub_8307(dat_100f8,dat_10188,0x7ffffffffffffff7);
  ...
  v6 = *(unsigned long *)((long)v16 * 8 + 0x100a0);
  error(2,*__errno_location(),"%s",v6);
  return v10;
}
    ...
    if (2 <= v23) {
      while( true ) {
        ...
        if (v28 < v8) {
          switch(dat_10210) {
            case 0:
              v13 = sub_490d(v26,v17);
              v14 = sub_490d(v25,v18);
              if (dat_10214 == '\x01') {
                ...
                v4 = dat_100a8;
                v15 = dat_100a0;
                printf(gettext("%s %s differ: byte %s, line %s is %3o %s %3o %s\n"),v15,v4,v13,v14,(unsigned long)v1,v19,(unsigned long)v2,v20);
                return 1;
              }
            ...
            case 1:
              do {
                ...
                v2 = *(unsigned char *)(v28 + (long)v6);
                if (v1 != v2) {
                  v13 = sub_490d(v26,v18);
                  if (dat_10214 != '\x01') // branch-flip
                    printf("%*s %3o %3o\n",(unsigned long)v24,v13,(unsigned long)v1,(unsigned long)v2);
                  else {
                    sub_43cf(v20,v1);
                    sub_43cf(v17,v2);
                    printf("%*s %3o %-4s %3o %s\n",(unsigned long)v24,v13,(unsigned long)v1,v20,(unsigned long)v2,v17);
                  }
                }
                v26 += 1;
                v28 += 1;
      ...
      if ((v22 <= 0) && (dat_10210 != 3)) {
        v13 = *(unsigned long *)((long)(int)(unsigned int)(v33 < v32) * 8 + 0x100a0);
        if (v26 != 1) { // branch-flip
          v14 = sub_490d(v26 + -1,v17);
      ...
      do {
        ...
        if (v9 != v8) {
          if (v9 == 0xffffffffffffffff) {
            v13 = *(unsigned long *)((long)v23 * 8 + 0x100a0);
            error(2,*__errno_location(),"%s",v13);
            return v10;
          }
          break;
...
char sub_4b36(char *a0,unsigned long a1)
{
  bool v1;
  char *v10; // stack - 0x58
  char *v11; // stack - 0xc0
  ...
  v5 = (char *)sub_6908(a1,2);
  v12 = 0;
  v11 = a0;
  while( true ) {
    while( true ) {
      if ((!*v11) || (v6 = (char *)sub_92f3(v11,v5), !v6)) {
        free(v5); // return-dupe
        return v12;
      }
...
void sub_5475(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_53bd(a0,a1,a2);
}
...
bool sub_5b45(long a0,long *a1)
{
  return (unsigned long)(*a1 - a0) <= (unsigned long)(*a1 - a1[3]) >> 1;
}

// Function: sub_5b86 @ 0x5b86
unsigned long sub_5b86(unsigned long *a0,char *a1) // return-dupe x3, return-dupe
{
  void *v1;
  long v2;
  long v3;
        ...
        if (1 <= v5) {
          if ((unsigned long)(long)(v5 + 0x1049) <= v8) {
            ...
            while( true ) {
              ...
              if ((v5 <= -1) && (*__errno_location() == 4)) goto label_5e35;
              if (v5 < 0) goto label_5e87;
...
unsigned long sub_5ec3(long *a0) // early-return
{
  if (*a0 == a0[1]) {
    *(unsigned int *)&a0[2] = 1;
    return 0xffffffff;
...
unsigned long sub_5f4b(unsigned long a0,long *a1) // return-dupe
{
  int v1; // eax
  int v2; // stack - 0x18
  long v3; // stack - 0x10
...
unsigned long sub_6062(unsigned long a0) // return-dupe
{
  bool v1;
  int v2; // eax
  char v3 [48];
  ...
  do {
    while( true ) {
      ...
      if (((v4 < v6) && (v2 = sub_67e7(a0,v4,v6), v2)) || (((unsigned long)(v7 - 1U) < (unsigned long)(v5 - 1U) && (v2 = sub_67e7(a0,v7,v5), v2)))) {
        sub_6027(v3);
        return 0;
      }
    }
...
unsigned long sub_6203(unsigned long a0) // return-dupe
{
  if (!sub_6062(a0))
    return 0;
  return 0xffffffff;
...
unsigned int sub_624f(unsigned long a0)
{
  unsigned int v1; // eax
  long v2;
...
long sub_645a(long a0)
{
  ...
  while( true ) {
    if (!v4)
      return 0;
    if ((unsigned long)-v4 / dat_20298 < v5)
      v5 = (unsigned long)-v4 / dat_20298;
    v1 = dat_20298 * v5;
...
unsigned long sub_67e7(unsigned long *a0,unsigned long a1,unsigned long a2) // return-dupe
{
  if ((a1 <= *a0) && (*a0 <= a2 - 1)) {
...
unsigned long sub_6874(unsigned long a0,long a1) // early-return
{
  ...
  if (v8) {
    if (2 <= __ctype_get_mb_cur_max()) { // branch-flip
      if (a1) {
        ...
        v9 = 0;
        memset(v3,0,8);
        while (((v10 = 0, v11 < v4 && (sub_8577(&v4), v13)) && (v1 = iswspace(v14), v1))) {
          v11 = &v11[v12];
        }
        v2 = strlen((char *)v11);
        memmove(v8,v11,v2 + 1);
...
void sub_6c67(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5) // return-dupe x10
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
void sub_7263(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,long a4)
{
  long v1; // stack - 0x10
...
void sub_72d6(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  long *v1;
  long v2 [11];
...
void sub_73dc(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_7594(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_76cd(a0,a1,a2);
}
...
void sub_769c(unsigned long a0,unsigned long a1)
{
...
void sub_7727(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_75e3(sub_84e0(a0,a1,a2));
}

// Function: sub_7760 @ 0x7760
void sub_7760(unsigned long a0,unsigned long a1)
{
  sub_778e(a0,a1,1);
}

// Function: sub_778e @ 0x778e
unsigned long sub_778e(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_786d(long a0,long *a1,long a2,long a3,long a4) // ternary
{
  long v1;
  long v2; // rax
  unsigned long v3; // rax
...
void sub_7ad1(void *a0,unsigned long a1)
{
...
int sub_7c4f(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  int v1; // eax
...
long sub_7cad(unsigned long a0,unsigned long a1)
{
  long v1; // rax
...
long sub_7cf6(unsigned long a0,unsigned long a1,unsigned long a2)
{
  long v1; // rax
...
unsigned int sub_7de9(unsigned long a0,unsigned int a1,int a2)
{
  int v1;
  int v2; // stack - 0x28
...
void sub_8577(long *a0)
{
  ...
  v3 = a0[3];
  v4 = a0[3];
  a0[4] = sub_aad0((long)a0 + 0x2c,v4,v2 - v3,(long)a0 + 0xc);
...
void sub_87d0(unsigned long *a0,unsigned long *a1)
{
  *a0 = *a1;
  *(char *)&a0[1] = *(char *)&a1[1];
...
unsigned long sub_8b5d(void *a0,void *a1,long *a2)
{
  ...
  v10 = v18;
  v11[0] = 0;
  *(unsigned long *)&v15[-8] = 0x8d55;
  memset(v9,0,8,v15[-8]);
  v36 = 0;
  while( true ) {
    v36 = 0;
    *(unsigned long *)&v15[-8] = 0x8db6;
    sub_9a61(v11);
    if ((v38 != '\x01') || (v39))
      v16 = 1;
    else {
    ...
    if (!v16) break;
    *(unsigned long *)&v15[-8] = 0x8d8f;
    sub_af80(v27 + v20 * 0x30,&v10);
...
label_8f2a:
  ...
  *v17 = 0;
  ...
  v32 = v19;
  v13[0] = 0;
  *(unsigned long *)&v15[-8] = 0x901d;
  memset(v12,0,8,v15[-8]);
  v31 = 0;
  v10 = v19;
  v11[0] = 0;
  *(unsigned long *)&v15[-8] = 0x904d;
  memset(v9,0,8,v15[-8]);
  v36 = 0;
  do {
    *(unsigned long *)&v15[-8] = 0x92a3;
    sub_9a61(v11);
    if ((v38 != '\x01') || (v39))
      v16 = 1;
    else {
...
label_92c9:
      ...
      for (v24 = *(long *)(v29 + v23 * 8); v24; v24 = v24 + -1) {
        *(unsigned long *)&v15[-8] = 0x91e7;
        ...
        if (!v16) {
          *(unsigned long *)&v15[-8] = 0x920e; // no-return
          abort(v15[-8]);
        }
      ...
      *(unsigned long *)&v15[-8] = 0x9247;
      ...
      if (!v16) {
        *(unsigned long *)&v15[-8] = 0x926e; // no-return
        abort(v15[-8]);
      }
      v32 = (void *)(v33 + (long)v32);
      v31 = 0;
...
void sub_9a61(char *a0)
{
  ...
  v5 = sub_a5e2(*(unsigned long *)&a0[0x10],v4);
  v2 = *(unsigned long *)&a0[0x10];
  *(unsigned long *)&a0[0x18] = sub_aad0(&a0[0x24],v2,v5,&a0[4]);
...
char * sub_a4ef(char *a0,unsigned long a1,unsigned long a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
...
unsigned long sub_aad0(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3) // early-return
{
  long v1;
...
void sub_af80(long *a0,long *a1) // return-dupe
{
