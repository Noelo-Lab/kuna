...
void sub_2a60(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_13fc8)(sub_2b67,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
char sub_646a(char *a0,unsigned long a1)
{
  bool v1;
  char *v10; // stack - 0x58
  char *v11; // stack - 0xc0
  ...
  v5 = (char *)sub_8113(a1,2);
  v12 = 0;
  v11 = a0;
  while( true ) {
    while( true ) {
      if ((!*v11) || (v6 = (char *)sub_a72c(v11,v5), !v6)) {
        free(v5); // return-dupe
        return v12;
      }
...
bool sub_7350(long a0,long *a1)
{
  return (unsigned long)(*a1 - a0) <= (unsigned long)(*a1 - a1[3]) >> 1;
}

// Function: sub_7391 @ 0x7391
unsigned long sub_7391(unsigned long *a0,char *a1) // return-dupe x3, return-dupe
{
  void *v1;
  long v2;
  long v3;
        ...
        if (1 <= v5) {
          if ((char *)(long)(v5 + 0x1049) <= v8) {
            ...
            while( true ) {
              ...
              if ((v5 <= -1) && (*__errno_location() == 4)) goto label_7640;
              if (v5 < 0) goto label_7692;
...
label_7540:
      if (v7) { // branch-flip
        v8 = (char *)((long)v8 << 1);
        if (!v8) goto label_7692;
        if (a0[4])
          munmap((void *)a0[4],a0[5]);
      }
      else {
        v7 = (char *)(long)getpagesize();
        for (v8 = v7; v8 <= "C_2.3"; v8 = (char *)((long)v8 << 1)) {
        }
      }
...
unsigned long sub_76ce(long *a0) // early-return
{
  if (*a0 == a0[1]) {
    *(unsigned int *)&a0[2] = 1;
    return 0xffffffff;
...
unsigned long sub_7756(unsigned long a0,long *a1) // return-dupe
{
  int v1; // eax
  int v2; // stack - 0x18
  long v3; // stack - 0x10
...
unsigned long sub_786d(unsigned long a0) // return-dupe
{
  bool v1;
  int v2; // eax
  char v3 [48];
  ...
  do {
    while( true ) {
      ...
      if (((v4 < v6) && (v2 = sub_7ff2(a0,v4,v6), v2)) || (((unsigned long)(v7 - 1U) < (unsigned long)(v5 - 1U) && (v2 = sub_7ff2(a0,v7,v5), v2)))) {
        sub_7832(v3);
        return 0;
      }
    }
...
unsigned long sub_7a0e(unsigned long a0) // return-dupe
{
  if (!sub_786d(a0))
    return 0;
  return 0xffffffff;
...
unsigned int sub_7a5a(unsigned long a0)
{
  unsigned int v1; // eax
  long v2;
...
long sub_7c65(long a0)
{
  ...
  while( true ) {
    if (!v4)
      return 0;
    if ((unsigned long)-v4 / dat_24178 < v5)
      v5 = (unsigned long)-v4 / dat_24178;
    v1 = dat_24178 * v5;
...
unsigned long sub_7ff2(unsigned long *a0,unsigned long a1,unsigned long a2) // return-dupe
{
  if ((a1 <= *a0) && (*a0 <= a2 - 1)) {
...
unsigned long sub_807f(unsigned long a0,long a1) // early-return
{
  ...
  if (v8) {
    if (2 <= __ctype_get_mb_cur_max()) { // branch-flip
      if (a1) {
        ...
        v9 = 0;
        memset(v3,0,8);
        while (((v10 = 0, v11 < v4 && (sub_99b0(&v4), v13)) && (v1 = iswspace(v14), v1))) {
          v11 = &v11[v12];
        }
        v2 = strlen((char *)v11);
        memmove(v8,v11,v2 + 1);
...
void sub_8472(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5) // return-dupe x10
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
void sub_8a6e(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,long a4)
{
  long v1; // stack - 0x10
...
void sub_8ae1(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  long *v1;
  long v2 [11];
...
void sub_8be7(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
void sub_8d9f(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_8ed8(a0,a1,a2);
}
...
void sub_8ea7(unsigned long a0,unsigned long a1)
{
...
void sub_8f32(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_8dee(sub_9919(a0,a1,a2));
}

// Function: sub_8f6b @ 0x8f6b
void sub_8f6b(unsigned long a0,unsigned long a1)
{
  sub_8f99(a0,a1,1);
}

// Function: sub_8f99 @ 0x8f99
unsigned long sub_8f99(long a0,unsigned long *a1,unsigned long a2)
{
  char v1 [16];
  long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_9078(long a0,long *a1,long a2,long a3,long a4) // ternary
{
  long v1;
  long v2; // rax
  unsigned long v3; // rax
...
void sub_9414(char *a0,unsigned long a1,long a2)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  char *v3; // rax
...
int sub_9579(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  int v1; // eax
...
long sub_95d7(unsigned long a0,unsigned long a1)
{
  long v1; // rax
...
long sub_9620(unsigned long a0,unsigned long a1,unsigned long a2)
{
  long v1; // rax
...
void sub_99b0(long *a0)
{
  ...
  v3 = a0[3];
  v4 = a0[3];
  a0[4] = sub_de82((long)a0 + 0x2c,v4,v2 - v3,(long)a0 + 0xc);
...
void sub_9c09(unsigned long *a0,unsigned long *a1)
{
  *a0 = *a1;
  *(char *)&a0[1] = *(char *)&a1[1];
...
unsigned long sub_9f96(void *a0,void *a1,long *a2)
{
  ...
  v10 = v18;
  v11[0] = 0;
  *(unsigned long *)&v15[-8] = 0xa18e;
  memset(v9,0,8,v15[-8]);
  v36 = 0;
  while( true ) {
    v36 = 0;
    *(unsigned long *)&v15[-8] = 0xa1ef;
    sub_ae9a(v11);
    if ((v38 != '\x01') || (v39))
      v16 = 1;
    else {
    ...
    if (!v16) break;
    *(unsigned long *)&v15[-8] = 0xa1c8;
    sub_e3dc(v27 + v20 * 0x30,&v10);
...
label_a363:
  ...
  *v17 = 0;
  ...
  v32 = v19;
  v13[0] = 0;
  *(unsigned long *)&v15[-8] = 0xa456;
  memset(v12,0,8,v15[-8]);
  v31 = 0;
  v10 = v19;
  v11[0] = 0;
  *(unsigned long *)&v15[-8] = 0xa486;
  memset(v9,0,8,v15[-8]);
  v36 = 0;
  do {
    *(unsigned long *)&v15[-8] = 0xa6dc;
    sub_ae9a(v11);
    if ((v38 != '\x01') || (v39))
      v16 = 1;
    else {
...
label_a702:
      ...
      for (v24 = *(long *)(v29 + v23 * 8); v24; v24 = v24 + -1) {
        *(unsigned long *)&v15[-8] = 0xa620;
        ...
        if (!v16) {
          *(unsigned long *)&v15[-8] = 0xa647; // no-return
          abort(v15[-8]);
        }
      ...
      *(unsigned long *)&v15[-8] = 0xa680;
      ...
      if (!v16) {
        *(unsigned long *)&v15[-8] = 0xa6a7; // no-return
        abort(v15[-8]);
      }
      v32 = (void *)(v33 + (long)v32);
      v31 = 0;
...
void sub_ae9a(char *a0)
{
  ...
  v5 = sub_d994(*(unsigned long *)&a0[0x10],v4);
  v2 = *(unsigned long *)&a0[0x10];
  *(unsigned long *)&a0[0x18] = sub_de82(&a0[0x24],v2,v5,&a0[4]);
...
void sub_b0db(char *a0,char *a1)
{
  *a0 = *a1;
  ...
  a0[0xc] = a1[0xc];
  sub_e3dc(&a0[0x10],&a1[0x10]);
}

// Function: sub_b170 @ 0xb170
unsigned long sub_b170(long a0)
{
  int v1;
  unsigned long v2; // rax
...
label_bf66:
    if ((v29 <= 1) && ((!v1 || (v16)))) goto label_c1c9;
    v32 = v29 + v24;
    while( true ) {
      if ((!v1) || (v16)) {
        if (v3) {
...
label_c1c9:
    if (((((v1) && (v19 != 2)) || (v14)) && ((v7 && (*(unsigned int *)(v7 + (unsigned long)(v22 >> 5) * 4) >> (v22 & 0x1f) & 1)))) || (v3)) goto label_c234;
  }
label_c2ef:
  if ((v2) && (!v4)) {
    if (v25 < v21)
...
label_c500:
  ...
  if (((v19 == 2) && (!v14)) && (v5)) {
    if (v6)
      return sub_b4c4(a0,v26,a2,v20,5,a5,v7,v18,v17);
    if ((!v21) && (v26)) {
      v21 = v26;
      v25 = 0;
      goto label_b57e;
...
unsigned long sub_c585(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  unsigned long v2; // rax
  ...
  v1 = *__errno_location();
  v2 = sub_b4c4(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *__errno_location() = v1;
  return v2;
}

// Function: sub_c62d @ 0xc62d
void sub_c62d(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_c663(a0,a1,0,a2);
}

// Function: sub_c663 @ 0xc663
unsigned long sub_c663(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  unsigned int v2; // eax
  long v3; // rax
  ...
  v3 = sub_b4c4(0,0,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_8dd0(v3 + 1);
  sub_b4c4(v4,v3 + 1,a0,a1,*a3,v2,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *__errno_location() = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void * sub_c84e(int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  int v1;
  unsigned int v2;
  unsigned long *v3;
  ...
  if ((0 <= a0) && (a0 <= 0x7ffffffe)) {
    ...
    v2 = a3[1];
    v9 = sub_b4c4(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v8 <= v9) {
      v8 = v9 + 1;
      v6[(long)a0 * 2] = v8;
      if (v7 != (void *)0x241c0)
      ...
      v7 = (void *)sub_8dd0(v8);
      v6[(long)a0 * 2 + 1] = v7;
      sub_b4c4(v7,v8,a1,a2,*a3,v2 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *__errno_location() = v1;
    return v7;
  }
...
void sub_cafd(unsigned int a0,unsigned long a1)
{
  sub_c84e(a0,a1,0xffffffffffffffff,0x24180);
}

// Function: sub_cb31 @ 0xcb31
void sub_cb31(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_c84e(a0,a1,a2,0x24180);
}

// Function: sub_cb63 @ 0xcb63
void sub_cb63(unsigned long a0)
{
  sub_cafd(0,a0);
}

// Function: sub_cb86 @ 0xcb86
void sub_cb86(unsigned long a0,unsigned long a1)
{
  sub_cb31(0,a0,a1);
}

// Function: sub_cbb1 @ 0xcbb1
void sub_cbb1(unsigned int a0,unsigned int a1,unsigned long a2)
{
  char v1 [56];
...
void sub_cc19(unsigned int a0,unsigned int a1,unsigned long a2,unsigned long a3)
{
  char v1 [56];
...
void sub_cc7f(unsigned int a0,unsigned long a1)
{
  sub_cbb1(0,a0,a1);
}

// Function: sub_cca7 @ 0xcca7
void sub_cca7(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_cc19(0,a0,a1,a2);
}

// Function: sub_ccd7 @ 0xccd7
void sub_ccd7(unsigned long a0,unsigned long a1,char a2)
{
...
void sub_cd92(unsigned long a0,char a1)
{
  sub_ccd7(a0,0xffffffffffffffff,(int)a1);
}

// Function: sub_cdc0 @ 0xcdc0
void sub_cdc0(unsigned long a0)
{
  sub_cd92(a0,0x3a);
}

// Function: sub_cde3 @ 0xcde3
void sub_cde3(unsigned long a0,unsigned long a1)
{
  sub_ccd7(a0,a1,0x3a);
}

// Function: sub_ce11 @ 0xce11
void sub_ce11(unsigned int a0,unsigned int a1,unsigned long a2)
{
...
void sub_ced3(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_cf0d(a0,a1,a2,a3,0xffffffffffffffff);
}

// Function: sub_cf0d @ 0xcf0d
void sub_cf0d(unsigned int a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned long v3; // stack - 0x38
...
void sub_cfcb(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_ced3(0,a0,a1,a2);
}

// Function: sub_cffe @ 0xcffe
void sub_cffe(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3)
{
  sub_cf0d(0,a0,a1,a2,a3);
}

// Function: sub_d03c @ 0xd03c
void sub_d03c(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_c84e(a0,a1,a2,0x14060);
}

// Function: sub_d06e @ 0xd06e
void sub_d06e(unsigned long a0,unsigned long a1)
{
  sub_d03c(0,a0,a1);
}

// Function: sub_d099 @ 0xd099
void sub_d099(unsigned int a0,unsigned long a1)
{
  sub_d03c(a0,a1,0xffffffffffffffff);
}

// Function: sub_d0c6 @ 0xd0c6
void sub_d0c6(unsigned long a0)
{
  sub_d099(0,a0);
}
...
char * sub_d8a1(char *a0,unsigned long a1,unsigned long a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
...
unsigned long sub_de82(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3) // early-return
{
  long v1;
...
void sub_e3dc(long *a0,long *a1) // return-dupe
{
...
void sub_e677(unsigned int a0,unsigned long a1,unsigned long a2)
{
  sub_e5bf(a0,a1,a2);
}
