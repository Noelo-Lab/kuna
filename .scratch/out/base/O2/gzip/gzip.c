...
void * localtime(void *a0)
{
  ...
  v1 = (void *)(*dat_17da0)(); // jump-as-call
  return v1;
}
...
void * opendir(char *a0)
{
  ...
  v1 = (void *)(*dat_17e20)(); // jump-as-call
  return v1;
}
...
void * readdir(void *a0)
{
  ...
  v1 = (void *)(*dat_17f00)(); // jump-as-call
  return v1;
}
...
void sub_39a0(int a0,char **a1)
{
  ...
  if (v17) { // branch-flip
    v7 = v17[optind];
    if ((!v7) || (strcmp(v7,"--"))) {
      v3 = getopt_long(v11,v17,"ab:cdfhH?klLmMnNqrS:tvVZ123456789",(void *)0x177c0,&v12);
      v4 = v3 + 0x83;
      if (v3 < 0) {
        if (optind != v11) {
...
label_3b65:
    v4 = getopt_long(a0,a1,"ab:cdfhH?klLmMnNqrS:tvVZ123456789",(void *)0x177c0,&v12);
    v3 = optind;
    if (v4 < 0) {
      if (dat_18028 <= -1)
        dat_18028 = dat_dc9f8;
...
label_411e:
      ...
      v18 = (int *)0x13350;
      sigemptyset((void *)0xdc940);
      do {
        v4 = *v18;
        sigaction(v4,NULL,&v13);
        if (v13 != (void *)0x1)
          sigaddset((void *)0xdc940,v4);
        v18 = &v18[1];
      ...
      do {
        ...
        if (sigismember(0xdc940,v4)) {
          if (!v19)
            dat_dc9e0 = 1;
          sigaction(v4,&v13,NULL);
        }
        v19 += 1;
      } while (v19 != 6);
      if (a0 != v3) { // branch-flip
        while (optind < a0) {
          v7 = a1[optind];
          optind += 1;
          v6 = strcmp(v7,"-");
...
label_3b44:
    if (v5 <= 0xd3) {
      (*(void *)((long)*(int *)((unsigned long)v5 * 4 + 0x12f80) + 0x12f80))(); // jump-as-call
      return;
    }
    if ((v4 <= 0x82) || (v4 == 0xc2)) {
...
void sub_4290(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_17fc0)(sub_39a0,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
label_4890:
      ...
      if ((int)v10 <= (int)v14) goto label_47b8;
      if (dat_19080 <= (int)v10) {
        dat_19068 = a0;
        return v10;
      }
      v2 = *(unsigned short *)((unsigned long)(a0 & 0x7fff) * 2 + 0x1a880);
      v9 = *(char *)(v5 + 0x3afff + (long)(int)v10);
      v4 = 1;
      v3 = 1;
      v15 = v1[(int)v10];
      v14 = v10;
...
label_51ba:
            v15 = sub_b160(0,*(char *)(v16 + 0x3b000));
            v17 = dat_1a000;
            v12 = dat_1906c;
            if (dat_1a000)
          ...
          if ((v17) && (dat_19088 < dat_1906c)) {
            ...
            dat_19088 = 0xffffffff;
label_5225:
            v13 = (dat_19078 & 0xffffffff) + 0x3b000;
            if ((long)dat_19078 <= -1)
              v13 = 0;
            sub_add0(v13,dat_1906c - dat_19078,v17,0);
      ...
      v15 = -1;
label_529c:
      v14 = dat_1906c - dat_19078;
      v13 = (dat_19078 & 0xffffffff) + 0x3b000;
      if ((long)dat_19078 <= -1)
        v13 = 0;
      sub_add0(v13,v14,v15,1); // return-dupe, tail-call
      return;
    }
    if (dat_1909c) {
      v17 = 0;
        ...
        if ((3 <= v9) && (v8 <= v9)) {
          ...
          *v2 = (short)v8 + -2 + (short)v9;
          ...
          if ((long)dat_19078 <= -1)
            v13 = 0;
          v17 = 0;
          sub_add0(v13,dat_1906c - dat_19078,v15,0);
          dat_19078 = (unsigned long)dat_1906c;
          v12 = dat_1909c;
        }
        else if (v17) { // branch-flip
          v16 = sub_b160(0,*(char *)((unsigned long)(v12 - 1) + 0x3b000));
          v15 = (int)v16;
          v16 &= 0xffffffff;
          if (dat_1a000) { // branch-flip
            v10 = (unsigned long)dat_1906c;
...
label_4ebc:
              ...
              if ((long)dat_19078 <= -1)
                v13 = 0;
              sub_add0(v13,dat_1906c - dat_19078,v11,0);
              v10 = (unsigned long)dat_1906c;
              dat_19078 = v10;
...
label_4ef8:
          ...
          if (dat_1a000) {
            if (dat_19088 < v10) {
              ...
              if ((long)dat_19078 <= -1)
                v13 = 0;
              sub_add0(v13,v10 - dat_19078,1,0);
              v10 = (unsigned long)dat_1906c;
              v12 = dat_1906c;
              dat_19078 = v10;
        ...
        while (v12 <= 0x105) {
          if (dat_190a0) {
            ...
            if (!dat_1909c) {
              v15 = (int)v16 + -1;
              if (v17)
                sub_b160(0,*(char *)((unsigned long)(dat_1906c - 1) + 0x3b000));
              goto label_4f79;
            }
            break;
          }
...
unsigned int sub_5750(unsigned int a0) // early-return x9, return-dupe x2
{
  ...
  if ((dat_dc9f4) && (dat_1a860)) {
    ...
    if (v11 <= v7) { // branch-flip
      ...
      dat_1a008 = v7 + 1;
      v16 = (unsigned long)*(unsigned char *)((unsigned long)v7 + 0x9c000);
    ...
    if (v13) { // branch-flip
      ...
      if (v8 <= v7) { // branch-flip
        ...
        dat_1a008 = v7 + 1;
        v1 = *(unsigned char *)((unsigned long)v7 + 0x9c000);
        v16 = (unsigned long)v1;
        v7 = (unsigned int)v1;
      }
      v8 = 0;
  ...
  dat_dc9dc = 0;
  dat_dc9d8 = v12;
  if ((memcmp(&v13,(void *)0x12c6d,2)) && (memcmp(&v13,(void *)0x12c70,2))) {
    if (((memcmp(&v13,(void *)0x12c90,2)) || (dat_1a008 != 2)) || (memcmp((void *)0x9c000,(void *)0x12c90,4))) {
      if (!memcmp(&v13,(void *)0x12c95,2)) {
        dat_180d0 = sub_c590;
        dat_18020 = 2;
        return 2;
      }
      if (!memcmp(&v13,(void *)0x12c98,2)) {
        dat_180d0 = sub_be90;
        dat_18020 = 1;
        dat_dc9dc = 1;
        return 1;
      }
      if (!memcmp(&v13,(void *)0x12c9b,2)) {
        dat_180d0 = sub_b920;
        dat_18020 = 3;
        dat_dc9dc = 1;
        return 3;
...
label_5c60:
      if (!v13) {
        while (!v7) {
          ...
          if (dat_1a00c <= dat_1a008) // branch-flip
            ...
            dat_1a008 += 1;
            v7 = (unsigned int)*(unsigned char *)(v16 + 0x9c000);
          }
        }
        if (v7 == 0xffffffff) {
          if (!dat_dc9e4)
    ...
    if (dat_1a00c <= dat_1a008) // branch-flip
      ...
      dat_1a008 += 1;
      dat_18020 = (unsigned int)*(unsigned char *)(v16 + 0x9c000);
    }
    if (dat_18020 != 8) {
    ...
    if (dat_1a00c <= dat_1a008) // branch-flip
      ...
      dat_1a008 += 1;
      v8 = (unsigned int)*(unsigned char *)(v16 + 0x9c000);
    }
    if (v8 & 0x20) {
      v15 = "%s: %s is encrypted -- not supported\n";
      sub_f6b0(stderr,v15,dat_1a850,0x1a420); // return-dupe
      dat_1a84c = 1;
      return 0xffffffff;
    }
    if (v8 & 0xc0) { // branch-flip
      sub_f6b0(stderr,"%s: %s has flags 0x%x -- not supported\n",dat_1a850,0x1a420,v8 & 0xff);
      dat_1a84c = 1;
      if (dat_dc9f4 <= 1) {
        dat_1a84c = 1;
        return 0xffffffff;
...
label_5a0f:
      v16 = (unsigned long)dat_1a008;
      dat_1a008 += 1;
      v16 = (unsigned long)*(unsigned char *)(v16 + 0x9c000);
      if (dat_1a008 < v11) goto label_5a2c;
label_5d80:
      v16 |= (long)(int)sub_d6c0(0) << 8;
      v11 = dat_1a00c;
      if (dat_1a00c <= dat_1a008) goto label_5da4;
label_5a4f:
      v10 = (unsigned long)dat_1a008;
      dat_1a008 += 1;
      v16 |= (unsigned long)*(unsigned char *)(v10 + 0x9c000) << 0x10;
      if (dat_1a008 < v11) goto label_5a73;
label_5dc9:
      v10 = (unsigned long)(int)sub_d6c0(0);
    }
    else {
      v11 = dat_1a00c;
      if (dat_1a008 < dat_1a00c) goto label_5a0f;
label_5d62:
      v16 = (unsigned long)(int)sub_d6c0(0);
      v11 = dat_1a00c;
      if (dat_1a00c <= dat_1a008) goto label_5d80;
label_5a2c:
      v10 = (unsigned long)dat_1a008;
      dat_1a008 += 1;
      v16 |= (unsigned long)*(unsigned char *)(v10 + 0x9c000) << 8;
      if (dat_1a008 < v11) goto label_5a4f;
label_5da4:
      v16 |= (long)(int)sub_d6c0(0) << 0x10;
      if (dat_1a00c <= dat_1a008) goto label_5dc9;
label_5a73:
      v10 = (unsigned long)dat_1a008;
      dat_1a008 += 1;
      v10 = (unsigned long)*(unsigned char *)(v10 + 0x9c000);
    }
    v16 |= v10 << 0x18;
    if ((v16) && (!dat_18028)) {
    ...
    if (v6 <= v11) // branch-flip
      ...
      dat_1a008 = v11 + 1;
      v23 = *(char *)((unsigned long)v11 + 0x9c000);
    }
    if (v8 & 2) {
      v19 = 8;
    ...
    if (v8 & 4) {
      ...
      if (v6 <= v11)
        ...
        dat_1a008 = v11 + 1;
        v17 = *(char *)((unsigned long)v11 + 0x9c000);
      }
      v2 = CONCAT11(v17,v4);
      if (dat_dc9e4)
        sub_f6b0(stderr,"%s: %s: extra field of %u bytes ignored\n",dat_1a850,0x1a420,v2);
      if (v8 & 2)
        sub_d0d0(&v14,2);
      sub_5690(v2,v8 & 0xff);
    }
    if (v8 & 8) {
      if ((dat_1802c) || (((dat_1a860 && (!dat_dc9e8)) || (2 <= dat_dc9d8))))
        sub_5690(0xffffffffffffffff,v8 & 0xff);
      else {
        v9 = (char *)sub_d290(0x1a020);
        v15 = v9;
        while( true ) {
          v16 = (unsigned long)dat_1a008;
          if (dat_1a00c <= dat_1a008) // branch-flip
        ...
        if (v8 & 2)
          sub_d0d0(v9,(int)v15 - (int)v9);
        v15 = (char *)sub_d290(v9);
    ...
    if (v8 & 2) {
      ...
      if (dat_1a00c <= dat_1a008) { // branch-flip
        ...
        dat_1a008 += 1;
        v6 = (unsigned int)*(unsigned char *)(v16 + 0x9c000);
        v8 = dat_1a008;
        v11 = dat_1a00c;
      }
      if (v11 <= v8) // branch-flip
        ...
        dat_1a008 = v8 + 1;
        v8 = (unsigned int)*(unsigned char *)((unsigned long)v8 + 0x9c000);
      }
      v6 = v8 << 8 | v6;
      if (v5 != v6) {
        sub_f6b0(stderr,"%s: %s: header checksum 0x%04x != computed checksum 0x%04x\n",dat_1a850,0x1a420,v6,(unsigned int)v5);
        dat_1a84c = 1;
        if (dat_dc9f4 <= 1) {
          dat_1a84c = 1;
          return 0xffffffff;
  ...
  sub_f6b0(stderr,v15,dat_1a850,0x1a420);
  dat_1a84c = 1;
  return 0xffffffff;
}
...
label_6718:
  ...
  if (dat_dc9e4) {
    ...
    if (v1) // branch-flip
      sub_f830("%s%3d %02d:%02d ",&"Jan"[(long)*(int *)((long)v1 + 0x10) * 4],*(unsigned int *)((long)v1 + 0xc),*(unsigned int *)((long)v1 + 8),*(unsigned int *)((long)v1 + 4));
    else {
      sub_f830("??? ?? ??:?? ");
    }
  }
...
void sub_6d00(char *a0,unsigned long a1)
{
  ...
  *(char *)(a1 + 0xdc100) = 0;
  dat_18014 = sub_e360(0xdc100,0x10000);
}
...
int sub_6dc0(void)
{
  ...
  if (!dat_dc9f0) {
    v7 = sub_dfd0(0x1a420);
    v5 = sub_6d00(0x1a420,v7 + -0x1a420);
...
void sub_6e90(char *a0)
{
  ...
  int v19; // stack - 0x4e0
  bool v2;
  unsigned long v20; // stack - 0x4c0
  long v21; // stack - 0x4b8
  long v22; // stack - 0x4b0
  int v3;
  int v4;
  int *v5; // rax
  unsigned long v6; // rax
...
label_73d0:
        ...
        if ((!dat_dc9f8) || (dat_18020 = sub_5750(dat_1a014), 0 <= dat_18020)) {
          if (!dat_1a860) {
            if (!dat_dc9f0) {
              v18 = (long)sub_dfd0(0x1a020);
              v19 = sub_6d00(0x1a020,(long)v18 + -0x1a020);
...
label_78ef:
            ...
            do {
              ...
              sigprocmask(0,(void *)0xdc940,&v13);
...
label_74a4:
          ...
          if (((dat_dc9f8) && (0 <= dat_1a838)) && ((dat_1a830 != dat_dc0b8 || (dat_dc0c0 != dat_1a838)))) {
            v21 = dat_1a830;
            v22 = dat_1a838;
            v3 = sub_ea40(dat_1a010,0x1a020,&v13);
            if (v3) { // branch-flip
label_7ee0:
              v5 = __errno_location();
              v3 = *v5;
...
label_7c7b:
          ...
          if (((dat_dca00) && ((((0 <= dat_18014 && (fdatasync())) && (*__errno_location() != 0x16)) || ((v3 = fsync(dat_1a010), v3 && (*__errno_location() != 0x16)))))) || (v3 = close(dat_1a010), v3))
            sub_d550(); // no-return
          if (!dat_dc9f0) {
            v9 = (char *)sub_dfd0(0x1a420);
            v14 = (char *)0x1a420;
            v17 = &v9[-0x1a420];
            v15 = v17;
            if (!v17) {
...
label_71d8:
        ...
        v8 = strlen(a0);
        if (v8 + v6 <= 0x3fd) {
          __strcpy_chk(v9,a0,0x400);
          if ((*(char *)sub_dfd0(v9)) && (v12[v8] != '/')) {
            v12[v8 + 1] = '/';
            v8 += 1;
          }
          strcpy(&v9[v8],v15);
  ...
  *(unsigned short *)(a0 + 6 + (long)a1 * 4) = 0xffff;
  ...
  do {
    while( true ) {
      ...
      if (v7 != v6) {
        if (v10 <= v4) break;
        v1 = (short *)((long)(int)v6 * 4 + 0xde9e0);
        *v1 = *v1 + (short)v4;
...
void sub_a090(unsigned long *a0) // return-dupe
{
  unsigned short *v1;
  bool v10;
  short v11;
  ...
  v21 = (unsigned short *)*a0;
  v31 = a0[1];
  dat_de0a0 = 0x23d;
  v29 = *(int *)((long)a0 + 0x1c);
  ...
  *(int *)((long)dat_de0a0 * 4 + 0xde0c0) = dat_de0c4;
  ...
  if (v29 <= 0x23c) {
    ...
    do {
      ...
      if ((int)v17 < (int)((unsigned short)v21[(unsigned long)v1[1] * 2 + 1] + 1)) {
        v32 += 1;
        v28 = v17;
      }
    ...
    if (v32) {
      ...
      v11 = *(short *)((long)(int)v28 * 2 + 0xde9c0);
      ...
      do {
        ...
        while( true ) {
          *(short *)((long)(int)v12 * 2 + 0xde9c0) = v11 + -1;
          v2 = (short *)((long)(int)v8 * 2 + 0xde9c0);
          *v2 = *v2 + 2;
...
label_a780:
      if (v4) { // branch-flip
        if (v7 != v4) {
          sub_43b0(*(unsigned short *)((long)(int)v4 * 4 + 0xde9e0),*(unsigned short *)((long)(int)v4 * 4 + 0xde9e2));
          v9 = v3;
        }
...
long sub_add0(long a0,unsigned long a1,int a2,int a3)
{
  unsigned short v1;
  ...
  do {
    ...
    do {
      if (v8 <= v13) {
        ...
        sub_b3f0(a0,0xdfbc0,8,0xdf9a0); // tail-call
        return;
      }
      v10 = 3;
...
label_bc2a:
        ...
        sub_b3f0(0x1fe,0x5b000,0xc,0x4b000);
      }
      else {
        v4 = (unsigned int)dat_df994;
        sub_b320(9);
...
unsigned long sub_be90(unsigned int a0,unsigned int a1) // return-dupe x2
{
  ...
  dat_1a978 = 0;
  v14 = (unsigned long)(dat_1a008 * 8);
  v19 = 0x101 - (unsigned long)(dat_183e8 == 0);
  v25 = dat_1a00c;
  v7 = 0x1f;
  v11 = (unsigned long *)0x1a888;
  while (v7) {
    v1 = &v11[1];
    *v11 = 0;
    v7 -= 1;
...
label_bfec:
  ...
  v10 = (unsigned int)v5;
  v17 = v16;
  if (v13 <= v10) goto label_c258;
label_bff9:
  dat_1a00c = 0;
  v7 = 0x9c000;
label_c00a:
  v25 = sub_d190(a0,v7,0x40000);
  if (v25 == 0xffffffff)
    sub_d4e0(); // no-return
  dat_1a828 += (int)v25;
  dat_1a00c += v25;
...
label_c0a8:
  ...
  v14 += (long)(int)v24;
  v17 = (long)((unsigned long)*(unsigned char *)(v7 + 0x9c001) << 8 | (unsigned long)*(unsigned char *)(v7 + 0x9c002) << 0x10 | (unsigned long)*(unsigned char *)(v7 + 0x9c000)) >> (v2 & 7) & (unsigned long)v26;
...
label_c138:
    ...
    if (0x40000 <= v6) { // branch-flip
      ...
      memcpy((void *)((long)v15 + 0x5b000),v4,(long)(int)v7);
      v15 = v6;
    }
    v10 = dat_1a00c;
    if (v19 < v3) {
      v20 = (unsigned short)v16;
      *(unsigned short *)(v19 * 2 + 0x1a880) = v20;
      *(unsigned char *)(v19 + 0x3b000) = v2;
      v19 += 1;
    }
  }
  else {
    ...
    v15 += 1;
    *(char *)(v7 + 0x5b000) = (char)v17;
    v10 = dat_1a00c;
  }
  v16 = v17;
  dat_1a00c = v10;
  if (v23 <= (long)v14) {
    if (!v25) goto label_c3f5;
    v5 = (unsigned long)v10;
    goto label_bfec;
  }
  if (v22 < v19) goto label_c1e5;
  goto label_c0a8;
label_c1e5:
  v7 = v14 - 1;
label_c1ef:
...
char * sub_d2b0(unsigned int *a0,unsigned long *a1,char *a2)
{
  ...
  if (v2) {
    ...
    if (*v2) { // branch-flip
      ...
      *a0 = v6 + 1U;
      v4 = (unsigned long *)sub_f540((long)(v6 + 2),8);
      v7 = (unsigned long *)*a1;
      *a1 = v4;
      *v4 = *v7;
      v5 = v2;
...
void sub_d3f0(unsigned long a0)
{
...
void sub_d460(unsigned long a0) // return-dupe
{
  if (!dat_1a85c) {
...
void sub_d640(void)
{
  ...
  sub_d5a0(dat_1a010,0x3b000,dat_1a004);
  dat_1a004 = 0;
}
...
unsigned long sub_d6c0(int a0)
{
  ...
  dat_1a00c = 0;
  do {
    v1 = sub_d190(dat_1a014,v2 + 0x9c000,0x40000 - (int)v2);
    if (!v1) {
...
unsigned long sub_d770(unsigned int a0,int a1) // return-dupe
{
  ...
  *__errno_location() = 0;
  ...
  while( true ) {
    ...
    v2 = sub_d190(a0,0x9c000,0x40000);
...
void sub_d8a0(void *a0,unsigned long a1,int a2) // return-dupe
{
  char *v1;
  char v2;
  char *v3;
...
unsigned long sub_df80(unsigned long a0,unsigned int a1)
{
  unsigned int v1; // eax
...
unsigned long sub_e060(void *a0) // early-return
{
  int v1;
  int *v2; // rax
...
unsigned long sub_e430(unsigned int *a0,unsigned long a1,unsigned int a2) // return-dupe
{
  long v1; // rax
...
char * sub_e540(void *a0,unsigned int a1)
{
  unsigned long v1;
  long v10;
  char *v11;
    ...
    while( true ) {
      *v4 = 0;
      ...
      if (v3) {
        ...
        if (v14) { // branch-flip
          if (v12 == v15)
            v8 = (void *)sub_f440(v8,&v12,1,0xffffffffffffffff,8);
          v2 = v15 * 8;
          v15 += 1;
          *(unsigned long *)((long)v8 + v2) = sub_f640(v11);
        }
        else {
          if (v13 - v10 <= (long)v1)
...
void sub_ee70(unsigned long a0,unsigned long a1)
{
  sub_ea40(0xffffffff,a0,a1); // tail-call
}
...
void sub_f440(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_f4fe;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
void sub_f5a0(void *a0,unsigned long a1)
{
...
unsigned long sub_f6b0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,void *a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  unsigned long v1;
...
void sub_f830(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,unsigned long a6,unsigned long a7,unsigned long a8,unsigned long a9,unsigned long a10,unsigned long a11,unsigned long a12,unsigned long a13)
{
  char v1; // al
...
int * sub_f900(int *a0,unsigned long *a1,int *a2,unsigned long a3)
{
  unsigned long v1;
  unsigned long v10;
  unsigned long v11;
...
unsigned long sub_10a00(void *a0,unsigned long a1,unsigned long a2)
{
  unsigned long v1;
  char *v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_10c20(unsigned int *a0,long *a1) // return-dupe x2
{
  unsigned int v1;
  long v2;
  unsigned int *v3;
...
unsigned long sub_10e50(char *a0,unsigned long *a1,unsigned long *a2) // return-dupe
{
  unsigned char v1;
  unsigned long *v10;
  char *v11;
