...
void * localtime_r(void *a0,void *a1)
{
  ...
  v1 = (void *)(*dat_1afd0)(); // jump-as-call
  return v1;
}
...
void * readdir(void *a0)
{
  ...
  v1 = (void *)(*dat_1ae70)(); // jump-as-call
  return v1;
}
...
void getmntent(void)
{
  (*dat_1ae90)(); // jump-as-call
}

// Function: setmntent @ 0x3a10
void setmntent(void)
{
  (*dat_1ae98)(); // jump-as-call
}
...
void * fopen(char *a0,char *a1)
{
  ...
  v1 = (void *)(*dat_1af08)(); // jump-as-call
  return v1;
}
...
void * fdopendir(int a0)
{
  ...
  v1 = (void *)(*dat_1af20)(); // jump-as-call
  return v1;
}
...
void sub_5250(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_1afc0)(sub_3c50,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_5b20(unsigned long a0,unsigned long a1,long a2)
{
  char *v1; // rax
...
void sub_5bb0(long *a0,void *a1,unsigned long a2)
{
  long v1;
  char *v2;
  void *v3;
  ...
  while (v1) {
    if ((v4) && (!memcmp(v5,a1,a2)))
      __fprintf_chk(stderr,1,", %s",sub_10ef0(v1));
    else {
...
long sub_5ce0(unsigned long a0,char *a1,unsigned long *a2,unsigned long a3,unsigned long a4,void *a5,char a6) // early-return
{
  char *v1;
  long v2;
...
void sub_5e10(unsigned long a0) // return-dupe
{
  unsigned long *v1; // rax
...
long sub_5e80(long *a0,int *a1) // early-return x2
{
  long *v1;
  long v2;
  void *v3;
...
{
  sub_c280(*(unsigned long *)((long)a0 + 8));
  free(a0); // tail-call
}

// Function: sub_6080 @ 0x6080
long sub_6080(unsigned long *a0,long a1) // early-return
{
  long *v1; // rax
  long *v2;
  long v3;
  ...
  *v2 = a1;
  v1 = (long *)sub_c720(*a0,v2);
  if (!v1)
    return 0;
  if (v2 == v1) {
    a0[2] = 0;
    v3 = sub_c0c0(0x3fd,0,sub_6050,0,0);
    v2[1] = v3;
    return v3;
  }
  v3 = v1[1];
...
long * sub_6130(void)
{
  ...
  v3 = v1;
  if (v1) {
    v2 = sub_c0c0(0xb,0,sub_6030,sub_6040,sub_6060);
    *v1 = v2;
    if (v2) { // branch-flip
      v1[1] = 0;
      v1[2] = 0;
...
unsigned long sub_61d0(long a0,unsigned long a1,long a2)
{
  long v1; // rax
  long v2;
  ...
  if (0x7ffffffffffffffe <= (unsigned long)(a2 - 1U)) {
    v2 = *(long *)(a0 + 8);
    if (!v2) {
      v2 = sub_d7e0(0x7fffffffffffffff);
      *(long *)(a0 + 8) = v2;
      if (!v2)
        return 0xffffffff;
    }
  ...
  return sub_c4f0(v1,a2,0); // tail-call
}

// Function: sub_6260 @ 0x6260
unsigned long sub_6260(long a0,unsigned long a1,long a2)
{
  long v1; // rax
  long v2;
...
unsigned long sub_6360(char *a0,char *a1,unsigned int a2) // early-return
{
  int v1; // eax
  unsigned int v2; // eax
...
label_6523:
      ...
      if (!(*(unsigned int *)((unsigned long)(*v10 >> 5) * 4 + 0x15b40) >> (*v10 & 0x1f) & 1)) {
        if (!mbsinit(&v5))
...
void sub_6700(long a0,unsigned long a1)
{
  unsigned long v1;
  unsigned long *v2; // rax
  
  v2 = (unsigned long *)sub_11c80(0x10);
...
void sub_6810(unsigned long *a0)
{
  unsigned int *v1;
  long *v2;
  unsigned long *v3;
...
void sub_6b70(long *a0,char *a1,unsigned int a2) // return-dupe x2
{
  unsigned int *v1;
  void *v10;
  char *v11;
  ...
  if ((!(a2 & 0x18000000)) || (!sub_6730(a1,a2))) {
    if (((!v4) || (*(int *)&v4[1])) || ((*(unsigned int *)((long)v4 + 0xc) ^ a2) & 0x60000018)) {
      ...
      *(unsigned int *)((long)v4 + 0xc) = a2;
      ...
      v4[2] = sub_c0c0(0,0,v13,v10,sub_6300);
      v17 = *a0;
      *a0 = (long)v4;
      *v4 = v17;
    }
...
label_6d4b:
  ...
  v8 = v4[2];
  if (v17 == v4[3]) {
    v8 = sub_11f60(v8,&v4[3],1,0xffffffffffffffff,0x48);
    v17 = v4[4];
    v4[2] = v8;
  }
  v4[4] = v17 + 1;
  ...
  *v1 = a2;
  ...
  if (a2 & 8) { // branch-flip
    ...
    if (0 < (long)v5) {
      do {
        v15 = v5;
        if (a1[v5 - 1] != '/') goto label_6c51;
        v5 -= 1;
      } while (v5);
      goto label_6ca6;
    }
    v15 = v5;
    if (!v5) goto label_6ca6;
label_6c51:
    v6 = (void *)sub_11ca0(v15 + 7);
    memcpy(v6,a1,v5);
...
int sub_6eb0(void *a0,long a1,void *a2,unsigned int a3,unsigned char a4,unsigned long a5)
{
  unsigned long v1;
  unsigned char *v10;
  int v11; // stack - 0x5c
  ...
  while( true ) {
    ...
    if (v2 == -1) break;
    if (v6 == v9)
      v3 = sub_11f60(v3,&v6,1,0xffffffffffffffff,1);
    *(char *)(v3 + v9) = (char)v2;
    v9 += 1;
  }
  v11 = ferror(a2);
  ...
  if (v9) { // branch-flip
    ...
    v5 = (unsigned long *)sub_11c80(0x10);
        ...
        if (*v10 == a4) {
          ...
          if (*(unsigned short *)(v3 + (unsigned long)a4 * 2) & 0x2000) { // branch-flip
            for (; v4 != v10; v10 = &v10[-1]) {
              if (!(*(unsigned char *)(v3 + 1 + (unsigned long)v10[-1] * 2) & 0x20)) goto label_706d;
            }
          }
          else {
label_706d:
...
unsigned int sub_70c0(unsigned long a0,unsigned long a1,char *a2,unsigned int a3,char a4) // return-dupe
{
  int v1;
  unsigned int v2; // eax
  void *v3; // rax
...
unsigned long sub_71a0(void *a0) // early-return
{
  int v1;
  int *v2; // rax
...
unsigned long sub_7280(void *a0,unsigned char *a1,unsigned int *a2,char a3,unsigned int a4,int a5,unsigned long a6,int a7)
{
  char *v1;
  char v10;
  bool v11;
  ...
  unsigned char *v23;
  long v24;
  char v25; // stack - 0x44b
  char v26 [23];
  unsigned short v27; // stack - 0x44d
  long v28;
  unsigned long v29; // stack - 0x488
  unsigned int v3;
  unsigned char v30 [1010];
  char v31; // sil
  unsigned int v32;
  int v33;
  unsigned int v34;
  ...
  unsigned char *v47; // stack - 0x4b8
  unsigned long v48; // stack - 0x4a8
  char v49; // stack - 0x4a0
  bool v5;
  ...
  v34 = a2[2];
  v2 = *v44;
  v12 = (unsigned char *)0x160e1;
  if (*(unsigned char **)&a2[0xc])
    v12 = *(unsigned char **)&a2[0xc];
  if (0xd <= (int)v34) // branch-flip
    v45 = v34 - 0xc;
  else {
    v45 = 0xc;
    if (v34)
...
label_7313:
  ...
  if (v20 - 0x30 <= 9) {
    ...
    do {
      v24 = (long)(int)v38 * 10;
      v37 = (int)v24;
      if ((v37 != v24) || (v38 = (unsigned long)(unsigned int)(v37 + (char)*v23 + -0x30), SCARRY4(v37,(char)*v23 + -0x30)))
        v38 = 0x7fffffff;
      v20 = (unsigned int)(char)v23[1];
      v23 = &v23[1];
      v32 = v20;
    } while (v20 - 0x30 <= 9);
  }
...
label_89ef:
    ...
    case 0x43:
      if (v32 != 0x45) {
        v20 = a2[5];
        v43 = (int)v20 < -0x76c;
        v22 = (int)((-(unsigned int)(v20 + 0x76c < 0x76c) & 0xffffff9d) + v20) / 100 + 0x13;
        v11 = -0x76c <= (int)v20;
        if (!v34)
          v34 = a4;
...
label_8a70:
    ...
    case 0x46:
      ...
      v16 = 4;
      v38 = sub_7280(0,"%Y-%m-%d",a2,v10,0x2b,4,v9,v33);
      v34 = 0x2b;
      v47 = "%Y-%m-%d";
      v13 = 0;
      v46 = v38;
    ...
    case 0x67:
      if (v32 != 0x45) {
        ...
        v4 = a2[5];
        v16 = (v20 - v3) + 0x17e;
        v22 = (v4 - 100) + ((int)v4 >> 0x1f & 400U);
        v16 = (v20 - v16) + 3 + (v16 / 7) * 7;
        if (0 <= v16) { // branch-flip
          v36 = 0x16d;
          if ((!(v22 & 3)) && (v36 = 0x16e, (v22 * -0x3d70a3d7 + 0x51eb850 >> 2 | v4 * 0x40000000) <= 0x28f5c28))
            v36 = 0x16e - (unsigned int)((int)v22 % 400 != 0);
          v21 = ((v20 - v36) - v3) + 0x17e;
          v36 = ((v20 - v36) - v21) + 3 + (v21 / 7) * 7;
          if (0 <= v36)
            v16 = v36;
          v36 = (v36 >> 0x1f) + 1;
        }
          ...
          v22 -= 1;
          v16 = 0x16d;
          if ((!(v22 & 3)) && (v16 = 0x16e, (v22 * -0x3d70a3d7 + 0x51eb850 >> 2 | v22 * 0x40000000) <= 0x28f5c28))
            v16 = 0x16e - (unsigned int)((int)v22 % 400 != 0);
          v21 = ((v16 + v20) - v3) + 0x17e;
          v36 = -1;
          v16 = ((v16 + v20) - v21) + 3 + (v21 / 7) * 7;
        }
        if (v31 == 'G') {
          v22 = v4 + 0x76c + v36;
          v43 = (int)v4 < 0xfffff894U - v36;
          if (v34) { // branch-flip
label_8a59:
            v47._0_4_ = 4;
            v20 = 9999;
...
label_8ce5:
        ...
        v22 = ((int)v4 % 100 + v36) % 100;
        if (0 <= (int)v22) goto label_78c0;
        if ((int)v4 < 0xfffff894U - v36) {
          v22 = -v22;
...
label_8a1a:
    ...
    case 0x54:
      ...
      v47 = "%H:%M:%S";
label_808e:
      v38 = sub_7280(0,v47,a2,v10,v34,v16,v9,v33);
      if ((v34 != 0x2d) && (0 <= v37)) {
        v13 = (unsigned long)v37;
        v46 = v13;
        if (v13 <= v38)
...
label_80e8:
      ...
      if (a0) {
        ...
        sub_7280(a0,v47,a2,v10,v34,v16,v9,a7);
      }
      v42 += v46;
      goto label_735f;
    case 0x55:
...
label_7c2e:
    ...
    case 0x57:
      if (v32 != 0x45) {
        v16 = (((int)(a2[6] + 6) / 7) * 7 - (a2[6] + 6)) + 7 + a2[7];
        goto label_7c2e;
      }
      break;
    case 0x58:
        ...
        if (v19) { // branch-flip
          if (v38) {
            ...
            do {
              v15 = *v41;
              v41 = &v41[1];
              fputc(*(int *)(*v14 + (unsigned long)v15 * 4),a0);
            } while (v41 != &v12[v38]);
          }
        }
        else if (v10) { // branch-flip
          if (v38) {
            v14 = __ctype_toupper_loc();
            v41 = v12;
            do {
              v15 = *v41;
              v41 = &v41[1];
...
label_7621:
      ...
      goto label_7626;
    case 0x73:
      v53 = *(unsigned long *)&a2[8];
      v54 = *(unsigned long *)&a2[10];
      v29 = *(unsigned long *)a2;
      v50 = *(unsigned long *)&a2[2];
      v51 = *(unsigned long *)&a2[4];
      v55 = *(unsigned long *)&a2[0xc];
      v52._0_4_ = (unsigned int)*(unsigned long *)&a2[6];
      v52 = CONCAT44(0xffffffff,(unsigned int)v52);
      v24 = sub_113a0(v9,&v29);
      if (v52 <= -1) {
        *v44 = 0x4b;
        return 0;
      }
      v43 = SUB81((unsigned long)v24 >> 0x3f,0);
      v41 = &v30[1];
      v18 = v24;
      do {
        v6 = v18 / 10;
        v19 = (char)v18 + (char)v6 * '\xf6';
        if (v24 <= -1)
          v19 = -v19;
        v41 = &v41[-1];
        *v41 = v19 + 0x30;
...
label_7b80:
      v5 = 0;
      v20 = 0;
      v15 = (unsigned char)(v22 >> 0x18);
      v43 = (bool)(v15 >> 7);
      v11 = (bool)((unsigned char)~v15 >> 7);
      goto label_78f0;
    case 0x77:
      if (v32 != 0x45) {
        v47._0_4_ = 1;
...
label_78ed:
    ...
    case 0x7a:
      v38 = 0;
label_8483:
      if ((int)a2[8] < 0) goto label_735f;
      v43 = 1;
      v16 = (int)*(unsigned long *)&a2[10];
      if ((0 <= v16) && (v43 = 0, !v16))
        v43 = *v12 == 0x2d;
      v22 = v16 / 0xe10;
      v36 = (v16 / 0x3c) % 0x3c;
...
label_8baf:
        ...
        v47._0_4_ = 9;
        v20 = 0x14;
        v22 = v16 % 0x3c + v22 * 10000 + v36 * 100;
        v11 = (bool)(v43 ^ 1);
      }
label_78f0:
      if ((v32 != 0x4f) || (!v11)) {
...
label_7f40:
        ...
        while( true ) {
          ...
          v20 = (int)v20 >> 1;
          v41 = &v39[-1];
          v39[-1] = (char)v22 + (char)(v22 / 10) * '\xf6' + 0x30;
          if ((v22 <= 9) && (!v20)) break;
          v22 /= 10;
          v39 = v41;
        }
...
label_8675:
          ...
          v13 = (unsigned long)v33;
          v42 += 1;
          v38 = 0;
          if ((v22 != 0x2d) && (v37 = v37 + -1, 0 <= v37)) {
label_7d87:
          ...
          v13 = (unsigned long)v33;
          if (((v33 < v37) && (v34 != 0x2d)) || (v38 = 0, v22 != 0x2d)) goto label_7d87;
        }
        v40 = (unsigned long)v33;
        if (~v42 <= v13) goto label_7388;
        if (a0) {
          if (v40 < v38) {
            if ((v22 != 0x30) && (v24 = 0, v22 != 0x2b)) {
              do {
                v24 += 1;
                fputc(0x20,a0);
              } while (v38 - v40 != v24);
...
label_7643:
      ...
      *v17 = v31;
      v1 = &v26[1];
      v17[1] = '\0';
      v38 = strftime(v1,0x400,(char *)&v27,a2);
      if (v38) {
        v13 = v38 - 1;
        v48 = v13;
        if ((v34 != 0x2d) && (0 <= v37)) {
        ...
        if (a0) {
          ...
          if (v49) { // branch-flip
            if (v13) {
              v14 = __ctype_tolower_loc();
              v41 = (unsigned char *)&v26[2];
              do {
                v15 = *v41;
                v41 = &v41[1];
                fputc(*(int *)(*v14 + (unsigned long)v15 * 4),a0);
              } while (v41 != (unsigned char *)&v1[v38]);
            }
          }
          else if (v10) { // branch-flip
            if (v13) {
...
label_7770:
  ...
  if ((unsigned char *)~v42 <= v47) goto label_7388;
  if (a0) {
    if (v41 < v39) {
      if ((v34 != 0x30) && (v34 != 0x2b)) {
        v24 = 0;
...
label_7a00:
    ...
    do {
      v17 = &v17[-1];
      *v17 = (char)v16 + (char)(v16 / 10) * '\xf6' + '0';
      v16 /= 10;
    } while (v17 != &v26[v38 - (unsigned int)(v36 - 1)]);
  }
  else {
    v13 = 0;
  }
  ...
  if (a0) { // branch-flip
    if (!v10) {
      fwrite(&v26[1],v13,1,a0);
      goto label_7aec;
    }
    if (v13) {
      v14 = __ctype_toupper_loc();
      v39 = (unsigned char *)&v26[1];
      v41 = &v39[v13];
      do {
        v15 = *v39;
        v39 = &v39[1];
...
long sub_8e20(unsigned long a0,unsigned long a1,void *a2)
{
  bool v1;
  int v2; // eax
  int v3;
...
unsigned long sub_90f0(unsigned int *a0,unsigned long a1,unsigned int a2) // return-dupe
{
  long v1; // rax
...
unsigned long sub_9170(long *a0,long *a1)
{
  if (a0[1] != a1[1])
    return 0;
  return CONCAT71((undefined7)((unsigned long)*a1 >> 8),*a0 == *a1);
...
unsigned long sub_91a0(long a0,unsigned long a1)
{
...
int sub_9200(long a0,long a1,char a2) // early-return x3
{
  void *v1;
  unsigned long *v2;
  char *v3;
...
long sub_93b0(long a0,long a1,unsigned long a2)
{
  unsigned long v1;
  long *v2;
  unsigned long v3;
...
void * sub_94c0(long a0,void *a1,unsigned long a2)
{
  unsigned long v1;
  void *v2; // rax
...
unsigned long sub_9560(long a0,int a1)
{
  long v1;
  long v2;
  unsigned long *v3; // rax
  ...
  if (!(*(unsigned char *)(v1 + 0x49) & 2))
    return 0;
  if (!v2) {
    v2 = sub_c0c0(0xd,0,sub_91c0,sub_91d0,dat_1afb8);
    *(long *)(v1 + 0x50) = v2;
  ...
  if ((0 <= a1) && (!fstatfs(a1,v6))) {
    if ((v2) && (v3 = malloc(0x10), v3)) {
      *v3 = *(unsigned long *)(a0 + 0x70);
      v3[1] = v6[0];
      v4 = (unsigned long *)sub_c720(v2,v3);
      if (v4) { // branch-flip
        if (v3 != v4)
          abort(); // no-return
      }
...
void sub_9690(long a0,int a1,char a2)
{
  int v1;
...
unsigned long sub_96f0(long a0,long a1)
{
  void *v1; // rax
...
unsigned long sub_9760(long a0)
{
  long v1; // rax
  void *v2; // rax
  
  if (*(unsigned int *)(a0 + 0x48) & 0x102) {
    v1 = sub_c0c0(0x1f,0,sub_91a0,sub_9170,dat_1afb8);
    *(long *)(a0 + 0x58) = v1;
...
unsigned long sub_97d0(long a0,unsigned long *a1) // return-dupe x2
{
  unsigned long v1;
  unsigned long *v2; // rax
  unsigned long *v3; // rax
  ...
  if (!(*(unsigned int *)(a0 + 0x48) & 0x102)) {
    v4 = sub_136b0(*(unsigned long *)(a0 + 0x58),&a1[0xe]);
    if (!(char)v4)
      return 1;
    *a1 = a1;
  ...
  *v2 = v4;
  v2[1] = a1[0xf];
  v3 = (unsigned long *)sub_c720(v1,v2);
  if (v2 == v3)
    return 1;
  free(v2);
  if (v3) {
...
void sub_9880(long a0,long a1)
{
  ...
  if (*(unsigned int *)(a0 + 0x48) & 0x102) { // branch-flip
    ...
    v4 = (void *)sub_c780(*(unsigned long *)(a0 + 0x58),&v5);
    if (!v4)
...
unsigned int sub_99d0(long a0,long a1,int a2,char *a3) // return-dupe
{
  unsigned int v1;
...
label_9d32:
    ...
    v13 = sub_eac0(v6,*(unsigned long *)(v2 + 0x30),v7,&v17);
    *(long *)(v2 + 0x18) = v13;
    if (!v13) {
      if (a1 == 3) {
        *(unsigned short *)(v2 + 0x68) = 4;
    ...
    if (*(short *)(v2 + 0x68) != 0xb) { // branch-flip
      ...
      *(unsigned short *)(v2 + 0x68) = sub_9200(a0,v2,0);
    }
    v27 = (char *)((unsigned long)(-(unsigned int)(a0[8] == 0) & 0x186a1) - 1);
    if (a1 == 2) {
label_a560:
      v22 = 0;
      v15 = *(unsigned int *)&a0[9];
...
label_a205:
      ...
      v13 = sub_9560(v2,v17);
      v7 = v17;
      if (v13 == 0x9fa0) goto label_a205;
      if (v13 <= 0x9fa0) {
        if ((v13) && (v13 != 0x6969)) goto label_a3a1;
        goto label_a205;
      }
      if ((v13 == 0x5346414f) || (v13 == 0xff534d42)) goto label_a205;
label_a3a1:
    ...
    if ((0 <= v7) && (!sub_99d0(a0,v2,v7,0))) goto label_9d32;
    if ((v22) && (v3))
      *(int *)(v2 + 0x40) = *__errno_location();
...
label_9e04:
        v19 = *(void **)(v2 + 0x18);
        if (!v19) goto label_a40e;
      }
      v10 = strlen((char *)((long)v9 + 0x13));
      v11 = (void *)sub_94c0(a0,(char *)((long)v9 + 0x13),v10);
      if (!v11) {
label_a2a8:
        v7 = *v8;
        free(v11);
...
label_a40e:
    ...
    if (*(unsigned char *)&a0[9] & 4) {
      if ((a0[6] == v23) || (!v20)) goto label_a42b;
label_a431:
      *v26 = 0;
    }
    if ((!v14) && (v22)) {
      if ((a1 != 1) && (v20)) goto label_a45c;
      goto label_a4b0;
    }
  }
  else {
...
label_a42b:
    ...
    v25 = NULL;
    if (!(bool)(v22 & v14 == NULL)) goto label_a4d5;
    v3 = 0;
    v20 = NULL;
label_a4b0:
    if (*(long *)(v2 + 0x58)) // branch-flip
      v7 = sub_99d0(a0,*(unsigned long *)(v2 + 8),0xffffffff,"..");
    else {
      v7 = sub_9940(a0);
    }
    if (v7) {
...
label_a45c:
  ...
  if (v20 == (char *)0x1)
    return v25;
  return (void *)sub_93b0(a0,v25,v20);
}
...
unsigned int sub_abe0(long *a0) // return-dupe
{
  void *v1;
  long v2;
  int v3; // eax
  ...
  if (*(unsigned int *)&a0[9] & 0x200) { // branch-flip
    ...
    if (fchdir((int)v2)) { // branch-flip
      ...
      v6 = *v4;
      v3 = close((int)a0[5]);
      if ((v6) || (!v3)) goto label_ac9c;
    }
    else {
      v2 = a0[5];
      if (!close((int)v2)) goto label_ac99;
      v4 = __errno_location();
    }
    v6 = *v4;
    goto label_ac9c;
          ...
          if (*(short *)((long)v12 + 0x68) != 0xb) {
            *(char *)(a0[4] + *(long *)((long)v12 + 0x48)) = 0;
            if (*(long *)((long)v12 + 0x58)) { // branch-flip
              ...
              v8 = sub_99d0(a0,*(unsigned long *)((long)v12 + 8),0xffffffff,"..");
            }
            else {
              v8 = sub_9940(a0);
            }
        ...
        *(short *)((long)v12 + 0x68) = v7;
        if ((v7 == 1) && (v3 = *(unsigned int *)&a0[9], !(v3 & 4))) {
          if (v3 & 0x200) // branch-flip
            v8 = sub_ea40(*(unsigned int *)((long)a0 + 0x2c),".");
          else {
            v8 = sub_139b0(".",(v3 & 0x10) << 0xd | 0x90900);
          }
...
label_afc2:
      ...
      if ((void *)a0[1]) { // branch-flip
        ...
        if (sub_99d0(a0,v9,0xffffffff,v4)) { // branch-flip
          v8 = *__errno_location();
...
unsigned long sub_b520(unsigned long a0,long a1,unsigned int a2)
{
  if (a2 <= 4) {
...
int * sub_b550(long *a0,unsigned int a1) // early-return x2
{
  unsigned int v1;
  long v2;
  void *v3;
  ...
  *v7 = 0;
  ...
  if (((*(long *)(v2 + 0x58)) || (**(char **)(v2 + 0x30) == '/')) || (v1 = *(unsigned int *)&a0[9], v1 & 4)) {
    v7 = (long)sub_9cd0(a0,v8);
    a0[1] = (long)v7;
  }
  else {
    if (v1 & 0x200) { // branch-flip
      v6 = sub_ea40(*(unsigned int *)((long)a0 + 0x2c),".");
      v9 = v6;
    }
    else {
...
unsigned long sub_b920(float a0,unsigned long a1,char a2) // ternary
{
  char v1 [16];
  unsigned long v2; // rax
...
bool sub_bc60(unsigned long *a0)
{
  long v1;
  long *v2;
  long v3;
...
long sub_bea0(unsigned long *a0)
{
  long *v1;
...
void sub_bf80(unsigned long *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
void sub_c090(unsigned long *a0)
{
  *(char *)&a0[2] = 0;
...
unsigned long sub_d520(char *a0,unsigned int *a1,long *a2) // early-return x4
{
  char *v1;
  char v2;
  int v3; // eax
  ...
  v3 = sub_59b0(a0,0x1aa40,0x15b10,4);
  if (0 <= v3) {
    *a2 = 1;
...
void sub_d710(unsigned int *a0,unsigned int a1)
{
...
char sub_d730(long a0)
{
  return *(char *)(a0 + 0x1c);
}

// Function: sub_d740 @ 0xd740
unsigned int sub_d740(long a0,unsigned int a1)
{
  unsigned int v1;
  unsigned int v2; // eax
  unsigned int v3; // edx
...
long * sub_d7e0(long a0)
{
  ...
  v3 = v1;
  if (v1) {
    v2 = sub_c0c0(0x3fd,0,sub_d7c0,sub_d7d0,dat_1afb8);
    *v1 = v2;
    if (v2) { // branch-flip
      v1[1] = a0;
      v1[2] = 0;
...
void sub_d850(unsigned long *a0)
{
  sub_c280(*a0);
  free((void *)a0[2]);
  free(a0); // tail-call
...
char * sub_d920(unsigned long a0,long a1)
{
  unsigned long v1;
  char *v2;
  char *v3; // r8
...
void sub_d9f0(long *a0,long *a1) // return-dupe
{
  long v1;
  long *v2;
...
unsigned long sub_da70(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
...
void sub_db00(char *a0)
{
  ...
  v4 = sub_da70(&a0[0x24],v2,sub_10f10(v2,v3),&a0[4]);
  *(long *)&a0[0x18] = v4;
  if (v4 == -1) {
    a0[0x18] = '\x01';
    a0[0x19] = '\0';
                ...
                *v6 = '\0';
                ...
                if (v7) {
                  *v7 = '\0';
                  ...
                  sub_def0(v20);
                  sub_def0(v5);
                  v8 = (unsigned long *)sub_11c80(0x38);
                  *v8 = sub_12160(v6);
                  v21 = 1;
                  v8[1] = sub_12160(v4);
                  v8[2] = sub_12160(v20);
                  v4 = (char *)sub_12160(v5);
                  v8[3] = v4;
...
label_e40b:
                      ...
                      if (strcmp(v4,"smbfs")) {
                        ...
                        if (strcmp(v4,"smb3")) {
                          v21 = 1;
                          if (strcmp(v4,"cifs")) goto label_e40b;
                        }
                      }
                    }
                  }
    ...
    if (sub_71a0(v3) != -1) goto label_e256;
  }
  else {
    ...
    while (v8 = (unsigned long *)getmntent(v10), v8) {
      ...
      v12 = (unsigned long *)sub_11c80(0x38);
      v13 = sub_12160(*v8);
      v1 = v8[1];
      *v12 = v13;
      v13 = sub_12160(v1);
...
void sub_e9f0(unsigned long *a0)
{
  free((void *)*a0);
  free((void *)a0[1]);
  free((void *)a0[2]);
...
void * sub_eac0(unsigned long a0,unsigned long a1,unsigned int a2,int *a3)
{
  int v1;
  int v2; // eax
  void *v3; // rax
    ...
    if (v27) {
      ...
      if (v23) {
        ...
        if (v31) {
          ...
          if ((a3 < v24 + v31) || (v9 = memcmp(v12,v32,v31), v9)) goto label_f780;
          if (!v26) {
            v8 = *v12;
...
label_f824:
          if ((char)v19 == '\\') {
            if (((bool)(v2 & v26)) && (v31)) goto label_f84a;
            v17 = 0x5c;
            goto label_f272;
          }
label_f053:
          v17 = (unsigned char)v19;
          if (v34 != 1) goto label_f5d3;
label_f060:
          v10 = __ctype_b_loc();
          v22 = 1;
...
label_ef48:
    v17 = (unsigned char)v22;
    v13 = v14;
    if (!v30) goto label_f0f3;
    if (!(*(unsigned int *)(v30 + (v22 >> 5) * 4) >> (v17 & 0x1f) & 1)) goto label_f0f3;
  }
  else {
label_f0f0:
    v8 = 0;
...
void * sub_10130(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_1b078 <= (int)a0) {
      v10 = (long)dat_1b078;
      v9 = (long)(int)((a0 - dat_1b078) + 1);
      if (dat_1b080 != (unsigned long *)0x1b090) // branch-flip
        v6 = (unsigned long *)sub_11f60(dat_1b080,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_11f60(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_1b090;
        v6[1] = dat_1b098;
      }
      dat_1b080 = v6;
      memset(&v6[(long)dat_1b078 * 2],0,(v10 - dat_1b078) * 0x10);
      dat_1b078 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_eca0(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x1b1c0)
        free(v8);
      v8 = (void *)sub_11cc0(v7);
      v4 = *a3;
      v1[1] = (unsigned long)v8;
      sub_eca0(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
unsigned int sub_103e0(long a0,unsigned int a1)
{
  unsigned int v1;
...
void sub_10440(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_eca0(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_104c0 @ 0x104c0
unsigned long sub_104c0(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_eca0(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_11cc0(v3 + 1);
  sub_eca0(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_105b0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_104c0(a0,a1,0,a2); // tail-call
}
...
void sub_10660(unsigned long a0,unsigned long a1)
{
  sub_10130(a0,a1,0xffffffffffffffff,0x1b2c0); // tail-call
}
...
void sub_10690(unsigned long a0)
{
  sub_10130(0,a0,0xffffffffffffffff,0x1b2c0); // tail-call
}

// Function: sub_106b0 @ 0x106b0
void sub_106b0(unsigned long a0,unsigned long a1)
{
  sub_10130(0,a0,a1,0x1b2c0); // tail-call
}

// Function: sub_106d0 @ 0x106d0
void sub_106d0(unsigned long a0,int a1,unsigned long a2)
{
...
void sub_10770(unsigned long a0,int a1,unsigned long a2,unsigned long a3)
{
  int v1 [14]; // stack - 0x48
...
void sub_10800(int a0,unsigned long a1)
{
  int v1 [14]; // stack - 0x48
...
void sub_10890(int a0,unsigned long a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_10920(unsigned long a0,unsigned long a1,unsigned char a2)
{
  unsigned int *v1;
  unsigned int v2;
...
void sub_109c0(unsigned long a0,unsigned char a1)
{
  unsigned int *v1;
  unsigned int v2;
  unsigned long v3; // stack - 0x48
...
void sub_10a60(unsigned long a0)
{
...
void sub_10af0(unsigned long a0,unsigned long a1)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned int v3; // stack - 0x3c
...
void sub_10b80(unsigned long a0,int a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_10c20(unsigned long a0,long a1,long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
...
void sub_10cc0(unsigned int a0,long a1,long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_10d60(long a0,long a1,unsigned long a2)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_10e00(long a0,long a1,unsigned long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_10eb0(unsigned long a0,unsigned long a1)
{
  sub_10130(0,a0,a1,0x1b040); // tail-call
}

// Function: sub_10ed0 @ 0x10ed0
void sub_10ed0(unsigned long a0,unsigned long a1)
{
  sub_10130(a0,a1,0xffffffffffffffff,0x1b040); // tail-call
}

// Function: sub_10ef0 @ 0x10ef0
void sub_10ef0(unsigned long a0)
{
  sub_10130(0,a0,0xffffffffffffffff,0x1b040); // tail-call
}
...
unsigned long sub_11080(long *a0,char *a1) // return-dupe
{
  char *v1;
  long *v2;
  int v3; // eax
...
void * sub_112f0(long a0,void *a1,void *a2) // return-dupe x3
{
  long v1; // rax
  ...
  if (!v1)
    return NULL;
  if ((!localtime_r(a1,a2)) || (!sub_11080(a0,a2))) {
    if (v1 == 1)
      return NULL;
    sub_10f50(v1);
    return NULL;
  }
  if ((v1 != 1) && (!sub_10f50(v1)))
    return NULL;
  return a2;
}
...
void sub_114f0(long a0)
{
  *(unsigned int *)(a0 + 0x20) = 0;
  sub_13040(a0,dat_1afd8,0x1b2f8); // tail-call
}
...
long sub_11570(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
  unsigned long v10; // stack - 0x48
  char *v2; // rax
...
void sub_11a10(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_11ab0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  long v1;
  unsigned long v2;
  long v3 [4];
...
void sub_11f60(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_1201e;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
void sub_121c0(unsigned long a0,unsigned int a1)
{
  if (sub_a7c0(a0,a1 | 0x200))
    return;
...
bool sub_12210(long a0,long a1)
{
  unsigned int v1; // eax
  bool v2; // r8b
...
unsigned int sub_12910(unsigned char *a0,long *a1,unsigned int a2,unsigned long *a3,char *a4)
{
  ...
  *v23 = 0;
  ...
  if (v24 != a0) { // branch-flip
    ...
    v27 = *v24;
    if (!v27) goto label_129cd;
    v28 = v25;
    if (!strchr(a4,(int)(char)v27)) goto label_129d5;
  }
  else {
    if ((!a4) || (v27 = *a0, !v27))
      return 4;
...
label_129d5:
    ...
    case 0x25:
      ...
      v15._8_8_ = 0;
      v15._0_8_ = v26;
      if ((SUB168(v5._0_16_ * v15._0_16_,8)) || (v6._8_8_ = 0, v6._0_8_ = SUB168(v5._0_16_ * v15._0_16_,0), v16._8_8_ = 0, v16._0_8_ = v26, v25 = SUB168(v6._0_16_ * v16._0_16_,0), SUB168(v6._0_16_ * v16._0_16_,8))) goto label_12b99;
label_12b67:
      v4._8_8_ = 0;
      v4._0_8_ = v25;
      v14._8_8_ = 0;
    ...
    case 0x29:
      ...
      if (SUB168(v2._0_16_ * v12._0_16_,8)) goto label_12b99;
      break;
    case 0xb:
    case 0x2b:
      v3._8_8_ = 0;
      ...
      if (!SUB168(v3._0_16_ * v13._0_16_,8)) goto label_12b67;
label_12b99:
      v32 = 1;
      v25 = 0xffffffffffffffff;
      break;
...
void sub_135f0(unsigned long a0)
{
  tzset();
  sub_13040(a0,dat_1afd0,0x1b300); // tail-call
}

// Function: sub_13620 @ 0x13620
unsigned long sub_13620(unsigned int *a0) // early-return x2, return-dupe
{
  unsigned int v1;
  unsigned long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_136b0(long *a0,long *a1)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
