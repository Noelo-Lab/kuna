...
void * opendir(char *a0)
{
  ...
  v1 = (void *)(*dat_24d60)(); // jump-as-call
  return v1;
}
...
void * getpwuid(unsigned int a0)
{
  ...
  v1 = (void *)(*dat_24d68)(); // jump-as-call
  return v1;
}
...
void * getpwnam(char *a0)
{
  ...
  v1 = (void *)(*dat_24e58)(); // jump-as-call
  return v1;
}
...
void * getgrnam(char *a0)
{
  ...
  v1 = (void *)(*dat_24e80)(); // jump-as-call
  return v1;
}
...
void * readdir(void *a0)
{
  ...
  v1 = (void *)(*dat_24ea0)(); // jump-as-call
  return v1;
}
...
void sub_6820(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_24fb8)(sub_4d10,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_6fb0(long a0,long a1,char a2)
{
  unsigned long *v1; // rax
  unsigned long v2;
...
unsigned char sub_75b0(char a0,unsigned int a1,int a2)
{
  unsigned int v1; // ecx
  bool v2;
...
void sub_76b0(char a0) // return-dupe
{
  unsigned int *v1; // rbx
  ...
  if (a0) {
    ...
    v6 = 0x14;
    v5 = (int *)0x1a664;
    sigemptyset((void *)0x26220);
    while( true ) {
      sigaction(v6,NULL,&v3);
      if (v3 != (void *)0x1)
        sigaddset((void *)0x26220,v6);
      if (v5 == (int *)0x1a690) break;
      v6 = *v5;
      v5 = &v5[1];
    }
    v23 = 0x10000000;
    ...
    v22 = dat_26298;
    while( true ) {
      if (sigismember(0x26220,v6)) {
        v3 = sub_6940;
        if (v6 == 0x14)
          v3 = sub_7520;
        sigaction(v6,&v3,NULL);
      }
      if (v2 == (int *)0x1a690) break;
      v6 = *v2;
      v2 = &v2[1];
    }
    return;
  }
  v1 = (unsigned int *)0x1a664;
  v4 = 0x14;
  while( true ) {
    if (sigismember(0x26220,v4))
      signal(v4,0);
    if (v1 == (unsigned int *)0x1a690) break;
    v4 = *v1;
    v1 = &v1[1];
  }
}
...
unsigned long sub_7920(unsigned long *a0,unsigned char *a1,unsigned long a2,int a3,unsigned long *a4,unsigned char *a5)
{
  bool v1;
  unsigned long v10;
  ...
  v16 = (unsigned char *)*a0;
  if ((unsigned int)sub_16930(a2) <= 2 & dat_262d8) { // branch-flip
    if (a3) { // branch-flip
      v1 = 1;
label_7982:
      v4 = sub_16a10(v16,0x2000,a1,0xffffffffffffffff,a2);
      if (0x2000 <= v4) {
        v16 = (unsigned char *)sub_18590(v4 + 1);
        sub_16a10(v16,v4 + 1,a1,0xffffffffffffffff,a2);
      }
      v17 = 1;
      if (*a1 == *v16)
        v17 = v4 != strlen((char *)a1);
      v15 = v4;
      if (!v1) goto label_79f0;
    }
    else {
      v4 = strlen((char *)a1);
      if (0x2000 <= v4)
      ...
      if (v5 <= v16) { // branch-flip
        ...
        do {
          ...
          if ('`' <= (char)v2) { // branch-flip
            if (0x1e <= (unsigned char)(v2 + 0x9f)) goto label_7bc5;
label_7c84:
            *v8 = v2;
            v13 = &v13[1];
            v4 += 1;
            ...
            if ('@' < (char)v2) goto label_7c84;
            if ((char)v2 <= '#') {
              if ('\x1f' >= (char)v2) goto label_7bc5;
              goto label_7c84;
            }
            if ((unsigned char)(v2 - 0x25) <= 0x1a) goto label_7c84;
label_7bc5:
            v11 = 0;
            v14 = v8;
            do {
              v7 = sub_12780(&v12,v13,(long)v5 - (long)v13,&v11);
              v8 = &v14[1];
              if (v7 == -1) {
                v13 = &v13[1];
label_7ce8:
      ...
      if (v16 < v5) {
        ...
        v8 = v16;
        do {
          if (!(*(unsigned char *)(*v6 + 1 + (unsigned long)*v8 * 2) & 0x40))
            *v8 = 0x3f;
          v8 = &v8[1];
        } while (v8 != v5);
      }
...
label_7b29:
    ...
    if (2 <= __ctype_get_mb_cur_max()) // branch-flip
      v10 = (unsigned long)(int)sub_12ca0(v16,v15,0);
    else if (&v16[v15] <= v16) // branch-flip
      v10 = 0;
    else {
      v10 = 0;
      v5 = v16;
      do {
        v10 = (v10 + 1) - (unsigned long)((*(unsigned short *)(*(long *)__ctype_b_loc() + (unsigned long)*v5 * 2) & 0x4000) == 0);
        v5 = &v5[1];
      } while (&v16[v15] != v5);
    }
    if (dat_263a8) goto label_7b29;
...
int sub_82b0(unsigned long *a0,unsigned long *a1)
{
  char *v1;
  char *v2;
...
int sub_8370(unsigned long *a0,unsigned long *a1)
{
  unsigned int v1;
  char *v2;
  char *v3;
  
  v1 = ((unsigned int)((long)a1[0x11] < (long)a0[0x11]) - (unsigned int)((long)a0[0x11] < (long)a1[0x11])) + ((unsigned int)((long)a1[0x10] < (long)a0[0x10]) - (unsigned int)((long)a0[0x10] < (long)a1[0x10])) * 2;
  if (!v1) {
    v2 = (char *)*a0;
    v3 = (char *)*a1;
...
int sub_83d0(unsigned long *a0,unsigned long *a1)
{
  unsigned int v1;
  char *v2;
  char *v3;
  
  v1 = ((unsigned int)((long)a1[0xf] < (long)a0[0xf]) - (unsigned int)((long)a0[0xf] < (long)a1[0xf])) + ((unsigned int)((long)a1[0xe] < (long)a0[0xe]) - (unsigned int)((long)a0[0xe] < (long)a1[0xe])) * 2;
  if (!v1) {
    v2 = (char *)*a0;
    v3 = (char *)*a1;
    return strcmp(v3,v2); // tail-call
...
int sub_8430(unsigned long *a0,unsigned long *a1)
{
  unsigned int v1;
  char *v2;
  char *v3;
...
int sub_8490(unsigned long *a0,unsigned long *a1)
{
  unsigned int v1;
  char *v2;
  char *v3;
  
  v1 = ((unsigned int)((long)a1[0xd] < (long)a0[0xd]) - (unsigned int)((long)a0[0xd] < (long)a1[0xd])) + ((unsigned int)((long)a1[0xc] < (long)a0[0xc]) - (unsigned int)((long)a0[0xc] < (long)a1[0xc])) * 2;
  if (!v1) {
    v2 = (char *)*a0;
    v3 = (char *)*a1;
    return strcmp(v3,v2); // tail-call
...
int sub_8880(unsigned long *a0,unsigned long *a1)
{
  char *v1;
  char *v2;
...
int sub_88c0(unsigned long *a0,unsigned long *a1)
{
  char *v1;
  char *v2;
...
int sub_8920(unsigned long *a0,unsigned long *a1)
{
  char *v1;
  char *v2;
...
void sub_8a70(unsigned long *a0,unsigned long *a1)
{
  char *v1;
  char *v2;
...
void sub_8c60(unsigned long *a0,unsigned long *a1)
{
  char *v1;
  char *v2;
...
void sub_9050(unsigned long *a0,unsigned long *a1)
{
  if (!(((unsigned int)((long)a0[0xf] < (long)a1[0xf]) - (unsigned int)((long)a1[0xf] < (long)a0[0xf])) + ((unsigned int)((long)a0[0xe] < (long)a1[0xe]) - (unsigned int)((long)a1[0xe] < (long)a0[0xe])) * 2)) {
    strcmp((char *)*a0,(char *)*a1); // tail-call
    return;
...
void sub_90a0(unsigned long *a0,unsigned long *a1)
{
  if (!(((unsigned int)((long)a0[0xd] < (long)a1[0xd]) - (unsigned int)((long)a1[0xd] < (long)a0[0xd])) + ((unsigned int)((long)a0[0xc] < (long)a1[0xc]) - (unsigned int)((long)a1[0xc] < (long)a0[0xc])) * 2)) {
    strcmp((char *)*a0,(char *)*a1); // tail-call
    return;
...
void sub_90f0(unsigned long *a0,unsigned long *a1)
{
  if (!(((unsigned int)((long)a0[0x11] < (long)a1[0x11]) - (unsigned int)((long)a1[0x11] < (long)a0[0x11])) + ((unsigned int)((long)a0[0x10] < (long)a1[0x10]) - (unsigned int)((long)a1[0x10] < (long)a0[0x10])) * 2)) {
    strcmp((char *)*a0,(char *)*a1); // tail-call
    return;
...
void sub_9150(unsigned long *a0,unsigned long *a1)
{
  if (!(((unsigned int)((long)a0[0xf] < (long)a1[0xf]) - (unsigned int)((long)a1[0xf] < (long)a0[0xf])) + ((unsigned int)((long)a0[0xe] < (long)a1[0xe]) - (unsigned int)((long)a1[0xe] < (long)a0[0xe])) * 2)) {
    strcmp((char *)*a0,(char *)*a1); // tail-call
    return;
...
void sub_92c0(char *a0,unsigned long a1,unsigned long a2)
{
  char *v1;
  int v2;
  bool v3; // cf
  ...
  *(unsigned long *)((long)v13 + -8) = 0x9efb;
  ...
  if (!v6) {
    *(unsigned long *)((long)v13 + -8) = 0x9f1b;
    v7 = dcgettext(NULL,"error canonicalizing %s",5,*(char *)((long)v13 + -8));
    *(unsigned long *)((long)v13 + -8) = 0x9f2f;
    sub_7540((char)v21,v7,a0);
  }
label_97d9:
  v11[0] = dat_262f8;
...
unsigned long sub_ba60(long a0,long a1)
{
  unsigned int v1; // eax
  int v2;
...
unsigned long sub_bb80(long a0,long a1)
{
  unsigned int v1; // eax
  int v2;
...
void sub_c590(long a0,unsigned long a1,unsigned long a2)
{
  unsigned char *v1;
  unsigned char v2; // al
  char *v3; // rax
  ...
  if (dat_262fc) {
    ...
    if ((*(char *)(a0 + 0xb8)) && (*(long *)(a0 + 0x20)))
      v3 = (char *)sub_12720(*(long *)(a0 + 0x20),v7,a2,"?");
    v5 = 0;
    if (dat_26338 != 4)
      v5 = (unsigned long)dat_26360;
    __printf_chk(1,"%*s ",v5,v3);
  }
  if (dat_2632c) {
    v3 = "?";
    if (*(char *)(a0 + 0xb8))
      v3 = (char *)sub_11550(*(unsigned long *)(a0 + 0x58),v7,dat_26328,0x200,dat_26320);
    v5 = 0;
    if (dat_26338 != 4)
      v5 = (unsigned long)dat_2635c;
    __printf_chk(1,"%*s ",v5,v3);
  }
  if (dat_26365) {
    v5 = 0;
    if (dat_26338 != 4)
      v5 = (unsigned long)dat_26354;
    __printf_chk(1,"%*s ",v5,*(unsigned long *)(a0 + 0xb0));
  }
  sub_c0e0(a0,0,0,a1);
  if ((dat_26314) && (v2 = sub_75b0(*(char *)(a0 + 0xb8),*(unsigned int *)(a0 + 0x30),*(unsigned int *)(a0 + 0xa8)), v2)) {
    dat_261f8 += 1;
    v1 = *(unsigned char **)((long)stdout + 0x28);
    if (*(unsigned char **)((long)stdout + 0x30) <= v1) // branch-flip
...
void sub_eb30(unsigned long a0,unsigned long a1,long a2)
{
  char *v1; // rax
...
void sub_ebc0(long *a0,void *a1,unsigned long a2)
{
  long v1;
  char *v2;
  void *v3;
  ...
  while (v1) {
    if ((v4) && (!memcmp(v5,a1,a2)))
      __fprintf_chk(stderr,1,", %s",sub_174c0(v1));
    else {
...
long sub_ecf0(unsigned long a0,char *a1,unsigned long *a2,unsigned long a3,unsigned long a4,void *a5,char a6) // early-return
{
  char *v1;
  long v2;
...
label_f587:
          ...
          if (!stat(v20,v16)) {
            ...
            if (!v26) {
              v26 = sub_10c60(7,0,sub_114c0,sub_114f0,sub_11530);
              if (!v26) {
                sub_18a90();
              }
            }
...
void sub_f930(long a0,unsigned long a1,unsigned long *a2)
{
  unsigned long *v1; // rax
  unsigned long *v2; // rax
...
unsigned long sub_f9c0(long a0,unsigned long a1,unsigned long *a2) // early-return
{
  long v1; // rax
...
void sub_fa20(unsigned int a0,char *a1) // ternary x2
{
  unsigned char v1;
  char v2; // cl
  char v3; // cl
...
void sub_fba0(long a0)
{
  sub_fa20(*(unsigned int *)(a0 + 0x18)); // tail-call
}
...
void sub_101e0(unsigned long a0,unsigned long a1)
{
  sub_10040(a0,0xffffffffffffffff,a1,0xffffffffffffffff); // tail-call
}

// Function: sub_10200 @ 0x10200
void sub_10200(void *a0)
{
  clock_gettime(0,a0); // tail-call
}

// Function: sub_10210 @ 0x10210
undefined16 sub_10210(void)
{
...
unsigned long sub_104c0(float a0,unsigned long a1,char a2) // ternary
{
  char v1 [16];
  unsigned long v2; // rax
...
bool sub_10800(unsigned long *a0)
{
  long v1;
  long *v2;
  long v3;
...
long sub_10a40(unsigned long *a0)
{
  long *v1;
...
void sub_10b20(unsigned long *a0,long a1,unsigned long a2)
{
  unsigned long v1; // rax
  long *v2;
  long *v3;
...
void sub_10c30(unsigned long *a0)
{
  *(char *)&a0[2] = 0;
...
unsigned long sub_114c0(unsigned long *a0,unsigned long a1)
{
  unsigned long v1; // rax
...
unsigned long sub_12150(char *a0,unsigned int *a1,long *a2) // early-return x4
{
  char *v1;
  char v2;
  int v3; // eax
  ...
  v3 = sub_e9c0(a0,150000,0x1e380,4);
  if (0 <= v3) {
    *a2 = 1;
...
char * sub_12680(unsigned long a0,long a1)
{
  unsigned long v1;
  char *v2;
  char *v3; // r8
...
char * sub_12720(unsigned long a0,long a1)
{
  bool v1;
  char *v2;
...
unsigned long sub_12780(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
...
label_12bc4:
    ...
    if (!__mbstowcs_chk(v8,a0,v1,0x3fffffffffffffff)) goto label_12bc4;
    v8[v7] = 0;
    v15 = *v8;
    if (v15) {
      v4 = 0;
      ...
      v11 = (unsigned long)(int)wcswidth(v8,v1);
      if (!v4) goto label_12b9b;
      v18 = wcstombs(0,v8,0);
label_12ae4:
      v18 += 1;
      v9 = malloc(v18);
...
label_12b9b:
    v16 = *a3;
    v18 = v17;
    if (v16 < v11) goto label_12ae4;
    v9 = NULL;
label_1296b:
    if (v16 <= v11) goto label_1286b;
    v16 -= v11;
    *a3 = v11;
...
label_1287f:
    ...
    v10 = 0;
    if (a4 != 1) {
      v11 = (unsigned long)((unsigned int)v16 & 1) + (v16 >> 1);
      v10 = v16 >> 1;
    }
  }
  v16 = v11 + v17;
  ...
  if (a2) {
    ...
    if ((a1 < v3) && (v6 = a1, v11)) {
      do {
        v12 = &v6[1];
        *v6 = 0x20;
        if (!&a1[v11 - (long)v12]) break;
        v6 = v12;
      } while (v12 < v3);
    }
    v11 = (long)v3 - (long)v12;
    if (v17 < (unsigned long)((long)v3 - (long)v12))
      v11 = v17;
    v6 = mempcpy(v12,a0,v11);
    v12 = v6;
    if ((v6 < v3) && (v13 = v6, v10)) {
      do {
        v12 = &v13[1];
        *v13 = 0x20;
        if (!&v6[v10 - (long)v12]) break;
        v13 = v12;
      } while (v12 < v3);
    }
    *v12 = 0;
...
void * sub_12bf0(unsigned long a0,unsigned long *a1,unsigned int a2,unsigned int a3)
{
  unsigned long v1;
  unsigned long v2;
  void *v3; // rax
...
int sub_12ca0(unsigned char *a0,long a1,unsigned int a2)
{
  unsigned char *v1;
  unsigned char v2;
  unsigned short v3;
  ...
  if (2 <= __ctype_get_mb_cur_max()) { // branch-flip
    ...
    if (a0 < v1) {
      do {
        v2 = *a0;
        if ('`' <= (char)v2) { // branch-flip
          if (0x1e <= (unsigned char)(v2 + 0x9f)) goto label_12d24;
label_12dd3:
          a0 = &a0[1];
          v9 += 1;
        }
        else {
          if ('@' < (char)v2) goto label_12dd3;
          if ('#' < (char)v2) {
            if (0x1b <= (unsigned char)(v2 - 0x25)) goto label_12d24;
            goto label_12dd3;
          }
          if ('\x1f' < (char)v2) goto label_12dd3;
label_12d24:
          v7 = 0;
          do {
            v5 = sub_12780(&v8,a0,(long)v1 - (long)a0,&v7);
            if (v5 == -1) {
              if (a2 & 1)
                return -1;
              goto label_12dd3;
...
long sub_13210(char *a0,long a1,char *a2,unsigned int *a3,char a4,unsigned int a5,int a6,unsigned long a7,int a8)
{
  unsigned int v1;
  unsigned long v10;
  long *v11; // rax
...
label_132ad:
  ...
  if (v8 != '%') {
    ...
    if (v10)
      v18 = v10;
    if ((unsigned long)(a1 - v34) <= v18) goto label_13330;
    if (a0) {
      v35 = a0;
      if (1 < (int)v37) {
        v35 = &a0[v10 - 1];
        memset(a0,0x20,v10 - 1);
      }
      a0 = &v35[1];
      *v35 = *a2;
    }
  ...
  if (v16 - 0x30 <= 9) {
    ...
    do {
      v13 = (long)(int)v37 * 10;
      v36 = (int)v13;
      if ((v36 != v13) || (v37 = (unsigned long)(unsigned int)(v36 + *v20 + -0x30), SCARRY4(v36,*v20 + -0x30)))
        v37 = 0x7fffffff;
      v16 = (unsigned int)v20[1];
      v20 = &v20[1];
    } while (v16 - 0x30 <= 9);
  }
  v10 = (unsigned long)v16;
  if (((char)v16 != 'E') && ((char)v16 != 'O'))
    v16 = 0;
  else {
    v10 = (unsigned long)(unsigned char)v20[1];
    v20 = &v20[1];
  }
  v26 = (unsigned char)v10;
  v36 = (int)v37;
  v35 = v20;
  if (0x7b <= v26) goto label_13450;
  v15 = (char)v17;
  v17 = v1;
  switch(v10 & 0xff) {
    case 0:
    ...
    case 0x25:
      ...
      if (v35 == a2) {
        if ((v32 != 0x2d) && (0 <= v36)) {
          v10 = (unsigned long)v36;
          v37 = 1;
          if (v10)
            v37 = v10;
          if ((unsigned long)(a1 - v34) <= v37) goto label_13330;
          if (a0) {
            if (2 <= v36) {
              v10 -= 1;
              v35 = &a0[v10];
...
label_14918:
          ...
          if ((unsigned long)(a1 - v34) <= 1) goto label_13330;
          v37 = 1;
    ...
    case 0x43:
      if (v16 != 0x45) {
        v30 = a3[5];
        v41._0_1_ = (int)v30 < -0x76c;
        v17 = (int)((-(unsigned int)(v30 + 0x76c < 0x76c) & 0xffffff9d) + v30) / 100 + 0x13;
        v9 = -0x76c <= (int)v30;
        if (!v32)
          v32 = a5;
...
label_13893:
    ...
    case 0x46:
      ...
      v37 = sub_13210(0,0xffffffffffffffff,"%Y-%m-%d",a3,v8,0x2b,4,v7,a8,(long)*(int *)((v10 & 0xff) * 4 + 0x1e3cc) + 0x1e3cc);
      v35 = "%Y-%m-%d";
      v10 = 0;
      v32 = 0x2b;
      v40 = v37;
    ...
    case 0x67:
      if (v16 != 0x45) {
        ...
        v4 = a3[6];
        v29 = (v3 - v4) + 0x17e;
        v17 = (v30 - 100) + ((int)v30 >> 0x1f & 400U);
        v29 = (v3 - v29) + 3 + (v29 / 7) * 7;
        if (0 <= v29) { // branch-flip
          v31 = 0x16d;
          if ((!(v17 & 3)) && (v31 = 0x16e, (v17 * -0x3d70a3d7 + 0x51eb850 >> 2 | v30 * 0x40000000) <= 0x28f5c28))
            v31 = 0x16e - (unsigned int)((int)v17 % 400 != 0);
          v27 = ((v3 - v31) - v4) + 0x17e;
          v31 = ((v3 - v31) - v27) + 3 + (v27 / 7) * 7;
          if (0 <= v31)
            v29 = v31;
          v31 = (v31 >> 0x1f) + 1;
        }
          ...
          v17 -= 1;
          v29 = 0x16d;
          if ((!(v17 & 3)) && (v29 = 0x16e, (v17 * -0x3d70a3d7 + 0x51eb850 >> 2 | v17 * 0x40000000) <= 0x28f5c28))
            v29 = 0x16e - (unsigned int)((int)v17 % 400 != 0);
          v31 = ((v29 + v3) - v4) + 0x17e;
          v29 = ((v29 + v3) - v31) + 3 + (v31 / 7) * 7;
          v31 = -1;
        }
        if (v26 == 0x47) {
          v17 = v30 + 0x76c + v31;
          v41._0_1_ = (int)v30 < 0xfffff894U - v31;
          if (v32) { // branch-flip
label_14988:
            v42 = 4;
            v30 = 9999;
            if (v32 == 0x2b) goto label_1499f;
            v38 = 0;
            v9 = (bool)(v41._0_1_ ^ 1);
          }
          else {
...
label_14c24:
            ...
            v38 = 0;
            v42 = 4;
            v9 = 0xfffff894U - v31 <= (int)v30;
            v32 = a5;
          }
          goto label_13893;
        }
        if (v26 == 0x67) {
          v17 = ((int)v30 % 100 + v31) % 100;
          if (0 <= (int)v17) { // branch-flip
            if (!v32)
              v32 = a5;
          }
          else {
            if ((int)v30 < 0xfffff894U - v31) {
              v17 = -v17;
              goto label_143d2;
            }
            v17 += 100;
            if (!v32) goto label_143d8;
          }
          goto label_14949;
        }
        v42 = 2;
    ...
    case 0x54:
      ...
      v35 = "%H:%M:%S";
label_13eef:
      v37 = sub_13210(0,0xffffffffffffffff,v35,a3,v8,v32,v29,v7,a8);
      if ((v32 != 0x2d) && (0 <= v36)) {
        v10 = (unsigned long)v36;
        v40 = v10;
        if (v10 <= v37)
...
label_13f6d:
      if ((unsigned long)(a1 - v34) <= v40) goto label_13330;
      if (a0) {
        v28 = a0;
        if (v37 < v10) {
          v10 -= v37;
        ...
        a0 = &v28[v37];
        sub_13210(v28,a1 - v34,v35,a3,v8,v32,v29,v7,a8);
      }
      v34 += v40;
      goto label_132f8;
    case 0x55:
...
label_13b93:
    ...
    case 0x57:
      if (v16 != 0x45) {
        v29 = (((int)(a3[6] + 6) / 7) * 7 - (a3[6] + 6)) + 7 + a3[7];
        goto label_13b93;
      }
      break;
    case 0x58:
    case 99:
    case 0x78:
      if (v16 != 0x4f) goto label_135d1;
      break;
    case 0x59:
      if (v16 == 0x45) goto label_138b1;
      if (v16 == 0x4f) break;
      v41._0_1_ = (int)a3[5] < -0x76c;
      v17 = a3[5] + 0x76c;
      if (v32) goto label_14988;
    ...
    case 0x5a:
      ...
      if ((unsigned long)(a1 - v34) <= v41) goto label_13330;
      if (a0) {
        v35 = a0;
        if (v37 < v10) {
          v10 -= v37;
        ...
        if (v15) { // branch-flip
          if (v37) {
            ...
            do {
              v10 -= 1;
              v35[v10] = (char)*(unsigned int *)(*v11 + (unsigned long)(unsigned char)v33[v10] * 4);
            } while (v10);
          }
        }
...
label_135d3:
      if (v16) goto label_138c0;
      v12 = (unsigned char *)((long)&v21 + 5);
      goto label_135f2;
    case 0x71:
      if (v16 == 0x4f) goto label_138b1;
      v38 = 0;
      v30 = 0;
      v42 = 1;
      v41._0_1_ = 0;
      v17 = ((int)(a3[4] * 0xb) >> 5) + 1;
      goto label_140a0;
    case 0x72:
label_135d1:
      v25 = '\0';
      goto label_135d3;
    case 0x73:
      v46 = *(unsigned long *)&a3[8];
      v47 = *(unsigned long *)&a3[10];
      v23 = *(unsigned long *)a3;
      v43 = *(unsigned long *)&a3[2];
      v44 = *(unsigned long *)&a3[4];
      v48 = *(unsigned long *)&a3[0xc];
      v45._0_4_ = (unsigned int)*(unsigned long *)&a3[6];
      v45 = CONCAT44(0xffffffff,(unsigned int)v45);
      v13 = sub_17d10(v7,&v23);
      if (v45 <= -1) {
        *v39 = 0x4b;
        return 0;
      }
      v41._0_1_ = SUB81((unsigned long)v13 >> 0x3f,0);
      v35 = &v24[1];
      v14 = v13;
      do {
        v5 = v14 / 10;
...
label_13ae0:
      v38 = 0;
      v30 = 0;
      v6 = (unsigned char)(v17 >> 0x18);
      v41._0_1_ = (bool)(v6 >> 7);
      v9 = (bool)((unsigned char)~v6 >> 7);
      goto label_138a0;
    case 0x77:
      if (v16 != 0x45) {
        v42 = 1;
...
label_138c0:
      v21._5_1_ = (char)v16;
      v12 = (unsigned char *)((long)&v21 + 6);
label_135f2:
      v21._3_2_ = 0x2520;
      *v12 = v26;
      v12[1] = 0;
      v37 = strftime((char *)&v22,0x400,(char *)((long)&v21 + 3),a3);
      if (v37) {
        v10 = v37 - 1;
        if ((v32 != 0x2d) && (0 <= v36)) {
          v19 = (unsigned long)v36;
          v18 = v19;
          if (v19 <= v10)
            v18 = v10;
        }
        ...
        if (a0) {
          ...
          if (v25) { // branch-flip
            ...
            if (v10) {
              v11 = __ctype_tolower_loc();
              do {
                v35[v13] = (char)*(unsigned int *)(*v11 + (unsigned long)*(unsigned char *)((long)&v22 + v13 + 1) * 4);
                v38 = v13 != 0;
                v13 -= 1;
              } while (v38);
            }
            ...
            memcpy(v35,(void *)((long)&v22 + 1),v10);
          }
          a0 = &v35[v10];
        }
label_13707:
...
label_1448c:
      v20 = v28;
      if ((int)a3[8] < 0) goto label_132f8;
      v41._0_1_ = 1;
      v29 = (int)*(unsigned long *)&a3[10];
      if ((0 <= v29) && (v41._0_1_ = 0, !v29))
        v41._0_1_ = *v33 == '-';
      v17 = v29 / 0xe10;
      v31 = (v29 / 0x3c) % 0x3c;
      if (v37 != 2) { // branch-flip
        if (3 <= v37) { // branch-flip
          v35 = v28;
          if (v37 != 3) break;
          if (v29 % 0x3c) goto label_14b36;
          if (v31) goto label_14532;
          v38 = 1;
          v42 = 3;
          v9 = (bool)(v41._0_1_ ^ 1);
          v30 = 0;
        }
        else if (v37) { // branch-flip
label_14532:
          v38 = 1;
          v42 = 6;
          v9 = (bool)(v41._0_1_ ^ 1);
...
label_14b36:
        ...
        v9 = (bool)(v41._0_1_ ^ 1);
        v30 = 0x14;
        v17 = v17 * 10000 + v31 * 100 + v29 % 0x3c;
      }
label_138a0:
      if ((v16 == 0x4f) && (v9)) goto label_138b1;
label_14288:
      if (v41._0_1_)
        v17 = -v17;
label_140a0:
      v37 = (unsigned long)v17;
      v28 = &v24[1];
      while( true ) {
        if (v30 & 1) {
          v28[-1] = ':';
        ...
        v30 = (int)v30 >> 1;
        v35 = &v28[-1];
        v28[-1] = (char)v37 + (char)(v37 / 10) * '\xf6' + '0';
        if (((unsigned int)v37 <= 9) && (!v30)) break;
        v37 /= 10;
        v28 = v35;
      }
label_13ca0:
      ...
      if (v36 <= -1)
        v36 = v42;
      v29 = ((int)v24 + 1) - (int)v35;
      if (v41._0_1_) { // branch-flip
        v15 = '-';
label_145e5:
        v27 = v36 + -1;
        v31 = v27 - v29;
        if ((v31 <= 0) || (v32 == 0x2d))
          v31 = 0;
        if (v17 != 0x5f) { // branch-flip
          if ((unsigned long)(a1 - v34) <= 1) goto label_13330;
          if (a0) goto label_14616;
label_1461d:
          v34 += 1;
          v36 = v27;
          if (v17 != 0x2d) goto label_1462a;
label_1465e:
          v18 = (unsigned long)v29;
          v37 = 0;
        }
        else {
          v37 = (unsigned long)v31;
          v34 += v37;
          if (a0) {
            memset(a0,0x20,v37);
            a0 = &a0[v37];
...
label_1462a:
        ...
        if (((v29 >= v36) || (v32 == 0x2d)) && (v17 == 0x2d)) goto label_1465e;
label_13ce9:
        v37 = (unsigned long)v36;
        v18 = (long)v29;
        if ((unsigned long)(long)v29 <= v37)
          v18 = v37;
      }
      ...
      if (a0) {
        ...
        if (v8) { // branch-flip
          if (v10) {
            ...
            do {
              v37 -= 1;
              v28[v37] = (char)*(unsigned int *)(*v11 + (unsigned long)(unsigned char)v35[v37] * 4);
            } while (v37);
          }
        }
        else {
...
label_13450:
  ...
  if ((unsigned long)(a1 - v34) <= v10) goto label_13330;
  if (a0) {
    v20 = a0;
    if (v37 < v18) {
      v18 -= v37;
    ...
    if (v8) { // branch-flip
      if (v37) {
        v11 = __ctype_toupper_loc();
        do {
          v20[v13] = (char)*(unsigned int *)(*v11 + (unsigned long)(unsigned char)a2[v13] * 4);
          v38 = v13 != 0;
          v13 -= 1;
        } while (v38);
      }
  ...
  goto label_132f8;
label_13977:
  v10 = (unsigned long)v31;
  v37 = v10;
  if (v31) { // branch-flip
label_13985:
    v35 = (char *)((long)&v22 + v37);
    do {
      v35 = &v35[-1];
      *v35 = (char)v29 + (char)(v29 / 10) * '\xf6' + '0';
      v29 /= 10;
    } while (v35 != (char *)((long)&v21 + (v37 - (unsigned int)(v31 - 1)) + 7));
  }
  else {
    v10 = 0;
  }
...
label_13330:
  ...
  if (a0) {
    if (v8) { // branch-flip
      if (v10) {
        ...
        do {
          v18 = v37 - 1;
          a0[v18] = (char)*(unsigned int *)(*v11 + (unsigned long)*(unsigned char *)((long)&v21 + v37 + 7) * 4);
          v37 = v18;
        } while (v18);
      }
    }
    else if (8 <= v10) { // branch-flip
      *(unsigned long *)a0 = CONCAT44(v22._4_4_,(unsigned int)v22);
      *(unsigned long *)&a0[v10 - 8] = *(unsigned long *)((long)&v21 + v10);
      v13 = (long)a0 - ((unsigned long)&a0[8] & 0xfffffffffffffff8);
      v37 = v13 + v10 & 0xfffffffffffffff8;
      if (8 <= v37) {
        v18 = 0;
        do {
          *(unsigned long *)(((unsigned long)&a0[8] & 0xfffffffffffffff8) + v18) = *(unsigned long *)((long)&v22 + (v18 - v13));
          v18 += 8;
        } while (v18 < v37);
      }
    }
      ...
      *(unsigned int *)&a0[v10 - 4] = *(unsigned int *)((long)&v21 + v10 + 4);
    }
    else if (v10) {
      *a0 = (char)v22;
      if (v10 & 2)
        *(unsigned short *)&a0[v10 - 2] = *(unsigned short *)((long)&v21 + v10 + 6);
    }
    a0 = &a0[v10];
  }
  v34 += v10;
  if ((v32 != 0x2d) && (0 <= v36 - v31)) {
    v37 = (unsigned long)(v36 - v31);
    if ((unsigned long)(a1 - v34) <= v37) goto label_13330;
    if (a0) { // branch-flip
      if (v37) {
        v35 = &a0[v37];
  ...
  else if (a1 == v34) goto label_13330;
label_132f8:
  v8 = v20[1];
  a2 = &v20[1];
  v37 = 0xffffffffffffffff;
  if (!v8) goto label_1330b;
  goto label_132ad;
}
...
long * sub_14df0(long *a0,long a1,long a2) // ternary
{
  long *v1; // rax
    ...
    if (v27) {
      ...
      if (v23) {
        ...
        if (v31) {
          ...
          if ((a3 < v24 + v31) || (v9 = memcmp(v12,v32,v31), v9)) goto label_15d50;
          if (!v26) {
            v8 = *v12;
...
label_15df4:
          if ((char)v19 == '\\') {
            if (((bool)(v2 & v26)) && (v31)) goto label_15e1a;
            v17 = 0x5c;
            goto label_15842;
          }
label_15623:
          v17 = (unsigned char)v19;
          if (v34 != 1) goto label_15ba3;
label_15630:
          v10 = __ctype_b_loc();
          v22 = 1;
...
label_15518:
    v17 = (unsigned char)v22;
    v13 = v14;
    if (!v30) goto label_156c3;
    if (!(*(unsigned int *)(v30 + (v22 >> 5) * 4) >> (v17 & 0x1f) & 1)) goto label_156c3;
  }
  else {
label_156c0:
    v8 = 0;
...
void * sub_16700(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_25258 <= (int)a0) {
      v10 = (long)dat_25258;
      v9 = (long)(int)((a0 - dat_25258) + 1);
      if (dat_25260 != (unsigned long *)0x25270) // branch-flip
        v6 = (unsigned long *)sub_18870(dat_25260,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_18870(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_25270;
        v6[1] = dat_25278;
      }
      dat_25260 = v6;
      memset(&v6[(long)dat_25258 * 2],0,(v10 - dat_25258) * 0x10);
      dat_25258 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_15270(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x26420)
        free(v8);
      v8 = (void *)sub_185d0(v7);
      v4 = *a3;
      v1[1] = (unsigned long)v8;
      sub_15270(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
unsigned int sub_169b0(long a0,unsigned int a1)
{
  unsigned int v1;
...
void sub_16a10(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_15270(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_16a90 @ 0x16a90
unsigned long sub_16a90(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_15270(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_185d0(v3 + 1);
  sub_15270(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_16b80(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_16a90(a0,a1,0,a2); // tail-call
}
...
void sub_16c30(unsigned long a0,unsigned long a1)
{
  sub_16700(a0,a1,0xffffffffffffffff,0x26520); // tail-call
}
...
void sub_16c60(unsigned long a0)
{
  sub_16700(0,a0,0xffffffffffffffff,0x26520); // tail-call
}

// Function: sub_16c80 @ 0x16c80
void sub_16c80(unsigned long a0,unsigned long a1)
{
  sub_16700(0,a0,a1,0x26520); // tail-call
}

// Function: sub_16ca0 @ 0x16ca0
void sub_16ca0(unsigned long a0,int a1,unsigned long a2)
{
...
void sub_16d40(unsigned long a0,int a1,unsigned long a2,unsigned long a3)
{
  int v1 [14]; // stack - 0x48
...
void sub_16dd0(int a0,unsigned long a1)
{
  int v1 [14]; // stack - 0x48
...
void sub_16e60(int a0,unsigned long a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_16ef0(unsigned long a0,unsigned long a1,unsigned char a2)
{
  unsigned int *v1;
  unsigned int v2;
...
void sub_16f90(unsigned long a0,unsigned char a1)
{
  unsigned int *v1;
  unsigned int v2;
  unsigned long v3; // stack - 0x48
...
void sub_17030(unsigned long a0)
{
...
void sub_170c0(unsigned long a0,unsigned long a1)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned int v3; // stack - 0x3c
...
void sub_17150(unsigned long a0,int a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_171f0(unsigned long a0,long a1,long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
...
void sub_17290(unsigned int a0,long a1,long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_17330(long a0,long a1,unsigned long a2)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_173d0(long a0,long a1,unsigned long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_17480(unsigned long a0,unsigned long a1)
{
  sub_16700(0,a0,a1,0x25220); // tail-call
}

// Function: sub_174a0 @ 0x174a0
void sub_174a0(unsigned long a0,unsigned long a1)
{
  sub_16700(a0,a1,0xffffffffffffffff,0x25220); // tail-call
}

// Function: sub_174c0 @ 0x174c0
void sub_174c0(unsigned long a0)
{
  sub_16700(0,a0,0xffffffffffffffff,0x25220); // tail-call
}

// Function: sub_174e0 @ 0x174e0
unsigned long * sub_174e0(unsigned long *a0,unsigned long a1) // early-return
{
  unsigned long *v1;
  unsigned long *v2;
  void *v3; // rax
...
unsigned long sub_175c0(long *a0) // return-dupe
{
  unsigned long v1;
  void *v2;
  void *v3; // rax
...
int sub_17680(unsigned long a0,unsigned long *a1)
{
  char *v1;
  int v2; // eax
...
int sub_17700(unsigned long a0,unsigned long *a1)
{
  char *v1;
  int v2; // eax
...
int sub_17780(unsigned long a0,unsigned long *a1)
{
  char *v1;
  int v2; // eax
...
unsigned long sub_179f0(long *a0,char *a1) // return-dupe
{
  char *v1;
  long *v2;
  int v3; // eax
...
void * sub_17c60(long a0,void *a1,void *a2) // return-dupe x3
{
  long v1; // rax
  ...
  if (!v1)
    return NULL;
  if ((!localtime_r(a1,a2)) || (!sub_179f0(a0,a2))) {
    if (v1 == 1)
      return NULL;
    sub_178c0(v1);
    return NULL;
  }
  if ((v1 != 1) && (!sub_178c0(v1)))
    return NULL;
  return a2;
}
...
void sub_17e60(long a0)
{
  *(unsigned int *)(a0 + 0x20) = 0;
  sub_19510(a0,dat_24fd0,0x26558); // tail-call
}

// Function: sub_17e80 @ 0x17e80
long sub_17e80(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
  unsigned long v10; // stack - 0x48
  char *v2; // rax
...
void sub_18320(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_183c0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  long v1;
  unsigned long v2;
  long v3 [4];
...
void sub_18870(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_1892e;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
void sub_18a00(void *a0,unsigned long a1)
{
...
unsigned long sub_18ad0(unsigned long a0,unsigned int a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,int a6)
{
  int v1;
  int *v2; // rax
  unsigned long v3; // stack - 0x48
  
  v1 = sub_18de0(a0,0,a1,&v3);
  if (v1) { // branch-flip
    v2 = __errno_location();
    if (v1 != 1) {
      if (v1 == 3)
...
void sub_18be0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
...
char * sub_18c10(void)
{
  ...
  while( true ) {
    ...
    *v1 = 0;
    ...
    v2 = (char *)sub_18870(0,&v6,1,0xffffffffffffffff,1);
    v3 = v6;
    v7 = v2;
  }
  return NULL;
...
unsigned int sub_18de0(unsigned char *a0,long *a1,unsigned int a2,unsigned long *a3,char *a4)
{
  ...
  *v23 = 0;
  ...
  if (v24 != a0) { // branch-flip
    ...
    v27 = *v24;
    if (!v27) goto label_18e9d;
    v28 = v25;
    if (!strchr(a4,(int)(char)v27)) goto label_18ea5;
  }
  else {
    if ((!a4) || (v27 = *a0, !v27))
      return 4;
...
label_18ea5:
    ...
    case 0x25:
      ...
      v15._8_8_ = 0;
      v15._0_8_ = v26;
      if ((SUB168(v5._0_16_ * v15._0_16_,8)) || (v6._8_8_ = 0, v6._0_8_ = SUB168(v5._0_16_ * v15._0_16_,0), v16._8_8_ = 0, v16._0_8_ = v26, v25 = SUB168(v6._0_16_ * v16._0_16_,0), SUB168(v6._0_16_ * v16._0_16_,8))) goto label_19069;
label_19037:
      v4._8_8_ = 0;
      v4._0_8_ = v25;
      v14._8_8_ = 0;
    ...
    case 0x29:
      ...
      if (SUB168(v2._0_16_ * v12._0_16_,8)) goto label_19069;
      break;
    case 0xb:
    case 0x2b:
      v3._8_8_ = 0;
      ...
      if (!SUB168(v3._0_16_ * v13._0_16_,8)) goto label_19037;
label_19069:
      v32 = 1;
      v25 = 0xffffffffffffffff;
      break;
...
void sub_19ac0(unsigned long a0)
{
  tzset();
  sub_19510(a0,dat_24fc8,0x26560); // tail-call
}

// Function: sub_19af0 @ 0x19af0
unsigned long sub_19af0(unsigned int *a0) // early-return x2, return-dupe
{
  unsigned int v1;
  unsigned long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_19b60(void *a0) // early-return
{
  int v1;
  int *v2; // rax
...
void sub_19bf0(unsigned int *a0)
{
  if (a0) {
...
unsigned long sub_19c40(unsigned int *a0,unsigned long a1,unsigned int a2) // return-dupe
{
  long v1; // rax
