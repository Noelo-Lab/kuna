...
void sub_3990(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_cfd8)(sub_2900,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
char * sub_3fe0(unsigned long a0,long a1)
{
  unsigned long v1;
  char *v2;
  char *v3; // r8
...
void sub_4120(char *a0)
{
  ...
  v4 = sub_70e0(&a0[0x24],v2,sub_5660(v2,v3),&a0[4]);
  *(long *)&a0[0x18] = v4;
  if (v4 == -1) {
    a0[0x18] = '\x01';
    a0[0x19] = '\0';
...
unsigned long sub_4290(char *a0,unsigned long a1)
{
  char v1;
  char v10; // stack - 0xac
  char *v11; // stack - 0xa8
...
void sub_4970(unsigned long a0,long a1,long a2)
{
  unsigned long v1;
  unsigned long v2;
  long v3;
...
unsigned long sub_5060(unsigned long a0)
{
  unsigned long v1;
  unsigned long v2;
  char v3 [1032];
...
long sub_5140(long a0) // return-dupe
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
  ...
  if (2 <= __ctype_get_mb_cur_max()) { // branch-flip
    if (a1) {
      ...
      while( true ) {
        ...
        if (v3) {
label_5b24:
          v14 = sub_70e0(v8,v9,(long)v10 - (long)v9,&v7);
...
label_58c3:
        ...
        if (!(*(unsigned int *)((unsigned long)(*v9 >> 5) * 4 + 0x9e60) >> (*v9 & 0x1f) & 1)) {
          if (mbsinit(&v7)) {
            v3 = 1;
            goto label_5b24;
          }
...
long sub_5c70(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
...
void sub_6110(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_61b0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  long v1;
  unsigned long v2;
  long v3 [4];
...
void sub_6610(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_66ce;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
void sub_6770(void *a0,unsigned long a1)
{
...
long sub_6fc0(int a0,void *a1,long a2)
{
  void *v1;
  unsigned long v2;
  long v3; // rax
...
unsigned long sub_70e0(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
...
void sub_7250(long *a0,long *a1) // return-dupe
{
  long v1;
  long *v2;
...
char sub_75e0(void *a0,char *a1,unsigned long *a2)
{
  char v1;
  char v10 [32];
...
label_8000:
              v18 = v9 - v21;
              if (v18) { // branch-flip
                if (!v29) goto label_804d;
                while ((!v32 || (v33))) {
                  v29 = '\0';
                  v30 = &v30[v31];
                  v18 -= 1;
                  if (!v18) goto label_8080;
label_804d:
                  sub_7470(v16);
                }
                if (v29) goto label_8110;
label_8080:
                sub_7470(v16);
              }
              else if (!v29) goto label_8080;
              v20 = v32;
              if (v32) { // branch-flip
                if (!v33) {
label_8110:
                  v20 = sub_75e0(a0,a1,&v11);
                  if (v20)
                    return v11;
                }
              }
          ...
          v10 = v9 + 1;
          if (!v26) goto label_7dd6;
          if (v40 == v27) goto label_7e16;
label_7d68:
          v7 = v37;
          v17 = v38;
        }
...
label_7e16:
              ...
              do {
                ...
                if ((char)v48) { // branch-flip
                  if (!v48._4_4_)
                    return NULL;
                  if (!v56) goto label_7f8e;
                  if (v48._4_4_ != v57) goto label_7d68;
                }
                else {
label_7f8e:
                  if ((v47 != v55) || (v6 = memcmp(v46,v54,v47), v6)) goto label_7d68;
                }
                v46 = &v7[v9];
                v44[4] = 0;
                v54 = &v1[v17];
        ...
        if (v4) {
          if (v17 * 5 <= v10) { // branch-flip
            if (v7) {
              ...
              v9 = v10;
              if (*v7) goto label_7bad;
            }
            v5 = sub_72d0(v1,a1,strlen(a1),&v11);
            if ((char)v5)
              return v11;
            v7 = NULL;
          }
...
char * sub_86d0(char *a0,unsigned long a1,unsigned long a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
...
void sub_8a50(unsigned long a0)
{
  if (a0 & 0xf)
    abort(); // no-return
  if (!(a0 & 0x10))
