...
void sub_41b0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_10fd8)(sub_2a20,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
void sub_45f0(void *a0,char a1,long a2,long a3)
{
  fputs_unlocked(".\n",a0);
  if (!a1)
    return;
...
void sub_5180(char *a0)
{
  ...
  v4 = sub_7b30(&a0[0x24],v2,sub_6600(v2,v3),&a0[4]);
  *(long *)&a0[0x18] = v4;
  if (v4 == -1) {
    a0[0x18] = '\x01';
    a0[0x19] = '\0';
...
unsigned long sub_52f0(char *a0,unsigned long a1)
{
  char v1;
  char v10; // stack - 0xac
  char *v11; // stack - 0xa8
...
unsigned long sub_6000(unsigned long a0)
{
  unsigned long v1;
  unsigned long v2;
  char v3 [1032];
...
long sub_60e0(long a0) // return-dupe
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
...
label_62a0:
          if (v11) { // branch-flip
            ...
            for (v12 = v11; v12 <= ".26"; v12 = (char *)((long)v12 * 2)) {
            }
          }
  ...
  if (2 <= __ctype_get_mb_cur_max()) { // branch-flip
    if (a1) {
      ...
      while( true ) {
        ...
        if (v3) {
label_6ac4:
          v14 = sub_7b30(v8,v9,(long)v10 - (long)v9,&v7);
...
label_6863:
        ...
        if (!(*(unsigned int *)((unsigned long)(*v9 >> 5) * 4 + 0xd300) >> (*v9 & 0x1f) & 1)) {
          if (mbsinit(&v7)) {
            v3 = 1;
            goto label_6ac4;
          }
...
long sub_6c10(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
...
void sub_70b0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_7150(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  long v1;
  unsigned long v2;
  long v3 [4];
...
void sub_75b0(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_766e;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
void sub_7810(char *a0,unsigned long a1,long a2)
{
  unsigned long v1; // rax
  unsigned long v2; // rax
  char *v3; // rax
...
unsigned long sub_7b30(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
...
void sub_7d30(long *a0,long *a1) // return-dupe
{
  long v1;
  long *v2;
...
char sub_80c0(void *a0,char *a1,unsigned long *a2)
{
  char v1;
  char v10 [32];
...
label_8ae0:
              v18 = v9 - v21;
              if (v18) { // branch-flip
                if (!v29) goto label_8b2d;
                while ((!v32 || (v33))) {
                  v29 = '\0';
                  v30 = &v30[v31];
                  v18 -= 1;
                  if (!v18) goto label_8b60;
label_8b2d:
                  sub_7f50(v16);
                }
                if (v29) goto label_8bf0;
label_8b60:
                sub_7f50(v16);
              }
              else if (!v29) goto label_8b60;
              v20 = v32;
              if (v32) { // branch-flip
                if (!v33) {
label_8bf0:
                  v20 = sub_80c0(a0,a1,&v11);
                  if (v20)
                    return v11;
                }
              }
          ...
          v10 = v9 + 1;
          if (!v26) goto label_88b6;
          if (v40 == v27) goto label_88f6;
label_8848:
          v7 = v37;
          v17 = v38;
        }
...
label_88f6:
              ...
              do {
                ...
                if ((char)v48) { // branch-flip
                  if (!v48._4_4_)
                    return NULL;
                  if (!v56) goto label_8a6e;
                  if (v48._4_4_ != v57) goto label_8848;
                }
                else {
label_8a6e:
                  if ((v47 != v55) || (v6 = memcmp(v46,v54,v47), v6)) goto label_8848;
                }
                v46 = &v7[v9];
                v44[4] = 0;
                v54 = &v1[v17];
        ...
        if (v4) {
          if (v17 * 5 <= v10) { // branch-flip
            if (v7) {
              ...
              v9 = v10;
              if (*v7) goto label_868d;
            }
            v5 = sub_7db0(v1,a1,strlen(a1),&v11);
            if ((char)v5)
              return v11;
            v7 = NULL;
          }
    ...
    if (v27) {
      ...
      if (v23) {
        ...
        if (v31) {
          ...
          if ((a3 < v24 + v31) || (v9 = memcmp(v12,v32,v31), v9)) goto label_97f0;
          if (!v26) {
            v8 = *v12;
...
label_9894:
          if ((char)v19 == '\\') {
            if (((bool)(v2 & v26)) && (v31)) goto label_98ba;
            v17 = 0x5c;
            goto label_92e2;
          }
label_90c3:
          v17 = (unsigned char)v19;
          if (v34 != 1) goto label_9643;
label_90d0:
          v10 = __ctype_b_loc();
          v22 = 1;
...
label_8fb8:
    v17 = (unsigned char)v22;
    v13 = v14;
    if (!v30) goto label_9163;
    if (!(*(unsigned int *)(v30 + (v22 >> 5) * 4) >> (v17 & 0x1f) & 1)) goto label_9163;
  }
  else {
label_9160:
    v8 = 0;
...
void * sub_a1a0(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_11078 <= (int)a0) {
      v10 = (long)dat_11078;
      v9 = (long)(int)((a0 - dat_11078) + 1);
      if (dat_11080 != (unsigned long *)0x11090) // branch-flip
        v6 = (unsigned long *)sub_75b0(dat_11080,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_75b0(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_11090;
        v6[1] = dat_11098;
      }
      dat_11080 = v6;
      memset(&v6[(long)dat_11078 * 2],0,(v10 - dat_11078) * 0x10);
      dat_11078 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_8d10(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x21180)
      ...
      sub_8d10(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
void sub_a4b0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_8d10(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_a530 @ 0xa530
unsigned long sub_a530(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_8d10(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_7350(v3 + 1);
  sub_8d10(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_a620(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_a530(a0,a1,0,a2); // tail-call
}
...
void sub_a6d0(unsigned long a0,unsigned long a1)
{
  sub_a1a0(a0,a1,0xffffffffffffffff,0x21280); // tail-call
}
...
void sub_a700(unsigned long a0)
{
  sub_a1a0(0,a0,0xffffffffffffffff,0x21280); // tail-call
}

// Function: sub_a720 @ 0xa720
void sub_a720(unsigned long a0,unsigned long a1)
{
  sub_a1a0(0,a0,a1,0x21280); // tail-call
}

// Function: sub_a740 @ 0xa740
void sub_a740(unsigned long a0,int a1,unsigned long a2)
{
...
void sub_a7e0(unsigned long a0,int a1,unsigned long a2,unsigned long a3)
{
  int v1 [14]; // stack - 0x48
...
void sub_a870(int a0,unsigned long a1)
{
  int v1 [14]; // stack - 0x48
...
void sub_a900(int a0,unsigned long a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_a990(unsigned long a0,unsigned long a1,unsigned char a2)
{
  unsigned int *v1;
  unsigned int v2;
...
void sub_aa30(unsigned long a0,unsigned char a1)
{
  unsigned int *v1;
  unsigned int v2;
  unsigned long v3; // stack - 0x48
...
void sub_aad0(unsigned long a0)
{
...
void sub_ab60(unsigned long a0,unsigned long a1)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned int v3; // stack - 0x3c
...
void sub_abf0(unsigned long a0,int a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_ac90(unsigned long a0,long a1,long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
...
void sub_ad30(unsigned int a0,long a1,long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_add0(long a0,long a1,unsigned long a2)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_ae70(long a0,long a1,unsigned long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_af20(unsigned long a0,unsigned long a1)
{
  sub_a1a0(0,a0,a1,0x11040); // tail-call
}

// Function: sub_af40 @ 0xaf40
void sub_af40(unsigned long a0,unsigned long a1)
{
  sub_a1a0(a0,a1,0xffffffffffffffff,0x11040); // tail-call
}

// Function: sub_af60 @ 0xaf60
void sub_af60(unsigned long a0)
{
  sub_a1a0(0,a0,0xffffffffffffffff,0x11040); // tail-call
}
...
char * sub_b5c0(char *a0,unsigned long a1,unsigned long a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
