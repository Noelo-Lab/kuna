...
void sub_4730(unsigned long a0,unsigned long a1,unsigned long a2)
{
  ...
  (*dat_ffd8)(sub_3b00,v2,&Stack0000000000000008,0,0,a2,v1);
  do {
  } while( true );
}
...
char * sub_4be0(char *a0,char a1,unsigned long a2)
{
  long v1;
  void *v2; // rax
...
void sub_4d10(void)
{
  ...
  do {
    while (v1 = *(char **)&stdin[8], *(char **)&stdin[0x10] <= v1) {
      v2 = __uflow();
...
void sub_4d80(unsigned long a0,unsigned char *a1)
{
  if ((!fread_unlocked(a0,1,0x10000,a1)) && (*a1 & 0x20))
    sub_4b30(dcgettext(NULL,"read failed",5)); // no-return
}

// Function: sub_4dc0 @ 0x4dc0
void sub_4dc0(unsigned long a0,int a1,unsigned long a2)
{
  unsigned char v1;
  unsigned int v2; // ebx
  unsigned int v3;
...
void sub_5950(int a0)
{
  ...
  if (0x1000 <= v1 + v2) { // branch-flip
    ...
    v3 = __mempcpy_chk(v5,dat_105e8,v1,(unsigned long)"up2");
...
void sub_5c20(char *a0)
{
  ...
  v4 = sub_8380(&a0[0x24],v2,sub_70a0(v2,v3),&a0[4]);
  *(long *)&a0[0x18] = v4;
  if (v4 == -1) {
    a0[0x18] = '\x01';
    a0[0x19] = '\0';
...
unsigned long sub_5d90(char *a0,unsigned long a1)
{
  char v1;
  char v10; // stack - 0xac
  char *v11; // stack - 0xa8
...
unsigned long sub_6aa0(unsigned long a0)
{
  unsigned long v1;
  unsigned long v2;
  char v3 [1032];
...
long sub_6b80(long a0) // return-dupe
{
  unsigned long v1;
  unsigned long v2;
  unsigned long v3;
  ...
  if (2 <= __ctype_get_mb_cur_max()) { // branch-flip
    if (a1) {
      ...
      while( true ) {
        ...
        if (v3) {
label_7564:
          v14 = sub_8380(v8,v9,(long)v10 - (long)v9,&v7);
...
label_7303:
        ...
        if (!(*(unsigned int *)((unsigned long)(*v9 >> 5) * 4 + 0xc260) >> (*v9 & 0x1f) & 1)) {
          if (mbsinit(&v7)) {
            v3 = 1;
            goto label_7564;
          }
...
long sub_76b0(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
...
void sub_7b50(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_7bf0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  long v1;
  unsigned long v2;
  long v3 [4];
...
void sub_8050(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_810e;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
void sub_81b0(void *a0,unsigned long a1)
{
...
unsigned long sub_8380(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
...
void sub_8580(long *a0,long *a1) // return-dupe
{
  long v1;
  long *v2;
...
char sub_8910(void *a0,char *a1,unsigned long *a2)
{
  char v1;
  char v10 [32];
...
label_9330:
              v18 = v9 - v21;
              if (v18) { // branch-flip
                if (!v29) goto label_937d;
                while ((!v32 || (v33))) {
                  v29 = '\0';
                  v30 = &v30[v31];
                  v18 -= 1;
                  if (!v18) goto label_93b0;
label_937d:
                  sub_87a0(v16);
                }
                if (v29) goto label_9440;
label_93b0:
                sub_87a0(v16);
              }
              else if (!v29) goto label_93b0;
              v20 = v32;
              if (v32) { // branch-flip
                if (!v33) {
label_9440:
                  v20 = sub_8910(a0,a1,&v11);
                  if (v20)
                    return v11;
                }
              }
          ...
          v10 = v9 + 1;
          if (!v26) goto label_9106;
          if (v40 == v27) goto label_9146;
label_9098:
          v7 = v37;
          v17 = v38;
        }
...
label_9146:
              ...
              do {
                ...
                if ((char)v48) { // branch-flip
                  if (!v48._4_4_)
                    return NULL;
                  if (!v56) goto label_92be;
                  if (v48._4_4_ != v57) goto label_9098;
                }
                else {
label_92be:
                  if ((v47 != v55) || (v6 = memcmp(v46,v54,v47), v6)) goto label_9098;
                }
                v46 = &v7[v9];
                v44[4] = 0;
                v54 = &v1[v17];
        ...
        if (v4) {
          if (v17 * 5 <= v10) { // branch-flip
            if (v7) {
              ...
              v9 = v10;
              if (*v7) goto label_8edd;
            }
            v5 = sub_8600(v1,a1,strlen(a1),&v11);
            if ((char)v5)
              return v11;
            v7 = NULL;
          }
...
char * sub_9ac0(char *a0,unsigned long a1,unsigned long a2)
{
  int v1;
  char *v2; // rax
  long v3; // rax
