...
int main(int argc,char **argv,char **envp)
{
  ...
  v14 = NULL;
  while (v2 = getopt_long(argc,v13,"0123456789cstuw:p:g:",(void *)0xbaa0,NULL), v2 != -1) {
    if (0x77 < v2) {
label_2acd:
...
void sub_3390(char a0) // return-dupe x2
{
  if (dat_17131) {
    dat_c0ec = dat_c0f0;
    return;
...
void sub_41c0(void *a0,unsigned int a1)
{
  if (a0) {
...
unsigned long sub_41f0(void *a0) // early-return
{
  int v1;
  int *v2; // rax
    ...
    if (v27) {
      ...
      if (v23) {
        ...
        if (v31) {
          ...
          if ((a3 < v24 + v31) || (v9 = memcmp(v12,v32,v31), v9)) goto label_4fb0;
          if (!v26) {
            v8 = *v12;
...
label_5054:
          if ((char)v19 == '\\') {
            if (((bool)(v2 & v26)) && (v31)) goto label_507a;
            v17 = 0x5c;
            goto label_4aa2;
          }
label_4883:
          v17 = (unsigned char)v19;
          if (v34 != 1) goto label_4e03;
label_4890:
          v10 = __ctype_b_loc();
          v22 = 1;
...
label_4778:
    v17 = (unsigned char)v22;
    v13 = v14;
    if (!v30) goto label_4923;
    if (!(*(unsigned int *)(v30 + (v22 >> 5) * 4) >> (v17 & 0x1f) & 1)) goto label_4923;
  }
  else {
label_4920:
    v8 = 0;
...
void * sub_5960(unsigned int a0,unsigned long a1,unsigned long a2,unsigned int *a3)
{
  unsigned long *v1;
  long v10; // stack - 0x48
  int *v11; // stack - 0x68
  ...
  if (a0 <= 0x7ffffffe) {
    ...
    if (dat_c058 <= (int)a0) {
      v10 = (long)dat_c058;
      v9 = (long)(int)((a0 - dat_c058) + 1);
      if (dat_c060 != (unsigned long *)0xc070) // branch-flip
        v6 = (unsigned long *)sub_7130(dat_c060,&v10,v9,0x7fffffff,0x10);
      else {
        v6 = (unsigned long *)sub_7130(0,&v10,v9,0x7fffffff,0x10);
        *v6 = dat_c070;
        v6[1] = dat_c078;
      }
      dat_c060 = v6;
      memset(&v6[(long)dat_c058 * 2],0,(v10 - dat_c058) * 0x10);
      dat_c058 = (int)v10;
    }
    v1 = &v6[(long)(int)a0 * 2];
    v3 = a3[1];
    v5 = *v1;
    v8 = (void *)v1[1];
    v7 = sub_44d0(v8,v5,a1,a2,*a3,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    if (v5 <= v7) {
      v7 += 1;
      *v1 = v7;
      if (v8 != (void *)0x17160)
      ...
      sub_44d0(v8,v7,a1,a2,v4,v3 | 1,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
    }
    *v11 = v2;
    return v8;
  }
...
void sub_5c70(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  int v1;
  int *v2; // rax
  ...
  v2 = __errno_location();
  v1 = *v2;
  sub_44d0(a0,a1,a2,a3,*a4,a4[1],&a4[2],*(unsigned long *)&a4[10],*(unsigned long *)&a4[0xc]);
  *v2 = v1;
}

// Function: sub_5cf0 @ 0x5cf0
unsigned long sub_5cf0(unsigned long a0,unsigned long a1,long *a2,unsigned int *a3)
{
  int v1;
  int *v2; // rax
  long v3; // rax
  ...
  v3 = sub_44d0(0,0,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  v4 = sub_6e90(v3 + 1);
  sub_44d0(v4,v3 + 1,a0,a1,*a3,v5,&a3[2],*(unsigned long *)&a3[10],*(unsigned long *)&a3[0xc]);
  *v2 = v1;
  if (a2)
    *a2 = v3;
  return v4;
...
void sub_5de0(unsigned long a0,unsigned long a1,unsigned long a2)
{
  sub_5cf0(a0,a1,0,a2); // tail-call
}
...
void sub_5e90(unsigned long a0,unsigned long a1)
{
  sub_5960(a0,a1,0xffffffffffffffff,0x17260); // tail-call
}
...
void sub_5ec0(unsigned long a0)
{
  sub_5960(0,a0,0xffffffffffffffff,0x17260); // tail-call
}

// Function: sub_5ee0 @ 0x5ee0
void sub_5ee0(unsigned long a0,unsigned long a1)
{
  sub_5960(0,a0,a1,0x17260); // tail-call
}

// Function: sub_5f00 @ 0x5f00
void sub_5f00(unsigned long a0,int a1,unsigned long a2)
{
...
void sub_5fa0(unsigned long a0,int a1,unsigned long a2,unsigned long a3)
{
  int v1 [14]; // stack - 0x48
...
void sub_6030(int a0,unsigned long a1)
{
  int v1 [14]; // stack - 0x48
...
void sub_60c0(int a0,unsigned long a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_6150(unsigned long a0,unsigned long a1,unsigned char a2)
{
  unsigned int *v1;
  unsigned int v2;
...
void sub_61f0(unsigned long a0,unsigned char a1)
{
  unsigned int *v1;
  unsigned int v2;
  unsigned long v3; // stack - 0x48
...
void sub_6290(unsigned long a0)
{
...
void sub_6320(unsigned long a0,unsigned long a1)
{
  unsigned long v1; // stack - 0x48
  unsigned long v2; // stack - 0x40
  unsigned int v3; // stack - 0x3c
...
void sub_63b0(unsigned long a0,int a1,unsigned long a2)
{
  int v1 [14]; // stack - 0x48
...
void sub_6450(unsigned long a0,long a1,long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
...
void sub_64f0(unsigned int a0,long a1,long a2,unsigned long a3,unsigned long a4)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_6590(long a0,long a1,unsigned long a2)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_6630(long a0,long a1,unsigned long a2,unsigned long a3)
{
  unsigned long v1; // stack - 0x48
  unsigned int v2; // stack - 0x44
  unsigned long v3; // stack - 0x40
...
void sub_66e0(unsigned long a0,unsigned long a1)
{
  sub_5960(0,a0,a1,0xc020); // tail-call
}

// Function: sub_6700 @ 0x6700
void sub_6700(unsigned long a0,unsigned long a1)
{
  sub_5960(a0,a1,0xffffffffffffffff,0xc020); // tail-call
}

// Function: sub_6720 @ 0x6720
void sub_6720(unsigned long a0)
{
  sub_5960(0,a0,0xffffffffffffffff,0xc020); // tail-call
}

// Function: sub_6740 @ 0x6740
long sub_6740(void *a0,long a1,unsigned long a2,unsigned long a3,unsigned long *a4,unsigned long a5)
{
  long v1;
...
void sub_6be0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned int *a4)
{
  unsigned int v1;
  long *v2;
  long v3;
...
void sub_6c80(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
  long v1;
  unsigned long v2;
  long v3 [4];
...
void sub_7130(void *a0,long *a1,long a2,long a3,long a4)
{
  ...
  if (SEXT816((long)v3) != SEXT816(v2) * SEXT816(a4)) // branch-flip
    ...
    if (0x80 <= (long)v3) goto label_71ee;
    v4 = 0x80;
  }
  v2 = v4 / a4;
  v3 = v4 - v4 % a4;
...
unsigned long sub_7390(unsigned long a0,unsigned int a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5,int a6)
{
  int v1;
  int *v2; // rax
  unsigned long v3; // stack - 0x48
  
  v1 = sub_74d0(a0,0,a1,&v3);
  if (v1) { // branch-flip
    v2 = __errno_location();
    if (v1 != 1) {
      if (v1 == 3)
...
void sub_74a0(unsigned long a0,unsigned long a1,unsigned long a2,unsigned long a3,unsigned long a4,unsigned long a5)
{
...
unsigned int sub_74d0(unsigned char *a0,long *a1,unsigned int a2,unsigned long *a3,char *a4)
{
  ...
  *v23 = 0;
  ...
  if (v24 != a0) { // branch-flip
    ...
    v27 = *v24;
    if (!v27) goto label_758d;
    v28 = v25;
    if (!strchr(a4,(int)(char)v27)) goto label_7595;
  }
  else {
    if ((!a4) || (v27 = *a0, !v27))
      return 4;
...
label_7595:
    ...
    case 0x25:
      ...
      v15._8_8_ = 0;
      v15._0_8_ = v26;
      if ((SUB168(v5._0_16_ * v15._0_16_,8)) || (v6._8_8_ = 0, v6._0_8_ = SUB168(v5._0_16_ * v15._0_16_,0), v16._8_8_ = 0, v16._0_8_ = v26, v25 = SUB168(v6._0_16_ * v16._0_16_,0), SUB168(v6._0_16_ * v16._0_16_,8))) goto label_7759;
label_7727:
      v4._8_8_ = 0;
      v4._0_8_ = v25;
      v14._8_8_ = 0;
    ...
    case 0x29:
      ...
      if (SUB168(v2._0_16_ * v12._0_16_,8)) goto label_7759;
      break;
    case 0xb:
    case 0x2b:
      v3._8_8_ = 0;
      ...
      if (!SUB168(v3._0_16_ * v13._0_16_,8)) goto label_7727;
label_7759:
      v32 = 1;
      v25 = 0xffffffffffffffff;
      break;
...
unsigned long sub_7900(unsigned int *a0) // early-return x2, return-dupe
{
  unsigned int v1;
  unsigned long v2; // rax
  unsigned long v3; // rax
...
unsigned long sub_79b0(unsigned int *a0,unsigned char *a1,unsigned long a2,void *a3)
{
  unsigned long v1; // rax
  long v2;
