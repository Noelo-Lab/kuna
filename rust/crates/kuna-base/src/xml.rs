...
mod tests {
    ...
    fn test_xml_corpus_datatests_and_stage_tests() {
        ...
        for dir in ["decompiler/datatests", "tests/stages"] {
        ...
        // 83 datatests + 48 stage testcases
        assert_eq!(count, 131, "corpus file count drifted");
    }
    ...
    fn test_xml_bytechunk_payload_roundtrips_byte_identically() {
        let root = repo_root();
        for rel in [
            "decompiler/datatests/ccmp.xml",
            "decompiler/datatests/deindirect.xml",
            "decompiler/datatests/elseif.xml",
        ] {
    ...
    fn test_xml_char_ref_high_bytes_appended_raw() {
        ...
        // (decompiler/datatests/stackstring.xml does exactly this)
    ...
    fn test_xml_document_storage_open_document() {
        let root = repo_root();
        let path = root.join("decompiler/datatests/ccmp.xml");
        let mut store = DocumentStorage::new();
