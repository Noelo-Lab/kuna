...
target.
    ...
    python -m kuna.pipeline.prdemo --record docs/features/<slug>/record.json
    python -m kuna.pipeline.prdemo --option stackguard --binary B --selector authenticate
"""
...
def main(argv=None):
    p = argparse.ArgumentParser(prog="python -m kuna.pipeline.prdemo",
